...
**Generated** 2026-09-20T20:22:52Z · 2026-09-20 13:22:52 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-20T20:22:43Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h -0.91%; DEX 24h $2.88B · 1d -19% · vs-7d-ago +65%; slot 269 ms
...
- **WARN · Last TPS sample outside 2.5σ of the 60-sample window** — Last sample 5,527 TPS is +2.78σ vs window mean 4,950 (n=60, σ=208). (threshold: `|last sample − window mean| > 2.5σ`)
- **INFO · Correlation: risk-off (SOL 24h ↓ + TVL 1d ↓ + DEX 1d ↓)** — SOL 24h -0.91%, DeFiLlama TVL 1d -2.27%, DEX 1d -18.68%. (threshold: `SOL 24h < 0 AND TVL 1d < 0 AND DEX 1d < 0`)
- **INFO · Large Solana DEX volume 7d move** — DeFiLlama Solana DEX volume 7d change is +64.94%. (threshold: `|7d %| >= 20`)
- **INFO · TPS vs 30d median (solana.com/data tx/86400)** — Current 4,950.45 TPS is +25.2% vs 30d median 3,954.42 TPS (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
...
| Health | `ok` |
| Slot | 448,838,167 |
| Block height | 426,878,828 |
| Block time | 2026-09-20T20:22:43Z |
| Epoch | 1,038 (97.72% · slot 422,167/432,000) |
| Mean TPS (last ~3,600s) | 4,950.4 |
| Mean non-vote TPS | 2,447.4 |
| Median TPS (same window) | 4,935.4 |
| Mean slot time | 268.7 ms |
| Median slot time | 267.9 ms |
| Transaction count (cluster) | 550,667,568,800 |
| Circulating supply | 587,366,503 SOL |
| Total supply | 634,375,182 SOL |
...
- `t23p8aBQ…` · 14.48K SOL · commission 0% · lag 1242931 slots
- `AYY1TCe3…` · 10.81K SOL · commission 0% · lag 214197 slots
- `NWY18yrP…` · 9.76K SOL · commission 10% · lag 39457 slots
- `mrgn4atx…` · 2.26K SOL · commission 0% · lag 240762 slots
- `pSoLoZx5…` · 1.51K SOL · commission 4% · lag 963415 slots
- `Hgozywot…` · 797.43 SOL · commission 100% · lag 345296 slots
- `EWARp8Sy…` · 64.91 SOL · commission 5% · lag 1842171 slots
- `9fTWmMqV…` · 23.85 SOL · commission 0% · lag 75792 slots
- `FLVgaCPv…` · 9.28 SOL · commission 5% · lag 20822629 slots
- `stacheBm…` · 3.00 SOL · commission 5% · lag 19302484 slots
- `HDRqPft5…` · 2.00 SOL · commission 100% · lag 448838167 slots
- `6mygxmZx…` · 2.00 SOL · commission 100% · lag 229729 slots
...
| Jito tip-floor run-rate (NOT REV) | $118.51K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 118505 USD; at p95 floor → 3612258 USD. |
...
| Market cap | $64.74B | coingecko.simple_price |
...
24h volume $79.29M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-09-20 (2026-09-20 13:22:52 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 5922ms https://api.mainnet-beta.solana.com
...
- `solana.com.rpc_data` [ok] 200 866ms https://solana.com/api/rpc/data
...
- `rss.nitter.solana_status` [ok] 200 2422ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [ok] 200 2277ms https://nitter.perennialte.ch/anza_xyz/rss
...
- `xstocks.assets.p4` [ok] 200 2526ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=4
...
- `xstocks.circ.WGSx` [ok] 200 271ms https://api.backed.fi/api/v2/public/assets/WGSx/circulating-supply?format=object
...
- `xstocks.mult.QUBTx` [ok] 200 599ms https://api.backed.fi/api/v2/public/assets/QUBTx/multiplier?network=Solana
- `xstocks.price.WYFIx` [FAIL]  12016ms https://api.backed.fi/api/v2/public/assets/WYFIx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.BETRx` [ok] 200 643ms https://api.backed.fi/api/v2/public/assets/BETRx/multiplier?network=Solana
...
- `xstocks.mult.SAILx` [ok] 200 1186ms https://api.backed.fi/api/v2/public/assets/SAILx/multiplier?network=Solana
...
- `xstocks.mult.SMTCx` [ok] 200 474ms https://api.backed.fi/api/v2/public/assets/SMTCx/multiplier?network=Solana
...
- `xstocks.mult.GFLx` [ok] 200 860ms https://api.backed.fi/api/v2/public/assets/GFLx/multiplier?network=Solana
...
- `xstocks.mult.WTRGx` [ok] 200 333ms https://api.backed.fi/api/v2/public/assets/WTRGx/multiplier?network=Solana
...
- `xstocks.price.IESCx` [FAIL]  12010ms https://api.backed.fi/api/v2/public/assets/IESCx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.AURx` [ok] 200 281ms https://api.backed.fi/api/v2/public/assets/AURx/circulating-supply?format=object
...
- `xstocks.mult.AURx` [ok] 200 738ms https://api.backed.fi/api/v2/public/assets/AURx/multiplier?network=Solana
...
- `xstocks.price.NWSx` [FAIL]  12014ms https://api.backed.fi/api/v2/public/assets/NWSx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.BAXx` [ok] 200 309ms https://api.backed.fi/api/v2/public/assets/BAXx/circulating-supply?format=object
...
- `xstocks.mult.RVTYx` [ok] 200 482ms https://api.backed.fi/api/v2/public/assets/RVTYx/multiplier?network=Solana
...
- `jup.tokens.search.METCx` [ok] 200 125ms https://lite-api.jup.ag/tokens/v2/search?query=METCx
