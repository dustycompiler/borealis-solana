...
**Generated** 2026-08-30T06:48:38Z · 2026-08-29 23:48:38 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-30T06:48:27Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h +1.41%; DEX 24h $1.81B · 1d -30% · vs-7d-ago -51%; slot 316 ms
...
| Health | `ok` |
| Slot | 442,814,814 |
| Block height | 420,862,609 |
| Block time | 2026-08-30T06:48:27Z |
| Epoch | 1,025 (3.43% · slot 14,814/432,000) |
| Mean TPS (last ~3,600s) | 3,465.5 |
| Mean non-vote TPS | 1,320.9 |
| Median TPS (same window) | 3,449.4 |
| Mean slot time | 315.9 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 543,343,519,069 |
| Circulating supply | 585,122,416 SOL |
| Total supply | 633,173,883 SOL |
...
- `mrgn4atx…` · 21.79K SOL · commission 0% · lag 11077 slots
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1562135 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 28693 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 134976 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 831060 slots
- `CpdzCVza…` · 315.26 SOL · commission 100% · lag 14463 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 55977 slots
- `HFTcVVrX…` · 152.80 SOL · commission 100% · lag 14357 slots
- `6pEtDovp…` · 131.96 SOL · commission 100% · lag 28741 slots
- `7G4Rfctw…` · 75.85 SOL · commission 100% · lag 53115 slots
- `DZKTNGR3…` · 48.61 SOL · commission 100% · lag 60657 slots
- `As9NxA9b…` · 46.69 SOL · commission 100% · lag 14480 slots
...
| --- | ---: | --- |
| TPS chart | 171 | data/history.jsonl snapshot tape |
| TVL chart | 171 | data/history.jsonl snapshot tape |
| SOL chart | 170 | data/history.jsonl snapshot tape |
| history.jsonl rows | 171 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $43.01K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 43009 USD; at p95 floor → 1266087 USD. |
...
24h volume $8.67M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-08-30 (2026-08-29 23:48:38 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 5091ms https://api.mainnet-beta.solana.com
...
- `rss.nitter.anza_xyz` [ok] 200 1472ms https://nitter.perennialte.ch/anza_xyz/rss
...
- `xstocks.assets.p0` [ok] 200 2329ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0
- `xstocks.assets.p1` [ok] 200 2079ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=1
...
- `xstocks.assets.p5` [ok] 200 2138ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=5
- `xstocks.assets.p6` [ok] 200 1842ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=6
- `xstocks.assets.p7` [ok] 200 266ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=7
...
- `xstocks.circ.METAx` [ok] 200 508ms https://api.backed.fi/api/v2/public/assets/METAx/circulating-supply?format=object
...
- `xstocks.mult.AMZNx` [ok] 200 614ms https://api.backed.fi/api/v2/public/assets/AMZNx/multiplier?network=Solana
- `xstocks.circ.NVDAx` [ok] 200 996ms https://api.backed.fi/api/v2/public/assets/NVDAx/circulating-supply?format=object
- `xstocks.mult.NVDAx` [ok] 200 534ms https://api.backed.fi/api/v2/public/assets/NVDAx/multiplier?network=Solana
...
- `xstocks.circ.SUOPTx` [ok] 200 490ms https://api.backed.fi/api/v2/public/assets/SUOPTx/circulating-supply?format=object
- `xstocks.circ.QQQx` [ok] 200 818ms https://api.backed.fi/api/v2/public/assets/QQQx/circulating-supply?format=object
- `xstocks.circ.MMGx` [ok] 200 583ms https://api.backed.fi/api/v2/public/assets/MMGx/circulating-supply?format=object
...
- `xstocks.mult.MMGx` [ok] 200 1057ms https://api.backed.fi/api/v2/public/assets/MMGx/multiplier?network=Solana
- `xstocks.mult.LAOPGx` [ok] 200 821ms https://api.backed.fi/api/v2/public/assets/LAOPGx/multiplier?network=Solana
- `xstocks.circ.TNGYIx` [ok] 200 2252ms https://api.backed.fi/api/v2/public/assets/TNGYIx/circulating-supply?format=object
- `xstocks.mult.TNGYIx` [ok] 200 205ms https://api.backed.fi/api/v2/public/assets/TNGYIx/multiplier?network=Solana
- `xstocks.price.JDLOGx` [FAIL]  12010ms https://api.backed.fi/api/v2/public/assets/JDLOGx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.JDLOGx` [ok] 200 324ms https://api.backed.fi/api/v2/public/assets/JDLOGx/multiplier?network=Solana
...
- `xstocks.mult.HAIDLx` [ok] 200 315ms https://api.backed.fi/api/v2/public/assets/HAIDLx/multiplier?network=Solana
...
- `xstocks.circ.WRFHDx` [ok] 200 1382ms https://api.backed.fi/api/v2/public/assets/WRFHDx/circulating-supply?format=object
...
- `xstocks.mult.WRFHDx` [ok] 200 869ms https://api.backed.fi/api/v2/public/assets/WRFHDx/multiplier?network=Solana
- `xstocks.mult.ENNHLx` [ok] 200 649ms https://api.backed.fi/api/v2/public/assets/ENNHLx/multiplier?network=Solana
- `xstocks.circ.SNBIOx` [ok] 200 2177ms https://api.backed.fi/api/v2/public/assets/SNBIOx/circulating-supply?format=object
...
- `xstocks.circ.SMOIHx` [ok] 200 2977ms https://api.backed.fi/api/v2/public/assets/SMOIHx/circulating-supply?format=object
- `xstocks.mult.SMOIHx` [ok] 200 206ms https://api.backed.fi/api/v2/public/assets/SMOIHx/multiplier?network=Solana
- `xstocks.circ.JTGEXx` [ok] 200 1003ms https://api.backed.fi/api/v2/public/assets/JTGEXx/circulating-supply?format=object
...
- `xstocks.mult.CRESMx` [ok] 200 1148ms https://api.backed.fi/api/v2/public/assets/CRESMx/multiplier?network=Solana
...
- `xstocks.circ.ASMPTx` [ok] 200 483ms https://api.backed.fi/api/v2/public/assets/ASMPTx/circulating-supply?format=object
...
- `xstocks.mult.JDHLTx` [ok] 200 1008ms https://api.backed.fi/api/v2/public/assets/JDHLTx/multiplier?network=Solana
...
- `xstocks.circ.CRESPx` [ok] 200 316ms https://api.backed.fi/api/v2/public/assets/CRESPx/circulating-supply?format=object
...
- `xstocks.mult.CTFJWx` [ok] 200 309ms https://api.backed.fi/api/v2/public/assets/CTFJWx/multiplier?network=Solana
...
- `xstocks.circ.WHGROx` [ok] 200 748ms https://api.backed.fi/api/v2/public/assets/WHGROx/circulating-supply?format=object
...
- `xstocks.mult.WHGROx` [ok] 200 1754ms https://api.backed.fi/api/v2/public/assets/WHGROx/multiplier?network=Solana
...
- `xstocks.circ.CKAHx` [ok] 200 449ms https://api.backed.fi/api/v2/public/assets/CKAHx/circulating-supply?format=object
...
- `xstocks.mult.HKCGAx` [ok] 200 806ms https://api.backed.fi/api/v2/public/assets/HKCGAx/multiplier?network=Solana
...
- `xstocks.circ.HKEXCx` [ok] 200 486ms https://api.backed.fi/api/v2/public/assets/HKEXCx/circulating-supply?format=object
- `xstocks.circ.COVELx` [ok] 200 192ms https://api.backed.fi/api/v2/public/assets/COVELx/circulating-supply?format=object
- `xstocks.mult.NONGx` [ok] 200 297ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
...
- `xstocks.mult.CHONGx` [ok] 200 288ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
...
- `xstocks.circ.MTRCPx` [ok] 200 344ms https://api.backed.fi/api/v2/public/assets/MTRCPx/circulating-supply?format=object
- `xstocks.circ.HNDLDx` [ok] 200 459ms https://api.backed.fi/api/v2/public/assets/HNDLDx/circulating-supply?format=object
...
- `xstocks.mult.HNDLDx` [ok] 200 336ms https://api.backed.fi/api/v2/public/assets/HNDLDx/multiplier?network=Solana
- `xstocks.circ.PICCx` [ok] 200 169ms https://api.backed.fi/api/v2/public/assets/PICCx/circulating-supply?format=object
...
- `xstocks.mult.CKHUTx` [ok] 200 420ms https://api.backed.fi/api/v2/public/assets/CKHUTx/multiplier?network=Solana
...
- `xstocks.price.BOCOMx` [FAIL]  12008ms https://api.backed.fi/api/v2/public/assets/BOCOMx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.BOCOMx` [ok] 200 169ms https://api.backed.fi/api/v2/public/assets/BOCOMx/circulating-supply?format=object
...
- `xstocks.mult.CPETCx` [ok] 200 205ms https://api.backed.fi/api/v2/public/assets/CPETCx/multiplier?network=Solana
...
- `xstocks.mult.CITICx` [ok] 200 452ms https://api.backed.fi/api/v2/public/assets/CITICx/multiplier?network=Solana
- `xstocks.mult.BOCHKx` [ok] 200 710ms https://api.backed.fi/api/v2/public/assets/BOCHKx/multiplier?network=Solana
- `xstocks.mult.ANTASx` [ok] 200 205ms https://api.backed.fi/api/v2/public/assets/ANTASx/multiplier?network=Solana
- `xstocks.circ.CRESLx` [ok] 200 436ms https://api.backed.fi/api/v2/public/assets/CRESLx/circulating-supply?format=object
...
- `xstocks.circ.PSBOCx` [ok] 200 297ms https://api.backed.fi/api/v2/public/assets/PSBOCx/circulating-supply?format=object
...
- `xstocks.circ.ICBCx` [ok] 200 413ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
...
- `jup.tokens.search.TNGYIx` [ok] 200 104ms https://lite-api.jup.ag/tokens/v2/search?query=TNGYIx
- `jup.tokens.search.JDLOGx` [ok] 200 100ms https://lite-api.jup.ag/tokens/v2/search?query=JDLOGx
