...
**Generated** 2026-08-29T14:33:29Z · 2026-08-29 07:33:29 PT
**Author** dustycompiler · **Version** 1.5.6 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-29T14:33:18Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h -0.63%; DEX 24h $2.59B · 1d -30% · vs-7d-ago -28%; slot 316 ms
...
- **WARN · SOL price vs 30d median (solana.com/data)** — Current 104.31 USD is +36.9% vs 30d median 76.20 USD (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
- **INFO · Correlation: risk-off (SOL 24h ↓ + TVL 1d ↓ + DEX 1d ↓)** — SOL 24h -0.63%, DeFiLlama TVL 1d -2.79%, DEX 1d -29.99%. (threshold: `SOL 24h < 0 AND TVL 1d < 0 AND DEX 1d < 0`)
...
| Health | `ok` |
| Slot | 442,630,319 |
| Block height | 420,678,198 |
| Block time | 2026-08-29T14:33:18Z |
| Epoch | 1,024 (60.72% · slot 262,320/432,000) |
| Mean TPS (last ~3,600s) | 3,812.5 |
| Mean non-vote TPS | 1,647.7 |
| Median TPS (same window) | 3,811.3 |
| Mean slot time | 316.5 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 543,108,877,561 |
| Circulating supply | 584,161,507 SOL |
| Total supply | 633,079,047 SOL |
...
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1377640 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 283618 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 646565 slots
- `kom1oNHy…` · 662.86 SOL · commission 5% · lag 1993803 slots
- `7ZjHeeYE…` · 176.09 SOL · commission 5% · lag 28304 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442630319 slots
- `pSo1KZXg…` · 2.00 SOL · commission 4% · lag 292478 slots
- `7Dvp5zCF…` · 1.07 SOL · commission 100% · lag 450964 slots
- `bcZxRSoz…` · 0.00 SOL · commission 0% · lag 1990320 slots
...
| --- | ---: | --- |
| TPS chart | 105 | data/history.jsonl snapshot tape |
| TVL chart | 105 | data/history.jsonl snapshot tape |
| SOL chart | 104 | data/history.jsonl snapshot tape |
| history.jsonl rows | 105 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $148.49K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 148494 USD; at p95 floor → 14849407 USD. |
...
| Market cap | $60.94B | coingecko.simple_price |
...
_As of 2026-08-29 (2026-08-29 07:33:29 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 7149ms https://api.mainnet-beta.solana.com
...
- `rss.nitter.solana` [ok] 200 2550ms https://nitter.perennialte.ch/solana/rss
...
- `rss.nitter.solana_devs` [ok] 200 2538ms https://nitter.perennialte.ch/solana_devs/rss
...
- `xstocks.assets.p0` [ok] 200 1450ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0
- `xstocks.assets.p1` [ok] 200 1157ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=1
- `xstocks.assets.p2` [ok] 200 836ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=2
...
- `xstocks.mult.TSLAx` [ok] 200 118ms https://api.backed.fi/api/v2/public/assets/TSLAx/multiplier?network=Solana
...
- `xstocks.mult.NVDAx` [ok] 200 118ms https://api.backed.fi/api/v2/public/assets/NVDAx/multiplier?network=Solana
...
- `xstocks.price.SUOPTx` [FAIL]  12009ms https://api.backed.fi/api/v2/public/assets/SUOPTx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.TNGYIx` [ok] 200 347ms https://api.backed.fi/api/v2/public/assets/TNGYIx/multiplier?network=Solana
- `xstocks.mult.SUOPTx` [ok] 200 116ms https://api.backed.fi/api/v2/public/assets/SUOPTx/multiplier?network=Solana
- `xstocks.mult.LAOPGx` [ok] 200 811ms https://api.backed.fi/api/v2/public/assets/LAOPGx/multiplier?network=Solana
...
- `xstocks.mult.JDLOGx` [ok] 200 140ms https://api.backed.fi/api/v2/public/assets/JDLOGx/multiplier?network=Solana
...
- `xstocks.circ.CTINSx` [ok] 200 521ms https://api.backed.fi/api/v2/public/assets/CTINSx/circulating-supply?format=object
...
- `xstocks.circ.HAIDLx` [ok] 200 528ms https://api.backed.fi/api/v2/public/assets/HAIDLx/circulating-supply?format=object
...
- `xstocks.mult.SNBIOx` [ok] 200 708ms https://api.backed.fi/api/v2/public/assets/SNBIOx/multiplier?network=Solana
- `xstocks.mult.WRFHDx` [ok] 200 1244ms https://api.backed.fi/api/v2/public/assets/WRFHDx/multiplier?network=Solana
...
- `xstocks.price.HRZRBx` [FAIL]  12017ms https://api.backed.fi/api/v2/public/assets/HRZRBx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.CSPCx` [ok] 200 309ms https://api.backed.fi/api/v2/public/assets/CSPCx/multiplier?network=Solana
...
- `xstocks.circ.CMENDx` [ok] 200 424ms https://api.backed.fi/api/v2/public/assets/CMENDx/circulating-supply?format=object
...
- `xstocks.circ.ASMPTx` [ok] 200 279ms https://api.backed.fi/api/v2/public/assets/ASMPTx/circulating-supply?format=object
...
- `xstocks.mult.SINOTx` [ok] 200 956ms https://api.backed.fi/api/v2/public/assets/SINOTx/multiplier?network=Solana
...
- `xstocks.mult.SINOx` [ok] 200 312ms https://api.backed.fi/api/v2/public/assets/SINOx/multiplier?network=Solana
...
- `xstocks.circ.CTPCAx` [ok] 200 869ms https://api.backed.fi/api/v2/public/assets/CTPCAx/circulating-supply?format=object
...
- `xstocks.circ.PWAHLx` [ok] 200 702ms https://api.backed.fi/api/v2/public/assets/PWAHLx/circulating-supply?format=object
...
- `xstocks.mult.GENTEx` [ok] 200 610ms https://api.backed.fi/api/v2/public/assets/GENTEx/multiplier?network=Solana
- `xstocks.price.CKAHx` [FAIL]  12016ms https://api.backed.fi/api/v2/public/assets/CKAHx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.CKINFx` [ok] 200 1096ms https://api.backed.fi/api/v2/public/assets/CKINFx/multiplier?network=Solana
...
- `xstocks.mult.HKCGAx` [ok] 200 1122ms https://api.backed.fi/api/v2/public/assets/HKCGAx/multiplier?network=Solana
...
- `xstocks.mult.NONGx` [ok] 200 614ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
...
- `xstocks.circ.GEELx` [ok] 200 552ms https://api.backed.fi/api/v2/public/assets/GEELx/circulating-supply?format=object
...
- `xstocks.mult.CKHUTx` [ok] 200 145ms https://api.backed.fi/api/v2/public/assets/CKHUTx/multiplier?network=Solana
...
- `xstocks.mult.CPETCx` [ok] 200 122ms https://api.backed.fi/api/v2/public/assets/CPETCx/multiplier?network=Solana
...
- `xstocks.mult.BOCHKx` [ok] 200 247ms https://api.backed.fi/api/v2/public/assets/BOCHKx/multiplier?network=Solana
...
- `xstocks.circ.ANTASx` [ok] 200 231ms https://api.backed.fi/api/v2/public/assets/ANTASx/circulating-supply?format=object
- `xstocks.circ.CRESLx` [ok] 200 167ms https://api.backed.fi/api/v2/public/assets/CRESLx/circulating-supply?format=object
- `xstocks.circ.HAIERx` [ok] 200 170ms https://api.backed.fi/api/v2/public/assets/HAIERx/circulating-supply?format=object
...
- `xstocks.circ.CITICx` [ok] 200 726ms https://api.backed.fi/api/v2/public/assets/CITICx/circulating-supply?format=object
...
- `xstocks.mult.ZJGLDx` [ok] 200 549ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/multiplier?network=Solana
- `xstocks.mult.CITICx` [ok] 200 834ms https://api.backed.fi/api/v2/public/assets/CITICx/multiplier?network=Solana
- `xstocks.circ.PSBOCx` [ok] 200 856ms https://api.backed.fi/api/v2/public/assets/PSBOCx/circulating-supply?format=object
...
- `xstocks.circ.ICBCx` [ok] 200 930ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
- `xstocks.mult.ICBCx` [ok] 200 138ms https://api.backed.fi/api/v2/public/assets/ICBCx/multiplier?network=Solana
...
- `jup.tokens.search.TNGYIx` [ok] 200 42ms https://lite-api.jup.ag/tokens/v2/search?query=TNGYIx
...
- `jup.tokens.search.JDLOGx` [ok] 200 44ms https://lite-api.jup.ag/tokens/v2/search?query=JDLOGx
