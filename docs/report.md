...
**Generated** 2026-08-29T17:33:38Z · 2026-08-29 10:33:38 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-29T17:33:27Z · **RPC health** `ok`
**Health score** 98 / 100 — `25×rpc_ok + 30×clamp(1 − max(0, slot_ms − 300)/300, 0, 1) + 25×clamp(1 − delinquent_stake_pct/2, 0, 1) + 20×clamp(tps / tps_baseline, 0, 1)`
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h +0.13%; DEX 24h $2.59B · 1d -30% · vs-7d-ago -28%; slot 317 ms
...
- **INFO · TPS vs 30d median (solana.com/data tx/86400)** — Current 4,347.58 TPS is +21.2% vs 30d median 3,585.83 TPS (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
...
| Health | `ok` |
| Slot | 442,664,355 |
| Block height | 420,712,214 |
| Block time | 2026-08-29T17:33:27Z |
| Epoch | 1,024 (68.60% · slot 296,356/432,000) |
| Mean TPS (last ~3,600s) | 4,347.6 |
| Mean non-vote TPS | 2,189.1 |
| Median TPS (same window) | 4,345.8 |
| Mean slot time | 317.3 ms |
| Median slot time | 316.6 ms |
| Transaction count (cluster) | 543,153,961,354 |
| Circulating supply | 584,161,388 SOL |
| Total supply | 633,078,928 SOL |
...
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1411676 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 317654 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 680601 slots
- `kom1oNHy…` · 662.86 SOL · commission 5% · lag 2027839 slots
- `7ZjHeeYE…` · 176.09 SOL · commission 5% · lag 62340 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442664355 slots
- `pSo1KZXg…` · 2.00 SOL · commission 4% · lag 326514 slots
- `7Dvp5zCF…` · 1.07 SOL · commission 100% · lag 485000 slots
- `bcZxRSoz…` · 0.00 SOL · commission 0% · lag 2024356 slots
...
| --- | ---: | --- |
| TPS chart | 118 | data/history.jsonl snapshot tape |
| TVL chart | 118 | data/history.jsonl snapshot tape |
| SOL chart | 117 | data/history.jsonl snapshot tape |
| history.jsonl rows | 118 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $59.47K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 59466 USD; at p95 floor → 19337907 USD. |
...
| p90 / p99 | 0.000013 / 0.000128 SOL | same sample |
...
24h volume $19.76M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-08-29 (2026-08-29 10:33:38 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 6320ms https://api.mainnet-beta.solana.com
...
- `llama.stablecoincharts` [ok] 200 1144ms https://stablecoins.llama.fi/stablecoincharts/Solana
...
- `rss.nitter.solana` [ok] 200 3681ms https://nitter.perennialte.ch/solana/rss
- `rss.nitter.solana_status` [ok] 200 5896ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [ok] 200 3605ms https://nitter.perennialte.ch/anza_xyz/rss
- `rss.nitter.solana_devs` [ok] 200 4421ms https://nitter.perennialte.ch/solana_devs/rss
...
- `xstocks.assets.p2` [ok] 200 2099ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=2
- `xstocks.assets.p3` [ok] 200 2166ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=3
...
- `xstocks.assets.p7` [ok] 200 412ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=7
...
- `xstocks.circ.AAPLx` [ok] 200 330ms https://api.backed.fi/api/v2/public/assets/AAPLx/circulating-supply?format=object
- `xstocks.mult.SPYx` [ok] 200 180ms https://api.backed.fi/api/v2/public/assets/SPYx/multiplier?network=Solana
- `xstocks.circ.GOOGLx` [ok] 200 386ms https://api.backed.fi/api/v2/public/assets/GOOGLx/circulating-supply?format=object
...
- `xstocks.circ.TSLAx` [ok] 200 561ms https://api.backed.fi/api/v2/public/assets/TSLAx/circulating-supply?format=object
- `xstocks.mult.GOOGLx` [ok] 200 263ms https://api.backed.fi/api/v2/public/assets/GOOGLx/multiplier?network=Solana
- `xstocks.mult.METAx` [ok] 200 530ms https://api.backed.fi/api/v2/public/assets/METAx/multiplier?network=Solana
...
- `xstocks.mult.AMZNx` [ok] 200 1012ms https://api.backed.fi/api/v2/public/assets/AMZNx/multiplier?network=Solana
...
- `xstocks.price.TNGYIx` [FAIL]  12014ms https://api.backed.fi/api/v2/public/assets/TNGYIx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.BANKCx` [ok] 200 1371ms https://api.backed.fi/api/v2/public/assets/BANKCx/circulating-supply?format=object
- `xstocks.circ.TNGYIx` [ok] 200 1168ms https://api.backed.fi/api/v2/public/assets/TNGYIx/circulating-supply?format=object
- `xstocks.circ.MMGx` [ok] 200 1343ms https://api.backed.fi/api/v2/public/assets/MMGx/circulating-supply?format=object
...
- `xstocks.circ.LAOPGx` [ok] 200 1165ms https://api.backed.fi/api/v2/public/assets/LAOPGx/circulating-supply?format=object
- `xstocks.mult.LAOPGx` [ok] 200 309ms https://api.backed.fi/api/v2/public/assets/LAOPGx/multiplier?network=Solana
- `xstocks.circ.SUOPTx` [ok] 200 2232ms https://api.backed.fi/api/v2/public/assets/SUOPTx/circulating-supply?format=object
...
- `xstocks.circ.CTINSx` [ok] 200 425ms https://api.backed.fi/api/v2/public/assets/CTINSx/circulating-supply?format=object
...
- `xstocks.circ.JDLOGx` [ok] 200 1136ms https://api.backed.fi/api/v2/public/assets/JDLOGx/circulating-supply?format=object
...
- `xstocks.circ.WRFHDx` [ok] 200 1966ms https://api.backed.fi/api/v2/public/assets/WRFHDx/circulating-supply?format=object
- `xstocks.circ.SNBIOx` [ok] 200 1842ms https://api.backed.fi/api/v2/public/assets/SNBIOx/circulating-supply?format=object
- `xstocks.mult.WRFHDx` [ok] 200 172ms https://api.backed.fi/api/v2/public/assets/WRFHDx/multiplier?network=Solana
- `xstocks.circ.SZIGHx` [ok] 200 1885ms https://api.backed.fi/api/v2/public/assets/SZIGHx/circulating-supply?format=object
- `xstocks.mult.SNBIOx` [ok] 200 488ms https://api.backed.fi/api/v2/public/assets/SNBIOx/multiplier?network=Solana
- `xstocks.mult.SZIGHx` [ok] 200 1144ms https://api.backed.fi/api/v2/public/assets/SZIGHx/multiplier?network=Solana
...
- `xstocks.price.CRESBx` [FAIL]  12011ms https://api.backed.fi/api/v2/public/assets/CRESBx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.SMOIHx` [ok] 200 1350ms https://api.backed.fi/api/v2/public/assets/SMOIHx/circulating-supply?format=object
...
- `xstocks.circ.HRZRBx` [ok] 200 1177ms https://api.backed.fi/api/v2/public/assets/HRZRBx/circulating-supply?format=object
...
- `xstocks.mult.CMERPx` [ok] 200 620ms https://api.backed.fi/api/v2/public/assets/CMERPx/multiplier?network=Solana
...
- `xstocks.price.WXXDCx` [FAIL]  12015ms https://api.backed.fi/api/v2/public/assets/WXXDCx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.CMENDx` [ok] 200 399ms https://api.backed.fi/api/v2/public/assets/CMENDx/multiplier?network=Solana
...
- `xstocks.mult.MIXUx` [ok] 200 595ms https://api.backed.fi/api/v2/public/assets/MIXUx/multiplier?network=Solana
...
- `xstocks.circ.SITCx` [ok] 200 801ms https://api.backed.fi/api/v2/public/assets/SITCx/circulating-supply?format=object
...
- `xstocks.mult.CRESPx` [ok] 200 420ms https://api.backed.fi/api/v2/public/assets/CRESPx/multiplier?network=Solana
...
- `xstocks.mult.CTPCAx` [ok] 200 927ms https://api.backed.fi/api/v2/public/assets/CTPCAx/multiplier?network=Solana
...
- `xstocks.circ.PWAHLx` [ok] 200 654ms https://api.backed.fi/api/v2/public/assets/PWAHLx/circulating-supply?format=object
...
- `xstocks.mult.WUXIBx` [ok] 200 176ms https://api.backed.fi/api/v2/public/assets/WUXIBx/multiplier?network=Solana
- `xstocks.circ.GENTEx` [ok] 200 738ms https://api.backed.fi/api/v2/public/assets/GENTEx/circulating-supply?format=object
...
- `xstocks.price.CKAHx` [FAIL]  12010ms https://api.backed.fi/api/v2/public/assets/CKAHx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.CKAHx` [ok] 200 384ms https://api.backed.fi/api/v2/public/assets/CKAHx/multiplier?network=Solana
- `xstocks.mult.SWPRPx` [ok] 200 623ms https://api.backed.fi/api/v2/public/assets/SWPRPx/multiplier?network=Solana
...
- `xstocks.circ.KUAIx` [ok] 200 284ms https://api.backed.fi/api/v2/public/assets/KUAIx/circulating-supply?format=object
...
- `xstocks.circ.HKCGAx` [ok] 200 1475ms https://api.backed.fi/api/v2/public/assets/HKCGAx/circulating-supply?format=object
...
- `xstocks.price.CHONGx` [FAIL]  12012ms https://api.backed.fi/api/v2/public/assets/CHONGx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.HKEXCx` [ok] 200 2151ms https://api.backed.fi/api/v2/public/assets/HKEXCx/circulating-supply?format=object
- `xstocks.circ.CHONGx` [ok] 200 305ms https://api.backed.fi/api/v2/public/assets/CHONGx/circulating-supply?format=object
...
- `xstocks.mult.CHONGx` [ok] 200 670ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
...
- `xstocks.price.PICCx` [FAIL]  12009ms https://api.backed.fi/api/v2/public/assets/PICCx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.CKHUTx` [ok] 200 419ms https://api.backed.fi/api/v2/public/assets/CKHUTx/circulating-supply?format=object
...
- `xstocks.mult.POPMTx` [ok] 200 185ms https://api.backed.fi/api/v2/public/assets/POPMTx/multiplier?network=Solana
...
- `xstocks.circ.BOCOMx` [ok] 200 637ms https://api.backed.fi/api/v2/public/assets/BOCOMx/circulating-supply?format=object
...
- `xstocks.price.CRESLx` [FAIL]  12016ms https://api.backed.fi/api/v2/public/assets/CRESLx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.ANTASx` [ok] 200 193ms https://api.backed.fi/api/v2/public/assets/ANTASx/circulating-supply?format=object
- `xstocks.circ.CRESLx` [ok] 200 172ms https://api.backed.fi/api/v2/public/assets/CRESLx/circulating-supply?format=object
...
- `xstocks.circ.CITICx` [ok] 200 1004ms https://api.backed.fi/api/v2/public/assets/CITICx/circulating-supply?format=object
- `xstocks.mult.CITICx` [ok] 200 218ms https://api.backed.fi/api/v2/public/assets/CITICx/multiplier?network=Solana
...
- `xstocks.price.PSBOCx` [FAIL]  12022ms https://api.backed.fi/api/v2/public/assets/PSBOCx/price-data — TimeoutError: The read operation timed out
- `xstocks.price.ICBCx` [FAIL]  12017ms https://api.backed.fi/api/v2/public/assets/ICBCx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.PSBOCx` [ok] 200 186ms https://api.backed.fi/api/v2/public/assets/PSBOCx/circulating-supply?format=object
- `xstocks.mult.PSBOCx` [ok] 200 282ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
- `xstocks.circ.ICBCx` [ok] 200 1546ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
- `xstocks.mult.ICBCx` [ok] 200 1117ms https://api.backed.fi/api/v2/public/assets/ICBCx/multiplier?network=Solana
...
- `jup.tokens.search.ZHAOMx` [ok] 200 108ms https://lite-api.jup.ag/tokens/v2/search?query=ZHAOMx
- `jup.tokens.search.TNGYIx` [ok] 200 106ms https://lite-api.jup.ag/tokens/v2/search?query=TNGYIx
- `jup.tokens.search.MMGx` [ok] 200 154ms https://lite-api.jup.ag/tokens/v2/search?query=MMGx
- `jup.tokens.search.BANKCx` [ok] 200 122ms https://lite-api.jup.ag/tokens/v2/search?query=BANKCx
- `jup.tokens.search.LAOPGx` [ok] 200 114ms https://lite-api.jup.ag/tokens/v2/search?query=LAOPGx
