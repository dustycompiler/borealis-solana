...
**Generated** 2026-08-30T09:03:43Z · 2026-08-30 02:03:43 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-30T09:03:32Z · **RPC health** `ok`
...
| Health | `ok` |
| Slot | 442,840,406 |
| Block height | 420,888,193 |
| Block time | 2026-08-30T09:03:32Z |
| Epoch | 1,025 (9.35% · slot 40,406/432,000) |
| Mean TPS (last ~3,600s) | 3,343.3 |
| Mean non-vote TPS | 1,205.7 |
| Median TPS (same window) | 3,300.8 |
| Mean slot time | 316.4 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 543,370,682,464 |
| Circulating supply | 585,122,129 SOL |
| Total supply | 633,173,812 SOL |
...
- `nymsGg7Z…` · 116.43K SOL · commission 0% · lag 996 slots
- `mrgn2vUP…` · 90.77K SOL · commission 0% · lag 13971 slots
- `mrgn4atx…` · 21.79K SOL · commission 0% · lag 36669 slots
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1587727 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 54285 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 160568 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 856652 slots
- `CpdzCVza…` · 315.26 SOL · commission 100% · lag 40055 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 81569 slots
- `HFTcVVrX…` · 152.80 SOL · commission 100% · lag 39949 slots
- `6pEtDovp…` · 131.96 SOL · commission 100% · lag 54333 slots
- `7G4Rfctw…` · 75.85 SOL · commission 100% · lag 78707 slots
...
| --- | ---: | --- |
| TPS chart | 180 | data/history.jsonl snapshot tape |
| TVL chart | 180 | data/history.jsonl snapshot tape |
| SOL chart | 179 | data/history.jsonl snapshot tape |
| history.jsonl rows | 180 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $40.92K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 40917 USD; at p95 floor → 218226 USD. |
...
| p90 / p99 | 0.000007 / 0.000068 SOL | same sample |
...
| Market cap | $61.28B | coingecko.simple_price |
...
24h volume $9.26M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-08-30 (2026-08-30 02:03:43 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `llama.stablecoincharts` [ok] 200 62ms https://stablecoins.llama.fi/stablecoincharts/Solana
...
- `rss.nitter.solana_status` [ok] 200 1520ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [ok] 200 1411ms https://nitter.perennialte.ch/anza_xyz/rss
...
- `rpc.getBlock` [ok] 200 158ms https://api.mainnet-beta.solana.com
...
- `xstocks.assets.p0` [ok] 200 1580ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0
- `xstocks.assets.p1` [ok] 200 2457ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=1
...
- `xstocks.assets.p6` [ok] 200 2234ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=6
...
- `xstocks.circ.TSLAx` [ok] 200 615ms https://api.backed.fi/api/v2/public/assets/TSLAx/circulating-supply?format=object
- `xstocks.mult.TSLAx` [ok] 200 119ms https://api.backed.fi/api/v2/public/assets/TSLAx/multiplier?network=Solana
- `xstocks.mult.METAx` [ok] 200 665ms https://api.backed.fi/api/v2/public/assets/METAx/multiplier?network=Solana
...
- `xstocks.price.BANKCx` [FAIL]  12012ms https://api.backed.fi/api/v2/public/assets/BANKCx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.QQQx` [ok] 200 149ms https://api.backed.fi/api/v2/public/assets/QQQx/circulating-supply?format=object
- `xstocks.price.SUOPTx` [FAIL]  12012ms https://api.backed.fi/api/v2/public/assets/SUOPTx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.SUOPTx` [ok] 200 113ms https://api.backed.fi/api/v2/public/assets/SUOPTx/circulating-supply?format=object
...
- `xstocks.mult.BANKCx` [ok] 200 648ms https://api.backed.fi/api/v2/public/assets/BANKCx/multiplier?network=Solana
...
- `xstocks.circ.ZHAOMx` [ok] 200 682ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/circulating-supply?format=object
...
- `xstocks.price.SZIGHx` [FAIL]  12007ms https://api.backed.fi/api/v2/public/assets/SZIGHx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.HAIDLx` [ok] 200 405ms https://api.backed.fi/api/v2/public/assets/HAIDLx/circulating-supply?format=object
- `xstocks.mult.CTINSx` [ok] 200 719ms https://api.backed.fi/api/v2/public/assets/CTINSx/multiplier?network=Solana
- `xstocks.mult.HAIDLx` [ok] 200 162ms https://api.backed.fi/api/v2/public/assets/HAIDLx/multiplier?network=Solana
- `xstocks.mult.JDLOGx` [ok] 200 1225ms https://api.backed.fi/api/v2/public/assets/JDLOGx/multiplier?network=Solana
...
- `xstocks.circ.SNBIOx` [ok] 200 1078ms https://api.backed.fi/api/v2/public/assets/SNBIOx/circulating-supply?format=object
- `xstocks.circ.SZIGHx` [ok] 200 1207ms https://api.backed.fi/api/v2/public/assets/SZIGHx/circulating-supply?format=object
...
- `xstocks.circ.ENNHLx` [ok] 200 1417ms https://api.backed.fi/api/v2/public/assets/ENNHLx/circulating-supply?format=object
...
- `xstocks.circ.CSPCx` [ok] 200 113ms https://api.backed.fi/api/v2/public/assets/CSPCx/circulating-supply?format=object
- `xstocks.mult.CMERPx` [ok] 200 138ms https://api.backed.fi/api/v2/public/assets/CMERPx/multiplier?network=Solana
- `xstocks.circ.SMOIHx` [ok] 200 1052ms https://api.backed.fi/api/v2/public/assets/SMOIHx/circulating-supply?format=object
...
- `xstocks.circ.CRESBx` [ok] 200 970ms https://api.backed.fi/api/v2/public/assets/CRESBx/circulating-supply?format=object
...
- `xstocks.mult.WXXDCx` [ok] 200 137ms https://api.backed.fi/api/v2/public/assets/WXXDCx/multiplier?network=Solana
...
- `xstocks.circ.ASMPTx` [ok] 200 554ms https://api.backed.fi/api/v2/public/assets/ASMPTx/circulating-supply?format=object
...
- `xstocks.mult.MIXUx` [ok] 200 285ms https://api.backed.fi/api/v2/public/assets/MIXUx/multiplier?network=Solana
- `xstocks.circ.SITCx` [ok] 200 111ms https://api.backed.fi/api/v2/public/assets/SITCx/circulating-supply?format=object
- `xstocks.mult.ASMPTx` [ok] 200 309ms https://api.backed.fi/api/v2/public/assets/ASMPTx/multiplier?network=Solana
- `xstocks.price.JDHLTx` [FAIL]  12016ms https://api.backed.fi/api/v2/public/assets/JDHLTx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.JDHLTx` [ok] 200 115ms https://api.backed.fi/api/v2/public/assets/JDHLTx/circulating-supply?format=object
...
- `xstocks.price.CTFJWx` [FAIL]  12009ms https://api.backed.fi/api/v2/public/assets/CTFJWx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.SINOTx` [ok] 200 131ms https://api.backed.fi/api/v2/public/assets/SINOTx/multiplier?network=Solana
...
- `xstocks.circ.WHGROx` [ok] 200 253ms https://api.backed.fi/api/v2/public/assets/WHGROx/circulating-supply?format=object
...
- `xstocks.circ.SINOx` [ok] 200 1299ms https://api.backed.fi/api/v2/public/assets/SINOx/circulating-supply?format=object
...
- `xstocks.circ.GENTEx` [ok] 200 1249ms https://api.backed.fi/api/v2/public/assets/GENTEx/circulating-supply?format=object
- `xstocks.mult.WUXIBx` [ok] 200 877ms https://api.backed.fi/api/v2/public/assets/WUXIBx/multiplier?network=Solana
...
- `xstocks.mult.SWPRPx` [ok] 200 2627ms https://api.backed.fi/api/v2/public/assets/SWPRPx/multiplier?network=Solana
...
- `xstocks.circ.HKCGAx` [ok] 200 1160ms https://api.backed.fi/api/v2/public/assets/HKCGAx/circulating-supply?format=object
...
- `xstocks.circ.KUAIx` [ok] 200 1137ms https://api.backed.fi/api/v2/public/assets/KUAIx/circulating-supply?format=object
- `xstocks.mult.KUAIx` [ok] 200 164ms https://api.backed.fi/api/v2/public/assets/KUAIx/multiplier?network=Solana
- `xstocks.circ.NONGx` [ok] 200 409ms https://api.backed.fi/api/v2/public/assets/NONGx/circulating-supply?format=object
- `xstocks.mult.NONGx` [ok] 200 138ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
- `xstocks.circ.COVELx` [ok] 200 580ms https://api.backed.fi/api/v2/public/assets/COVELx/circulating-supply?format=object
- `xstocks.mult.COVELx` [ok] 200 309ms https://api.backed.fi/api/v2/public/assets/COVELx/multiplier?network=Solana
...
- `xstocks.mult.MEITx` [ok] 200 371ms https://api.backed.fi/api/v2/public/assets/MEITx/multiplier?network=Solana
- `xstocks.mult.CHONGx` [ok] 200 647ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
...
- `xstocks.circ.PICCx` [ok] 200 113ms https://api.backed.fi/api/v2/public/assets/PICCx/circulating-supply?format=object
...
- `xstocks.mult.MTRCPx` [ok] 200 1233ms https://api.backed.fi/api/v2/public/assets/MTRCPx/multiplier?network=Solana
- `xstocks.price.BOCOMx` [FAIL]  12011ms https://api.backed.fi/api/v2/public/assets/BOCOMx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.BOCOMx` [ok] 200 1326ms https://api.backed.fi/api/v2/public/assets/BOCOMx/circulating-supply?format=object
- `xstocks.mult.BOCOMx` [ok] 200 151ms https://api.backed.fi/api/v2/public/assets/BOCOMx/multiplier?network=Solana
- `xstocks.mult.CPETCx` [ok] 200 681ms https://api.backed.fi/api/v2/public/assets/CPETCx/multiplier?network=Solana
- `xstocks.price.BOCHKx` [FAIL]  12018ms https://api.backed.fi/api/v2/public/assets/BOCHKx/price-data — TimeoutError: The read operation timed out
- `xstocks.price.CITICx` [FAIL]  12008ms https://api.backed.fi/api/v2/public/assets/CITICx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.BOCHKx` [ok] 200 986ms https://api.backed.fi/api/v2/public/assets/BOCHKx/circulating-supply?format=object
- `xstocks.mult.BOCHKx` [ok] 200 131ms https://api.backed.fi/api/v2/public/assets/BOCHKx/multiplier?network=Solana
- `xstocks.mult.CITICx` [ok] 200 713ms https://api.backed.fi/api/v2/public/assets/CITICx/multiplier?network=Solana
...
- `xstocks.circ.ANTASx` [ok] 200 1622ms https://api.backed.fi/api/v2/public/assets/ANTASx/circulating-supply?format=object
...
- `xstocks.circ.CRESLx` [ok] 200 1471ms https://api.backed.fi/api/v2/public/assets/CRESLx/circulating-supply?format=object
- `xstocks.mult.CRESLx` [ok] 200 132ms https://api.backed.fi/api/v2/public/assets/CRESLx/multiplier?network=Solana
- `xstocks.mult.ANTASx` [ok] 200 441ms https://api.backed.fi/api/v2/public/assets/ANTASx/multiplier?network=Solana
- `xstocks.circ.ZJGLDx` [ok] 200 421ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/circulating-supply?format=object
...
- `xstocks.mult.HAIERx` [ok] 200 1508ms https://api.backed.fi/api/v2/public/assets/HAIERx/multiplier?network=Solana
- `xstocks.circ.PSBOCx` [ok] 200 180ms https://api.backed.fi/api/v2/public/assets/PSBOCx/circulating-supply?format=object
- `xstocks.mult.PSBOCx` [ok] 200 147ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
- `xstocks.circ.ICBCx` [ok] 200 1089ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
...
- `jup.tokens.search.ZHAOMx` [ok] 200 44ms https://lite-api.jup.ag/tokens/v2/search?query=ZHAOMx
- `jup.tokens.search.WRFHDx` [ok] 200 37ms https://lite-api.jup.ag/tokens/v2/search?query=WRFHDx
...
- `jito.daily_mev_rewards` [ok] 200 3580ms https://kobe.mainnet.jito.network/api/v1/daily_mev_rewards
