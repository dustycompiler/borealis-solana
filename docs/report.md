...
**Generated** 2026-08-30T11:03:58Z · 2026-08-30 04:03:58 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-30T11:03:47Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h +1.59%; DEX 24h $1.67B · 1d -36% · vs-7d-ago -55%; slot 316 ms
...
- **WARN · SOL price vs 30d median (solana.com/data)** — Current 105.12 USD is +38.0% vs 30d median 76.20 USD (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
...
| Health | `ok` |
| Slot | 442,863,212 |
| Block height | 420,910,996 |
| Block time | 2026-08-30T11:03:47Z |
| Epoch | 1,025 (14.63% · slot 63,213/432,000) |
| Mean TPS (last ~3,600s) | 3,203.4 |
| Mean non-vote TPS | 1,068.4 |
| Median TPS (same window) | 3,188.6 |
| Mean slot time | 316.3 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 543,394,253,851 |
| Circulating supply | 585,122,066 SOL |
| Total supply | 633,173,750 SOL |
...
- `nymsGg7Z…` · 116.43K SOL · commission 0% · lag 23802 slots
- `mrgn2vUP…` · 90.77K SOL · commission 0% · lag 36777 slots
- `mrgn4atx…` · 21.79K SOL · commission 0% · lag 59475 slots
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1610533 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 77091 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 183374 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 879458 slots
- `CpdzCVza…` · 315.26 SOL · commission 100% · lag 62861 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 104375 slots
- `HFTcVVrX…` · 152.80 SOL · commission 100% · lag 62755 slots
- `6pEtDovp…` · 131.96 SOL · commission 100% · lag 77139 slots
- `7G4Rfctw…` · 75.85 SOL · commission 100% · lag 101513 slots
...
| --- | ---: | --- |
| TPS chart | 188 | data/history.jsonl snapshot tape |
| TVL chart | 188 | data/history.jsonl snapshot tape |
| SOL chart | 187 | data/history.jsonl snapshot tape |
| history.jsonl rows | 188 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $30.55K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 30553 USD; at p95 floor → 970396 USD. |
...
| p90 / p99 | 0.000009 / 0.000122 SOL | same sample |
...
_As of 2026-08-30 (2026-08-30 04:03:58 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `coingecko.simple_price` [ok] 200 22ms https://api.coingecko.com/api/v3/simple/price?ids=solana&vs_currencies=usd&include_24hr_change=true&include_market_cap=true&include_24hr_vol=true&include_last_updated_at=true
...
- `solana.com.rpc_data` [ok] 200 2317ms https://solana.com/api/rpc/data
...
- `rss.nitter.solana_status` [ok] 200 1492ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [ok] 200 2184ms https://nitter.perennialte.ch/anza_xyz/rss
- `rss.nitter.solana_devs` [ok] 200 1497ms https://nitter.perennialte.ch/solana_devs/rss
...
- `xstocks.assets.p5` [ok] 200 1151ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=5
- `xstocks.assets.p6` [ok] 200 1119ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=6
- `xstocks.assets.p7` [ok] 200 214ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=7
...
- `xstocks.circ.AMZNx` [ok] 200 675ms https://api.backed.fi/api/v2/public/assets/AMZNx/circulating-supply?format=object
- `xstocks.mult.NVDAx` [ok] 200 817ms https://api.backed.fi/api/v2/public/assets/NVDAx/multiplier?network=Solana
- `xstocks.mult.AMZNx` [ok] 200 345ms https://api.backed.fi/api/v2/public/assets/AMZNx/multiplier?network=Solana
- `xstocks.circ.SPYx` [ok] 200 1705ms https://api.backed.fi/api/v2/public/assets/SPYx/circulating-supply?format=object
...
- `xstocks.price.TNGYIx` [FAIL]  12017ms https://api.backed.fi/api/v2/public/assets/TNGYIx/price-data — TimeoutError: The read operation timed out
- `xstocks.price.ZHAOMx` [FAIL]  12011ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.TNGYIx` [ok] 200 775ms https://api.backed.fi/api/v2/public/assets/TNGYIx/multiplier?network=Solana
...
- `xstocks.price.KUNLx` [FAIL]  12024ms https://api.backed.fi/api/v2/public/assets/KUNLx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.JDLOGx` [ok] 200 708ms https://api.backed.fi/api/v2/public/assets/JDLOGx/multiplier?network=Solana
...
- `xstocks.circ.SZIGHx` [ok] 200 1324ms https://api.backed.fi/api/v2/public/assets/SZIGHx/circulating-supply?format=object
...
- `xstocks.circ.CRESBx` [ok] 200 1243ms https://api.backed.fi/api/v2/public/assets/CRESBx/circulating-supply?format=object
...
- `xstocks.circ.SMOIHx` [ok] 200 1821ms https://api.backed.fi/api/v2/public/assets/SMOIHx/circulating-supply?format=object
- `xstocks.circ.CMERPx` [ok] 200 900ms https://api.backed.fi/api/v2/public/assets/CMERPx/circulating-supply?format=object
...
- `xstocks.circ.CSPCx` [ok] 200 1691ms https://api.backed.fi/api/v2/public/assets/CSPCx/circulating-supply?format=object
...
- `xstocks.mult.SMOIHx` [ok] 200 1434ms https://api.backed.fi/api/v2/public/assets/SMOIHx/multiplier?network=Solana
...
- `xstocks.circ.CRESMx` [ok] 200 2209ms https://api.backed.fi/api/v2/public/assets/CRESMx/circulating-supply?format=object
- `xstocks.circ.WXXDCx` [ok] 200 1527ms https://api.backed.fi/api/v2/public/assets/WXXDCx/circulating-supply?format=object
- `xstocks.mult.WXXDCx` [ok] 200 156ms https://api.backed.fi/api/v2/public/assets/WXXDCx/multiplier?network=Solana
- `xstocks.mult.CRESMx` [ok] 200 458ms https://api.backed.fi/api/v2/public/assets/CRESMx/multiplier?network=Solana
- `xstocks.price.CMENDx` [FAIL]  12015ms https://api.backed.fi/api/v2/public/assets/CMENDx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.price.SITCx` [FAIL]  12011ms https://api.backed.fi/api/v2/public/assets/SITCx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.MIXUx` [ok] 200 1329ms https://api.backed.fi/api/v2/public/assets/MIXUx/circulating-supply?format=object
- `xstocks.circ.SITCx` [ok] 200 289ms https://api.backed.fi/api/v2/public/assets/SITCx/circulating-supply?format=object
- `xstocks.circ.CMENDx` [ok] 200 1850ms https://api.backed.fi/api/v2/public/assets/CMENDx/circulating-supply?format=object
...
- `xstocks.mult.CMENDx` [ok] 200 918ms https://api.backed.fi/api/v2/public/assets/CMENDx/multiplier?network=Solana
- `xstocks.mult.SITCx` [ok] 200 1074ms https://api.backed.fi/api/v2/public/assets/SITCx/multiplier?network=Solana
...
- `xstocks.circ.JDHLTx` [ok] 200 1313ms https://api.backed.fi/api/v2/public/assets/JDHLTx/circulating-supply?format=object
...
- `xstocks.circ.CRESPx` [ok] 200 1153ms https://api.backed.fi/api/v2/public/assets/CRESPx/circulating-supply?format=object
...
- `xstocks.circ.PRADx` [ok] 200 1559ms https://api.backed.fi/api/v2/public/assets/PRADx/circulating-supply?format=object
- `xstocks.mult.WHGROx` [ok] 200 131ms https://api.backed.fi/api/v2/public/assets/WHGROx/multiplier?network=Solana
- `xstocks.circ.SINOTx` [ok] 200 1606ms https://api.backed.fi/api/v2/public/assets/SINOTx/circulating-supply?format=object
...
- `xstocks.circ.CTFJWx` [ok] 200 1366ms https://api.backed.fi/api/v2/public/assets/CTFJWx/circulating-supply?format=object
...
- `xstocks.circ.CLONPx` [ok] 200 1551ms https://api.backed.fi/api/v2/public/assets/CLONPx/circulating-supply?format=object
...
- `xstocks.circ.SINOx` [ok] 200 1346ms https://api.backed.fi/api/v2/public/assets/SINOx/circulating-supply?format=object
- `xstocks.circ.CTPCAx` [ok] 200 1356ms https://api.backed.fi/api/v2/public/assets/CTPCAx/circulating-supply?format=object
...
- `xstocks.price.PWAHLx` [FAIL]  12011ms https://api.backed.fi/api/v2/public/assets/PWAHLx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.CRAUTx` [ok] 200 878ms https://api.backed.fi/api/v2/public/assets/CRAUTx/circulating-supply?format=object
...
- `xstocks.circ.CKINFx` [ok] 200 1246ms https://api.backed.fi/api/v2/public/assets/CKINFx/circulating-supply?format=object
- `xstocks.circ.CKAHx` [ok] 200 1422ms https://api.backed.fi/api/v2/public/assets/CKAHx/circulating-supply?format=object
- `xstocks.mult.CKINFx` [ok] 200 128ms https://api.backed.fi/api/v2/public/assets/CKINFx/multiplier?network=Solana
- `xstocks.mult.CKAHx` [ok] 200 282ms https://api.backed.fi/api/v2/public/assets/CKAHx/multiplier?network=Solana
...
- `xstocks.mult.KUAIx` [ok] 200 259ms https://api.backed.fi/api/v2/public/assets/KUAIx/multiplier?network=Solana
...
- `xstocks.circ.CHONGx` [ok] 200 119ms https://api.backed.fi/api/v2/public/assets/CHONGx/circulating-supply?format=object
...
- `xstocks.mult.CHONGx` [ok] 200 356ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
- `xstocks.circ.COVELx` [ok] 200 902ms https://api.backed.fi/api/v2/public/assets/COVELx/circulating-supply?format=object
- `xstocks.mult.COVELx` [ok] 200 198ms https://api.backed.fi/api/v2/public/assets/COVELx/multiplier?network=Solana
- `xstocks.circ.NONGx` [ok] 200 1840ms https://api.backed.fi/api/v2/public/assets/NONGx/circulating-supply?format=object
...
- `xstocks.mult.NONGx` [ok] 200 1432ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
...
- `xstocks.circ.MEITx` [ok] 200 1597ms https://api.backed.fi/api/v2/public/assets/MEITx/circulating-supply?format=object
...
- `xstocks.circ.MTRCPx` [ok] 200 114ms https://api.backed.fi/api/v2/public/assets/MTRCPx/circulating-supply?format=object
...
- `xstocks.circ.CKHUTx` [ok] 200 977ms https://api.backed.fi/api/v2/public/assets/CKHUTx/circulating-supply?format=object
...
- `xstocks.mult.BOCOMx` [ok] 200 124ms https://api.backed.fi/api/v2/public/assets/BOCOMx/multiplier?network=Solana
...
- `xstocks.circ.CPETCx` [ok] 200 237ms https://api.backed.fi/api/v2/public/assets/CPETCx/circulating-supply?format=object
- `xstocks.mult.CPETCx` [ok] 200 1223ms https://api.backed.fi/api/v2/public/assets/CPETCx/multiplier?network=Solana
...
- `xstocks.mult.BOCHKx` [ok] 200 116ms https://api.backed.fi/api/v2/public/assets/BOCHKx/multiplier?network=Solana
...
- `xstocks.mult.CITICx` [ok] 200 260ms https://api.backed.fi/api/v2/public/assets/CITICx/multiplier?network=Solana
...
- `xstocks.mult.ANTASx` [ok] 200 611ms https://api.backed.fi/api/v2/public/assets/ANTASx/multiplier?network=Solana
...
- `xstocks.circ.HAIERx` [ok] 200 116ms https://api.backed.fi/api/v2/public/assets/HAIERx/circulating-supply?format=object
- `xstocks.mult.HAIERx` [ok] 200 127ms https://api.backed.fi/api/v2/public/assets/HAIERx/multiplier?network=Solana
- `xstocks.mult.CRESLx` [ok] 200 580ms https://api.backed.fi/api/v2/public/assets/CRESLx/multiplier?network=Solana
...
- `xstocks.mult.ZJGLDx` [ok] 200 158ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/multiplier?network=Solana
...
- `xstocks.circ.PSBOCx` [ok] 200 215ms https://api.backed.fi/api/v2/public/assets/PSBOCx/circulating-supply?format=object
- `xstocks.mult.PSBOCx` [ok] 200 263ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
...
- `xstocks.circ.ICBCx` [ok] 200 123ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
...
- `jup.tokens.search.LAOPGx` [ok] 200 45ms https://lite-api.jup.ag/tokens/v2/search?query=LAOPGx
- `jup.tokens.search.KUNLx` [ok] 200 44ms https://lite-api.jup.ag/tokens/v2/search?query=KUNLx
- `jup.tokens.search.WRFHDx` [ok] 200 46ms https://lite-api.jup.ag/tokens/v2/search?query=WRFHDx
...
- `jito.daily_mev_rewards` [ok] 200 2194ms https://kobe.mainnet.jito.network/api/v1/daily_mev_rewards
