...
**Generated** 2026-09-20T05:06:01Z · 2026-09-19 22:06:01 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-20T05:05:51Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** SURGE — SOL 24h -3.15%; DEX 24h $3.23B · 1d -9% · vs-7d-ago +85%; slot 267 ms
...
- **INFO · Correlation: risk-off (SOL 24h ↓ + TVL 1d ↓ + DEX 1d ↓)** — SOL 24h -3.15%, DeFiLlama TVL 1d -1.76%, DEX 1d -8.58%. (threshold: `SOL 24h < 0 AND TVL 1d < 0 AND DEX 1d < 0`)
...
| Health | `ok` |
| Slot | 448,631,860 |
| Block height | 426,672,584 |
| Block time | 2026-09-20T05:05:51Z |
| Epoch | 1,038 (49.97% · slot 215,860/432,000) |
| Mean TPS (last ~3,600s) | 3,930.0 |
| Mean non-vote TPS | 1,397.7 |
| Median TPS (same window) | 3,911.6 |
| Mean slot time | 266.8 ms |
| Median slot time | 266.7 ms |
| Transaction count (cluster) | 550,437,255,836 |
| Circulating supply | 587,367,107 SOL |
| Total supply | 634,375,787 SOL |
...
- `t23p8aBQ…` · 14.48K SOL · commission 0% · lag 1036624 slots
- `AYY1TCe3…` · 10.81K SOL · commission 0% · lag 7890 slots
- `mrgn4atx…` · 2.26K SOL · commission 0% · lag 34455 slots
- `pSoLoZx5…` · 1.51K SOL · commission 4% · lag 757108 slots
- `Hgozywot…` · 797.43 SOL · commission 100% · lag 138989 slots
- `EWARp8Sy…` · 64.91 SOL · commission 5% · lag 1635864 slots
- `FLVgaCPv…` · 9.28 SOL · commission 5% · lag 20616322 slots
- `stacheBm…` · 3.00 SOL · commission 5% · lag 19096177 slots
- `HDRqPft5…` · 2.00 SOL · commission 100% · lag 448631860 slots
- `6mygxmZx…` · 2.00 SOL · commission 100% · lag 23422 slots
- `6DTkuiey…` · 2.00 SOL · commission 100% · lag 448631860 slots
- `Fb77sbwg…` · 1.08 SOL · commission 0% · lag 2375833 slots
...
| Jito tip-floor run-rate (NOT REV) | $31.22K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 31219 USD; at p95 floor → 666548 USD. |
...
| Metric | Value | Source |
| --- | ---: | --- |
| SOL/USD | $108.96 | coingecko.simple_price |
| 24h change | -3.15% | coingecko.simple_price |
| Market cap | $64.00B | coingecko.simple_price |
...
_As of 2026-09-20 (2026-09-19 22:06:01 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rss.xcancel.solana_devs` [FAIL] 451 252ms https://xcancel.com/solana_devs/rss — HTTP 451 
...
- `rss.nitter.anza_xyz` [ok] 200 578ms https://nitter.perennialte.ch/anza_xyz/rss
...
- `xstocks.assets.p3` [ok] 200 4450ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=3
- `xstocks.assets.p4` [ok] 200 5016ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=4
- `xstocks.assets.p5` [ok] 200 1665ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=5
...
- `xstocks.circ.WGSx` [ok] 200 661ms https://api.backed.fi/api/v2/public/assets/WGSx/circulating-supply?format=object
...
- `xstocks.mult.BETRx` [ok] 200 463ms https://api.backed.fi/api/v2/public/assets/BETRx/multiplier?network=Solana
...
- `xstocks.circ.WYFIx` [ok] 200 851ms https://api.backed.fi/api/v2/public/assets/WYFIx/circulating-supply?format=object
...
- `xstocks.circ.AAONx` [ok] 200 1449ms https://api.backed.fi/api/v2/public/assets/AAONx/circulating-supply?format=object
...
- `xstocks.mult.MPx` [ok] 200 319ms https://api.backed.fi/api/v2/public/assets/MPx/multiplier?network=Solana
...
- `xstocks.mult.DVAx` [ok] 200 524ms https://api.backed.fi/api/v2/public/assets/DVAx/multiplier?network=Solana
- `xstocks.circ.BXPx` [ok] 200 458ms https://api.backed.fi/api/v2/public/assets/BXPx/circulating-supply?format=object
...
- `xstocks.mult.BXPx` [ok] 200 459ms https://api.backed.fi/api/v2/public/assets/BXPx/multiplier?network=Solana
...
- `xstocks.circ.DYx` [ok] 200 493ms https://api.backed.fi/api/v2/public/assets/DYx/circulating-supply?format=object
...
- `xstocks.mult.AMx` [ok] 200 456ms https://api.backed.fi/api/v2/public/assets/AMx/multiplier?network=Solana
...
- `xstocks.mult.DYx` [ok] 200 604ms https://api.backed.fi/api/v2/public/assets/DYx/multiplier?network=Solana
...
- `xstocks.mult.WMSx` [ok] 200 936ms https://api.backed.fi/api/v2/public/assets/WMSx/multiplier?network=Solana
...
- `xstocks.circ.ALSNx` [ok] 200 1177ms https://api.backed.fi/api/v2/public/assets/ALSNx/circulating-supply?format=object
...
- `xstocks.mult.BPOPx` [ok] 200 422ms https://api.backed.fi/api/v2/public/assets/BPOPx/multiplier?network=Solana
...
- `xstocks.circ.EGPx` [ok] 200 2077ms https://api.backed.fi/api/v2/public/assets/EGPx/circulating-supply?format=object
- `xstocks.mult.EGPx` [ok] 200 333ms https://api.backed.fi/api/v2/public/assets/EGPx/multiplier?network=Solana
- `xstocks.circ.DPZx` [ok] 200 1838ms https://api.backed.fi/api/v2/public/assets/DPZx/circulating-supply?format=object
...
- `xstocks.circ.PAGx` [ok] 200 1813ms https://api.backed.fi/api/v2/public/assets/PAGx/circulating-supply?format=object
- `xstocks.mult.PAGx` [ok] 200 395ms https://api.backed.fi/api/v2/public/assets/PAGx/multiplier?network=Solana
...
- `xstocks.circ.HIIx` [ok] 200 1222ms https://api.backed.fi/api/v2/public/assets/HIIx/circulating-supply?format=object
...
- `xstocks.circ.ARx` [ok] 200 1119ms https://api.backed.fi/api/v2/public/assets/ARx/circulating-supply?format=object
...
- `xstocks.mult.MGMx` [ok] 200 729ms https://api.backed.fi/api/v2/public/assets/MGMx/multiplier?network=Solana
...
- `xstocks.circ.WTRGx` [ok] 200 1784ms https://api.backed.fi/api/v2/public/assets/WTRGx/circulating-supply?format=object
...
- `xstocks.mult.HUBSx` [ok] 200 1033ms https://api.backed.fi/api/v2/public/assets/HUBSx/multiplier?network=Solana
...
- `xstocks.mult.JKHYx` [ok] 200 763ms https://api.backed.fi/api/v2/public/assets/JKHYx/multiplier?network=Solana
...
- `xstocks.circ.AMHx` [ok] 200 1243ms https://api.backed.fi/api/v2/public/assets/AMHx/circulating-supply?format=object
...
- `xstocks.circ.UHALx` [ok] 200 963ms https://api.backed.fi/api/v2/public/assets/UHALx/circulating-supply?format=object
...
- `xstocks.mult.UHALx` [ok] 200 395ms https://api.backed.fi/api/v2/public/assets/UHALx/multiplier?network=Solana
...
- `xstocks.circ.AHRx` [ok] 200 1002ms https://api.backed.fi/api/v2/public/assets/AHRx/circulating-supply?format=object
...
- `xstocks.circ.Hx` [ok] 200 316ms https://api.backed.fi/api/v2/public/assets/Hx/circulating-supply?format=object
...
- `xstocks.price.BAXx` [FAIL]  12015ms https://api.backed.fi/api/v2/public/assets/BAXx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.MANHx` [ok] 200 1153ms https://api.backed.fi/api/v2/public/assets/MANHx/circulating-supply?format=object
...
- `xstocks.mult.MANHx` [ok] 200 480ms https://api.backed.fi/api/v2/public/assets/MANHx/multiplier?network=Solana
...
- `xstocks.circ.TXRHx` [ok] 200 180ms https://api.backed.fi/api/v2/public/assets/TXRHx/circulating-supply?format=object
...
- `xstocks.circ.CACIx` [ok] 200 1734ms https://api.backed.fi/api/v2/public/assets/CACIx/circulating-supply?format=object
...
- `jup.tokens.search.METCx` [ok] 200 101ms https://lite-api.jup.ag/tokens/v2/search?query=METCx
