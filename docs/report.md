...
**Generated** 2026-09-03T11:06:35Z · 2026-09-03 04:06:35 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-03T11:06:24Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** ELEVATED — SOL 24h +2.50%; DEX 24h $2.33B · 1d +7% · vs-7d-ago -1%; slot 315 ms
...
- **INFO · SOL price vs 30d median (solana.com/data)** — Current 100.37 USD is +21.3% vs 30d median 82.77 USD (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
...
| Health | `ok` |
| Slot | 443,955,593 |
| Block height | 422,002,783 |
| Block time | 2026-09-03T11:06:24Z |
| Epoch | 1,027 (67.50% · slot 291,594/432,000) |
| Mean TPS (last ~3,600s) | 3,373.3 |
| Mean non-vote TPS | 1,233.8 |
| Median TPS (same window) | 3,366.2 |
| Mean slot time | 314.6 ms |
| Median slot time | 314.1 ms |
| Transaction count (cluster) | 544,744,409,352 |
| Circulating supply | 585,274,910 SOL |
| Total supply | 633,360,946 SOL |
...
- `xLabscif…` · 84.41K SOL · commission 5% · lag 167220 slots
- `prt1st4R…` · 78.62K SOL · commission 5% · lag 468651 slots
- `E4xNK4Uw…` · 10.45K SOL · commission 5% · lag 606870 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 1169472 slots
- `Fb77sbwg…` · 2.13K SOL · commission 0% · lag 655937 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 516954 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 1971839 slots
- `CpdzCVza…` · 193.38 SOL · commission 100% · lag 1155242 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 1196756 slots
- `HFTcVVrX…` · 149.48 SOL · commission 100% · lag 1155136 slots
- `6pEtDovp…` · 131.86 SOL · commission 100% · lag 1169520 slots
- `7G4Rfctw…` · 75.85 SOL · commission 100% · lag 1193894 slots
...
| Jito tip-floor run-rate (NOT REV) | $12.26K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 12262 USD; at p95 floor → 1043103 USD. |
...
24h volume $27.10M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-09-03 (2026-09-03 04:06:35 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `llama.stablecoincharts` [ok] 200 895ms https://stablecoins.llama.fi/stablecoincharts/Solana
...
- `rss.nitter.anza_xyz` [ok] 200 3201ms https://nitter.perennialte.ch/anza_xyz/rss
...
- `rpc.getBlock.fallback` [ok] 200 500ms https://solana-rpc.publicnode.com
...
- `rpc.getBlock` [ok] 200 412ms https://api.mainnet-beta.solana.com
- `xstocks.assets.p0` [FAIL]  15082ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0 — TimeoutError: The read operation timed out
- `xstocks.assets.p0` [FAIL]  15088ms https://api.xstocks.fi/api/v2/public/assets?pageSize=100&page=0 — TimeoutError: The read operation timed out
