...
**Generated** 2026-09-20T15:36:05Z · 2026-09-20 08:36:05 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-20T15:35:56Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h -3.06%; DEX 24h $2.88B · 1d -19% · vs-7d-ago +65%; slot 267 ms
...
- **WARN · Correlation: risk-off (SOL 24h ↓ + TVL 1d ↓ + DEX 1d ↓)** — SOL 24h -3.06%, DeFiLlama TVL 1d -2.96%, DEX 1d -18.70%. (threshold: `SOL 24h < 0 AND TVL 1d < 0 AND DEX 1d < 0`)
...
| Health | `ok` |
| Slot | 448,773,888 |
| Block height | 426,814,601 |
| Block time | 2026-09-20T15:35:56Z |
| Epoch | 1,038 (82.84% · slot 357,889/432,000) |
| Mean TPS (last ~3,600s) | 4,354.2 |
| Mean non-vote TPS | 1,832.7 |
| Median TPS (same window) | 4,341.1 |
| Mean slot time | 267.3 ms |
| Median slot time | 266.7 ms |
| Transaction count (cluster) | 550,585,653,649 |
| Circulating supply | 587,366,717 SOL |
| Total supply | 634,375,396 SOL |
...
- `t23p8aBQ…` · 14.48K SOL · commission 0% · lag 1178652 slots
- `AYY1TCe3…` · 10.81K SOL · commission 0% · lag 149918 slots
- `mrgn4atx…` · 2.26K SOL · commission 0% · lag 176483 slots
- `pSoLoZx5…` · 1.51K SOL · commission 4% · lag 899136 slots
- `Hgozywot…` · 797.43 SOL · commission 100% · lag 281017 slots
- `EWARp8Sy…` · 64.91 SOL · commission 5% · lag 1777892 slots
- `9fTWmMqV…` · 23.85 SOL · commission 0% · lag 11513 slots
- `FLVgaCPv…` · 9.28 SOL · commission 5% · lag 20758350 slots
- `stacheBm…` · 3.00 SOL · commission 5% · lag 19238205 slots
- `HDRqPft5…` · 2.00 SOL · commission 100% · lag 448773888 slots
- `6mygxmZx…` · 2.00 SOL · commission 100% · lag 165450 slots
- `6DTkuiey…` · 2.00 SOL · commission 100% · lag 448773888 slots
...
| Jito tip-floor run-rate (NOT REV) | $171.25K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 171252 USD; at p95 floor → 1392402 USD. |
...
| Metric | Value | Source |
| --- | ---: | --- |
| SOL/USD | $108.15 | coingecko.simple_price |
...
24h volume $88.25M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-09-20 (2026-09-20 08:36:05 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rss.nitter.solana` [ok] 200 2334ms https://nitter.perennialte.ch/solana/rss
- `rss.nitter.solana_status` [ok] 200 688ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [ok] 200 960ms https://nitter.perennialte.ch/anza_xyz/rss
- `rss.nitter.solana_devs` [ok] 200 986ms https://nitter.perennialte.ch/solana_devs/rss
...
- `xstocks.assets.p1` [ok] 200 1528ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=1
- `xstocks.assets.p2` [ok] 200 2107ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=2
...
- `xstocks.assets.p6` [ok] 200 1500ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=6
...
- `xstocks.circ.METCx` [ok] 200 478ms https://api.backed.fi/api/v2/public/assets/METCx/circulating-supply?format=object
- `xstocks.mult.QUBTx` [ok] 200 358ms https://api.backed.fi/api/v2/public/assets/QUBTx/multiplier?network=Solana
- `xstocks.mult.FLNCx` [ok] 200 194ms https://api.backed.fi/api/v2/public/assets/FLNCx/multiplier?network=Solana
- `xstocks.circ.WRLDx` [ok] 200 769ms https://api.backed.fi/api/v2/public/assets/WRLDx/circulating-supply?format=object
...
- `xstocks.mult.INDIx` [ok] 200 962ms https://api.backed.fi/api/v2/public/assets/INDIx/multiplier?network=Solana
...
- `xstocks.price.SCIx` [FAIL]  12014ms https://api.backed.fi/api/v2/public/assets/SCIx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.DRSx` [ok] 200 409ms https://api.backed.fi/api/v2/public/assets/DRSx/circulating-supply?format=object
- `xstocks.mult.DRSx` [ok] 200 182ms https://api.backed.fi/api/v2/public/assets/DRSx/multiplier?network=Solana
- `xstocks.circ.SCIx` [ok] 200 650ms https://api.backed.fi/api/v2/public/assets/SCIx/circulating-supply?format=object
...
- `xstocks.circ.DCIx` [ok] 200 162ms https://api.backed.fi/api/v2/public/assets/DCIx/circulating-supply?format=object
...
- `xstocks.circ.GSATx` [ok] 200 756ms https://api.backed.fi/api/v2/public/assets/GSATx/circulating-supply?format=object
...
- `xstocks.mult.MPx` [ok] 200 664ms https://api.backed.fi/api/v2/public/assets/MPx/multiplier?network=Solana
...
- `xstocks.circ.FDSx` [ok] 200 380ms https://api.backed.fi/api/v2/public/assets/FDSx/circulating-supply?format=object
- `xstocks.mult.FDSx` [ok] 200 235ms https://api.backed.fi/api/v2/public/assets/FDSx/multiplier?network=Solana
- `xstocks.mult.WMSx` [ok] 200 693ms https://api.backed.fi/api/v2/public/assets/WMSx/multiplier?network=Solana
...
- `xstocks.circ.ALSNx` [ok] 200 1204ms https://api.backed.fi/api/v2/public/assets/ALSNx/circulating-supply?format=object
...
- `xstocks.circ.SMTCx` [ok] 200 1395ms https://api.backed.fi/api/v2/public/assets/SMTCx/circulating-supply?format=object
...
- `xstocks.circ.TTMIx` [ok] 200 298ms https://api.backed.fi/api/v2/public/assets/TTMIx/circulating-supply?format=object
...
- `xstocks.price.KTOSx` [FAIL]  12008ms https://api.backed.fi/api/v2/public/assets/KTOSx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.AEISx` [ok] 200 173ms https://api.backed.fi/api/v2/public/assets/AEISx/circulating-supply?format=object
- `xstocks.mult.BPOPx` [ok] 200 733ms https://api.backed.fi/api/v2/public/assets/BPOPx/multiplier?network=Solana
...
- `xstocks.mult.AEISx` [ok] 200 567ms https://api.backed.fi/api/v2/public/assets/AEISx/multiplier?network=Solana
...
- `xstocks.circ.JKHYx` [ok] 200 599ms https://api.backed.fi/api/v2/public/assets/JKHYx/circulating-supply?format=object
- `xstocks.mult.OCx` [ok] 200 354ms https://api.backed.fi/api/v2/public/assets/OCx/multiplier?network=Solana
- `xstocks.mult.JKHYx` [ok] 200 245ms https://api.backed.fi/api/v2/public/assets/JKHYx/multiplier?network=Solana
- `xstocks.mult.AFGx` [ok] 200 2493ms https://api.backed.fi/api/v2/public/assets/AFGx/multiplier?network=Solana
...
- `xstocks.price.NWSx` [FAIL]  12008ms https://api.backed.fi/api/v2/public/assets/NWSx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.NWSx` [ok] 200 405ms https://api.backed.fi/api/v2/public/assets/NWSx/multiplier?network=Solana
