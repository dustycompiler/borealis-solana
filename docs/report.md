...
**Generated** 2026-08-29T11:48:47Z · 2026-08-29 04:48:47 PT
**Author** dustycompiler · **Version** 1.5.6 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-29T11:48:37Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h -2.28%; DEX 24h $2.59B · 1d -30% · vs-7d-ago -28%; slot 317 ms
...
- **WARN · Correlation: risk-off (SOL 24h ↓ + TVL 1d ↓ + DEX 1d ↓)** — SOL 24h -2.28%, DeFiLlama TVL 1d -2.87%, DEX 1d -29.99%. (threshold: `SOL 24h < 0 AND TVL 1d < 0 AND DEX 1d < 0`)
- **WARN · Large Solana DEX volume 7d move** — DeFiLlama Solana DEX volume 7d change is -28.06%. (threshold: `|7d %| >= 20`)
- **WARN · SOL price vs 30d median (solana.com/data)** — Current 103.57 USD is +36.3% vs 30d median 76.00 USD (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
...
| Health | `ok` |
| Slot | 442,599,111 |
| Block height | 420,647,002 |
| Block time | 2026-08-29T11:48:37Z |
| Epoch | 1,024 (53.50% · slot 231,112/432,000) |
| Mean TPS (last ~3,600s) | 3,313.5 |
| Mean non-vote TPS | 1,149.2 |
| Median TPS (same window) | 3,326.7 |
| Mean slot time | 316.7 ms |
| Median slot time | 317.5 ms |
| Transaction count (cluster) | 543,072,342,761 |
| Circulating supply | 584,161,603 SOL |
| Total supply | 633,079,144 SOL |
...
- `mrgn4atx…` · 20.33K SOL · commission 0% · lag 3776 slots
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1346432 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 252410 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 615357 slots
- `kom1oNHy…` · 662.86 SOL · commission 5% · lag 1962595 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442599111 slots
- `pSo1KZXg…` · 2.00 SOL · commission 4% · lag 261270 slots
- `7Dvp5zCF…` · 1.07 SOL · commission 100% · lag 419756 slots
- `bcZxRSoz…` · 0.00 SOL · commission 0% · lag 1959112 slots
...
| --- | ---: | --- |
| TPS chart | 94 | data/history.jsonl snapshot tape |
| TVL chart | 94 | data/history.jsonl snapshot tape |
| SOL chart | 93 | data/history.jsonl snapshot tape |
| history.jsonl rows | 94 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $36.27K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 36269 USD; at p95 floor → 10283382 USD. |
...
24h volume $29.98M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-08-29 (2026-08-29 04:48:47 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rss.nitter.solana_status` [ok] 200 2545ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [ok] 200 1651ms https://nitter.perennialte.ch/anza_xyz/rss
- `rss.nitter.solana_devs` [ok] 200 2335ms https://nitter.perennialte.ch/solana_devs/rss
- `status.incidents` [ok] 200 10755ms https://status.solana.com/api/v2/incidents.json
...
- `xstocks.assets.p4` [ok] 200 2497ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=4
- `xstocks.assets.p5` [ok] 200 1028ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=5
- `xstocks.assets.p6` [ok] 200 1216ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=6
...
- `xstocks.circ.MSFTx` [ok] 200 116ms https://api.backed.fi/api/v2/public/assets/MSFTx/circulating-supply?format=object
...
- `xstocks.circ.NVDAx` [ok] 200 370ms https://api.backed.fi/api/v2/public/assets/NVDAx/circulating-supply?format=object
...
- `xstocks.price.COINx` [FAIL]  12008ms https://api.backed.fi/api/v2/public/assets/COINx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.price.SUOPTx` [FAIL]  12011ms https://api.backed.fi/api/v2/public/assets/SUOPTx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.price.MMGx` [FAIL]  12011ms https://api.backed.fi/api/v2/public/assets/MMGx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.MMGx` [ok] 200 134ms https://api.backed.fi/api/v2/public/assets/MMGx/multiplier?network=Solana
...
- `xstocks.circ.ZHAOMx` [ok] 200 112ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/circulating-supply?format=object
...
- `xstocks.mult.LAOPGx` [ok] 200 978ms https://api.backed.fi/api/v2/public/assets/LAOPGx/multiplier?network=Solana
- `xstocks.circ.SUOPTx` [ok] 200 1847ms https://api.backed.fi/api/v2/public/assets/SUOPTx/circulating-supply?format=object
...
- `xstocks.circ.KUNLx` [ok] 200 288ms https://api.backed.fi/api/v2/public/assets/KUNLx/circulating-supply?format=object
- `xstocks.mult.WRFHDx` [ok] 200 129ms https://api.backed.fi/api/v2/public/assets/WRFHDx/multiplier?network=Solana
- `xstocks.price.HAIDLx` [FAIL]  12010ms https://api.backed.fi/api/v2/public/assets/HAIDLx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.ENNHLx` [ok] 200 921ms https://api.backed.fi/api/v2/public/assets/ENNHLx/circulating-supply?format=object
...
- `xstocks.price.HRZRBx` [FAIL]  12008ms https://api.backed.fi/api/v2/public/assets/HRZRBx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.CRESBx` [ok] 200 522ms https://api.backed.fi/api/v2/public/assets/CRESBx/circulating-supply?format=object
...
- `xstocks.circ.HRZRBx` [ok] 200 1457ms https://api.backed.fi/api/v2/public/assets/HRZRBx/circulating-supply?format=object
...
- `xstocks.mult.CSPCx` [ok] 200 1083ms https://api.backed.fi/api/v2/public/assets/CSPCx/multiplier?network=Solana
- `xstocks.mult.HRZRBx` [ok] 200 338ms https://api.backed.fi/api/v2/public/assets/HRZRBx/multiplier?network=Solana
- `xstocks.circ.JTGEXx` [ok] 200 1055ms https://api.backed.fi/api/v2/public/assets/JTGEXx/circulating-supply?format=object
...
- `xstocks.circ.WXXDCx` [ok] 200 1093ms https://api.backed.fi/api/v2/public/assets/WXXDCx/circulating-supply?format=object
...
- `xstocks.circ.BDWAPx` [ok] 200 1514ms https://api.backed.fi/api/v2/public/assets/BDWAPx/circulating-supply?format=object
- `xstocks.circ.SITCx` [ok] 200 204ms https://api.backed.fi/api/v2/public/assets/SITCx/circulating-supply?format=object
- `xstocks.circ.MIXUx` [ok] 200 1120ms https://api.backed.fi/api/v2/public/assets/MIXUx/circulating-supply?format=object
- `xstocks.circ.WHRFRx` [ok] 200 595ms https://api.backed.fi/api/v2/public/assets/WHRFRx/circulating-supply?format=object
- `xstocks.mult.BDWAPx` [ok] 200 136ms https://api.backed.fi/api/v2/public/assets/BDWAPx/multiplier?network=Solana
...
- `xstocks.circ.JDHLTx` [ok] 200 1603ms https://api.backed.fi/api/v2/public/assets/JDHLTx/circulating-supply?format=object
...
- `xstocks.mult.JDHLTx` [ok] 200 512ms https://api.backed.fi/api/v2/public/assets/JDHLTx/multiplier?network=Solana
...
- `xstocks.mult.CTFJWx` [ok] 200 528ms https://api.backed.fi/api/v2/public/assets/CTFJWx/multiplier?network=Solana
...
- `xstocks.mult.CTPCAx` [ok] 200 336ms https://api.backed.fi/api/v2/public/assets/CTPCAx/multiplier?network=Solana
...
- `xstocks.price.CRAUTx` [FAIL]  12015ms https://api.backed.fi/api/v2/public/assets/CRAUTx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.CLPHDx` [ok] 200 1047ms https://api.backed.fi/api/v2/public/assets/CLPHDx/circulating-supply?format=object
- `xstocks.circ.GENTEx` [ok] 200 1232ms https://api.backed.fi/api/v2/public/assets/GENTEx/circulating-supply?format=object
- `xstocks.mult.CLPHDx` [ok] 200 378ms https://api.backed.fi/api/v2/public/assets/CLPHDx/multiplier?network=Solana
- `xstocks.circ.SWPRPx` [ok] 200 855ms https://api.backed.fi/api/v2/public/assets/SWPRPx/circulating-supply?format=object
...
- `xstocks.circ.WUXIBx` [ok] 200 1732ms https://api.backed.fi/api/v2/public/assets/WUXIBx/circulating-supply?format=object
...
- `xstocks.circ.HKCGAx` [ok] 200 1275ms https://api.backed.fi/api/v2/public/assets/HKCGAx/circulating-supply?format=object
...
- `xstocks.circ.KUAIx` [ok] 200 1161ms https://api.backed.fi/api/v2/public/assets/KUAIx/circulating-supply?format=object
...
- `xstocks.circ.HKEXCx` [ok] 200 1197ms https://api.backed.fi/api/v2/public/assets/HKEXCx/circulating-supply?format=object
...
- `xstocks.mult.HKEXCx` [ok] 200 117ms https://api.backed.fi/api/v2/public/assets/HKEXCx/multiplier?network=Solana
- `xstocks.mult.CHONGx` [ok] 200 393ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
- `xstocks.circ.NONGx` [ok] 200 1852ms https://api.backed.fi/api/v2/public/assets/NONGx/circulating-supply?format=object
- `xstocks.mult.NONGx` [ok] 200 119ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
- `xstocks.circ.GEELx` [ok] 200 1158ms https://api.backed.fi/api/v2/public/assets/GEELx/circulating-supply?format=object
- `xstocks.mult.GEELx` [ok] 200 124ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
- `xstocks.circ.MEITx` [ok] 200 1412ms https://api.backed.fi/api/v2/public/assets/MEITx/circulating-supply?format=object
- `xstocks.mult.MEITx` [ok] 200 402ms https://api.backed.fi/api/v2/public/assets/MEITx/multiplier?network=Solana
- `xstocks.price.MTRCPx` [FAIL]  12016ms https://api.backed.fi/api/v2/public/assets/MTRCPx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.MTRCPx` [ok] 200 968ms https://api.backed.fi/api/v2/public/assets/MTRCPx/circulating-supply?format=object
...
- `xstocks.circ.PICCx` [ok] 200 576ms https://api.backed.fi/api/v2/public/assets/PICCx/circulating-supply?format=object
...
- `xstocks.mult.COSCx` [ok] 200 126ms https://api.backed.fi/api/v2/public/assets/COSCx/multiplier?network=Solana
...
- `xstocks.circ.HNDLDx` [ok] 200 1164ms https://api.backed.fi/api/v2/public/assets/HNDLDx/circulating-supply?format=object
...
- `xstocks.mult.BOCOMx` [ok] 200 122ms https://api.backed.fi/api/v2/public/assets/BOCOMx/multiplier?network=Solana
...
- `xstocks.circ.CPETCx` [ok] 200 269ms https://api.backed.fi/api/v2/public/assets/CPETCx/circulating-supply?format=object
- `xstocks.mult.CPETCx` [ok] 200 131ms https://api.backed.fi/api/v2/public/assets/CPETCx/multiplier?network=Solana
...
- `xstocks.mult.BOCHKx` [ok] 200 447ms https://api.backed.fi/api/v2/public/assets/BOCHKx/multiplier?network=Solana
...
- `xstocks.mult.ANTASx` [ok] 200 122ms https://api.backed.fi/api/v2/public/assets/ANTASx/multiplier?network=Solana
...
- `xstocks.circ.CITICx` [ok] 200 495ms https://api.backed.fi/api/v2/public/assets/CITICx/circulating-supply?format=object
- `xstocks.mult.CRESLx` [ok] 200 121ms https://api.backed.fi/api/v2/public/assets/CRESLx/multiplier?network=Solana
- `xstocks.mult.CITICx` [ok] 200 120ms https://api.backed.fi/api/v2/public/assets/CITICx/multiplier?network=Solana
...
- `xstocks.circ.PSBOCx` [ok] 200 452ms https://api.backed.fi/api/v2/public/assets/PSBOCx/circulating-supply?format=object
- `xstocks.price.ICBCx` [FAIL]  12013ms https://api.backed.fi/api/v2/public/assets/ICBCx/price-data — TimeoutError: The read operation timed out
- `xstocks.mult.PSBOCx` [ok] 200 160ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
- `xstocks.mult.ZJGLDx` [ok] 200 627ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/multiplier?network=Solana
- `xstocks.circ.ICBCx` [ok] 200 154ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
- `xstocks.mult.ICBCx` [ok] 200 122ms https://api.backed.fi/api/v2/public/assets/ICBCx/multiplier?network=Solana
- `xstocks.circ.HAIERx` [ok] 200 2267ms https://api.backed.fi/api/v2/public/assets/HAIERx/circulating-supply?format=object
...
- `jup.tokens.search.TNGYIx` [ok] 200 47ms https://lite-api.jup.ag/tokens/v2/search?query=TNGYIx
- `jup.tokens.search.ZHAOMx` [ok] 200 37ms https://lite-api.jup.ag/tokens/v2/search?query=ZHAOMx
- `jup.tokens.search.LAOPGx` [ok] 200 37ms https://lite-api.jup.ag/tokens/v2/search?query=LAOPGx
