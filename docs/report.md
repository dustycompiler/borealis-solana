...
**Generated** 2026-09-11T00:52:26Z · 2026-09-10 17:52:26 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-11T00:52:16Z · **RPC health** `ok`
**Health score** 98 / 100 — `25×rpc_ok + 30×clamp(1 − max(0, slot_ms − 300)/300, 0, 1) + 25×clamp(1 − delinquent_stake_pct/2, 0, 1) + 20×clamp(tps / tps_baseline, 0, 1)`
**Network health** HEALTHY · **Ecosystem** ELEVATED — SOL 24h -2.30%; DEX 24h $3.00B · 1d +11% · vs-7d-ago +31%; slot 317 ms
...
| Health | `ok` |
| Slot | 446,024,982 |
| Block height | 424,068,300 |
| Block time | 2026-09-11T00:52:16Z |
| Epoch | 1,032 (46.52% · slot 200,985/432,000) |
| Mean TPS (last ~3,600s) | 3,872.7 |
| Mean non-vote TPS | 1,752.0 |
| Median TPS (same window) | 3,869.1 |
| Mean slot time | 317.1 ms |
| Median slot time | 317.5 ms |
| Transaction count (cluster) | 547,217,321,883 |
| Circulating supply | 586,537,875 SOL |
| Total supply | 633,830,440 SOL |
...
- `mrgn2vUP…` · 90.78K SOL · commission 0% · lag 19896 slots
- `scs2Ra91…` · 58.59K SOL · commission 10% · lag 145900 slots
- `mrgn4atx…` · 19.89K SOL · commission 0% · lag 60743 slots
- `AYY1TCe3…` · 10.81K SOL · commission 0% · lag 170825 slots
- `inWVrrYJ…` · 8.46K SOL · commission 0% · lag 325885 slots
- `xLabscif…` · 3.36K SOL · commission 5% · lag 2236609 slots
- `5ZjxMYBb…` · 3.21K SOL · commission 0% · lag 2059060 slots
- `pSoLoZx5…` · 1.51K SOL · commission 4% · lag 229820 slots
- `4GEEKSwu…` · 326.50 SOL · commission 5% · lag 215370 slots
- `stacheBm…` · 3.00 SOL · commission 5% · lag 16489299 slots
- `6mygxmZx…` · 2.00 SOL · commission 100% · lag 446024982 slots
- `Fb77sbwg…` · 1.08 SOL · commission 0% · lag 1185971 slots
...
| Jito tip-floor run-rate (NOT REV) | $28.84K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 28836 USD; at p95 floor → 5748308 USD. |
...
| Market cap | $57.90B | coingecko.simple_price |
...
24h volume $91.90M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-09-11 (2026-09-10 17:52:26 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getRecentPerformanceSamples` [ok] 200 489ms https://api.mainnet-beta.solana.com
- `rpc.getSupply` [ok] 200 8172ms https://api.mainnet-beta.solana.com
- `rpc.getVoteAccounts` [ok] 200 1047ms https://api.mainnet-beta.solana.com
...
- `llama.fees` [ok] 200 1463ms https://api.llama.fi/overview/fees/Solana?excludeTotalDataChart=true&excludeTotalDataChartBreakdown=true
...
- `rss.xcancel.solana` [ok] 200 1110ms https://xcancel.com/solana/rss
- `rss.xcancel.solana_status` [ok] 200 437ms https://xcancel.com/solana_status/rss
- `rss.xcancel.anza_xyz` [ok] 200 867ms https://xcancel.com/anza_xyz/rss
- `rss.xcancel.solana_devs` [ok] 200 673ms https://xcancel.com/solana_devs/rss
...
- `rpc.getBlocks` [ok] 200 491ms https://api.mainnet-beta.solana.com
...
- `xstocks.assets.p0` [FAIL]  15548ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0 — TimeoutError: The read operation timed out
- `xstocks.assets.p0` [FAIL]  15083ms https://api.xstocks.fi/api/v2/public/assets?pageSize=100&page=0 — TimeoutError: The read operation timed out
...
- `dune.public_embed` [ok] 200 481ms https://dune.com/embeds/dashboard/cryptoonchain/solana-explorer
