...
**Generated** 2026-08-30T11:48:42Z · 2026-08-30 04:48:42 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-30T11:48:31Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h +1.38%; DEX 24h $1.67B · 1d -36% · vs-7d-ago -55%; slot 317 ms
...
| Health | `ok` |
| Slot | 442,871,690 |
| Block height | 420,919,473 |
| Block time | 2026-08-30T11:48:31Z |
| Epoch | 1,025 (16.59% · slot 71,690/432,000) |
| Mean TPS (last ~3,600s) | 3,247.0 |
| Mean non-vote TPS | 1,110.9 |
| Median TPS (same window) | 3,247.8 |
| Mean slot time | 316.6 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 543,403,015,402 |
| Circulating supply | 585,122,043 SOL |
| Total supply | 633,173,727 SOL |
...
- `mrgn4atx…` · 21.79K SOL · commission 0% · lag 67953 slots
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1619011 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 85569 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 191852 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 887936 slots
- `CpdzCVza…` · 315.26 SOL · commission 100% · lag 71339 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 112853 slots
- `HFTcVVrX…` · 152.80 SOL · commission 100% · lag 71233 slots
- `6pEtDovp…` · 131.96 SOL · commission 100% · lag 85617 slots
- `7G4Rfctw…` · 75.85 SOL · commission 100% · lag 109991 slots
- `DZKTNGR3…` · 48.61 SOL · commission 100% · lag 117533 slots
- `As9NxA9b…` · 46.69 SOL · commission 100% · lag 71356 slots
...
| --- | ---: | --- |
| TPS chart | 191 | data/history.jsonl snapshot tape |
| TVL chart | 191 | data/history.jsonl snapshot tape |
| SOL chart | 190 | data/history.jsonl snapshot tape |
| history.jsonl rows | 191 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $60.28K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 60277 USD; at p95 floor → 294030 USD. |
...
_As of 2026-08-30 (2026-08-30 04:48:42 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rss.nitter.solana` [ok] 200 1855ms https://nitter.perennialte.ch/solana/rss
- `rss.nitter.solana_status` [ok] 200 2370ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [ok] 200 1550ms https://nitter.perennialte.ch/anza_xyz/rss
- `rss.nitter.solana_devs` [ok] 200 2074ms https://nitter.perennialte.ch/solana_devs/rss
...
- `xstocks.assets.p1` [ok] 200 1757ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=1
- `xstocks.assets.p2` [ok] 200 1048ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=2
...
- `xstocks.assets.p6` [ok] 200 1174ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=6
- `xstocks.assets.p7` [ok] 200 193ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=7
...
- `xstocks.mult.TSLAx` [ok] 200 165ms https://api.backed.fi/api/v2/public/assets/TSLAx/multiplier?network=Solana
...
- `xstocks.mult.SPYx` [ok] 200 875ms https://api.backed.fi/api/v2/public/assets/SPYx/multiplier?network=Solana
...
- `xstocks.mult.BANKCx` [ok] 200 136ms https://api.backed.fi/api/v2/public/assets/BANKCx/multiplier?network=Solana
...
- `xstocks.circ.ZHAOMx` [ok] 200 1164ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/circulating-supply?format=object
- `xstocks.mult.SUOPTx` [ok] 200 1322ms https://api.backed.fi/api/v2/public/assets/SUOPTx/multiplier?network=Solana
- `xstocks.mult.ZHAOMx` [ok] 200 437ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/multiplier?network=Solana
...
- `xstocks.mult.JDLOGx` [ok] 200 166ms https://api.backed.fi/api/v2/public/assets/JDLOGx/multiplier?network=Solana
...
- `xstocks.circ.HAIDLx` [ok] 200 1019ms https://api.backed.fi/api/v2/public/assets/HAIDLx/circulating-supply?format=object
- `xstocks.circ.WRFHDx` [ok] 200 1267ms https://api.backed.fi/api/v2/public/assets/WRFHDx/circulating-supply?format=object
...
- `xstocks.price.ENNHLx` [FAIL]  12014ms https://api.backed.fi/api/v2/public/assets/ENNHLx/price-data — TimeoutError: The read operation timed out
- `xstocks.mult.SNBIOx` [ok] 200 453ms https://api.backed.fi/api/v2/public/assets/SNBIOx/multiplier?network=Solana
- `xstocks.mult.SZIGHx` [ok] 200 302ms https://api.backed.fi/api/v2/public/assets/SZIGHx/multiplier?network=Solana
- `xstocks.circ.ENNHLx` [ok] 200 1500ms https://api.backed.fi/api/v2/public/assets/ENNHLx/circulating-supply?format=object
...
- `xstocks.price.CRESBx` [FAIL]  12008ms https://api.backed.fi/api/v2/public/assets/CRESBx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.CSPCx` [ok] 200 295ms https://api.backed.fi/api/v2/public/assets/CSPCx/circulating-supply?format=object
- `xstocks.mult.CMERPx` [ok] 200 114ms https://api.backed.fi/api/v2/public/assets/CMERPx/multiplier?network=Solana
...
- `xstocks.mult.CRESBx` [ok] 200 1457ms https://api.backed.fi/api/v2/public/assets/CRESBx/multiplier?network=Solana
- `xstocks.mult.CRESMx` [ok] 200 132ms https://api.backed.fi/api/v2/public/assets/CRESMx/multiplier?network=Solana
- `xstocks.mult.CSPCx` [ok] 200 758ms https://api.backed.fi/api/v2/public/assets/CSPCx/multiplier?network=Solana
...
- `xstocks.circ.WXXDCx` [ok] 200 1386ms https://api.backed.fi/api/v2/public/assets/WXXDCx/circulating-supply?format=object
...
- `xstocks.circ.BDWAPx` [ok] 200 1046ms https://api.backed.fi/api/v2/public/assets/BDWAPx/circulating-supply?format=object
...
- `xstocks.mult.MIXUx` [ok] 200 348ms https://api.backed.fi/api/v2/public/assets/MIXUx/multiplier?network=Solana
...
- `xstocks.circ.SITCx` [ok] 200 1227ms https://api.backed.fi/api/v2/public/assets/SITCx/circulating-supply?format=object
- `xstocks.circ.WHRFRx` [ok] 200 1286ms https://api.backed.fi/api/v2/public/assets/WHRFRx/circulating-supply?format=object
...
- `xstocks.circ.SNDSCx` [ok] 200 1138ms https://api.backed.fi/api/v2/public/assets/SNDSCx/circulating-supply?format=object
...
- `xstocks.mult.CRESPx` [ok] 200 1320ms https://api.backed.fi/api/v2/public/assets/CRESPx/multiplier?network=Solana
...
- `xstocks.circ.PRADx` [ok] 200 1038ms https://api.backed.fi/api/v2/public/assets/PRADx/circulating-supply?format=object
...
- `xstocks.mult.CTFJWx` [ok] 200 1006ms https://api.backed.fi/api/v2/public/assets/CTFJWx/multiplier?network=Solana
...
- `xstocks.price.SINOx` [FAIL]  12007ms https://api.backed.fi/api/v2/public/assets/SINOx/price-data — TimeoutError: The read operation timed out
- `xstocks.mult.CLONPx` [ok] 200 515ms https://api.backed.fi/api/v2/public/assets/CLONPx/multiplier?network=Solana
- `xstocks.circ.SINOTx` [ok] 200 1405ms https://api.backed.fi/api/v2/public/assets/SINOTx/circulating-supply?format=object
- `xstocks.mult.SINOTx` [ok] 200 273ms https://api.backed.fi/api/v2/public/assets/SINOTx/multiplier?network=Solana
- `xstocks.circ.WHGROx` [ok] 200 809ms https://api.backed.fi/api/v2/public/assets/WHGROx/circulating-supply?format=object
...
- `xstocks.mult.CTPCAx` [ok] 200 796ms https://api.backed.fi/api/v2/public/assets/CTPCAx/multiplier?network=Solana
...
- `xstocks.circ.PWAHLx` [ok] 200 1054ms https://api.backed.fi/api/v2/public/assets/PWAHLx/circulating-supply?format=object
...
- `xstocks.price.CRAUTx` [FAIL]  12009ms https://api.backed.fi/api/v2/public/assets/CRAUTx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.CLPHDx` [ok] 200 1063ms https://api.backed.fi/api/v2/public/assets/CLPHDx/circulating-supply?format=object
...
- `xstocks.circ.GENTEx` [ok] 200 1224ms https://api.backed.fi/api/v2/public/assets/GENTEx/circulating-supply?format=object
...
- `xstocks.circ.WUXIBx` [ok] 200 1118ms https://api.backed.fi/api/v2/public/assets/WUXIBx/circulating-supply?format=object
- `xstocks.mult.CKAHx` [ok] 200 149ms https://api.backed.fi/api/v2/public/assets/CKAHx/multiplier?network=Solana
- `xstocks.mult.SWPRPx` [ok] 200 669ms https://api.backed.fi/api/v2/public/assets/SWPRPx/multiplier?network=Solana
...
- `xstocks.mult.CKINFx` [ok] 200 130ms https://api.backed.fi/api/v2/public/assets/CKINFx/multiplier?network=Solana
...
- `xstocks.circ.KUAIx` [ok] 200 935ms https://api.backed.fi/api/v2/public/assets/KUAIx/circulating-supply?format=object
...
- `xstocks.mult.KUAIx` [ok] 200 134ms https://api.backed.fi/api/v2/public/assets/KUAIx/multiplier?network=Solana
- `xstocks.circ.HKEXCx` [ok] 200 487ms https://api.backed.fi/api/v2/public/assets/HKEXCx/circulating-supply?format=object
...
- `xstocks.mult.CHONGx` [ok] 200 114ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
- `xstocks.circ.NONGx` [ok] 200 1079ms https://api.backed.fi/api/v2/public/assets/NONGx/circulating-supply?format=object
- `xstocks.mult.NONGx` [ok] 200 198ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
- `xstocks.circ.MEITx` [ok] 200 939ms https://api.backed.fi/api/v2/public/assets/MEITx/circulating-supply?format=object
...
- `xstocks.circ.MTRCPx` [ok] 200 998ms https://api.backed.fi/api/v2/public/assets/MTRCPx/circulating-supply?format=object
...
- `xstocks.mult.HNDLDx` [ok] 200 966ms https://api.backed.fi/api/v2/public/assets/HNDLDx/multiplier?network=Solana
...
- `xstocks.circ.PICCx` [ok] 200 1840ms https://api.backed.fi/api/v2/public/assets/PICCx/circulating-supply?format=object
- `xstocks.mult.PICCx` [ok] 200 164ms https://api.backed.fi/api/v2/public/assets/PICCx/multiplier?network=Solana
- `xstocks.mult.BOCOMx` [ok] 200 636ms https://api.backed.fi/api/v2/public/assets/BOCOMx/multiplier?network=Solana
...
- `xstocks.circ.CPETCx` [ok] 200 280ms https://api.backed.fi/api/v2/public/assets/CPETCx/circulating-supply?format=object
- `xstocks.mult.CPETCx` [ok] 200 617ms https://api.backed.fi/api/v2/public/assets/CPETCx/multiplier?network=Solana
...
- `xstocks.mult.BOCHKx` [ok] 200 210ms https://api.backed.fi/api/v2/public/assets/BOCHKx/multiplier?network=Solana
...
- `xstocks.circ.CITICx` [ok] 200 193ms https://api.backed.fi/api/v2/public/assets/CITICx/circulating-supply?format=object
...
- `xstocks.mult.ANTASx` [ok] 200 188ms https://api.backed.fi/api/v2/public/assets/ANTASx/multiplier?network=Solana
...
- `xstocks.circ.CRESLx` [ok] 200 112ms https://api.backed.fi/api/v2/public/assets/CRESLx/circulating-supply?format=object
- `xstocks.circ.HAIERx` [ok] 200 113ms https://api.backed.fi/api/v2/public/assets/HAIERx/circulating-supply?format=object
- `xstocks.mult.CRESLx` [ok] 200 128ms https://api.backed.fi/api/v2/public/assets/CRESLx/multiplier?network=Solana
...
- `xstocks.mult.PSBOCx` [ok] 200 115ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
- `xstocks.circ.ZJGLDx` [ok] 200 436ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/circulating-supply?format=object
...
- `xstocks.mult.ICBCx` [ok] 200 115ms https://api.backed.fi/api/v2/public/assets/ICBCx/multiplier?network=Solana
...
- `jup.tokens.search.TNGYIx` [ok] 200 45ms https://lite-api.jup.ag/tokens/v2/search?query=TNGYIx
