...
**Generated** 2026-08-31T07:18:39Z · 2026-08-31 00:18:39 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-31T07:18:28Z · **RPC health** `ok`
**Health score** 98 / 100 — `25×rpc_ok + 30×clamp(1 − max(0, slot_ms − 300)/300, 0, 1) + 25×clamp(1 − delinquent_stake_pct/2, 0, 1) + 20×clamp(tps / tps_baseline, 0, 1)`
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h -2.22%; DEX 24h $1.87B · 1d +12% · vs-7d-ago -36%; slot 318 ms
...
| Health | `ok` |
| Slot | 443,092,668 |
| Block height | 421,140,370 |
| Block time | 2026-08-31T07:18:28Z |
| Epoch | 1,025 (67.75% · slot 292,668/432,000) |
| Mean TPS (last ~3,600s) | 3,967.2 |
| Mean non-vote TPS | 1,844.7 |
| Median TPS (same window) | 4,036.2 |
| Mean slot time | 318.4 ms |
| Median slot time | 317.5 ms |
| Transaction count (cluster) | 543,690,297,823 |
| Circulating supply | 585,121,290 SOL |
| Total supply | 633,172,974 SOL |
...
- `mrgn4atx…` · 21.79K SOL · commission 0% · lag 110885 slots
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1839989 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 306547 slots
- `Fb77sbwg…` · 2.13K SOL · commission 0% · lag 173243 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 412830 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 1108914 slots
- `CpdzCVza…` · 315.26 SOL · commission 100% · lag 292317 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 333831 slots
- `HFTcVVrX…` · 152.80 SOL · commission 100% · lag 292211 slots
- `6pEtDovp…` · 131.96 SOL · commission 100% · lag 306595 slots
- `7G4Rfctw…` · 75.85 SOL · commission 100% · lag 330969 slots
- `DZKTNGR3…` · 48.61 SOL · commission 100% · lag 338511 slots
...
| --- | ---: | --- |
| TPS chart | 269 | data/history.jsonl snapshot tape |
| TVL chart | 269 | data/history.jsonl snapshot tape |
| SOL chart | 268 | data/history.jsonl snapshot tape |
| history.jsonl rows | 269 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $402.27K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 402268 USD; at p95 floor → 1799380 USD. |
...
| p90 / p99 | 0.000013 / 0.000227 SOL | same sample |
...
Listed 715 · Solana deployments 715 · priced 80 · priced-subset mcap $285.54M (lower bound, not a census).
24h volume $12.60M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-08-31 (2026-08-31 00:18:39 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `llama.stablecoinchains` [ok] 200 222ms https://stablecoins.llama.fi/stablecoinchains
...
- `xstocks.assets.p2` [ok] 200 988ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=2
- `xstocks.assets.p3` [ok] 200 1407ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=3
...
- `xstocks.assets.p6` [ok] 200 1384ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=6
- `xstocks.assets.p7` [ok] 200 389ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=7
- `xstocks.price.AMZNx` [ok] 200 234ms https://api.backed.fi/api/v2/public/assets/AMZNx/price-data
- `xstocks.price.AAPLx` [ok] 200 387ms https://api.backed.fi/api/v2/public/assets/AAPLx/price-data
- `xstocks.price.MSFTx` [ok] 200 392ms https://api.backed.fi/api/v2/public/assets/MSFTx/price-data
- `xstocks.price.METAx` [ok] 200 391ms https://api.backed.fi/api/v2/public/assets/METAx/price-data
- `xstocks.price.GOOGLx` [ok] 200 480ms https://api.backed.fi/api/v2/public/assets/GOOGLx/price-data
...
- `xstocks.price.NVDAx` [ok] 200 936ms https://api.backed.fi/api/v2/public/assets/NVDAx/price-data
...
- `xstocks.price.QQQx` [ok] 200 386ms https://api.backed.fi/api/v2/public/assets/QQQx/price-data
...
- `xstocks.price.TSLAx` [ok] 200 1267ms https://api.backed.fi/api/v2/public/assets/TSLAx/price-data
...
- `xstocks.circ.SUOPTx` [ok] 200 295ms https://api.backed.fi/api/v2/public/assets/SUOPTx/circulating-supply?format=object
...
- `xstocks.circ.TNGYIx` [ok] 200 346ms https://api.backed.fi/api/v2/public/assets/TNGYIx/circulating-supply?format=object
- `xstocks.circ.MMGx` [ok] 200 675ms https://api.backed.fi/api/v2/public/assets/MMGx/circulating-supply?format=object
- `xstocks.price.CTINSx` [ok] 200 207ms https://api.backed.fi/api/v2/public/assets/CTINSx/price-data
...
- `xstocks.mult.ZHAOMx` [ok] 200 324ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/multiplier?network=Solana
- `xstocks.price.KUNLx` [ok] 200 124ms https://api.backed.fi/api/v2/public/assets/KUNLx/price-data
- `xstocks.circ.LAOPGx` [ok] 200 442ms https://api.backed.fi/api/v2/public/assets/LAOPGx/circulating-supply?format=object
...
- `xstocks.price.SNBIOx` [ok] 200 131ms https://api.backed.fi/api/v2/public/assets/SNBIOx/price-data
- `xstocks.circ.CTINSx` [ok] 200 514ms https://api.backed.fi/api/v2/public/assets/CTINSx/circulating-supply?format=object
...
- `xstocks.price.SZIGHx` [ok] 200 121ms https://api.backed.fi/api/v2/public/assets/SZIGHx/price-data
- `xstocks.price.WRFHDx` [ok] 200 722ms https://api.backed.fi/api/v2/public/assets/WRFHDx/price-data
...
- `xstocks.circ.JDLOGx` [ok] 200 1067ms https://api.backed.fi/api/v2/public/assets/JDLOGx/circulating-supply?format=object
- `xstocks.circ.SMOIHx` [ok] 200 121ms https://api.backed.fi/api/v2/public/assets/SMOIHx/circulating-supply?format=object
- `xstocks.circ.HAIDLx` [ok] 200 523ms https://api.backed.fi/api/v2/public/assets/HAIDLx/circulating-supply?format=object
...
- `xstocks.price.HRZRBx` [ok] 200 569ms https://api.backed.fi/api/v2/public/assets/HRZRBx/price-data
- `xstocks.price.JTGEXx` [ok] 200 130ms https://api.backed.fi/api/v2/public/assets/JTGEXx/price-data
- `xstocks.price.CRESBx` [ok] 200 423ms https://api.backed.fi/api/v2/public/assets/CRESBx/price-data
- `xstocks.mult.KUNLx` [ok] 200 1165ms https://api.backed.fi/api/v2/public/assets/KUNLx/multiplier?network=Solana
...
- `xstocks.mult.JDLOGx` [ok] 200 521ms https://api.backed.fi/api/v2/public/assets/JDLOGx/multiplier?network=Solana
...
- `xstocks.price.CMERPx` [ok] 200 883ms https://api.backed.fi/api/v2/public/assets/CMERPx/price-data
...
- `xstocks.mult.CSPCx` [ok] 200 740ms https://api.backed.fi/api/v2/public/assets/CSPCx/multiplier?network=Solana
...
- `xstocks.circ.CRESMx` [ok] 200 904ms https://api.backed.fi/api/v2/public/assets/CRESMx/circulating-supply?format=object
...
- `xstocks.mult.MIXUx` [ok] 200 630ms https://api.backed.fi/api/v2/public/assets/MIXUx/multiplier?network=Solana
- `xstocks.price.JDHLTx` [ok] 200 258ms https://api.backed.fi/api/v2/public/assets/JDHLTx/price-data
...
- `xstocks.price.CRESPx` [ok] 200 552ms https://api.backed.fi/api/v2/public/assets/CRESPx/price-data
...
- `xstocks.circ.WXXDCx` [ok] 200 1783ms https://api.backed.fi/api/v2/public/assets/WXXDCx/circulating-supply?format=object
...
- `xstocks.price.CTFJWx` [ok] 200 1032ms https://api.backed.fi/api/v2/public/assets/CTFJWx/price-data
- `xstocks.circ.SINOTx` [ok] 200 1187ms https://api.backed.fi/api/v2/public/assets/SINOTx/circulating-supply?format=object
- `xstocks.mult.CLONPx` [ok] 200 138ms https://api.backed.fi/api/v2/public/assets/CLONPx/multiplier?network=Solana
- `xstocks.circ.HRZRBx` [ok] 200 3150ms https://api.backed.fi/api/v2/public/assets/HRZRBx/circulating-supply?format=object
...
- `xstocks.mult.PWAHLx` [ok] 200 496ms https://api.backed.fi/api/v2/public/assets/PWAHLx/multiplier?network=Solana
- `xstocks.price.GENTEx` [ok] 200 389ms https://api.backed.fi/api/v2/public/assets/GENTEx/price-data
...
- `xstocks.circ.SINOx` [ok] 200 1223ms https://api.backed.fi/api/v2/public/assets/SINOx/circulating-supply?format=object
- `xstocks.mult.CTFJWx` [ok] 200 332ms https://api.backed.fi/api/v2/public/assets/CTFJWx/multiplier?network=Solana
- `xstocks.price.CTPCAx` [ok] 200 1300ms https://api.backed.fi/api/v2/public/assets/CTPCAx/price-data
- `xstocks.mult.SINOx` [ok] 200 136ms https://api.backed.fi/api/v2/public/assets/SINOx/multiplier?network=Solana
- `xstocks.circ.CRAUTx` [ok] 200 319ms https://api.backed.fi/api/v2/public/assets/CRAUTx/circulating-supply?format=object
...
- `xstocks.mult.HRZRBx` [ok] 200 851ms https://api.backed.fi/api/v2/public/assets/HRZRBx/multiplier?network=Solana
- `xstocks.mult.WUXIBx` [ok] 200 186ms https://api.backed.fi/api/v2/public/assets/WUXIBx/multiplier?network=Solana
- `xstocks.price.CKINFx` [ok] 200 295ms https://api.backed.fi/api/v2/public/assets/CKINFx/price-data
...
- `xstocks.price.KUAIx` [ok] 200 494ms https://api.backed.fi/api/v2/public/assets/KUAIx/price-data
...
- `xstocks.mult.NONGx` [ok] 200 395ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
- `xstocks.mult.SINOTx` [ok] 200 1837ms https://api.backed.fi/api/v2/public/assets/SINOTx/multiplier?network=Solana
- `xstocks.mult.HKEXCx` [ok] 200 313ms https://api.backed.fi/api/v2/public/assets/HKEXCx/multiplier?network=Solana
- `xstocks.circ.SWPRPx` [ok] 200 1156ms https://api.backed.fi/api/v2/public/assets/SWPRPx/circulating-supply?format=object
- `xstocks.circ.HKCGAx` [ok] 200 972ms https://api.backed.fi/api/v2/public/assets/HKCGAx/circulating-supply?format=object
...
- `xstocks.mult.CKINFx` [ok] 200 787ms https://api.backed.fi/api/v2/public/assets/CKINFx/multiplier?network=Solana
...
- `xstocks.price.COVELx` [ok] 200 441ms https://api.backed.fi/api/v2/public/assets/COVELx/price-data
...
- `xstocks.mult.MTRCPx` [ok] 200 123ms https://api.backed.fi/api/v2/public/assets/MTRCPx/multiplier?network=Solana
- `xstocks.mult.COVELx` [ok] 200 148ms https://api.backed.fi/api/v2/public/assets/COVELx/multiplier?network=Solana
- `xstocks.price.CKHUTx` [ok] 200 138ms https://api.backed.fi/api/v2/public/assets/CKHUTx/price-data
- `xstocks.mult.CKAHx` [ok] 200 1256ms https://api.backed.fi/api/v2/public/assets/CKAHx/multiplier?network=Solana
- `xstocks.mult.CHONGx` [ok] 200 479ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
...
- `xstocks.price.MEITx` [ok] 200 1104ms https://api.backed.fi/api/v2/public/assets/MEITx/price-data
...
- `xstocks.price.PICCx` [ok] 200 808ms https://api.backed.fi/api/v2/public/assets/PICCx/price-data
...
- `xstocks.circ.CPETCx` [ok] 200 112ms https://api.backed.fi/api/v2/public/assets/CPETCx/circulating-supply?format=object
...
- `xstocks.mult.BOCHKx` [ok] 200 362ms https://api.backed.fi/api/v2/public/assets/BOCHKx/multiplier?network=Solana
- `xstocks.circ.ANTASx` [ok] 200 129ms https://api.backed.fi/api/v2/public/assets/ANTASx/circulating-supply?format=object
...
- `xstocks.mult.MEITx` [ok] 200 618ms https://api.backed.fi/api/v2/public/assets/MEITx/multiplier?network=Solana
- `xstocks.mult.ANTASx` [ok] 200 314ms https://api.backed.fi/api/v2/public/assets/ANTASx/multiplier?network=Solana
- `xstocks.price.COSCx` [ok] 200 1424ms https://api.backed.fi/api/v2/public/assets/COSCx/price-data
- `xstocks.price.ICBCx` [ok] 200 134ms https://api.backed.fi/api/v2/public/assets/ICBCx/price-data
- `xstocks.circ.CRESLx` [ok] 200 532ms https://api.backed.fi/api/v2/public/assets/CRESLx/circulating-supply?format=object
- `xstocks.circ.ICBCx` [ok] 200 115ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
- `xstocks.price.PSBOCx` [ok] 200 479ms https://api.backed.fi/api/v2/public/assets/PSBOCx/price-data
- `xstocks.price.HAIERx` [ok] 200 784ms https://api.backed.fi/api/v2/public/assets/HAIERx/price-data
...
- `xstocks.price.CITICx` [ok] 200 1267ms https://api.backed.fi/api/v2/public/assets/CITICx/price-data
- `xstocks.mult.PSBOCx` [ok] 200 198ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
- `xstocks.mult.CRESLx` [ok] 200 464ms https://api.backed.fi/api/v2/public/assets/CRESLx/multiplier?network=Solana
- `xstocks.circ.CITICx` [ok] 200 117ms https://api.backed.fi/api/v2/public/assets/CITICx/circulating-supply?format=object
- `xstocks.circ.COSCx` [ok] 200 626ms https://api.backed.fi/api/v2/public/assets/COSCx/circulating-supply?format=object
...
- `xstocks.circ.ZJGLDx` [ok] 200 1142ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/circulating-supply?format=object
- `xstocks.mult.ZJGLDx` [ok] 200 127ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/multiplier?network=Solana
- `xstocks.circ.HAIERx` [ok] 200 1208ms https://api.backed.fi/api/v2/public/assets/HAIERx/circulating-supply?format=object
- `xstocks.mult.HAIERx` [ok] 200 324ms https://api.backed.fi/api/v2/public/assets/HAIERx/multiplier?network=Solana
- `llama.protocol.xstocks` [ok] 200 33ms https://api.llama.fi/protocol/xstocks
- `jup.tokens.search.xStock` [ok] 200 2141ms https://lite-api.jup.ag/tokens/v2/search?query=xStock
...
- `jup.tokens.search.MIXUx` [ok] 200 36ms https://lite-api.jup.ag/tokens/v2/search?query=MIXUx
