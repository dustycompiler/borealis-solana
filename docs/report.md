...
**Generated** 2026-08-30T04:34:20Z · 2026-08-29 21:34:20 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-30T04:34:08Z · **RPC health** `ok`
**Health score** 98 / 100 — `25×rpc_ok + 30×clamp(1 − max(0, slot_ms − 300)/300, 0, 1) + 25×clamp(1 − delinquent_stake_pct/2, 0, 1) + 20×clamp(tps / tps_baseline, 0, 1)`
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h +1.29%; DEX 24h $1.81B · 1d -30% · vs-7d-ago -51%; slot 317 ms
...
| Health | `ok` |
| Slot | 442,789,335 |
| Block height | 420,837,130 |
| Block time | 2026-08-30T04:34:08Z |
| Epoch | 1,024 (97.53% · slot 421,335/432,000) |
| Mean TPS (last ~3,600s) | 3,582.8 |
| Mean non-vote TPS | 1,430.8 |
| Median TPS (same window) | 3,552.0 |
| Mean slot time | 316.8 ms |
| Median slot time | 317.5 ms |
| Transaction count (cluster) | 543,315,501,634 |
| Circulating supply | 585,035,965 SOL |
| Total supply | 633,078,505 SOL |
...
- `mrgn4atx…` · 20.33K SOL · commission 0% · lag 74435 slots
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1536656 slots
- `FSyAsxcE…` · 3.03K SOL · commission 100% · lag 3214 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 109497 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 805581 slots
- `kom1oNHy…` · 662.86 SOL · commission 5% · lag 2152819 slots
- `7ZjHeeYE…` · 176.09 SOL · commission 5% · lag 30498 slots
- `6pEtDovp…` · 131.93 SOL · commission 100% · lag 3262 slots
- `7G4Rfctw…` · 92.70 SOL · commission 100% · lag 27636 slots
- `DZKTNGR3…` · 48.60 SOL · commission 100% · lag 35178 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442789335 slots
- `pSo1KZXg…` · 2.00 SOL · commission 4% · lag 451494 slots
...
| --- | ---: | --- |
| TPS chart | 162 | data/history.jsonl snapshot tape |
| TVL chart | 162 | data/history.jsonl snapshot tape |
| SOL chart | 161 | data/history.jsonl snapshot tape |
| history.jsonl rows | 162 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $26.86K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 26856 USD; at p95 floor → 1408989 USD. |
...
| p90 / p99 | 0.000010 / 0.000171 SOL | same sample |
...
24h volume $17.95M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-08-30 (2026-08-29 21:34:20 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rss.nitter.solana` [ok] 200 1535ms https://nitter.perennialte.ch/solana/rss
...
- `rss.nitter.solana_devs` [ok] 200 2460ms https://nitter.perennialte.ch/solana_devs/rss
...
- `xstocks.assets.p2` [ok] 200 1279ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=2
- `xstocks.assets.p3` [ok] 200 759ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=3
...
- `xstocks.assets.p6` [ok] 200 2144ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=6
...
- `xstocks.circ.AAPLx` [ok] 200 329ms https://api.backed.fi/api/v2/public/assets/AAPLx/circulating-supply?format=object
...
- `xstocks.circ.MMGx` [ok] 200 113ms https://api.backed.fi/api/v2/public/assets/MMGx/circulating-supply?format=object
...
- `xstocks.mult.QQQx` [ok] 200 715ms https://api.backed.fi/api/v2/public/assets/QQQx/multiplier?network=Solana
...
- `xstocks.circ.CTINSx` [ok] 200 281ms https://api.backed.fi/api/v2/public/assets/CTINSx/circulating-supply?format=object
...
- `xstocks.mult.JDLOGx` [ok] 200 1336ms https://api.backed.fi/api/v2/public/assets/JDLOGx/multiplier?network=Solana
- `xstocks.mult.ENNHLx` [ok] 200 781ms https://api.backed.fi/api/v2/public/assets/ENNHLx/multiplier?network=Solana
- `xstocks.price.SMOIHx` [FAIL]  12012ms https://api.backed.fi/api/v2/public/assets/SMOIHx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.HRZRBx` [ok] 200 291ms https://api.backed.fi/api/v2/public/assets/HRZRBx/circulating-supply?format=object
...
- `xstocks.mult.CMERPx` [ok] 200 391ms https://api.backed.fi/api/v2/public/assets/CMERPx/multiplier?network=Solana
...
- `xstocks.circ.JTGEXx` [ok] 200 800ms https://api.backed.fi/api/v2/public/assets/JTGEXx/circulating-supply?format=object
...
- `xstocks.price.WUXIBx` [FAIL]  12015ms https://api.backed.fi/api/v2/public/assets/WUXIBx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.CRAUTx` [ok] 200 115ms https://api.backed.fi/api/v2/public/assets/CRAUTx/circulating-supply?format=object
...
- `xstocks.mult.PWAHLx` [ok] 200 1066ms https://api.backed.fi/api/v2/public/assets/PWAHLx/multiplier?network=Solana
- `xstocks.circ.SWPRPx` [ok] 200 149ms https://api.backed.fi/api/v2/public/assets/SWPRPx/circulating-supply?format=object
...
- `xstocks.mult.SWPRPx` [ok] 200 269ms https://api.backed.fi/api/v2/public/assets/SWPRPx/multiplier?network=Solana
- `xstocks.mult.CLPHDx` [ok] 200 1028ms https://api.backed.fi/api/v2/public/assets/CLPHDx/multiplier?network=Solana
...
- `xstocks.mult.GENTEx` [ok] 200 2013ms https://api.backed.fi/api/v2/public/assets/GENTEx/multiplier?network=Solana
- `xstocks.mult.CKAHx` [ok] 200 1088ms https://api.backed.fi/api/v2/public/assets/CKAHx/multiplier?network=Solana
...
- `xstocks.circ.KUAIx` [ok] 200 485ms https://api.backed.fi/api/v2/public/assets/KUAIx/circulating-supply?format=object
...
- `xstocks.mult.NONGx` [ok] 200 134ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
...
- `xstocks.circ.COVELx` [ok] 200 576ms https://api.backed.fi/api/v2/public/assets/COVELx/circulating-supply?format=object
...
- `xstocks.circ.CHONGx` [ok] 200 442ms https://api.backed.fi/api/v2/public/assets/CHONGx/circulating-supply?format=object
...
- `xstocks.circ.MEITx` [ok] 200 306ms https://api.backed.fi/api/v2/public/assets/MEITx/circulating-supply?format=object
...
- `xstocks.mult.CHONGx` [ok] 200 630ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
...
- `xstocks.mult.HNDLDx` [ok] 200 147ms https://api.backed.fi/api/v2/public/assets/HNDLDx/multiplier?network=Solana
...
- `xstocks.circ.CPETCx` [ok] 200 276ms https://api.backed.fi/api/v2/public/assets/CPETCx/circulating-supply?format=object
- `xstocks.mult.BOCOMx` [ok] 200 138ms https://api.backed.fi/api/v2/public/assets/BOCOMx/multiplier?network=Solana
- `xstocks.mult.CPETCx` [ok] 200 1148ms https://api.backed.fi/api/v2/public/assets/CPETCx/multiplier?network=Solana
...
- `xstocks.mult.CITICx` [ok] 200 320ms https://api.backed.fi/api/v2/public/assets/CITICx/multiplier?network=Solana
- `xstocks.mult.ANTASx` [ok] 200 156ms https://api.backed.fi/api/v2/public/assets/ANTASx/multiplier?network=Solana
...
- `xstocks.circ.CRESLx` [ok] 200 141ms https://api.backed.fi/api/v2/public/assets/CRESLx/circulating-supply?format=object
- `xstocks.mult.CRESLx` [ok] 200 157ms https://api.backed.fi/api/v2/public/assets/CRESLx/multiplier?network=Solana
- `xstocks.circ.HAIERx` [ok] 200 374ms https://api.backed.fi/api/v2/public/assets/HAIERx/circulating-supply?format=object
- `xstocks.mult.HAIERx` [ok] 200 139ms https://api.backed.fi/api/v2/public/assets/HAIERx/multiplier?network=Solana
...
- `xstocks.mult.PSBOCx` [ok] 200 133ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
- `xstocks.mult.ZJGLDx` [ok] 200 668ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/multiplier?network=Solana
- `xstocks.price.ICBCx` [FAIL]  12015ms https://api.backed.fi/api/v2/public/assets/ICBCx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.ICBCx` [ok] 200 436ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
