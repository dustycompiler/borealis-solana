...
**Generated** 2026-08-30T16:03:43Z · 2026-08-30 09:03:43 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-30T16:03:32Z · **RPC health** `ok`
**Health score** 98 / 100 — `25×rpc_ok + 30×clamp(1 − max(0, slot_ms − 300)/300, 0, 1) + 25×clamp(1 − delinquent_stake_pct/2, 0, 1) + 20×clamp(tps / tps_baseline, 0, 1)`
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h +0.96%; DEX 24h $1.67B · 1d -36% · vs-7d-ago -55%; slot 316 ms
...
- **WARN · SOL price vs 30d median (solana.com/data)** — Current 106.17 USD is +39.0% vs 30d median 76.37 USD (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
...
| Health | `ok` |
| Slot | 442,919,955 |
| Block height | 420,967,725 |
| Block time | 2026-08-30T16:03:32Z |
| Epoch | 1,025 (27.77% · slot 119,956/432,000) |
| Mean TPS (last ~3,600s) | 4,142.8 |
| Mean non-vote TPS | 2,004.9 |
| Median TPS (same window) | 4,106.6 |
| Mean slot time | 316.1 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 543,461,758,701 |
| Circulating supply | 585,121,889 SOL |
| Total supply | 633,173,572 SOL |
...
- `nymsGg7Z…` · 116.43K SOL · commission 0% · lag 354 slots
- `mrgn2vUP…` · 90.77K SOL · commission 0% · lag 43897 slots
- `mrgn4atx…` · 21.79K SOL · commission 0% · lag 116218 slots
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1667276 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 133834 slots
- `Fb77sbwg…` · 2.13K SOL · commission 0% · lag 530 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 240117 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 936201 slots
- `CpdzCVza…` · 315.26 SOL · commission 100% · lag 119604 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 161118 slots
- `HFTcVVrX…` · 152.80 SOL · commission 100% · lag 119498 slots
- `6pEtDovp…` · 131.96 SOL · commission 100% · lag 133882 slots
...
| --- | ---: | --- |
| TPS chart | 208 | data/history.jsonl snapshot tape |
| TVL chart | 208 | data/history.jsonl snapshot tape |
| SOL chart | 207 | data/history.jsonl snapshot tape |
| history.jsonl rows | 208 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $184.25K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 184253 USD; at p95 floor → 9195658 USD. |
...
| p90 / p99 | 0.000013 / 0.000150 SOL | same sample |
...
| 24h volume | $2.23B | coingecko.simple_price |
...
24h volume $9.95M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-08-30 (2026-08-30 09:03:43 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 5391ms https://api.mainnet-beta.solana.com
...
- `rss.nitter.solana_status` [ok] 200 2318ms https://nitter.perennialte.ch/solana_status/rss
...
- `xstocks.assets.p4` [ok] 200 5970ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=4
...
- `xstocks.circ.TSLAx` [ok] 200 172ms https://api.backed.fi/api/v2/public/assets/TSLAx/circulating-supply?format=object
...
- `xstocks.price.MSFTx` [ok] 200 553ms https://api.backed.fi/api/v2/public/assets/MSFTx/price-data
...
- `xstocks.mult.NVDAx` [ok] 200 194ms https://api.backed.fi/api/v2/public/assets/NVDAx/multiplier?network=Solana
...
- `xstocks.mult.AAPLx` [ok] 200 177ms https://api.backed.fi/api/v2/public/assets/AAPLx/multiplier?network=Solana
...
- `xstocks.price.TNGYIx` [ok] 200 254ms https://api.backed.fi/api/v2/public/assets/TNGYIx/price-data
- `xstocks.price.QQQx` [ok] 200 699ms https://api.backed.fi/api/v2/public/assets/QQQx/price-data
...
- `xstocks.circ.MMGx` [ok] 200 192ms https://api.backed.fi/api/v2/public/assets/MMGx/circulating-supply?format=object
...
- `xstocks.price.ZHAOMx` [ok] 200 594ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/price-data
...
- `xstocks.circ.LAOPGx` [ok] 200 795ms https://api.backed.fi/api/v2/public/assets/LAOPGx/circulating-supply?format=object
...
- `xstocks.mult.CTINSx` [ok] 200 410ms https://api.backed.fi/api/v2/public/assets/CTINSx/multiplier?network=Solana
- `xstocks.mult.HAIDLx` [ok] 200 191ms https://api.backed.fi/api/v2/public/assets/HAIDLx/multiplier?network=Solana
- `xstocks.mult.ZHAOMx` [ok] 200 682ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/multiplier?network=Solana
...
- `xstocks.mult.LAOPGx` [ok] 200 447ms https://api.backed.fi/api/v2/public/assets/LAOPGx/multiplier?network=Solana
- `xstocks.mult.JDLOGx` [ok] 200 831ms https://api.backed.fi/api/v2/public/assets/JDLOGx/multiplier?network=Solana
...
- `xstocks.price.CMERPx` [ok] 200 186ms https://api.backed.fi/api/v2/public/assets/CMERPx/price-data
...
- `xstocks.circ.CRESMx` [ok] 200 180ms https://api.backed.fi/api/v2/public/assets/CRESMx/circulating-supply?format=object
...
- `xstocks.circ.SMOIHx` [ok] 200 634ms https://api.backed.fi/api/v2/public/assets/SMOIHx/circulating-supply?format=object
- `xstocks.mult.CRESBx` [ok] 200 388ms https://api.backed.fi/api/v2/public/assets/CRESBx/multiplier?network=Solana
- `xstocks.price.WXXDCx` [ok] 200 465ms https://api.backed.fi/api/v2/public/assets/WXXDCx/price-data
...
- `xstocks.price.CMENDx` [ok] 200 817ms https://api.backed.fi/api/v2/public/assets/CMENDx/price-data
...
- `xstocks.mult.WHRFRx` [ok] 200 365ms https://api.backed.fi/api/v2/public/assets/WHRFRx/multiplier?network=Solana
...
- `xstocks.circ.CRESPx` [ok] 200 460ms https://api.backed.fi/api/v2/public/assets/CRESPx/circulating-supply?format=object
...
- `xstocks.mult.CMENDx` [ok] 200 623ms https://api.backed.fi/api/v2/public/assets/CMENDx/multiplier?network=Solana
...
- `xstocks.circ.CLPHDx` [ok] 200 701ms https://api.backed.fi/api/v2/public/assets/CLPHDx/circulating-supply?format=object
- `xstocks.price.GENTEx` [ok] 200 671ms https://api.backed.fi/api/v2/public/assets/GENTEx/price-data
...
- `xstocks.mult.SWPRPx` [ok] 200 444ms https://api.backed.fi/api/v2/public/assets/SWPRPx/multiplier?network=Solana
...
- `xstocks.mult.NONGx` [ok] 200 189ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
...
- `xstocks.price.HKEXCx` [ok] 200 870ms https://api.backed.fi/api/v2/public/assets/HKEXCx/price-data
- `xstocks.circ.CHONGx` [ok] 200 186ms https://api.backed.fi/api/v2/public/assets/CHONGx/circulating-supply?format=object
- `xstocks.price.MEITx` [ok] 200 582ms https://api.backed.fi/api/v2/public/assets/MEITx/price-data
...
- `xstocks.circ.MTRCPx` [ok] 200 480ms https://api.backed.fi/api/v2/public/assets/MTRCPx/circulating-supply?format=object
...
- `xstocks.price.HNDLDx` [ok] 200 941ms https://api.backed.fi/api/v2/public/assets/HNDLDx/price-data
- `xstocks.circ.COVELx` [ok] 200 1266ms https://api.backed.fi/api/v2/public/assets/COVELx/circulating-supply?format=object
- `xstocks.mult.HKEXCx` [ok] 200 529ms https://api.backed.fi/api/v2/public/assets/HKEXCx/multiplier?network=Solana
- `xstocks.circ.COSCx` [ok] 200 300ms https://api.backed.fi/api/v2/public/assets/COSCx/circulating-supply?format=object
- `xstocks.mult.MEITx` [ok] 200 373ms https://api.backed.fi/api/v2/public/assets/MEITx/multiplier?network=Solana
...
- `xstocks.mult.PICCx` [ok] 200 496ms https://api.backed.fi/api/v2/public/assets/PICCx/multiplier?network=Solana
...
- `xstocks.mult.GEELx` [ok] 200 1157ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
- `xstocks.price.CPETCx` [ok] 200 177ms https://api.backed.fi/api/v2/public/assets/CPETCx/price-data
- `xstocks.price.BOCHKx` [ok] 200 206ms https://api.backed.fi/api/v2/public/assets/BOCHKx/price-data
- `xstocks.circ.POPMTx` [ok] 200 180ms https://api.backed.fi/api/v2/public/assets/POPMTx/circulating-supply?format=object
- `xstocks.circ.BOCOMx` [ok] 200 172ms https://api.backed.fi/api/v2/public/assets/BOCOMx/circulating-supply?format=object
- `xstocks.circ.CPETCx` [ok] 200 245ms https://api.backed.fi/api/v2/public/assets/CPETCx/circulating-supply?format=object
- `xstocks.circ.BOCHKx` [ok] 200 208ms https://api.backed.fi/api/v2/public/assets/BOCHKx/circulating-supply?format=object
...
- `xstocks.mult.CPETCx` [ok] 200 199ms https://api.backed.fi/api/v2/public/assets/CPETCx/multiplier?network=Solana
- `xstocks.mult.BOCHKx` [ok] 200 205ms https://api.backed.fi/api/v2/public/assets/BOCHKx/multiplier?network=Solana
- `xstocks.price.ANTASx` [ok] 200 477ms https://api.backed.fi/api/v2/public/assets/ANTASx/price-data
- `xstocks.price.HAIERx` [ok] 200 190ms https://api.backed.fi/api/v2/public/assets/HAIERx/price-data
- `xstocks.price.CRESLx` [ok] 200 266ms https://api.backed.fi/api/v2/public/assets/CRESLx/price-data
- `xstocks.price.CITICx` [ok] 200 719ms https://api.backed.fi/api/v2/public/assets/CITICx/price-data
...
- `xstocks.mult.HNDLDx` [ok] 200 1066ms https://api.backed.fi/api/v2/public/assets/HNDLDx/multiplier?network=Solana
- `xstocks.price.PSBOCx` [ok] 200 420ms https://api.backed.fi/api/v2/public/assets/PSBOCx/price-data
- `xstocks.circ.CITICx` [ok] 200 187ms https://api.backed.fi/api/v2/public/assets/CITICx/circulating-supply?format=object
- `xstocks.price.ZJGLDx` [ok] 200 448ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/price-data
- `xstocks.price.ICBCx` [ok] 200 204ms https://api.backed.fi/api/v2/public/assets/ICBCx/price-data
- `xstocks.mult.ANTASx` [ok] 200 220ms https://api.backed.fi/api/v2/public/assets/ANTASx/multiplier?network=Solana
- `xstocks.mult.CITICx` [ok] 200 185ms https://api.backed.fi/api/v2/public/assets/CITICx/multiplier?network=Solana
- `xstocks.mult.CRESLx` [ok] 200 345ms https://api.backed.fi/api/v2/public/assets/CRESLx/multiplier?network=Solana
- `xstocks.circ.ICBCx` [ok] 200 189ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
- `xstocks.mult.HAIERx` [ok] 200 518ms https://api.backed.fi/api/v2/public/assets/HAIERx/multiplier?network=Solana
- `xstocks.mult.ICBCx` [ok] 200 241ms https://api.backed.fi/api/v2/public/assets/ICBCx/multiplier?network=Solana
- `xstocks.circ.ZJGLDx` [ok] 200 562ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/circulating-supply?format=object
- `xstocks.circ.PSBOCx` [ok] 200 1083ms https://api.backed.fi/api/v2/public/assets/PSBOCx/circulating-supply?format=object
- `xstocks.mult.ZJGLDx` [ok] 200 515ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/multiplier?network=Solana
...
- `jup.tokens.search.MEITx` [ok] 200 174ms https://lite-api.jup.ag/tokens/v2/search?query=MEITx
