...
**Generated** 2026-08-29T10:33:49Z · 2026-08-29 03:33:49 PT
**Author** dustycompiler · **Version** 1.5.6 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-29T10:33:38Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h -2.27%; DEX 24h $2.62B · 1d -29% · vs-7d-ago -27%; slot 317 ms
...
- **WARN · Correlation: risk-off (SOL 24h ↓ + TVL 1d ↓ + DEX 1d ↓)** — SOL 24h -2.27%, DeFiLlama TVL 1d -2.78%, DEX 1d -29.33%. (threshold: `SOL 24h < 0 AND TVL 1d < 0 AND DEX 1d < 0`)
- **WARN · Large Solana DEX volume 7d move** — DeFiLlama Solana DEX volume 7d change is -27.38%. (threshold: `|7d %| >= 20`)
- **WARN · SOL price vs 30d median (solana.com/data)** — Current 103.38 USD is +36.0% vs 30d median 76.00 USD (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
...
| Health | `ok` |
| Slot | 442,584,896 |
| Block height | 420,632,798 |
| Block time | 2026-08-29T10:33:38Z |
| Epoch | 1,024 (50.21% · slot 216,896/432,000) |
| Mean TPS (last ~3,600s) | 3,351.6 |
| Mean non-vote TPS | 1,193.3 |
| Median TPS (same window) | 3,305.9 |
| Mean slot time | 316.9 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 543,057,461,984 |
| Circulating supply | 584,161,643 SOL |
| Total supply | 633,079,183 SOL |
...
- `mrgn4atx…` · 20.33K SOL · commission 0% · lag 13143 slots
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1332217 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 238195 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 601142 slots
- `kom1oNHy…` · 662.86 SOL · commission 5% · lag 1948380 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442584896 slots
- `pSo1KZXg…` · 2.00 SOL · commission 4% · lag 247055 slots
- `7Dvp5zCF…` · 1.07 SOL · commission 100% · lag 405541 slots
- `bcZxRSoz…` · 0.00 SOL · commission 0% · lag 1944897 slots
...
| --- | ---: | --- |
| TPS chart | 89 | data/history.jsonl snapshot tape |
| TVL chart | 89 | data/history.jsonl snapshot tape |
| SOL chart | 88 | data/history.jsonl snapshot tape |
| history.jsonl rows | 89 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $14.93K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 14933 USD; at p95 floor → 1048575 USD. |
...
24h volume $30.14M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-08-29 (2026-08-29 03:33:49 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 7072ms https://api.mainnet-beta.solana.com
...
- `rss.nitter.anza_xyz` [ok] 200 1381ms https://nitter.perennialte.ch/anza_xyz/rss
...
- `xstocks.assets.p2` [ok] 200 895ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=2
...
- `xstocks.assets.p7` [ok] 200 376ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=7
...
- `xstocks.circ.AMZNx` [ok] 200 476ms https://api.backed.fi/api/v2/public/assets/AMZNx/circulating-supply?format=object
...
- `xstocks.circ.SUOPTx` [ok] 200 268ms https://api.backed.fi/api/v2/public/assets/SUOPTx/circulating-supply?format=object
- `xstocks.circ.MMGx` [ok] 200 196ms https://api.backed.fi/api/v2/public/assets/MMGx/circulating-supply?format=object
- `xstocks.circ.COINx` [ok] 200 333ms https://api.backed.fi/api/v2/public/assets/COINx/circulating-supply?format=object
- `xstocks.mult.SUOPTx` [ok] 200 181ms https://api.backed.fi/api/v2/public/assets/SUOPTx/multiplier?network=Solana
...
- `xstocks.circ.TNGYIx` [ok] 200 315ms https://api.backed.fi/api/v2/public/assets/TNGYIx/circulating-supply?format=object
...
- `xstocks.circ.LAOPGx` [ok] 200 358ms https://api.backed.fi/api/v2/public/assets/LAOPGx/circulating-supply?format=object
- `xstocks.circ.BANKCx` [ok] 200 900ms https://api.backed.fi/api/v2/public/assets/BANKCx/circulating-supply?format=object
...
- `xstocks.circ.JDLOGx` [ok] 200 351ms https://api.backed.fi/api/v2/public/assets/JDLOGx/circulating-supply?format=object
...
- `xstocks.mult.KUNLx` [ok] 200 486ms https://api.backed.fi/api/v2/public/assets/KUNLx/multiplier?network=Solana
- `xstocks.circ.ENNHLx` [ok] 200 125ms https://api.backed.fi/api/v2/public/assets/ENNHLx/circulating-supply?format=object
- `xstocks.circ.HAIDLx` [ok] 200 641ms https://api.backed.fi/api/v2/public/assets/HAIDLx/circulating-supply?format=object
- `xstocks.mult.SZIGHx` [ok] 200 175ms https://api.backed.fi/api/v2/public/assets/SZIGHx/multiplier?network=Solana
- `xstocks.mult.JDLOGx` [ok] 200 786ms https://api.backed.fi/api/v2/public/assets/JDLOGx/multiplier?network=Solana
- `xstocks.mult.ENNHLx` [ok] 200 559ms https://api.backed.fi/api/v2/public/assets/ENNHLx/multiplier?network=Solana
- `xstocks.mult.HAIDLx` [ok] 200 729ms https://api.backed.fi/api/v2/public/assets/HAIDLx/multiplier?network=Solana
...
- `xstocks.mult.SMOIHx` [ok] 200 321ms https://api.backed.fi/api/v2/public/assets/SMOIHx/multiplier?network=Solana
...
- `xstocks.circ.CRESBx` [ok] 200 382ms https://api.backed.fi/api/v2/public/assets/CRESBx/circulating-supply?format=object
...
- `xstocks.mult.CSPCx` [ok] 200 289ms https://api.backed.fi/api/v2/public/assets/CSPCx/multiplier?network=Solana
...
- `xstocks.mult.WXXDCx` [ok] 200 267ms https://api.backed.fi/api/v2/public/assets/WXXDCx/multiplier?network=Solana
...
- `xstocks.circ.CMENDx` [ok] 200 267ms https://api.backed.fi/api/v2/public/assets/CMENDx/circulating-supply?format=object
...
- `xstocks.circ.WHRFRx` [ok] 200 313ms https://api.backed.fi/api/v2/public/assets/WHRFRx/circulating-supply?format=object
...
- `xstocks.mult.MIXUx` [ok] 200 564ms https://api.backed.fi/api/v2/public/assets/MIXUx/multiplier?network=Solana
...
- `xstocks.price.SNDSCx` [FAIL]  12015ms https://api.backed.fi/api/v2/public/assets/SNDSCx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.CRESPx` [ok] 200 436ms https://api.backed.fi/api/v2/public/assets/CRESPx/circulating-supply?format=object
...
- `xstocks.mult.CRESPx` [ok] 200 150ms https://api.backed.fi/api/v2/public/assets/CRESPx/multiplier?network=Solana
...
- `xstocks.circ.CLONPx` [ok] 200 316ms https://api.backed.fi/api/v2/public/assets/CLONPx/circulating-supply?format=object
...
- `xstocks.mult.SINOTx` [ok] 200 643ms https://api.backed.fi/api/v2/public/assets/SINOTx/multiplier?network=Solana
...
- `xstocks.mult.CTFJWx` [ok] 200 873ms https://api.backed.fi/api/v2/public/assets/CTFJWx/multiplier?network=Solana
- `xstocks.circ.SINOx` [ok] 200 1287ms https://api.backed.fi/api/v2/public/assets/SINOx/circulating-supply?format=object
...
- `xstocks.circ.CKINFx` [ok] 200 639ms https://api.backed.fi/api/v2/public/assets/CKINFx/circulating-supply?format=object
- `xstocks.mult.CKINFx` [ok] 200 375ms https://api.backed.fi/api/v2/public/assets/CKINFx/multiplier?network=Solana
...
- `xstocks.circ.HKEXCx` [ok] 200 403ms https://api.backed.fi/api/v2/public/assets/HKEXCx/circulating-supply?format=object
...
- `xstocks.mult.MEITx` [ok] 200 701ms https://api.backed.fi/api/v2/public/assets/MEITx/multiplier?network=Solana
...
- `xstocks.circ.GEELx` [ok] 200 282ms https://api.backed.fi/api/v2/public/assets/GEELx/circulating-supply?format=object
...
- `xstocks.price.BOCOMx` [FAIL]  12027ms https://api.backed.fi/api/v2/public/assets/BOCOMx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.POPMTx` [ok] 200 631ms https://api.backed.fi/api/v2/public/assets/POPMTx/multiplier?network=Solana
...
- `xstocks.mult.CPETCx` [ok] 200 520ms https://api.backed.fi/api/v2/public/assets/CPETCx/multiplier?network=Solana
...
- `xstocks.circ.CITICx` [ok] 200 1180ms https://api.backed.fi/api/v2/public/assets/CITICx/circulating-supply?format=object
- `xstocks.circ.CRESLx` [ok] 200 507ms https://api.backed.fi/api/v2/public/assets/CRESLx/circulating-supply?format=object
...
- `xstocks.mult.ZJGLDx` [ok] 200 143ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/multiplier?network=Solana
- `xstocks.mult.HAIERx` [ok] 200 558ms https://api.backed.fi/api/v2/public/assets/HAIERx/multiplier?network=Solana
...
- `xstocks.mult.CITICx` [ok] 200 961ms https://api.backed.fi/api/v2/public/assets/CITICx/multiplier?network=Solana
...
- `xstocks.circ.PSBOCx` [ok] 200 1283ms https://api.backed.fi/api/v2/public/assets/PSBOCx/circulating-supply?format=object
- `xstocks.mult.PSBOCx` [ok] 200 167ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
- `xstocks.circ.ICBCx` [ok] 200 1097ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
...
- `jup.tokens.search.LAOPGx` [ok] 200 55ms https://lite-api.jup.ag/tokens/v2/search?query=LAOPGx
...
- `jup.tokens.search.WRFHDx` [ok] 200 52ms https://lite-api.jup.ag/tokens/v2/search?query=WRFHDx
