...
**Generated** 2026-08-29T12:33:46Z · 2026-08-29 05:33:46 PT
**Author** dustycompiler · **Version** 1.5.6 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-29T12:33:35Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h -1.35%; DEX 24h $2.59B · 1d -30% · vs-7d-ago -28%; slot 317 ms
...
- **INFO · Correlation: risk-off (SOL 24h ↓ + TVL 1d ↓ + DEX 1d ↓)** — SOL 24h -1.35%, DeFiLlama TVL 1d -2.85%, DEX 1d -29.99%. (threshold: `SOL 24h < 0 AND TVL 1d < 0 AND DEX 1d < 0`)
...
| Health | `ok` |
| Slot | 442,607,623 |
| Block height | 420,655,513 |
| Block time | 2026-08-29T12:33:35Z |
| Epoch | 1,024 (55.47% · slot 239,623/432,000) |
| Mean TPS (last ~3,600s) | 3,513.9 |
| Mean non-vote TPS | 1,353.4 |
| Median TPS (same window) | 3,453.9 |
| Mean slot time | 317.0 ms |
| Median slot time | 317.5 ms |
| Transaction count (cluster) | 543,081,939,806 |
| Circulating supply | 584,161,578 SOL |
| Total supply | 633,079,118 SOL |
...
- `mrgn4atx…` · 20.33K SOL · commission 0% · lag 12288 slots
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1354944 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 260922 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 623869 slots
- `kom1oNHy…` · 662.86 SOL · commission 5% · lag 1971107 slots
- `7ZjHeeYE…` · 176.09 SOL · commission 5% · lag 5608 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442607623 slots
- `pSo1KZXg…` · 2.00 SOL · commission 4% · lag 269782 slots
- `7Dvp5zCF…` · 1.07 SOL · commission 100% · lag 428268 slots
- `bcZxRSoz…` · 0.00 SOL · commission 0% · lag 1967624 slots
...
| --- | ---: | --- |
| TPS chart | 97 | data/history.jsonl snapshot tape |
| TVL chart | 97 | data/history.jsonl snapshot tape |
| SOL chart | 96 | data/history.jsonl snapshot tape |
| history.jsonl rows | 97 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $59.94K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 59939 USD; at p95 floor → 5421794 USD. |
...
_As of 2026-08-29 (2026-08-29 05:33:46 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 5630ms https://api.mainnet-beta.solana.com
...
- `rss.news.rss` [ok] 200 392ms https://solana.com/news/rss.xml
...
- `rss.xcancel.solana_devs` [ok] 200 428ms https://xcancel.com/solana_devs/rss
...
- `rss.nitter.anza_xyz` [ok] 200 1548ms https://nitter.perennialte.ch/anza_xyz/rss
...
- `xstocks.assets.p0` [ok] 200 4916ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0
...
- `xstocks.circ.AAPLx` [ok] 200 473ms https://api.backed.fi/api/v2/public/assets/AAPLx/circulating-supply?format=object
- `xstocks.circ.AMZNx` [ok] 200 474ms https://api.backed.fi/api/v2/public/assets/AMZNx/circulating-supply?format=object
...
- `xstocks.circ.METAx` [ok] 200 614ms https://api.backed.fi/api/v2/public/assets/METAx/circulating-supply?format=object
...
- `xstocks.mult.AAPLx` [ok] 200 617ms https://api.backed.fi/api/v2/public/assets/AAPLx/multiplier?network=Solana
...
- `xstocks.mult.BANKCx` [ok] 200 1014ms https://api.backed.fi/api/v2/public/assets/BANKCx/multiplier?network=Solana
...
- `xstocks.price.HAIDLx` [FAIL]  12009ms https://api.backed.fi/api/v2/public/assets/HAIDLx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.HAIDLx` [ok] 200 269ms https://api.backed.fi/api/v2/public/assets/HAIDLx/circulating-supply?format=object
...
- `xstocks.circ.SNBIOx` [ok] 200 359ms https://api.backed.fi/api/v2/public/assets/SNBIOx/circulating-supply?format=object
- `xstocks.mult.WRFHDx` [ok] 200 526ms https://api.backed.fi/api/v2/public/assets/WRFHDx/multiplier?network=Solana
- `xstocks.circ.JDLOGx` [ok] 200 989ms https://api.backed.fi/api/v2/public/assets/JDLOGx/circulating-supply?format=object
...
- `xstocks.mult.HAIDLx` [ok] 200 1099ms https://api.backed.fi/api/v2/public/assets/HAIDLx/multiplier?network=Solana
...
- `xstocks.circ.CRESMx` [ok] 200 171ms https://api.backed.fi/api/v2/public/assets/CRESMx/circulating-supply?format=object
- `xstocks.circ.WXXDCx` [ok] 200 193ms https://api.backed.fi/api/v2/public/assets/WXXDCx/circulating-supply?format=object
- `xstocks.circ.JTGEXx` [ok] 200 697ms https://api.backed.fi/api/v2/public/assets/JTGEXx/circulating-supply?format=object
...
- `xstocks.circ.BDWAPx` [ok] 200 453ms https://api.backed.fi/api/v2/public/assets/BDWAPx/circulating-supply?format=object
...
- `xstocks.price.JDHLTx` [FAIL]  12017ms https://api.backed.fi/api/v2/public/assets/JDHLTx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.SNDSCx` [ok] 200 524ms https://api.backed.fi/api/v2/public/assets/SNDSCx/circulating-supply?format=object
...
- `xstocks.circ.CRESPx` [ok] 200 412ms https://api.backed.fi/api/v2/public/assets/CRESPx/circulating-supply?format=object
...
- `xstocks.mult.PRADx` [ok] 200 438ms https://api.backed.fi/api/v2/public/assets/PRADx/multiplier?network=Solana
...
- `xstocks.circ.CTFJWx` [ok] 200 173ms https://api.backed.fi/api/v2/public/assets/CTFJWx/circulating-supply?format=object
...
- `xstocks.mult.CTPCAx` [ok] 200 311ms https://api.backed.fi/api/v2/public/assets/CTPCAx/multiplier?network=Solana
- `xstocks.mult.SINOx` [ok] 200 214ms https://api.backed.fi/api/v2/public/assets/SINOx/multiplier?network=Solana
...
- `xstocks.price.GENTEx` [FAIL]  12018ms https://api.backed.fi/api/v2/public/assets/GENTEx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.GENTEx` [ok] 200 670ms https://api.backed.fi/api/v2/public/assets/GENTEx/multiplier?network=Solana
...
- `xstocks.circ.SWPRPx` [ok] 200 2241ms https://api.backed.fi/api/v2/public/assets/SWPRPx/circulating-supply?format=object
...
- `xstocks.mult.GEELx` [ok] 200 698ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
...
- `xstocks.price.COSCx` [FAIL]  12015ms https://api.backed.fi/api/v2/public/assets/COSCx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.PICCx` [ok] 200 664ms https://api.backed.fi/api/v2/public/assets/PICCx/multiplier?network=Solana
...
- `xstocks.mult.MTRCPx` [ok] 200 1421ms https://api.backed.fi/api/v2/public/assets/MTRCPx/multiplier?network=Solana
- `xstocks.mult.CKHUTx` [ok] 200 394ms https://api.backed.fi/api/v2/public/assets/CKHUTx/multiplier?network=Solana
...
- `xstocks.circ.CPETCx` [ok] 200 190ms https://api.backed.fi/api/v2/public/assets/CPETCx/circulating-supply?format=object
...
- `xstocks.circ.CITICx` [ok] 200 236ms https://api.backed.fi/api/v2/public/assets/CITICx/circulating-supply?format=object
...
- `xstocks.circ.HAIERx` [ok] 200 191ms https://api.backed.fi/api/v2/public/assets/HAIERx/circulating-supply?format=object
- `xstocks.circ.ZJGLDx` [ok] 200 184ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/circulating-supply?format=object
- `xstocks.mult.ANTASx` [ok] 200 393ms https://api.backed.fi/api/v2/public/assets/ANTASx/multiplier?network=Solana
...
- `xstocks.mult.ZJGLDx` [ok] 200 224ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/multiplier?network=Solana
...
- `xstocks.circ.ICBCx` [ok] 200 176ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
- `xstocks.mult.ICBCx` [ok] 200 174ms https://api.backed.fi/api/v2/public/assets/ICBCx/multiplier?network=Solana
- `xstocks.mult.PSBOCx` [ok] 200 2456ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
- `llama.protocol.xstocks` [ok] 200 4209ms https://api.llama.fi/protocol/xstocks
