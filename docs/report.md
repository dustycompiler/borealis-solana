...
**Generated** 2026-08-29T11:18:29Z · 2026-08-29 04:18:29 PT
**Author** dustycompiler · **Version** 1.5.6 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-29T11:18:19Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h -2.70%; DEX 24h $2.59B · 1d -30% · vs-7d-ago -28%; slot 316 ms
...
- **WARN · Correlation: risk-off (SOL 24h ↓ + TVL 1d ↓ + DEX 1d ↓)** — SOL 24h -2.70%, DeFiLlama TVL 1d -2.78%, DEX 1d -29.99%. (threshold: `SOL 24h < 0 AND TVL 1d < 0 AND DEX 1d < 0`)
...
- **WARN · Last slot-time sample outside 2.5σ of the 60-sample window** — Last sample 330 ms is +2.91σ vs window mean 316 ms (n=60). (threshold: `|last sample − window mean| > 2.5σ`)
...
| Health | `ok` |
| Slot | 442,593,376 |
| Block height | 420,641,276 |
| Block time | 2026-08-29T11:18:19Z |
| Epoch | 1,024 (52.17% · slot 225,378/432,000) |
| Mean TPS (last ~3,600s) | 3,270.4 |
| Mean non-vote TPS | 1,103.9 |
| Median TPS (same window) | 3,269.2 |
| Mean slot time | 316.2 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 543,066,248,878 |
| Circulating supply | 584,161,619 SOL |
| Total supply | 633,079,160 SOL |
...
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1340697 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 246675 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 609622 slots
- `kom1oNHy…` · 662.86 SOL · commission 5% · lag 1956860 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442593376 slots
- `pSo1KZXg…` · 2.00 SOL · commission 4% · lag 255535 slots
- `7Dvp5zCF…` · 1.07 SOL · commission 100% · lag 414021 slots
- `bcZxRSoz…` · 0.00 SOL · commission 0% · lag 1953377 slots
...
| --- | ---: | --- |
| TPS chart | 92 | data/history.jsonl snapshot tape |
| TVL chart | 92 | data/history.jsonl snapshot tape |
| SOL chart | 91 | data/history.jsonl snapshot tape |
| history.jsonl rows | 92 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $49.42K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 49416 USD; at p95 floor → 9883286 USD. |
...
| p90 / p99 | 0.000009 / 0.000163 SOL | same sample |
...
24h volume $30.08M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-08-29 (2026-08-29 04:18:29 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getVoteAccounts` [ok] 200 676ms https://api.mainnet-beta.solana.com
...
- `solana.com.databricks` [ok] 200 1298ms https://solana.com/api/databricks/data?days=30
...
- `rss.nitter.solana` [ok] 200 4934ms https://nitter.perennialte.ch/solana/rss
...
- `rss.nitter.solana_devs` [ok] 200 1797ms https://nitter.perennialte.ch/solana_devs/rss
...
- `xstocks.assets.p2` [ok] 200 1204ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=2
- `xstocks.assets.p3` [ok] 200 873ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=3
- `xstocks.assets.p4` [ok] 200 2014ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=4
- `xstocks.assets.p5` [ok] 200 2917ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=5
...
- `xstocks.circ.MSFTx` [ok] 200 372ms https://api.backed.fi/api/v2/public/assets/MSFTx/circulating-supply?format=object
...
- `xstocks.circ.TSLAx` [ok] 200 395ms https://api.backed.fi/api/v2/public/assets/TSLAx/circulating-supply?format=object
...
- `xstocks.circ.AMZNx` [ok] 200 690ms https://api.backed.fi/api/v2/public/assets/AMZNx/circulating-supply?format=object
...
- `xstocks.circ.SUOPTx` [ok] 200 511ms https://api.backed.fi/api/v2/public/assets/SUOPTx/circulating-supply?format=object
...
- `xstocks.mult.COINx` [ok] 200 742ms https://api.backed.fi/api/v2/public/assets/COINx/multiplier?network=Solana
- `xstocks.mult.BANKCx` [ok] 200 669ms https://api.backed.fi/api/v2/public/assets/BANKCx/multiplier?network=Solana
- `xstocks.circ.ZHAOMx` [ok] 200 557ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/circulating-supply?format=object
- `xstocks.mult.ZHAOMx` [ok] 200 194ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/multiplier?network=Solana
- `xstocks.circ.LAOPGx` [ok] 200 596ms https://api.backed.fi/api/v2/public/assets/LAOPGx/circulating-supply?format=object
...
- `xstocks.price.KUNLx` [FAIL]  12013ms https://api.backed.fi/api/v2/public/assets/KUNLx/price-data — TimeoutError: The read operation timed out
- `xstocks.price.HAIDLx` [FAIL]  12008ms https://api.backed.fi/api/v2/public/assets/HAIDLx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.KUNLx` [ok] 200 192ms https://api.backed.fi/api/v2/public/assets/KUNLx/circulating-supply?format=object
...
- `xstocks.mult.ENNHLx` [ok] 200 368ms https://api.backed.fi/api/v2/public/assets/ENNHLx/multiplier?network=Solana
...
- `xstocks.circ.CSPCx` [ok] 200 167ms https://api.backed.fi/api/v2/public/assets/CSPCx/circulating-supply?format=object
...
- `xstocks.circ.HRZRBx` [ok] 200 595ms https://api.backed.fi/api/v2/public/assets/HRZRBx/circulating-supply?format=object
...
- `xstocks.circ.CMERPx` [ok] 200 1009ms https://api.backed.fi/api/v2/public/assets/CMERPx/circulating-supply?format=object
...
- `xstocks.circ.SMOIHx` [ok] 200 1846ms https://api.backed.fi/api/v2/public/assets/SMOIHx/circulating-supply?format=object
- `xstocks.mult.WXXDCx` [ok] 200 188ms https://api.backed.fi/api/v2/public/assets/WXXDCx/multiplier?network=Solana
- `xstocks.circ.CRESBx` [ok] 200 1446ms https://api.backed.fi/api/v2/public/assets/CRESBx/circulating-supply?format=object
...
- `xstocks.mult.SMOIHx` [ok] 200 1014ms https://api.backed.fi/api/v2/public/assets/SMOIHx/multiplier?network=Solana
- `xstocks.circ.CRESMx` [ok] 200 1975ms https://api.backed.fi/api/v2/public/assets/CRESMx/circulating-supply?format=object
...
- `xstocks.price.BDWAPx` [FAIL]  12025ms https://api.backed.fi/api/v2/public/assets/BDWAPx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.MIXUx` [ok] 200 794ms https://api.backed.fi/api/v2/public/assets/MIXUx/circulating-supply?format=object
- `xstocks.circ.CMENDx` [ok] 200 1397ms https://api.backed.fi/api/v2/public/assets/CMENDx/circulating-supply?format=object
...
- `xstocks.circ.WHRFRx` [ok] 200 1151ms https://api.backed.fi/api/v2/public/assets/WHRFRx/circulating-supply?format=object
- `xstocks.mult.JDHLTx` [ok] 200 302ms https://api.backed.fi/api/v2/public/assets/JDHLTx/multiplier?network=Solana
- `xstocks.circ.SITCx` [ok] 200 1160ms https://api.backed.fi/api/v2/public/assets/SITCx/circulating-supply?format=object
...
- `xstocks.circ.ASMPTx` [ok] 200 2439ms https://api.backed.fi/api/v2/public/assets/ASMPTx/circulating-supply?format=object
...
- `xstocks.mult.SNDSCx` [ok] 200 750ms https://api.backed.fi/api/v2/public/assets/SNDSCx/multiplier?network=Solana
...
- `xstocks.circ.SINOTx` [ok] 200 975ms https://api.backed.fi/api/v2/public/assets/SINOTx/circulating-supply?format=object
- `xstocks.mult.SINOTx` [ok] 200 220ms https://api.backed.fi/api/v2/public/assets/SINOTx/multiplier?network=Solana
- `xstocks.circ.PRADx` [ok] 200 1653ms https://api.backed.fi/api/v2/public/assets/PRADx/circulating-supply?format=object
...
- `xstocks.circ.CLONPx` [ok] 200 1124ms https://api.backed.fi/api/v2/public/assets/CLONPx/circulating-supply?format=object
- `xstocks.mult.PRADx` [ok] 200 413ms https://api.backed.fi/api/v2/public/assets/PRADx/multiplier?network=Solana
- `xstocks.circ.WHGROx` [ok] 200 1130ms https://api.backed.fi/api/v2/public/assets/WHGROx/circulating-supply?format=object
...
- `xstocks.mult.CTFJWx` [ok] 200 1656ms https://api.backed.fi/api/v2/public/assets/CTFJWx/multiplier?network=Solana
...
- `xstocks.circ.SINOx` [ok] 200 1725ms https://api.backed.fi/api/v2/public/assets/SINOx/circulating-supply?format=object
- `xstocks.mult.SINOx` [ok] 200 284ms https://api.backed.fi/api/v2/public/assets/SINOx/multiplier?network=Solana
- `xstocks.mult.CTPCAx` [ok] 200 396ms https://api.backed.fi/api/v2/public/assets/CTPCAx/multiplier?network=Solana
...
- `xstocks.circ.PWAHLx` [ok] 200 1823ms https://api.backed.fi/api/v2/public/assets/PWAHLx/circulating-supply?format=object
...
- `xstocks.circ.CKAHx` [ok] 200 1223ms https://api.backed.fi/api/v2/public/assets/CKAHx/circulating-supply?format=object
- `xstocks.circ.CKINFx` [ok] 200 1230ms https://api.backed.fi/api/v2/public/assets/CKINFx/circulating-supply?format=object
- `xstocks.mult.CKINFx` [ok] 200 218ms https://api.backed.fi/api/v2/public/assets/CKINFx/multiplier?network=Solana
- `xstocks.mult.CKAHx` [ok] 200 1114ms https://api.backed.fi/api/v2/public/assets/CKAHx/multiplier?network=Solana
...
- `xstocks.circ.HKCGAx` [ok] 200 272ms https://api.backed.fi/api/v2/public/assets/HKCGAx/circulating-supply?format=object
- `xstocks.price.KUAIx` [FAIL]  12016ms https://api.backed.fi/api/v2/public/assets/KUAIx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.COVELx` [ok] 200 374ms https://api.backed.fi/api/v2/public/assets/COVELx/circulating-supply?format=object
...
- `xstocks.mult.NONGx` [ok] 200 662ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
- `xstocks.circ.CHONGx` [ok] 200 1225ms https://api.backed.fi/api/v2/public/assets/CHONGx/circulating-supply?format=object
...
- `xstocks.circ.MEITx` [ok] 200 794ms https://api.backed.fi/api/v2/public/assets/MEITx/circulating-supply?format=object
...
- `xstocks.circ.COSCx` [ok] 200 386ms https://api.backed.fi/api/v2/public/assets/COSCx/circulating-supply?format=object
- `xstocks.price.POPMTx` [FAIL]  12018ms https://api.backed.fi/api/v2/public/assets/POPMTx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.PICCx` [ok] 200 1354ms https://api.backed.fi/api/v2/public/assets/PICCx/circulating-supply?format=object
- `xstocks.circ.CKHUTx` [ok] 200 1216ms https://api.backed.fi/api/v2/public/assets/CKHUTx/circulating-supply?format=object
...
- `xstocks.mult.COSCx` [ok] 200 1285ms https://api.backed.fi/api/v2/public/assets/COSCx/multiplier?network=Solana
...
- `xstocks.mult.POPMTx` [ok] 200 592ms https://api.backed.fi/api/v2/public/assets/POPMTx/multiplier?network=Solana
- `xstocks.price.CPETCx` [FAIL]  12009ms https://api.backed.fi/api/v2/public/assets/CPETCx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.CPETCx` [ok] 200 183ms https://api.backed.fi/api/v2/public/assets/CPETCx/circulating-supply?format=object
- `xstocks.mult.CPETCx` [ok] 200 191ms https://api.backed.fi/api/v2/public/assets/CPETCx/multiplier?network=Solana
- `xstocks.circ.BOCOMx` [ok] 200 2329ms https://api.backed.fi/api/v2/public/assets/BOCOMx/circulating-supply?format=object
- `xstocks.mult.BOCOMx` [ok] 200 198ms https://api.backed.fi/api/v2/public/assets/BOCOMx/multiplier?network=Solana
...
- `xstocks.circ.BOCHKx` [ok] 200 491ms https://api.backed.fi/api/v2/public/assets/BOCHKx/circulating-supply?format=object
- `xstocks.mult.BOCHKx` [ok] 200 714ms https://api.backed.fi/api/v2/public/assets/BOCHKx/multiplier?network=Solana
- `xstocks.circ.CITICx` [ok] 200 1113ms https://api.backed.fi/api/v2/public/assets/CITICx/circulating-supply?format=object
- `xstocks.mult.CITICx` [ok] 200 560ms https://api.backed.fi/api/v2/public/assets/CITICx/multiplier?network=Solana
...
- `xstocks.circ.ANTASx` [ok] 200 193ms https://api.backed.fi/api/v2/public/assets/ANTASx/circulating-supply?format=object
- `xstocks.circ.HAIERx` [ok] 200 192ms https://api.backed.fi/api/v2/public/assets/HAIERx/circulating-supply?format=object
...
- `xstocks.mult.ANTASx` [ok] 200 322ms https://api.backed.fi/api/v2/public/assets/ANTASx/multiplier?network=Solana
- `xstocks.mult.CRESLx` [ok] 200 961ms https://api.backed.fi/api/v2/public/assets/CRESLx/multiplier?network=Solana
...
- `xstocks.circ.ZJGLDx` [ok] 200 1776ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/circulating-supply?format=object
...
- `xstocks.circ.ICBCx` [ok] 200 359ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
- `xstocks.mult.ICBCx` [ok] 200 229ms https://api.backed.fi/api/v2/public/assets/ICBCx/multiplier?network=Solana
...
- `jup.tokens.search.JDLOGx` [ok] 200 103ms https://lite-api.jup.ag/tokens/v2/search?query=JDLOGx
- `jup.tokens.search.WRFHDx` [ok] 200 161ms https://lite-api.jup.ag/tokens/v2/search?query=WRFHDx
