...
**Generated** 2026-09-19T12:42:35Z · 2026-09-19 05:42:35 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-19T12:42:26Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** SURGE — SOL 24h +5.50%; DEX 24h $3.54B · 1d +36% · vs-7d-ago +8%; slot 266 ms
...
| Health | `ok` |
| Slot | 448,410,845 |
| Block height | 426,451,669 |
| Block time | 2026-09-19T12:42:26Z |
| Epoch | 1,037 (98.81% · slot 426,847/432,000) |
| Mean TPS (last ~3,600s) | 3,931.4 |
| Mean non-vote TPS | 1,399.1 |
| Median TPS (same window) | 3,925.3 |
| Mean slot time | 265.8 ms |
| Median slot time | 265.5 ms |
| Transaction count (cluster) | 550,173,832,125 |
| Circulating supply | 587,296,213 SOL |
| Total supply | 634,297,463 SOL |
...
- `FGiEdzde…` · 128.30K SOL · commission 5% · lag 1850407 slots
- `t23p8aBQ…` · 14.66K SOL · commission 0% · lag 815609 slots
- `AYY1TCe3…` · 10.81K SOL · commission 0% · lag 23553 slots
- `mrgn4atx…` · 2.26K SOL · commission 0% · lag 399172 slots
- `pSoLoZx5…` · 1.51K SOL · commission 4% · lag 536093 slots
- `Hgozywot…` · 807.55 SOL · commission 100% · lag 264031 slots
- `TiMxX1ya…` · 114.23 SOL · commission 0% · lag 72792366 slots
- `EWARp8Sy…` · 98.61 SOL · commission 5% · lag 1414849 slots
- `BZBKHmW1…` · 5.90 SOL · commission 5% · lag 45626366 slots
- `R1parD2C…` · 1.63 SOL · commission 5% · lag 64361975 slots
- `Fb77sbwg…` · 1.08 SOL · commission 0% · lag 2154818 slots
...
| Jito tip-floor run-rate (NOT REV) | $15.75K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 15749 USD; at p95 floor → 2708010 USD. |
...
24h volume $108.21M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-09-19 (2026-09-19 05:42:35 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 5049ms https://api.mainnet-beta.solana.com
...
- `rss.nitter.solana_status` [ok] 200 907ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [ok] 200 3710ms https://nitter.perennialte.ch/anza_xyz/rss
...
- `xstocks.assets.p3` [ok] 200 2344ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=3
- `xstocks.assets.p4` [ok] 200 1575ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=4
...
- `xstocks.assets.p7` [ok] 200 1612ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=7
...
- `xstocks.circ.XRXx` [ok] 200 226ms https://api.backed.fi/api/v2/public/assets/XRXx/circulating-supply?format=object
...
- `xstocks.mult.INDIx` [ok] 200 515ms https://api.backed.fi/api/v2/public/assets/INDIx/multiplier?network=Solana
- `xstocks.circ.WRLDx` [ok] 200 1086ms https://api.backed.fi/api/v2/public/assets/WRLDx/circulating-supply?format=object
- `xstocks.mult.PCTx` [ok] 200 902ms https://api.backed.fi/api/v2/public/assets/PCTx/multiplier?network=Solana
- `xstocks.mult.WRLDx` [ok] 200 849ms https://api.backed.fi/api/v2/public/assets/WRLDx/multiplier?network=Solana
...
- `xstocks.circ.SCIx` [ok] 200 278ms https://api.backed.fi/api/v2/public/assets/SCIx/circulating-supply?format=object
...
- `xstocks.circ.DRSx` [ok] 200 758ms https://api.backed.fi/api/v2/public/assets/DRSx/circulating-supply?format=object
- `xstocks.mult.WYFIx` [ok] 200 907ms https://api.backed.fi/api/v2/public/assets/WYFIx/multiplier?network=Solana
...
- `xstocks.circ.BXPx` [ok] 200 1945ms https://api.backed.fi/api/v2/public/assets/BXPx/circulating-supply?format=object
- `xstocks.mult.BXPx` [ok] 200 213ms https://api.backed.fi/api/v2/public/assets/BXPx/multiplier?network=Solana
- `xstocks.circ.DCIx` [ok] 200 2617ms https://api.backed.fi/api/v2/public/assets/DCIx/circulating-supply?format=object
- `xstocks.mult.DCIx` [ok] 200 298ms https://api.backed.fi/api/v2/public/assets/DCIx/multiplier?network=Solana
...
- `xstocks.mult.WMSx` [ok] 200 454ms https://api.backed.fi/api/v2/public/assets/WMSx/multiplier?network=Solana
- `xstocks.circ.ALSNx` [ok] 200 180ms https://api.backed.fi/api/v2/public/assets/ALSNx/circulating-supply?format=object
- `xstocks.circ.DYx` [ok] 200 1010ms https://api.backed.fi/api/v2/public/assets/DYx/circulating-supply?format=object
- `xstocks.circ.AMx` [ok] 200 906ms https://api.backed.fi/api/v2/public/assets/AMx/circulating-supply?format=object
...
- `xstocks.circ.FDSx` [ok] 200 1102ms https://api.backed.fi/api/v2/public/assets/FDSx/circulating-supply?format=object
- `xstocks.mult.AMx` [ok] 200 560ms https://api.backed.fi/api/v2/public/assets/AMx/multiplier?network=Solana
...
- `xstocks.circ.SFx` [ok] 200 672ms https://api.backed.fi/api/v2/public/assets/SFx/circulating-supply?format=object
- `xstocks.mult.AXSMx` [ok] 200 507ms https://api.backed.fi/api/v2/public/assets/AXSMx/multiplier?network=Solana
- `xstocks.mult.SFx` [ok] 200 404ms https://api.backed.fi/api/v2/public/assets/SFx/multiplier?network=Solana
...
- `xstocks.circ.GFLx` [ok] 200 270ms https://api.backed.fi/api/v2/public/assets/GFLx/circulating-supply?format=object
- `xstocks.mult.GFLx` [ok] 200 189ms https://api.backed.fi/api/v2/public/assets/GFLx/multiplier?network=Solana
- `xstocks.circ.MGMx` [ok] 200 501ms https://api.backed.fi/api/v2/public/assets/MGMx/circulating-supply?format=object
- `xstocks.mult.MGMx` [ok] 200 216ms https://api.backed.fi/api/v2/public/assets/MGMx/multiplier?network=Solana
- `xstocks.circ.ARx` [ok] 200 1467ms https://api.backed.fi/api/v2/public/assets/ARx/circulating-supply?format=object
...
- `xstocks.circ.HALOx` [ok] 200 403ms https://api.backed.fi/api/v2/public/assets/HALOx/circulating-supply?format=object
- `xstocks.mult.HALOx` [ok] 200 236ms https://api.backed.fi/api/v2/public/assets/HALOx/multiplier?network=Solana
...
- `xstocks.mult.HUBSx` [ok] 200 262ms https://api.backed.fi/api/v2/public/assets/HUBSx/multiplier?network=Solana
- `xstocks.circ.AMKRx` [ok] 200 412ms https://api.backed.fi/api/v2/public/assets/AMKRx/circulating-supply?format=object
- `xstocks.circ.AFGx` [ok] 200 1100ms https://api.backed.fi/api/v2/public/assets/AFGx/circulating-supply?format=object
...
- `xstocks.mult.JKHYx` [ok] 200 300ms https://api.backed.fi/api/v2/public/assets/JKHYx/multiplier?network=Solana
...
- `xstocks.circ.JEFx` [ok] 200 315ms https://api.backed.fi/api/v2/public/assets/JEFx/circulating-supply?format=object
...
- `xstocks.circ.ITx` [ok] 200 726ms https://api.backed.fi/api/v2/public/assets/ITx/circulating-supply?format=object
...
- `xstocks.mult.AHRx` [ok] 200 305ms https://api.backed.fi/api/v2/public/assets/AHRx/multiplier?network=Solana
...
- `xstocks.mult.IVZx` [ok] 200 383ms https://api.backed.fi/api/v2/public/assets/IVZx/multiplier?network=Solana
...
- `xstocks.circ.GWREx` [ok] 200 313ms https://api.backed.fi/api/v2/public/assets/GWREx/circulating-supply?format=object
...
- `xstocks.circ.CACIx` [ok] 200 338ms https://api.backed.fi/api/v2/public/assets/CACIx/circulating-supply?format=object
- `xstocks.mult.CACIx` [ok] 200 294ms https://api.backed.fi/api/v2/public/assets/CACIx/multiplier?network=Solana
- `xstocks.circ.MANHx` [ok] 200 1373ms https://api.backed.fi/api/v2/public/assets/MANHx/circulating-supply?format=object
