...
**Generated** 2026-09-06T10:49:03Z · 2026-09-06 03:49:03 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-06T10:48:52Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** ELEVATED — SOL 24h +3.82%; DEX 24h $1.96B · 1d +4% · vs-7d-ago +17%; slot 317 ms
...
| Health | `ok` |
| Slot | 444,773,917 |
| Block height | 422,818,279 |
| Block time | 2026-09-06T10:48:52Z |
| Epoch | 1,029 (56.93% · slot 245,917/432,000) |
| Mean TPS (last ~3,600s) | 3,513.3 |
| Mean non-vote TPS | 1,389.2 |
| Median TPS (same window) | 3,514.5 |
| Mean slot time | 316.8 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 545,656,622,505 |
| Circulating supply | 585,445,218 SOL |
| Total supply | 633,549,093 SOL |
...
- `xLabscif…` · 28.57K SOL · commission 5% · lag 985544 slots
- `mrgn4atx…` · 20.30K SOL · commission 0% · lag 9807 slots
- `prt1st4R…` · 13.11K SOL · commission 5% · lag 1286975 slots
- `E4xNK4Uw…` · 6.26K SOL · commission 5% · lag 1425194 slots
- `5ZjxMYBb…` · 4.06K SOL · commission 0% · lag 807995 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 1987796 slots
- `pSoLoZx5…` · 1.51K SOL · commission 4% · lag 234726 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 1335278 slots
- `CpdzCVza…` · 193.38 SOL · commission 100% · lag 1973566 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 2015080 slots
- `HFTcVVrX…` · 148.42 SOL · commission 100% · lag 1973460 slots
- `6pEtDovp…` · 131.86 SOL · commission 100% · lag 1987844 slots
...
| Jito tip-floor run-rate (NOT REV) | $49.51K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 49512 USD; at p95 floor → 153262 USD. |
...
| Metric | Value | Source |
| --- | ---: | --- |
| SOL/USD | $106.51 | coingecko.simple_price |
...
24h volume $55.90M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-09-06 (2026-09-06 03:49:03 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `llama.protocols` [ok] 200 53ms https://api.llama.fi/protocols
- `llama.stablecoinchains` [ok] 200 203ms https://stablecoins.llama.fi/stablecoinchains
- `llama.stablecoins` [ok] 200 38ms https://stablecoins.llama.fi/stablecoins?includePrices=true
...
- `rss.nitter.solana` [ok] 200 1406ms https://nitter.perennialte.ch/solana/rss
...
- `xstocks.assets.p2` [ok] 200 2071ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=2
...
- `xstocks.circ.AAPLx` [ok] 200 455ms https://api.backed.fi/api/v2/public/assets/AAPLx/circulating-supply?format=object
...
- `xstocks.mult.MSFTx` [ok] 200 748ms https://api.backed.fi/api/v2/public/assets/MSFTx/multiplier?network=Solana
- `xstocks.circ.METAx` [ok] 200 1162ms https://api.backed.fi/api/v2/public/assets/METAx/circulating-supply?format=object
- `xstocks.mult.AAPLx` [ok] 200 865ms https://api.backed.fi/api/v2/public/assets/AAPLx/multiplier?network=Solana
- `xstocks.mult.METAx` [ok] 200 200ms https://api.backed.fi/api/v2/public/assets/METAx/multiplier?network=Solana
- `xstocks.mult.TSLAx` [ok] 200 1159ms https://api.backed.fi/api/v2/public/assets/TSLAx/multiplier?network=Solana
...
- `xstocks.circ.QQQx` [ok] 200 690ms https://api.backed.fi/api/v2/public/assets/QQQx/circulating-supply?format=object
- `xstocks.mult.MVLLx` [ok] 200 359ms https://api.backed.fi/api/v2/public/assets/MVLLx/multiplier?network=Solana
- `xstocks.circ.MUUx` [ok] 200 110ms https://api.backed.fi/api/v2/public/assets/MUUx/circulating-supply?format=object
...
- `xstocks.circ.KORUx` [ok] 200 107ms https://api.backed.fi/api/v2/public/assets/KORUx/circulating-supply?format=object
- `xstocks.mult.DRAMx` [ok] 200 716ms https://api.backed.fi/api/v2/public/assets/DRAMx/multiplier?network=Solana
- `xstocks.mult.KORUx` [ok] 200 287ms https://api.backed.fi/api/v2/public/assets/KORUx/multiplier?network=Solana
- `xstocks.circ.DJTx` [ok] 200 515ms https://api.backed.fi/api/v2/public/assets/DJTx/circulating-supply?format=object
- `xstocks.mult.AXTIx` [ok] 200 760ms https://api.backed.fi/api/v2/public/assets/AXTIx/multiplier?network=Solana
- `xstocks.mult.MUUx` [ok] 200 1147ms https://api.backed.fi/api/v2/public/assets/MUUx/multiplier?network=Solana
...
- `xstocks.circ.SNXXx` [ok] 200 110ms https://api.backed.fi/api/v2/public/assets/SNXXx/circulating-supply?format=object
...
- `xstocks.mult.SOXSx` [ok] 200 682ms https://api.backed.fi/api/v2/public/assets/SOXSx/multiplier?network=Solana
...
- `xstocks.mult.MMGx` [ok] 200 112ms https://api.backed.fi/api/v2/public/assets/MMGx/multiplier?network=Solana
...
- `xstocks.mult.SUOPTx` [ok] 200 1769ms https://api.backed.fi/api/v2/public/assets/SUOPTx/multiplier?network=Solana
- `xstocks.circ.BANKCx` [ok] 200 4125ms https://api.backed.fi/api/v2/public/assets/BANKCx/circulating-supply?format=object
- `xstocks.mult.BANKCx` [ok] 200 114ms https://api.backed.fi/api/v2/public/assets/BANKCx/multiplier?network=Solana
...
- `xstocks.circ.CTINSx` [ok] 200 157ms https://api.backed.fi/api/v2/public/assets/CTINSx/circulating-supply?format=object
- `xstocks.circ.JDLOGx` [ok] 200 260ms https://api.backed.fi/api/v2/public/assets/JDLOGx/circulating-supply?format=object
- `xstocks.mult.JDLOGx` [ok] 200 288ms https://api.backed.fi/api/v2/public/assets/JDLOGx/multiplier?network=Solana
...
- `xstocks.mult.SNBIOx` [ok] 200 674ms https://api.backed.fi/api/v2/public/assets/SNBIOx/multiplier?network=Solana
...
- `xstocks.mult.SZIGHx` [ok] 200 631ms https://api.backed.fi/api/v2/public/assets/SZIGHx/multiplier?network=Solana
...
- `xstocks.circ.HRZRBx` [ok] 200 617ms https://api.backed.fi/api/v2/public/assets/HRZRBx/circulating-supply?format=object
- `xstocks.mult.SMOIHx` [ok] 200 938ms https://api.backed.fi/api/v2/public/assets/SMOIHx/multiplier?network=Solana
- `xstocks.mult.HRZRBx` [ok] 200 733ms https://api.backed.fi/api/v2/public/assets/HRZRBx/multiplier?network=Solana
...
- `xstocks.mult.CRESBx` [ok] 200 1673ms https://api.backed.fi/api/v2/public/assets/CRESBx/multiplier?network=Solana
...
- `xstocks.mult.CRESMx` [ok] 200 981ms https://api.backed.fi/api/v2/public/assets/CRESMx/multiplier?network=Solana
...
- `xstocks.circ.CMENDx` [ok] 200 661ms https://api.backed.fi/api/v2/public/assets/CMENDx/circulating-supply?format=object
...
- `xstocks.mult.CMENDx` [ok] 200 796ms https://api.backed.fi/api/v2/public/assets/CMENDx/multiplier?network=Solana
- `xstocks.mult.MIXUx` [ok] 200 321ms https://api.backed.fi/api/v2/public/assets/MIXUx/multiplier?network=Solana
- `xstocks.circ.ASMPTx` [ok] 200 240ms https://api.backed.fi/api/v2/public/assets/ASMPTx/circulating-supply?format=object
- `xstocks.mult.ASMPTx` [ok] 200 397ms https://api.backed.fi/api/v2/public/assets/ASMPTx/multiplier?network=Solana
...
- `xstocks.circ.SITCx` [ok] 200 435ms https://api.backed.fi/api/v2/public/assets/SITCx/circulating-supply?format=object
- `xstocks.mult.SITCx` [ok] 200 196ms https://api.backed.fi/api/v2/public/assets/SITCx/multiplier?network=Solana
- `xstocks.mult.JDHLTx` [ok] 200 376ms https://api.backed.fi/api/v2/public/assets/JDHLTx/multiplier?network=Solana
...
- `xstocks.circ.SNDSCx` [ok] 200 391ms https://api.backed.fi/api/v2/public/assets/SNDSCx/circulating-supply?format=object
...
- `xstocks.circ.CRESPx` [ok] 200 458ms https://api.backed.fi/api/v2/public/assets/CRESPx/circulating-supply?format=object
- `xstocks.price.PRADx` [FAIL]  12012ms https://api.backed.fi/api/v2/public/assets/PRADx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.SINOTx` [ok] 200 109ms https://api.backed.fi/api/v2/public/assets/SINOTx/circulating-supply?format=object
- `xstocks.mult.SINOTx` [ok] 200 268ms https://api.backed.fi/api/v2/public/assets/SINOTx/multiplier?network=Solana
...
- `xstocks.circ.PRADx` [ok] 200 751ms https://api.backed.fi/api/v2/public/assets/PRADx/circulating-supply?format=object
...
- `xstocks.mult.CLONPx` [ok] 200 560ms https://api.backed.fi/api/v2/public/assets/CLONPx/multiplier?network=Solana
...
- `xstocks.mult.WHGROx` [ok] 200 357ms https://api.backed.fi/api/v2/public/assets/WHGROx/multiplier?network=Solana
...
- `xstocks.mult.CTPCAx` [ok] 200 109ms https://api.backed.fi/api/v2/public/assets/CTPCAx/multiplier?network=Solana
...
- `xstocks.mult.PWAHLx` [ok] 200 627ms https://api.backed.fi/api/v2/public/assets/PWAHLx/multiplier?network=Solana
...
- `xstocks.circ.GENTEx` [ok] 200 107ms https://api.backed.fi/api/v2/public/assets/GENTEx/circulating-supply?format=object
...
- `xstocks.mult.CRAUTx` [ok] 200 375ms https://api.backed.fi/api/v2/public/assets/CRAUTx/multiplier?network=Solana
...
- `xstocks.mult.WUXIBx` [ok] 200 109ms https://api.backed.fi/api/v2/public/assets/WUXIBx/multiplier?network=Solana
...
- `xstocks.circ.CKINFx` [ok] 200 826ms https://api.backed.fi/api/v2/public/assets/CKINFx/circulating-supply?format=object
- `xstocks.price.HKCGAx` [FAIL]  12023ms https://api.backed.fi/api/v2/public/assets/HKCGAx/price-data — TimeoutError: The read operation timed out
- `xstocks.mult.CKINFx` [ok] 200 696ms https://api.backed.fi/api/v2/public/assets/CKINFx/multiplier?network=Solana
...
- `xstocks.circ.NONGx` [ok] 200 367ms https://api.backed.fi/api/v2/public/assets/NONGx/circulating-supply?format=object
- `xstocks.mult.NONGx` [ok] 200 350ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
...
- `xstocks.mult.MEITx` [ok] 200 392ms https://api.backed.fi/api/v2/public/assets/MEITx/multiplier?network=Solana
- `xstocks.circ.CHONGx` [ok] 200 782ms https://api.backed.fi/api/v2/public/assets/CHONGx/circulating-supply?format=object
...
- `xstocks.mult.GEELx` [ok] 200 123ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
- `xstocks.circ.MTRCPx` [ok] 200 545ms https://api.backed.fi/api/v2/public/assets/MTRCPx/circulating-supply?format=object
...
- `xstocks.mult.PICCx` [ok] 200 153ms https://api.backed.fi/api/v2/public/assets/PICCx/multiplier?network=Solana
- `xstocks.circ.COSCx` [ok] 200 209ms https://api.backed.fi/api/v2/public/assets/COSCx/circulating-supply?format=object
- `xstocks.mult.MTRCPx` [ok] 200 1131ms https://api.backed.fi/api/v2/public/assets/MTRCPx/multiplier?network=Solana
- `xstocks.mult.COSCx` [ok] 200 393ms https://api.backed.fi/api/v2/public/assets/COSCx/multiplier?network=Solana
...
- `xstocks.mult.CKHUTx` [ok] 200 882ms https://api.backed.fi/api/v2/public/assets/CKHUTx/multiplier?network=Solana
...
- `jup.tokens.search.AXTIx` [ok] 200 37ms https://lite-api.jup.ag/tokens/v2/search?query=AXTIx
- `jup.tokens.search.MUUx` [ok] 200 38ms https://lite-api.jup.ag/tokens/v2/search?query=MUUx
- `jup.tokens.search.DJTx` [ok] 200 35ms https://lite-api.jup.ag/tokens/v2/search?query=DJTx
