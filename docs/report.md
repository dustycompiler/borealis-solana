...
**Generated** 2026-08-30T08:33:50Z · 2026-08-30 01:33:50 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-30T08:33:40Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h +1.56%; DEX 24h $1.81B · 1d -30% · vs-7d-ago -51%; slot 316 ms
...
- **WARN · SOL price vs 30d median (solana.com/data)** — Current 104.98 USD is +37.8% vs 30d median 76.20 USD (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
...
| Health | `ok` |
| Slot | 442,834,744 |
| Block height | 420,882,534 |
| Block time | 2026-08-30T08:33:40Z |
| Epoch | 1,025 (8.04% · slot 34,747/432,000) |
| Mean TPS (last ~3,600s) | 3,371.4 |
| Mean non-vote TPS | 1,233.8 |
| Median TPS (same window) | 3,302.8 |
| Mean slot time | 316.4 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 543,364,779,323 |
| Circulating supply | 585,122,151 SOL |
| Total supply | 633,173,827 SOL |
...
- `mrgn2vUP…` · 90.77K SOL · commission 0% · lag 8309 slots
- `mrgn4atx…` · 21.79K SOL · commission 0% · lag 31007 slots
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1582065 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 48623 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 154906 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 850990 slots
- `CpdzCVza…` · 315.26 SOL · commission 100% · lag 34393 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 75907 slots
- `HFTcVVrX…` · 152.80 SOL · commission 100% · lag 34287 slots
- `6pEtDovp…` · 131.96 SOL · commission 100% · lag 48671 slots
- `7G4Rfctw…` · 75.85 SOL · commission 100% · lag 73045 slots
- `DZKTNGR3…` · 48.61 SOL · commission 100% · lag 80587 slots
...
| --- | ---: | --- |
| TPS chart | 178 | data/history.jsonl snapshot tape |
| TVL chart | 178 | data/history.jsonl snapshot tape |
| SOL chart | 177 | data/history.jsonl snapshot tape |
| history.jsonl rows | 178 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $151.02K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 151022 USD; at p95 floor → 7431628 USD. |
...
| p90 / p99 | 0.000008 / 0.000082 SOL | same sample |
...
24h volume $9.24M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-08-30 (2026-08-30 01:33:50 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getEpochInfo` [ok] 200 532ms https://api.mainnet-beta.solana.com
- `rpc.getRecentPerformanceSamples` [ok] 200 523ms https://api.mainnet-beta.solana.com
- `rpc.getSupply` [ok] 200 7932ms https://api.mainnet-beta.solana.com
- `rpc.getVoteAccounts` [ok] 200 1342ms https://api.mainnet-beta.solana.com
...
- `rss.xcancel.solana` [ok] 200 481ms https://xcancel.com/solana/rss
...
- `rss.nitter.solana_status` [ok] 200 2506ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [ok] 200 1197ms https://nitter.perennialte.ch/anza_xyz/rss
- `rss.nitter.solana_devs` [ok] 200 1375ms https://nitter.perennialte.ch/solana_devs/rss
...
- `rpc.getBlocks` [ok] 200 645ms https://api.mainnet-beta.solana.com
...
- `xstocks.assets.p0` [ok] 200 3222ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0
...
- `xstocks.mult.MSFTx` [ok] 200 118ms https://api.backed.fi/api/v2/public/assets/MSFTx/multiplier?network=Solana
...
- `xstocks.mult.TSLAx` [ok] 200 341ms https://api.backed.fi/api/v2/public/assets/TSLAx/multiplier?network=Solana
...
- `xstocks.mult.BANKCx` [ok] 200 113ms https://api.backed.fi/api/v2/public/assets/BANKCx/multiplier?network=Solana
...
- `xstocks.mult.TNGYIx` [ok] 200 148ms https://api.backed.fi/api/v2/public/assets/TNGYIx/multiplier?network=Solana
...
- `xstocks.mult.ZHAOMx` [ok] 200 645ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/multiplier?network=Solana
...
- `xstocks.mult.JDLOGx` [ok] 200 116ms https://api.backed.fi/api/v2/public/assets/JDLOGx/multiplier?network=Solana
...
- `xstocks.mult.KUNLx` [ok] 200 109ms https://api.backed.fi/api/v2/public/assets/KUNLx/multiplier?network=Solana
- `xstocks.circ.CTINSx` [ok] 200 288ms https://api.backed.fi/api/v2/public/assets/CTINSx/circulating-supply?format=object
...
- `xstocks.mult.HAIDLx` [ok] 200 112ms https://api.backed.fi/api/v2/public/assets/HAIDLx/multiplier?network=Solana
...
- `xstocks.mult.ENNHLx` [ok] 200 137ms https://api.backed.fi/api/v2/public/assets/ENNHLx/multiplier?network=Solana
...
- `xstocks.circ.HRZRBx` [ok] 200 667ms https://api.backed.fi/api/v2/public/assets/HRZRBx/circulating-supply?format=object
...
- `xstocks.mult.SMOIHx` [ok] 200 1334ms https://api.backed.fi/api/v2/public/assets/SMOIHx/multiplier?network=Solana
...
- `xstocks.mult.JDHLTx` [ok] 200 138ms https://api.backed.fi/api/v2/public/assets/JDHLTx/multiplier?network=Solana
- `xstocks.mult.SNDSCx` [ok] 200 529ms https://api.backed.fi/api/v2/public/assets/SNDSCx/multiplier?network=Solana
- `xstocks.mult.ASMPTx` [ok] 200 1375ms https://api.backed.fi/api/v2/public/assets/ASMPTx/multiplier?network=Solana
...
- `xstocks.price.CLONPx` [FAIL]  12014ms https://api.backed.fi/api/v2/public/assets/CLONPx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.CLONPx` [ok] 200 575ms https://api.backed.fi/api/v2/public/assets/CLONPx/circulating-supply?format=object
...
- `xstocks.circ.CTPCAx` [ok] 200 704ms https://api.backed.fi/api/v2/public/assets/CTPCAx/circulating-supply?format=object
- `xstocks.mult.WHGROx` [ok] 200 1019ms https://api.backed.fi/api/v2/public/assets/WHGROx/multiplier?network=Solana
...
- `xstocks.price.CLPHDx` [FAIL]  12010ms https://api.backed.fi/api/v2/public/assets/CLPHDx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.GENTEx` [ok] 200 696ms https://api.backed.fi/api/v2/public/assets/GENTEx/circulating-supply?format=object
...
- `xstocks.mult.SWPRPx` [ok] 200 736ms https://api.backed.fi/api/v2/public/assets/SWPRPx/multiplier?network=Solana
...
- `xstocks.mult.KUAIx` [ok] 200 750ms https://api.backed.fi/api/v2/public/assets/KUAIx/multiplier?network=Solana
...
- `xstocks.mult.GEELx` [ok] 200 138ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
...
- `xstocks.circ.HNDLDx` [ok] 200 266ms https://api.backed.fi/api/v2/public/assets/HNDLDx/circulating-supply?format=object
...
- `xstocks.circ.CKHUTx` [ok] 200 766ms https://api.backed.fi/api/v2/public/assets/CKHUTx/circulating-supply?format=object
...
- `xstocks.mult.MTRCPx` [ok] 200 1811ms https://api.backed.fi/api/v2/public/assets/MTRCPx/multiplier?network=Solana
- `xstocks.circ.POPMTx` [ok] 200 128ms https://api.backed.fi/api/v2/public/assets/POPMTx/circulating-supply?format=object
- `xstocks.mult.POPMTx` [ok] 200 115ms https://api.backed.fi/api/v2/public/assets/POPMTx/multiplier?network=Solana
- `xstocks.price.BOCOMx` [FAIL]  12015ms https://api.backed.fi/api/v2/public/assets/BOCOMx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.BOCOMx` [ok] 200 300ms https://api.backed.fi/api/v2/public/assets/BOCOMx/multiplier?network=Solana
...
- `xstocks.circ.BOCHKx` [ok] 200 116ms https://api.backed.fi/api/v2/public/assets/BOCHKx/circulating-supply?format=object
...
- `xstocks.circ.CITICx` [ok] 200 140ms https://api.backed.fi/api/v2/public/assets/CITICx/circulating-supply?format=object
...
- `xstocks.mult.HAIERx` [ok] 200 304ms https://api.backed.fi/api/v2/public/assets/HAIERx/multiplier?network=Solana
- `xstocks.circ.PSBOCx` [ok] 200 115ms https://api.backed.fi/api/v2/public/assets/PSBOCx/circulating-supply?format=object
- `xstocks.circ.ZJGLDx` [ok] 200 119ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/circulating-supply?format=object
- `xstocks.circ.ICBCx` [ok] 200 114ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
- `xstocks.circ.CRESLx` [ok] 200 845ms https://api.backed.fi/api/v2/public/assets/CRESLx/circulating-supply?format=object
- `xstocks.mult.ICBCx` [ok] 200 160ms https://api.backed.fi/api/v2/public/assets/ICBCx/multiplier?network=Solana
- `xstocks.mult.ZJGLDx` [ok] 200 224ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/multiplier?network=Solana
- `xstocks.mult.PSBOCx` [ok] 200 396ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
- `xstocks.mult.CRESLx` [ok] 200 503ms https://api.backed.fi/api/v2/public/assets/CRESLx/multiplier?network=Solana
...
- `jup.tokens.search.SUOPTx` [ok] 200 37ms https://lite-api.jup.ag/tokens/v2/search?query=SUOPTx
- `jup.tokens.search.TNGYIx` [ok] 200 43ms https://lite-api.jup.ag/tokens/v2/search?query=TNGYIx
...
- `jup.tokens.search.JDLOGx` [ok] 200 40ms https://lite-api.jup.ag/tokens/v2/search?query=JDLOGx
