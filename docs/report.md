...
**Generated** 2026-09-05T12:41:59Z · 2026-09-05 05:41:59 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-05T12:41:47Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h +1.04%; DEX 24h $1.88B · 1d -24% · vs-7d-ago -27%; slot 315 ms
...
| Health | `ok` |
| Slot | 444,521,912 |
| Block height | 422,566,423 |
| Block time | 2026-09-05T12:41:47Z |
| Epoch | 1,028 (98.59% · slot 425,912/432,000) |
| Mean TPS (last ~3,600s) | 3,047.9 |
| Mean non-vote TPS | 916.0 |
| Median TPS (same window) | 3,032.9 |
| Mean slot time | 314.7 ms |
| Median slot time | 314.1 ms |
| Transaction count (cluster) | 545,382,077,835 |
| Circulating supply | 585,359,541 SOL |
| Total supply | 633,454,567 SOL |
...
- `xLabscif…` · 78.25K SOL · commission 5% · lag 733539 slots
- `mrgn4atx…` · 20.30K SOL · commission 0% · lag 10029 slots
- `prt1st4R…` · 19.80K SOL · commission 5% · lag 1034970 slots
- `E4xNK4Uw…` · 10.45K SOL · commission 5% · lag 1173189 slots
- `5ZjxMYBb…` · 4.06K SOL · commission 0% · lag 555990 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 1735791 slots
- `Fb77sbwg…` · 2.13K SOL · commission 0% · lag 345355 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 1083273 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 2538158 slots
- `CpdzCVza…` · 193.38 SOL · commission 100% · lag 1721561 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 1763075 slots
- `HFTcVVrX…` · 149.48 SOL · commission 100% · lag 1721455 slots
...
| Jito tip-floor run-rate (NOT REV) | $8.33K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 8328 USD; at p95 floor → 436837 USD. |
...
| p90 / p99 | 0.000007 / 0.000080 SOL | same sample |
...
24h volume $21.69M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-09-05 (2026-09-05 05:41:59 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 5741ms https://api.mainnet-beta.solana.com
...
- `rpc.getBlock.fallback` [ok] 200 940ms https://solana-rpc.publicnode.com
...
- `xstocks.assets.p2` [ok] 200 2244ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=2
- `xstocks.assets.p3` [ok] 200 1873ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=3
- `xstocks.assets.p4` [ok] 200 1866ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=4
...
- `xstocks.assets.p7` [ok] 200 803ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=7
...
- `xstocks.circ.MSFTx` [ok] 200 620ms https://api.backed.fi/api/v2/public/assets/MSFTx/circulating-supply?format=object
- `xstocks.mult.MSFTx` [ok] 200 241ms https://api.backed.fi/api/v2/public/assets/MSFTx/multiplier?network=Solana
- `xstocks.mult.AAPLx` [ok] 200 732ms https://api.backed.fi/api/v2/public/assets/AAPLx/multiplier?network=Solana
- `xstocks.circ.METAx` [ok] 200 1043ms https://api.backed.fi/api/v2/public/assets/METAx/circulating-supply?format=object
...
- `xstocks.mult.TSLAx` [ok] 200 1133ms https://api.backed.fi/api/v2/public/assets/TSLAx/multiplier?network=Solana
- `xstocks.circ.SPYx` [ok] 200 1369ms https://api.backed.fi/api/v2/public/assets/SPYx/circulating-supply?format=object
...
- `xstocks.circ.AMZNx` [ok] 200 2481ms https://api.backed.fi/api/v2/public/assets/AMZNx/circulating-supply?format=object
- `xstocks.mult.AMZNx` [ok] 200 884ms https://api.backed.fi/api/v2/public/assets/AMZNx/multiplier?network=Solana
...
- `xstocks.mult.QQQx` [ok] 200 503ms https://api.backed.fi/api/v2/public/assets/QQQx/multiplier?network=Solana
...
- `xstocks.mult.AXTIx` [ok] 200 538ms https://api.backed.fi/api/v2/public/assets/AXTIx/multiplier?network=Solana
- `xstocks.circ.MVLLx` [ok] 200 1828ms https://api.backed.fi/api/v2/public/assets/MVLLx/circulating-supply?format=object
- `xstocks.circ.MUUx` [ok] 200 1912ms https://api.backed.fi/api/v2/public/assets/MUUx/circulating-supply?format=object
...
- `xstocks.circ.DJTx` [ok] 200 2702ms https://api.backed.fi/api/v2/public/assets/DJTx/circulating-supply?format=object
- `xstocks.mult.DJTx` [ok] 200 427ms https://api.backed.fi/api/v2/public/assets/DJTx/multiplier?network=Solana
- `xstocks.mult.MVLLx` [ok] 200 2016ms https://api.backed.fi/api/v2/public/assets/MVLLx/multiplier?network=Solana
- `xstocks.circ.KORUx` [ok] 200 2093ms https://api.backed.fi/api/v2/public/assets/KORUx/circulating-supply?format=object
- `xstocks.mult.KORUx` [ok] 200 651ms https://api.backed.fi/api/v2/public/assets/KORUx/multiplier?network=Solana
- `xstocks.price.INTWx` [FAIL]  12013ms https://api.backed.fi/api/v2/public/assets/INTWx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.INTWx` [ok] 200 1495ms https://api.backed.fi/api/v2/public/assets/INTWx/circulating-supply?format=object
- `xstocks.circ.SHEINx` [ok] 200 531ms https://api.backed.fi/api/v2/public/assets/SHEINx/circulating-supply?format=object
- `xstocks.mult.SNXXx` [ok] 200 708ms https://api.backed.fi/api/v2/public/assets/SNXXx/multiplier?network=Solana
- `xstocks.mult.INTWx` [ok] 200 475ms https://api.backed.fi/api/v2/public/assets/INTWx/multiplier?network=Solana
- `xstocks.circ.SOXSx` [ok] 200 1542ms https://api.backed.fi/api/v2/public/assets/SOXSx/circulating-supply?format=object
- `xstocks.mult.SHEINx` [ok] 200 295ms https://api.backed.fi/api/v2/public/assets/SHEINx/multiplier?network=Solana
...
- `xstocks.mult.SUOPTx` [ok] 200 1108ms https://api.backed.fi/api/v2/public/assets/SUOPTx/multiplier?network=Solana
- `xstocks.circ.BANKCx` [ok] 200 1464ms https://api.backed.fi/api/v2/public/assets/BANKCx/circulating-supply?format=object
- `xstocks.mult.MMGx` [ok] 200 584ms https://api.backed.fi/api/v2/public/assets/MMGx/multiplier?network=Solana
- `xstocks.mult.BANKCx` [ok] 200 365ms https://api.backed.fi/api/v2/public/assets/BANKCx/multiplier?network=Solana
- `xstocks.price.TNGYIx` [FAIL]  12015ms https://api.backed.fi/api/v2/public/assets/TNGYIx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.TNGYIx` [ok] 200 512ms https://api.backed.fi/api/v2/public/assets/TNGYIx/multiplier?network=Solana
- `xstocks.circ.ZHAOMx` [ok] 200 721ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/circulating-supply?format=object
...
- `xstocks.circ.CTINSx` [ok] 200 510ms https://api.backed.fi/api/v2/public/assets/CTINSx/circulating-supply?format=object
...
- `xstocks.price.HAIDLx` [FAIL]  12007ms https://api.backed.fi/api/v2/public/assets/HAIDLx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.KUNLx` [ok] 200 511ms https://api.backed.fi/api/v2/public/assets/KUNLx/circulating-supply?format=object
- `xstocks.mult.CTINSx` [ok] 200 1930ms https://api.backed.fi/api/v2/public/assets/CTINSx/multiplier?network=Solana
...
- `xstocks.circ.SZIGHx` [ok] 200 675ms https://api.backed.fi/api/v2/public/assets/SZIGHx/circulating-supply?format=object
...
- `xstocks.mult.HRZRBx` [ok] 200 953ms https://api.backed.fi/api/v2/public/assets/HRZRBx/multiplier?network=Solana
- `xstocks.circ.CSPCx` [ok] 200 653ms https://api.backed.fi/api/v2/public/assets/CSPCx/circulating-supply?format=object
- `xstocks.mult.CSPCx` [ok] 200 430ms https://api.backed.fi/api/v2/public/assets/CSPCx/multiplier?network=Solana
...
- `xstocks.mult.JTGEXx` [ok] 200 459ms https://api.backed.fi/api/v2/public/assets/JTGEXx/multiplier?network=Solana
...
- `xstocks.circ.WXXDCx` [ok] 200 978ms https://api.backed.fi/api/v2/public/assets/WXXDCx/circulating-supply?format=object
- `xstocks.circ.CRESMx` [ok] 200 1659ms https://api.backed.fi/api/v2/public/assets/CRESMx/circulating-supply?format=object
...
- `xstocks.mult.MIXUx` [ok] 200 373ms https://api.backed.fi/api/v2/public/assets/MIXUx/multiplier?network=Solana
...
- `xstocks.circ.SITCx` [ok] 200 1560ms https://api.backed.fi/api/v2/public/assets/SITCx/circulating-supply?format=object
- `xstocks.circ.CRESPx` [ok] 200 185ms https://api.backed.fi/api/v2/public/assets/CRESPx/circulating-supply?format=object
- `xstocks.circ.SNDSCx` [ok] 200 551ms https://api.backed.fi/api/v2/public/assets/SNDSCx/circulating-supply?format=object
- `xstocks.mult.CRESPx` [ok] 200 651ms https://api.backed.fi/api/v2/public/assets/CRESPx/multiplier?network=Solana
...
- `xstocks.mult.PRADx` [ok] 200 163ms https://api.backed.fi/api/v2/public/assets/PRADx/multiplier?network=Solana
...
- `xstocks.circ.SINOTx` [ok] 200 810ms https://api.backed.fi/api/v2/public/assets/SINOTx/circulating-supply?format=object
- `xstocks.circ.CLONPx` [ok] 200 351ms https://api.backed.fi/api/v2/public/assets/CLONPx/circulating-supply?format=object
...
- `xstocks.mult.SINOx` [ok] 200 340ms https://api.backed.fi/api/v2/public/assets/SINOx/multiplier?network=Solana
...
- `xstocks.circ.PWAHLx` [ok] 200 730ms https://api.backed.fi/api/v2/public/assets/PWAHLx/circulating-supply?format=object
...
- `xstocks.mult.WHGROx` [ok] 200 492ms https://api.backed.fi/api/v2/public/assets/WHGROx/multiplier?network=Solana
...
- `xstocks.circ.CLPHDx` [ok] 200 1800ms https://api.backed.fi/api/v2/public/assets/CLPHDx/circulating-supply?format=object
...
- `xstocks.mult.PWAHLx` [ok] 200 1918ms https://api.backed.fi/api/v2/public/assets/PWAHLx/multiplier?network=Solana
- `xstocks.circ.CRAUTx` [ok] 200 1415ms https://api.backed.fi/api/v2/public/assets/CRAUTx/circulating-supply?format=object
- `xstocks.mult.WUXIBx` [ok] 200 757ms https://api.backed.fi/api/v2/public/assets/WUXIBx/multiplier?network=Solana
...
- `xstocks.price.KUAIx` [FAIL]  12009ms https://api.backed.fi/api/v2/public/assets/KUAIx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.CKINFx` [ok] 200 1313ms https://api.backed.fi/api/v2/public/assets/CKINFx/circulating-supply?format=object
- `xstocks.circ.HKCGAx` [ok] 200 1165ms https://api.backed.fi/api/v2/public/assets/HKCGAx/circulating-supply?format=object
...
- `xstocks.circ.KUAIx` [ok] 200 1164ms https://api.backed.fi/api/v2/public/assets/KUAIx/circulating-supply?format=object
- `xstocks.mult.CKINFx` [ok] 200 1081ms https://api.backed.fi/api/v2/public/assets/CKINFx/multiplier?network=Solana
- `xstocks.circ.COVELx` [ok] 200 612ms https://api.backed.fi/api/v2/public/assets/COVELx/circulating-supply?format=object
...
- `xstocks.circ.HKEXCx` [ok] 200 2007ms https://api.backed.fi/api/v2/public/assets/HKEXCx/circulating-supply?format=object
...
- `xstocks.circ.CHONGx` [ok] 200 359ms https://api.backed.fi/api/v2/public/assets/CHONGx/circulating-supply?format=object
...
- `xstocks.price.HNDLDx` [FAIL]  12009ms https://api.backed.fi/api/v2/public/assets/HNDLDx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.GEELx` [ok] 200 747ms https://api.backed.fi/api/v2/public/assets/GEELx/circulating-supply?format=object
...
- `xstocks.mult.COSCx` [ok] 200 460ms https://api.backed.fi/api/v2/public/assets/COSCx/multiplier?network=Solana
...
- `xstocks.circ.CKHUTx` [ok] 200 816ms https://api.backed.fi/api/v2/public/assets/CKHUTx/circulating-supply?format=object
- `xstocks.mult.CKHUTx` [ok] 200 571ms https://api.backed.fi/api/v2/public/assets/CKHUTx/multiplier?network=Solana
- `xstocks.mult.GEELx` [ok] 200 3320ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
- `llama.protocol.xstocks` [ok] 200 29ms https://api.llama.fi/protocol/xstocks
- `jup.tokens.search.xStock` [ok] 200 434ms https://lite-api.jup.ag/tokens/v2/search?query=xStock
- `jup.tokens.search.DRAMx` [ok] 200 106ms https://lite-api.jup.ag/tokens/v2/search?query=DRAMx
- `jup.tokens.search.AXTIx` [ok] 200 103ms https://lite-api.jup.ag/tokens/v2/search?query=AXTIx
...
- `jito.tip_floor` [ok] 200 528ms https://bundles.jito.wtf/api/v1/bundles/tip_floor
