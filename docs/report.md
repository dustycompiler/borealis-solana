...
**Generated** 2026-09-05T22:22:07Z · 2026-09-05 15:22:07 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-05T22:21:56Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h +1.87%; DEX 24h $1.88B · 1d -24% · vs-7d-ago -27%; slot 315 ms
...
| Health | `ok` |
| Slot | 444,632,270 |
| Block height | 422,676,685 |
| Block time | 2026-09-05T22:21:56Z |
| Epoch | 1,029 (24.14% · slot 104,271/432,000) |
| Mean TPS (last ~3,600s) | 3,343.6 |
| Mean non-vote TPS | 1,207.7 |
| Median TPS (same window) | 3,347.8 |
| Mean slot time | 315.1 ms |
| Median slot time | 314.1 ms |
| Transaction count (cluster) | 545,501,243,500 |
| Circulating supply | 585,445,629 SOL |
| Total supply | 633,549,504 SOL |
...
- `xLabscif…` · 28.57K SOL · commission 5% · lag 843897 slots
- `mrgn4atx…` · 20.30K SOL · commission 0% · lag 7312 slots
- `prt1st4R…` · 13.11K SOL · commission 5% · lag 1145328 slots
- `E4xNK4Uw…` · 6.26K SOL · commission 5% · lag 1283547 slots
- `5ZjxMYBb…` · 4.06K SOL · commission 0% · lag 666348 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 1846149 slots
- `pSoLoZx5…` · 1.51K SOL · commission 4% · lag 93079 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 1193631 slots
- `CpdzCVza…` · 193.38 SOL · commission 100% · lag 1831919 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 1873433 slots
- `HFTcVVrX…` · 148.42 SOL · commission 100% · lag 1831813 slots
- `6pEtDovp…` · 131.86 SOL · commission 100% · lag 1846197 slots
...
| Jito tip-floor run-rate (NOT REV) | $24.88K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 24884 USD; at p95 floor → 406108 USD. |
...
24h volume $17.23M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-09-05 (2026-09-05 15:22:07 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 5862ms https://api.mainnet-beta.solana.com
...
- `llama.chains` [ok] 200 790ms https://api.llama.fi/v2/chains
...
- `rss.nitter.solana` [ok] 200 1399ms https://nitter.perennialte.ch/solana/rss
- `rss.nitter.solana_status` [ok] 200 1533ms https://nitter.perennialte.ch/solana_status/rss
...
- `rpc.getBlock.fallback` [ok] 200 882ms https://solana-rpc.publicnode.com
...
- `xstocks.assets.p3` [ok] 200 2057ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=3
...
- `xstocks.price.GOOGLx` [FAIL]  12014ms https://api.backed.fi/api/v2/public/assets/GOOGLx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.price.AAPLx` [FAIL]  12016ms https://api.backed.fi/api/v2/public/assets/AAPLx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.NVDAx` [ok] 200 334ms https://api.backed.fi/api/v2/public/assets/NVDAx/circulating-supply?format=object
...
- `xstocks.circ.AMZNx` [ok] 200 680ms https://api.backed.fi/api/v2/public/assets/AMZNx/circulating-supply?format=object
- `xstocks.circ.GOOGLx` [ok] 200 731ms https://api.backed.fi/api/v2/public/assets/GOOGLx/circulating-supply?format=object
- `xstocks.circ.SPYx` [ok] 200 1038ms https://api.backed.fi/api/v2/public/assets/SPYx/circulating-supply?format=object
- `xstocks.mult.AAPLx` [ok] 200 1034ms https://api.backed.fi/api/v2/public/assets/AAPLx/multiplier?network=Solana
- `xstocks.mult.GOOGLx` [ok] 200 676ms https://api.backed.fi/api/v2/public/assets/GOOGLx/multiplier?network=Solana
- `xstocks.mult.AMZNx` [ok] 200 1009ms https://api.backed.fi/api/v2/public/assets/AMZNx/multiplier?network=Solana
- `xstocks.mult.NVDAx` [ok] 200 1431ms https://api.backed.fi/api/v2/public/assets/NVDAx/multiplier?network=Solana
- `xstocks.mult.SPYx` [ok] 200 1026ms https://api.backed.fi/api/v2/public/assets/SPYx/multiplier?network=Solana
...
- `xstocks.circ.QQQx` [ok] 200 781ms https://api.backed.fi/api/v2/public/assets/QQQx/circulating-supply?format=object
...
- `xstocks.circ.MVLLx` [ok] 200 263ms https://api.backed.fi/api/v2/public/assets/MVLLx/circulating-supply?format=object
...
- `xstocks.mult.DRAMx` [ok] 200 1162ms https://api.backed.fi/api/v2/public/assets/DRAMx/multiplier?network=Solana
- `xstocks.circ.MUUx` [ok] 200 799ms https://api.backed.fi/api/v2/public/assets/MUUx/circulating-supply?format=object
...
- `xstocks.circ.KORUx` [ok] 200 777ms https://api.backed.fi/api/v2/public/assets/KORUx/circulating-supply?format=object
- `xstocks.mult.MUUx` [ok] 200 679ms https://api.backed.fi/api/v2/public/assets/MUUx/multiplier?network=Solana
- `xstocks.mult.AXTIx` [ok] 200 389ms https://api.backed.fi/api/v2/public/assets/AXTIx/multiplier?network=Solana
- `xstocks.mult.KORUx` [ok] 200 581ms https://api.backed.fi/api/v2/public/assets/KORUx/multiplier?network=Solana
...
- `xstocks.mult.INTWx` [ok] 200 337ms https://api.backed.fi/api/v2/public/assets/INTWx/multiplier?network=Solana
...
- `xstocks.circ.SNXXx` [ok] 200 542ms https://api.backed.fi/api/v2/public/assets/SNXXx/circulating-supply?format=object
- `xstocks.circ.SHEINx` [ok] 200 451ms https://api.backed.fi/api/v2/public/assets/SHEINx/circulating-supply?format=object
- `xstocks.circ.NWGx` [ok] 200 410ms https://api.backed.fi/api/v2/public/assets/NWGx/circulating-supply?format=object
...
- `xstocks.mult.MMGx` [ok] 200 608ms https://api.backed.fi/api/v2/public/assets/MMGx/multiplier?network=Solana
...
- `xstocks.price.WRFHDx` [FAIL]  12013ms https://api.backed.fi/api/v2/public/assets/WRFHDx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.LAOPGx` [ok] 200 843ms https://api.backed.fi/api/v2/public/assets/LAOPGx/circulating-supply?format=object
...
- `xstocks.mult.LAOPGx` [ok] 200 392ms https://api.backed.fi/api/v2/public/assets/LAOPGx/multiplier?network=Solana
...
- `xstocks.price.SNBIOx` [FAIL]  12008ms https://api.backed.fi/api/v2/public/assets/SNBIOx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.SMOIHx` [ok] 200 672ms https://api.backed.fi/api/v2/public/assets/SMOIHx/circulating-supply?format=object
...
- `xstocks.mult.CMERPx` [ok] 200 796ms https://api.backed.fi/api/v2/public/assets/CMERPx/multiplier?network=Solana
- `xstocks.circ.ENNHLx` [ok] 200 1751ms https://api.backed.fi/api/v2/public/assets/ENNHLx/circulating-supply?format=object
...
- `xstocks.circ.CSPCx` [ok] 200 802ms https://api.backed.fi/api/v2/public/assets/CSPCx/circulating-supply?format=object
...
- `xstocks.circ.CRESMx` [ok] 200 937ms https://api.backed.fi/api/v2/public/assets/CRESMx/circulating-supply?format=object
- `xstocks.mult.JTGEXx` [ok] 200 1276ms https://api.backed.fi/api/v2/public/assets/JTGEXx/multiplier?network=Solana
...
- `xstocks.mult.CRESMx` [ok] 200 955ms https://api.backed.fi/api/v2/public/assets/CRESMx/multiplier?network=Solana
- `xstocks.mult.CMENDx` [ok] 200 574ms https://api.backed.fi/api/v2/public/assets/CMENDx/multiplier?network=Solana
- `xstocks.mult.MIXUx` [ok] 200 174ms https://api.backed.fi/api/v2/public/assets/MIXUx/multiplier?network=Solana
- `xstocks.mult.BDWAPx` [ok] 200 515ms https://api.backed.fi/api/v2/public/assets/BDWAPx/multiplier?network=Solana
- `xstocks.price.ASMPTx` [FAIL]  12017ms https://api.backed.fi/api/v2/public/assets/ASMPTx/price-data — TimeoutError: The read operation timed out
- `xstocks.mult.WXXDCx` [ok] 200 919ms https://api.backed.fi/api/v2/public/assets/WXXDCx/multiplier?network=Solana
- `xstocks.circ.ASMPTx` [ok] 200 1248ms https://api.backed.fi/api/v2/public/assets/ASMPTx/circulating-supply?format=object
...
- `xstocks.mult.ASMPTx` [ok] 200 1330ms https://api.backed.fi/api/v2/public/assets/ASMPTx/multiplier?network=Solana
...
- `xstocks.price.SINOTx` [FAIL]  12010ms https://api.backed.fi/api/v2/public/assets/SINOTx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.SNDSCx` [ok] 200 935ms https://api.backed.fi/api/v2/public/assets/SNDSCx/circulating-supply?format=object
...
- `xstocks.mult.CTFJWx` [ok] 200 858ms https://api.backed.fi/api/v2/public/assets/CTFJWx/multiplier?network=Solana
...
- `xstocks.circ.CTPCAx` [ok] 200 493ms https://api.backed.fi/api/v2/public/assets/CTPCAx/circulating-supply?format=object
...
- `xstocks.mult.SINOx` [ok] 200 798ms https://api.backed.fi/api/v2/public/assets/SINOx/multiplier?network=Solana
...
- `xstocks.mult.CLPHDx` [ok] 200 416ms https://api.backed.fi/api/v2/public/assets/CLPHDx/multiplier?network=Solana
- `xstocks.mult.CTPCAx` [ok] 200 1393ms https://api.backed.fi/api/v2/public/assets/CTPCAx/multiplier?network=Solana
...
- `xstocks.circ.CRAUTx` [ok] 200 590ms https://api.backed.fi/api/v2/public/assets/CRAUTx/circulating-supply?format=object
- `xstocks.mult.CRAUTx` [ok] 200 167ms https://api.backed.fi/api/v2/public/assets/CRAUTx/multiplier?network=Solana
- `xstocks.circ.WUXIBx` [ok] 200 510ms https://api.backed.fi/api/v2/public/assets/WUXIBx/circulating-supply?format=object
...
- `xstocks.circ.SWPRPx` [ok] 200 817ms https://api.backed.fi/api/v2/public/assets/SWPRPx/circulating-supply?format=object
...
- `xstocks.circ.HKCGAx` [ok] 200 177ms https://api.backed.fi/api/v2/public/assets/HKCGAx/circulating-supply?format=object
- `xstocks.circ.KUAIx` [ok] 200 362ms https://api.backed.fi/api/v2/public/assets/KUAIx/circulating-supply?format=object
- `xstocks.mult.HKCGAx` [ok] 200 262ms https://api.backed.fi/api/v2/public/assets/HKCGAx/multiplier?network=Solana
- `xstocks.circ.CKAHx` [ok] 200 780ms https://api.backed.fi/api/v2/public/assets/CKAHx/circulating-supply?format=object
- `xstocks.price.HKEXCx` [FAIL]  12008ms https://api.backed.fi/api/v2/public/assets/HKEXCx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.HKEXCx` [ok] 200 584ms https://api.backed.fi/api/v2/public/assets/HKEXCx/multiplier?network=Solana
...
- `xstocks.circ.NONGx` [ok] 200 1453ms https://api.backed.fi/api/v2/public/assets/NONGx/circulating-supply?format=object
- `xstocks.mult.NONGx` [ok] 200 381ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
- `xstocks.circ.COVELx` [ok] 200 672ms https://api.backed.fi/api/v2/public/assets/COVELx/circulating-supply?format=object
...
- `xstocks.circ.MEITx` [ok] 200 465ms https://api.backed.fi/api/v2/public/assets/MEITx/circulating-supply?format=object
...
- `xstocks.circ.GEELx` [ok] 200 416ms https://api.backed.fi/api/v2/public/assets/GEELx/circulating-supply?format=object
...
- `xstocks.circ.HNDLDx` [ok] 200 436ms https://api.backed.fi/api/v2/public/assets/HNDLDx/circulating-supply?format=object
- `xstocks.mult.MTRCPx` [ok] 200 581ms https://api.backed.fi/api/v2/public/assets/MTRCPx/multiplier?network=Solana
- `xstocks.mult.HNDLDx` [ok] 200 274ms https://api.backed.fi/api/v2/public/assets/HNDLDx/multiplier?network=Solana
...
- `llama.protocol.xstocks` [ok] 200 2595ms https://api.llama.fi/protocol/xstocks
