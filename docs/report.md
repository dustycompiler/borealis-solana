...
**Generated** 2026-08-29T17:48:25Z · 2026-08-29 10:48:25 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-29T17:48:15Z · **RPC health** `ok`
...
- **WARN · SOL price vs 30d median (solana.com/data)** — Current 104.74 USD is +37.5% vs 30d median 76.20 USD (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
- **INFO · Correlation: risk-off (SOL 24h ↓ + TVL 1d ↓ + DEX 1d ↓)** — SOL 24h -0.13%, DeFiLlama TVL 1d -2.17%, DEX 1d -29.99%. (threshold: `SOL 24h < 0 AND TVL 1d < 0 AND DEX 1d < 0`)
...
- **INFO · TPS vs 30d median (solana.com/data tx/86400)** — Current 4,444.06 TPS is +23.9% vs 30d median 3,585.83 TPS (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
...
| Health | `ok` |
| Slot | 442,667,140 |
| Block height | 420,714,994 |
| Block time | 2026-08-29T17:48:15Z |
| Epoch | 1,024 (69.25% · slot 299,140/432,000) |
| Mean TPS (last ~3,600s) | 4,444.1 |
| Mean non-vote TPS | 2,288.0 |
| Median TPS (same window) | 4,472.6 |
| Mean slot time | 317.6 ms |
| Median slot time | 317.5 ms |
| Transaction count (cluster) | 543,158,135,349 |
| Circulating supply | 584,161,377 SOL |
| Total supply | 633,078,917 SOL |
...
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1414461 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 320439 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 683386 slots
- `kom1oNHy…` · 662.86 SOL · commission 5% · lag 2030624 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442667140 slots
- `pSo1KZXg…` · 2.00 SOL · commission 4% · lag 329299 slots
- `7Dvp5zCF…` · 1.07 SOL · commission 100% · lag 487785 slots
- `bcZxRSoz…` · 0.00 SOL · commission 0% · lag 2027141 slots
...
| --- | ---: | --- |
| TPS chart | 119 | data/history.jsonl snapshot tape |
| TVL chart | 119 | data/history.jsonl snapshot tape |
| SOL chart | 118 | data/history.jsonl snapshot tape |
| history.jsonl rows | 119 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $165.64K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 165642 USD; at p95 floor → 20982426 USD. |
...
24h volume $19.73M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-08-29 (2026-08-29 10:48:25 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rss.xcancel.solana_devs` [ok] 200 427ms https://xcancel.com/solana_devs/rss
- `rss.nitter.solana` [ok] 200 2293ms https://nitter.perennialte.ch/solana/rss
- `rss.nitter.solana_status` [ok] 200 1481ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [ok] 200 1723ms https://nitter.perennialte.ch/anza_xyz/rss
- `rss.nitter.solana_devs` [ok] 200 1390ms https://nitter.perennialte.ch/solana_devs/rss
...
- `xstocks.assets.p6` [ok] 200 2430ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=6
...
- `xstocks.mult.METAx` [ok] 200 766ms https://api.backed.fi/api/v2/public/assets/METAx/multiplier?network=Solana
- `xstocks.circ.MSFTx` [ok] 200 1729ms https://api.backed.fi/api/v2/public/assets/MSFTx/circulating-supply?format=object
...
- `xstocks.circ.TNGYIx` [ok] 200 387ms https://api.backed.fi/api/v2/public/assets/TNGYIx/circulating-supply?format=object
- `xstocks.circ.SUOPTx` [ok] 200 655ms https://api.backed.fi/api/v2/public/assets/SUOPTx/circulating-supply?format=object
...
- `xstocks.mult.SUOPTx` [ok] 200 783ms https://api.backed.fi/api/v2/public/assets/SUOPTx/multiplier?network=Solana
...
- `xstocks.circ.LAOPGx` [ok] 200 438ms https://api.backed.fi/api/v2/public/assets/LAOPGx/circulating-supply?format=object
...
- `xstocks.circ.KUNLx` [ok] 200 406ms https://api.backed.fi/api/v2/public/assets/KUNLx/circulating-supply?format=object
...
- `xstocks.mult.HAIDLx` [ok] 200 206ms https://api.backed.fi/api/v2/public/assets/HAIDLx/multiplier?network=Solana
...
- `xstocks.mult.WRFHDx` [ok] 200 575ms https://api.backed.fi/api/v2/public/assets/WRFHDx/multiplier?network=Solana
...
- `xstocks.mult.JTGEXx` [ok] 200 613ms https://api.backed.fi/api/v2/public/assets/JTGEXx/multiplier?network=Solana
...
- `xstocks.price.MIXUx` [FAIL]  12008ms https://api.backed.fi/api/v2/public/assets/MIXUx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.ASMPTx` [ok] 200 672ms https://api.backed.fi/api/v2/public/assets/ASMPTx/circulating-supply?format=object
- `xstocks.circ.JDHLTx` [ok] 200 178ms https://api.backed.fi/api/v2/public/assets/JDHLTx/circulating-supply?format=object
- `xstocks.mult.WHRFRx` [ok] 200 419ms https://api.backed.fi/api/v2/public/assets/WHRFRx/multiplier?network=Solana
...
- `xstocks.mult.CRESPx` [ok] 200 363ms https://api.backed.fi/api/v2/public/assets/CRESPx/multiplier?network=Solana
...
- `xstocks.price.SINOx` [FAIL]  12009ms https://api.backed.fi/api/v2/public/assets/SINOx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.SINOTx` [ok] 200 1291ms https://api.backed.fi/api/v2/public/assets/SINOTx/circulating-supply?format=object
...
- `xstocks.circ.PWAHLx` [ok] 200 454ms https://api.backed.fi/api/v2/public/assets/PWAHLx/circulating-supply?format=object
...
- `xstocks.price.CKINFx` [FAIL]  12009ms https://api.backed.fi/api/v2/public/assets/CKINFx/price-data — TimeoutError: The read operation timed out
- `xstocks.mult.CKAHx` [ok] 200 189ms https://api.backed.fi/api/v2/public/assets/CKAHx/multiplier?network=Solana
- `xstocks.circ.SWPRPx` [ok] 200 779ms https://api.backed.fi/api/v2/public/assets/SWPRPx/circulating-supply?format=object
- `xstocks.circ.CKINFx` [ok] 200 705ms https://api.backed.fi/api/v2/public/assets/CKINFx/circulating-supply?format=object
...
- `xstocks.price.HKEXCx` [FAIL]  12024ms https://api.backed.fi/api/v2/public/assets/HKEXCx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.NONGx` [ok] 200 427ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
...
- `xstocks.circ.MEITx` [ok] 200 215ms https://api.backed.fi/api/v2/public/assets/MEITx/circulating-supply?format=object
...
- `xstocks.mult.MEITx` [ok] 200 611ms https://api.backed.fi/api/v2/public/assets/MEITx/multiplier?network=Solana
- `xstocks.mult.CHONGx` [ok] 200 1394ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
...
- `xstocks.mult.HNDLDx` [ok] 200 753ms https://api.backed.fi/api/v2/public/assets/HNDLDx/multiplier?network=Solana
...
- `xstocks.mult.COSCx` [ok] 200 342ms https://api.backed.fi/api/v2/public/assets/COSCx/multiplier?network=Solana
- `xstocks.mult.PICCx` [ok] 200 498ms https://api.backed.fi/api/v2/public/assets/PICCx/multiplier?network=Solana
- `xstocks.circ.CKHUTx` [ok] 200 657ms https://api.backed.fi/api/v2/public/assets/CKHUTx/circulating-supply?format=object
...
- `xstocks.price.BOCOMx` [FAIL]  12024ms https://api.backed.fi/api/v2/public/assets/BOCOMx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.CPETCx` [ok] 200 177ms https://api.backed.fi/api/v2/public/assets/CPETCx/circulating-supply?format=object
- `xstocks.circ.BOCOMx` [ok] 200 338ms https://api.backed.fi/api/v2/public/assets/BOCOMx/circulating-supply?format=object
- `xstocks.mult.POPMTx` [ok] 200 649ms https://api.backed.fi/api/v2/public/assets/POPMTx/multiplier?network=Solana
- `xstocks.mult.BOCOMx` [ok] 200 190ms https://api.backed.fi/api/v2/public/assets/BOCOMx/multiplier?network=Solana
- `xstocks.mult.CPETCx` [ok] 200 332ms https://api.backed.fi/api/v2/public/assets/CPETCx/multiplier?network=Solana
...
- `xstocks.circ.CITICx` [ok] 200 175ms https://api.backed.fi/api/v2/public/assets/CITICx/circulating-supply?format=object
...
- `xstocks.circ.ANTASx` [ok] 200 169ms https://api.backed.fi/api/v2/public/assets/ANTASx/circulating-supply?format=object
...
- `xstocks.circ.HAIERx` [ok] 200 188ms https://api.backed.fi/api/v2/public/assets/HAIERx/circulating-supply?format=object
...
- `xstocks.circ.ZJGLDx` [ok] 200 175ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/circulating-supply?format=object
...
- `xstocks.mult.ICBCx` [ok] 200 177ms https://api.backed.fi/api/v2/public/assets/ICBCx/multiplier?network=Solana
...
- `jup.tokens.search.MMGx` [ok] 200 120ms https://lite-api.jup.ag/tokens/v2/search?query=MMGx
- `jup.tokens.search.ZHAOMx` [ok] 200 100ms https://lite-api.jup.ag/tokens/v2/search?query=ZHAOMx
- `jup.tokens.search.TNGYIx` [ok] 200 116ms https://lite-api.jup.ag/tokens/v2/search?query=TNGYIx
...
- `jup.tokens.search.LAOPGx` [ok] 200 99ms https://lite-api.jup.ag/tokens/v2/search?query=LAOPGx
- `jup.tokens.search.JDLOGx` [ok] 200 117ms https://lite-api.jup.ag/tokens/v2/search?query=JDLOGx
- `jup.tokens.search.CTINSx` [ok] 200 106ms https://lite-api.jup.ag/tokens/v2/search?query=CTINSx
