...
**Generated** 2026-08-29T15:12:19Z · 2026-08-29 08:12:19 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-29T15:12:10Z · **RPC health** `ok`
**Health score** 100 / 100 — `25×rpc_ok + 30×clamp(1 − max(0, slot_ms − 350)/350, 0, 1) + 25×clamp(1 − delinquent_stake_pct/2, 0, 1) + 20×clamp(tps / tps_baseline, 0, 1)`
...
- **WARN · SOL price vs 30d median (solana.com/data)** — Current 105.11 USD is +37.9% vs 30d median 76.20 USD (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
...
| Health | `ok` |
| Slot | 442,637,668 |
| Block height | 420,685,550 |
| Block time | 2026-08-29T15:12:10Z |
| Epoch | 1,024 (62.42% · slot 269,672/432,000) |
| Mean TPS (last ~3,600s) | 3,924.6 |
| Mean non-vote TPS | 1,762.6 |
| Median TPS (same window) | 3,872.3 |
| Mean slot time | 317.0 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 543,118,122,549 |
| Circulating supply | 584,161,483 SOL |
| Total supply | 633,079,023 SOL |
...
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1384989 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 290967 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 653914 slots
- `kom1oNHy…` · 662.86 SOL · commission 5% · lag 2001152 slots
- `7ZjHeeYE…` · 176.09 SOL · commission 5% · lag 35653 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442637668 slots
- `pSo1KZXg…` · 2.00 SOL · commission 4% · lag 299827 slots
- `7Dvp5zCF…` · 1.07 SOL · commission 100% · lag 458313 slots
- `bcZxRSoz…` · 0.00 SOL · commission 0% · lag 1997669 slots
...
| --- | ---: | --- |
| TPS chart | 108 | data/history.jsonl snapshot tape |
| TVL chart | 108 | data/history.jsonl snapshot tape |
| SOL chart | 107 | data/history.jsonl snapshot tape |
| history.jsonl rows | 108 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $143.46K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 143456 USD; at p95 floor → 10404649 USD. |
...
_As of 2026-08-29 (2026-08-29 08:12:19 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 7106ms https://api.mainnet-beta.solana.com
- `rpc.getVoteAccounts` [ok] 200 1107ms https://api.mainnet-beta.solana.com
...
- `rss.anza.medium` [ok] 200 528ms https://medium.com/feed/anza-xyz
...
- `rss.nitter.solana_status` [ok] 200 927ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [ok] 200 939ms https://nitter.perennialte.ch/anza_xyz/rss
...
- `rpc.getBlocks` [ok] 200 553ms https://api.mainnet-beta.solana.com
...
- `xstocks.assets.p0` [ok] 200 1299ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0
- `xstocks.assets.p1` [ok] 200 1664ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=1
- `xstocks.assets.p2` [ok] 200 1282ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=2
- `xstocks.assets.p3` [ok] 200 1067ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=3
...
- `xstocks.assets.p7` [ok] 200 668ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=7
- `xstocks.price.NVDAx` [FAIL]  12015ms https://api.backed.fi/api/v2/public/assets/NVDAx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.AAPLx` [ok] 200 118ms https://api.backed.fi/api/v2/public/assets/AAPLx/circulating-supply?format=object
...
- `xstocks.mult.SPYx` [ok] 200 418ms https://api.backed.fi/api/v2/public/assets/SPYx/multiplier?network=Solana
- `xstocks.mult.NVDAx` [ok] 200 432ms https://api.backed.fi/api/v2/public/assets/NVDAx/multiplier?network=Solana
...
- `xstocks.mult.GOOGLx` [ok] 200 711ms https://api.backed.fi/api/v2/public/assets/GOOGLx/multiplier?network=Solana
...
- `xstocks.price.BANKCx` [FAIL]  12011ms https://api.backed.fi/api/v2/public/assets/BANKCx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.BANKCx` [ok] 200 937ms https://api.backed.fi/api/v2/public/assets/BANKCx/circulating-supply?format=object
- `xstocks.mult.LAOPGx` [ok] 200 428ms https://api.backed.fi/api/v2/public/assets/LAOPGx/multiplier?network=Solana
...
- `xstocks.mult.CTINSx` [ok] 200 130ms https://api.backed.fi/api/v2/public/assets/CTINSx/multiplier?network=Solana
...
- `xstocks.mult.SZIGHx` [ok] 200 834ms https://api.backed.fi/api/v2/public/assets/SZIGHx/multiplier?network=Solana
...
- `xstocks.price.CMERPx` [FAIL]  12012ms https://api.backed.fi/api/v2/public/assets/CMERPx/price-data — TimeoutError: The read operation timed out
- `xstocks.price.CRESBx` [FAIL]  12015ms https://api.backed.fi/api/v2/public/assets/CRESBx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.SMOIHx` [ok] 200 602ms https://api.backed.fi/api/v2/public/assets/SMOIHx/circulating-supply?format=object
...
- `xstocks.mult.HRZRBx` [ok] 200 1065ms https://api.backed.fi/api/v2/public/assets/HRZRBx/multiplier?network=Solana
...
- `xstocks.circ.CSPCx` [ok] 200 1225ms https://api.backed.fi/api/v2/public/assets/CSPCx/circulating-supply?format=object
- `xstocks.mult.JTGEXx` [ok] 200 1419ms https://api.backed.fi/api/v2/public/assets/JTGEXx/multiplier?network=Solana
- `xstocks.mult.CSPCx` [ok] 200 1101ms https://api.backed.fi/api/v2/public/assets/CSPCx/multiplier?network=Solana
...
- `xstocks.mult.MIXUx` [ok] 200 260ms https://api.backed.fi/api/v2/public/assets/MIXUx/multiplier?network=Solana
...
- `xstocks.mult.BDWAPx` [ok] 200 597ms https://api.backed.fi/api/v2/public/assets/BDWAPx/multiplier?network=Solana
...
- `xstocks.circ.SITCx` [ok] 200 567ms https://api.backed.fi/api/v2/public/assets/SITCx/circulating-supply?format=object
...
- `xstocks.mult.ASMPTx` [ok] 200 1364ms https://api.backed.fi/api/v2/public/assets/ASMPTx/multiplier?network=Solana
...
- `xstocks.circ.PRADx` [ok] 200 546ms https://api.backed.fi/api/v2/public/assets/PRADx/circulating-supply?format=object
...
- `xstocks.circ.CTPCAx` [ok] 200 839ms https://api.backed.fi/api/v2/public/assets/CTPCAx/circulating-supply?format=object
...
- `xstocks.mult.PWAHLx` [ok] 200 407ms https://api.backed.fi/api/v2/public/assets/PWAHLx/multiplier?network=Solana
...
- `xstocks.circ.CRAUTx` [ok] 200 1210ms https://api.backed.fi/api/v2/public/assets/CRAUTx/circulating-supply?format=object
...
- `xstocks.mult.CKAHx` [ok] 200 236ms https://api.backed.fi/api/v2/public/assets/CKAHx/multiplier?network=Solana
- `xstocks.circ.SWPRPx` [ok] 200 935ms https://api.backed.fi/api/v2/public/assets/SWPRPx/circulating-supply?format=object
- `xstocks.mult.SWPRPx` [ok] 200 538ms https://api.backed.fi/api/v2/public/assets/SWPRPx/multiplier?network=Solana
- `xstocks.circ.WUXIBx` [ok] 200 2038ms https://api.backed.fi/api/v2/public/assets/WUXIBx/circulating-supply?format=object
...
- `xstocks.circ.CKINFx` [ok] 200 288ms https://api.backed.fi/api/v2/public/assets/CKINFx/circulating-supply?format=object
- `xstocks.mult.CKINFx` [ok] 200 175ms https://api.backed.fi/api/v2/public/assets/CKINFx/multiplier?network=Solana
- `xstocks.mult.WUXIBx` [ok] 200 1059ms https://api.backed.fi/api/v2/public/assets/WUXIBx/multiplier?network=Solana
...
- `xstocks.mult.HKCGAx` [ok] 200 141ms https://api.backed.fi/api/v2/public/assets/HKCGAx/multiplier?network=Solana
...
- `xstocks.mult.KUAIx` [ok] 200 352ms https://api.backed.fi/api/v2/public/assets/KUAIx/multiplier?network=Solana
- `xstocks.circ.HKEXCx` [ok] 200 519ms https://api.backed.fi/api/v2/public/assets/HKEXCx/circulating-supply?format=object
...
- `xstocks.mult.HKEXCx` [ok] 200 964ms https://api.backed.fi/api/v2/public/assets/HKEXCx/multiplier?network=Solana
...
- `xstocks.circ.CHONGx` [ok] 200 215ms https://api.backed.fi/api/v2/public/assets/CHONGx/circulating-supply?format=object
...
- `xstocks.circ.MEITx` [ok] 200 1191ms https://api.backed.fi/api/v2/public/assets/MEITx/circulating-supply?format=object
- `xstocks.mult.MEITx` [ok] 200 175ms https://api.backed.fi/api/v2/public/assets/MEITx/multiplier?network=Solana
- `xstocks.circ.GEELx` [ok] 200 2185ms https://api.backed.fi/api/v2/public/assets/GEELx/circulating-supply?format=object
...
- `xstocks.mult.COSCx` [ok] 200 167ms https://api.backed.fi/api/v2/public/assets/COSCx/multiplier?network=Solana
...
- `xstocks.circ.CKHUTx` [ok] 200 981ms https://api.backed.fi/api/v2/public/assets/CKHUTx/circulating-supply?format=object
- `xstocks.mult.CKHUTx` [ok] 200 156ms https://api.backed.fi/api/v2/public/assets/CKHUTx/multiplier?network=Solana
- `xstocks.circ.POPMTx` [ok] 200 1078ms https://api.backed.fi/api/v2/public/assets/POPMTx/circulating-supply?format=object
...
- `xstocks.circ.BOCOMx` [ok] 200 1087ms https://api.backed.fi/api/v2/public/assets/BOCOMx/circulating-supply?format=object
...
- `xstocks.mult.CPETCx` [ok] 200 160ms https://api.backed.fi/api/v2/public/assets/CPETCx/multiplier?network=Solana
...
- `xstocks.circ.CITICx` [ok] 200 768ms https://api.backed.fi/api/v2/public/assets/CITICx/circulating-supply?format=object
- `xstocks.circ.BOCHKx` [ok] 200 987ms https://api.backed.fi/api/v2/public/assets/BOCHKx/circulating-supply?format=object
- `xstocks.mult.BOCHKx` [ok] 200 142ms https://api.backed.fi/api/v2/public/assets/BOCHKx/multiplier?network=Solana
- `xstocks.mult.CITICx` [ok] 200 273ms https://api.backed.fi/api/v2/public/assets/CITICx/multiplier?network=Solana
- `xstocks.price.ANTASx` [FAIL]  12012ms https://api.backed.fi/api/v2/public/assets/ANTASx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.HAIERx` [ok] 200 517ms https://api.backed.fi/api/v2/public/assets/HAIERx/circulating-supply?format=object
- `xstocks.mult.HAIERx` [ok] 200 155ms https://api.backed.fi/api/v2/public/assets/HAIERx/multiplier?network=Solana
- `xstocks.price.ZJGLDx` [FAIL]  12013ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.PSBOCx` [ok] 200 122ms https://api.backed.fi/api/v2/public/assets/PSBOCx/circulating-supply?format=object
...
- `xstocks.mult.ICBCx` [ok] 200 742ms https://api.backed.fi/api/v2/public/assets/ICBCx/multiplier?network=Solana
...
- `jup.tokens.search.JDLOGx` [ok] 200 37ms https://lite-api.jup.ag/tokens/v2/search?query=JDLOGx
