...
**Generated** 2026-09-05T11:34:08Z · 2026-09-05 04:34:08 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-05T11:33:58Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h -1.91%; DEX 24h $1.88B · 1d -24% · vs-7d-ago -27%; slot 314 ms
...
- **INFO · Correlation: risk-off (SOL 24h ↓ + TVL 1d ↓ + DEX 1d ↓)** — SOL 24h -1.91%, DeFiLlama TVL 1d -0.82%, DEX 1d -23.50%. (threshold: `SOL 24h < 0 AND TVL 1d < 0 AND DEX 1d < 0`)
- **INFO · TPS vs 30d median (solana.com/data tx/86400)** — Current 3,009.47 TPS is -20.2% vs 30d median 3,772.26 TPS (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
...
| Health | `ok` |
| Slot | 444,508,981 |
| Block height | 422,553,556 |
| Block time | 2026-09-05T11:33:58Z |
| Epoch | 1,028 (95.60% · slot 412,981/432,000) |
| Mean TPS (last ~3,600s) | 3,009.5 |
| Mean non-vote TPS | 872.0 |
| Median TPS (same window) | 3,003.4 |
| Mean slot time | 314.3 ms |
| Median slot time | 314.1 ms |
| Transaction count (cluster) | 545,369,673,326 |
| Circulating supply | 585,359,574 SOL |
| Total supply | 633,454,599 SOL |
...
- `xLabscif…` · 78.25K SOL · commission 5% · lag 720608 slots
- `prt1st4R…` · 19.80K SOL · commission 5% · lag 1022039 slots
- `E4xNK4Uw…` · 10.45K SOL · commission 5% · lag 1160258 slots
- `5ZjxMYBb…` · 4.06K SOL · commission 0% · lag 543059 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 1722860 slots
- `Fb77sbwg…` · 2.13K SOL · commission 0% · lag 332424 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 1070342 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 2525227 slots
- `CpdzCVza…` · 193.38 SOL · commission 100% · lag 1708630 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 1750144 slots
- `HFTcVVrX…` · 149.48 SOL · commission 100% · lag 1708524 slots
- `6pEtDovp…` · 131.86 SOL · commission 100% · lag 1722908 slots
...
| Jito tip-floor run-rate (NOT REV) | $9.67K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 9667 USD; at p95 floor → 150721 USD. |
...
| p90 / p99 | 0.000007 / 0.000065 SOL | same sample |
...
24h volume $24.13M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-09-05 (2026-09-05 04:34:08 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 5796ms https://api.mainnet-beta.solana.com
...
- `rss.nitter.solana` [ok] 200 1314ms https://nitter.perennialte.ch/solana/rss
- `rss.nitter.solana_status` [ok] 200 1464ms https://nitter.perennialte.ch/solana_status/rss
...
- `rpc.getBlock.fallback` [ok] 200 833ms https://solana-rpc.publicnode.com
...
- `xstocks.assets.p4` [ok] 200 2512ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=4
- `xstocks.assets.p5` [ok] 200 1719ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=5
- `xstocks.assets.p6` [ok] 200 2746ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=6
...
- `xstocks.circ.MSFTx` [ok] 200 901ms https://api.backed.fi/api/v2/public/assets/MSFTx/circulating-supply?format=object
- `xstocks.circ.SPYx` [ok] 200 954ms https://api.backed.fi/api/v2/public/assets/SPYx/circulating-supply?format=object
- `xstocks.mult.AMZNx` [ok] 200 609ms https://api.backed.fi/api/v2/public/assets/AMZNx/multiplier?network=Solana
- `xstocks.circ.TSLAx` [ok] 200 1150ms https://api.backed.fi/api/v2/public/assets/TSLAx/circulating-supply?format=object
- `xstocks.circ.METAx` [ok] 200 1225ms https://api.backed.fi/api/v2/public/assets/METAx/circulating-supply?format=object
...
- `xstocks.mult.SPYx` [ok] 200 1072ms https://api.backed.fi/api/v2/public/assets/SPYx/multiplier?network=Solana
...
- `xstocks.price.MUUx` [FAIL]  12012ms https://api.backed.fi/api/v2/public/assets/MUUx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.DJTx` [ok] 200 245ms https://api.backed.fi/api/v2/public/assets/DJTx/circulating-supply?format=object
- `xstocks.circ.AXTIx` [ok] 200 598ms https://api.backed.fi/api/v2/public/assets/AXTIx/circulating-supply?format=object
...
- `xstocks.circ.MVLLx` [ok] 200 963ms https://api.backed.fi/api/v2/public/assets/MVLLx/circulating-supply?format=object
- `xstocks.mult.DJTx` [ok] 200 198ms https://api.backed.fi/api/v2/public/assets/DJTx/multiplier?network=Solana
...
- `xstocks.mult.AXTIx` [ok] 200 1660ms https://api.backed.fi/api/v2/public/assets/AXTIx/multiplier?network=Solana
- `xstocks.mult.MVLLx` [ok] 200 2318ms https://api.backed.fi/api/v2/public/assets/MVLLx/multiplier?network=Solana
...
- `xstocks.circ.SNXXx` [ok] 200 554ms https://api.backed.fi/api/v2/public/assets/SNXXx/circulating-supply?format=object
...
- `xstocks.circ.INTWx` [ok] 200 1575ms https://api.backed.fi/api/v2/public/assets/INTWx/circulating-supply?format=object
...
- `xstocks.circ.NWGx` [ok] 200 877ms https://api.backed.fi/api/v2/public/assets/NWGx/circulating-supply?format=object
...
- `xstocks.mult.SNXXx` [ok] 200 1934ms https://api.backed.fi/api/v2/public/assets/SNXXx/multiplier?network=Solana
- `xstocks.mult.NWGx` [ok] 200 1212ms https://api.backed.fi/api/v2/public/assets/NWGx/multiplier?network=Solana
...
- `xstocks.mult.MMGx` [ok] 200 1130ms https://api.backed.fi/api/v2/public/assets/MMGx/multiplier?network=Solana
...
- `xstocks.circ.TNGYIx` [ok] 200 284ms https://api.backed.fi/api/v2/public/assets/TNGYIx/circulating-supply?format=object
...
- `xstocks.mult.ZHAOMx` [ok] 200 788ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/multiplier?network=Solana
- `xstocks.mult.JDLOGx` [ok] 200 199ms https://api.backed.fi/api/v2/public/assets/JDLOGx/multiplier?network=Solana
- `xstocks.mult.LAOPGx` [ok] 200 750ms https://api.backed.fi/api/v2/public/assets/LAOPGx/multiplier?network=Solana
- `xstocks.price.CTINSx` [FAIL]  12013ms https://api.backed.fi/api/v2/public/assets/CTINSx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.CTINSx` [ok] 200 610ms https://api.backed.fi/api/v2/public/assets/CTINSx/circulating-supply?format=object
- `xstocks.mult.KUNLx` [ok] 200 745ms https://api.backed.fi/api/v2/public/assets/KUNLx/multiplier?network=Solana
...
- `xstocks.circ.ENNHLx` [ok] 200 522ms https://api.backed.fi/api/v2/public/assets/ENNHLx/circulating-supply?format=object
- `xstocks.circ.SZIGHx` [ok] 200 744ms https://api.backed.fi/api/v2/public/assets/SZIGHx/circulating-supply?format=object
- `xstocks.mult.ENNHLx` [ok] 200 688ms https://api.backed.fi/api/v2/public/assets/ENNHLx/multiplier?network=Solana
- `xstocks.mult.SMOIHx` [ok] 200 1031ms https://api.backed.fi/api/v2/public/assets/SMOIHx/multiplier?network=Solana
...
- `xstocks.mult.SZIGHx` [ok] 200 875ms https://api.backed.fi/api/v2/public/assets/SZIGHx/multiplier?network=Solana
...
- `xstocks.circ.HRZRBx` [ok] 200 489ms https://api.backed.fi/api/v2/public/assets/HRZRBx/circulating-supply?format=object
...
- `xstocks.circ.CSPCx` [ok] 200 442ms https://api.backed.fi/api/v2/public/assets/CSPCx/circulating-supply?format=object
- `xstocks.mult.CSPCx` [ok] 200 520ms https://api.backed.fi/api/v2/public/assets/CSPCx/multiplier?network=Solana
...
- `xstocks.mult.JTGEXx` [ok] 200 639ms https://api.backed.fi/api/v2/public/assets/JTGEXx/multiplier?network=Solana
...
- `xstocks.mult.CMENDx` [ok] 200 833ms https://api.backed.fi/api/v2/public/assets/CMENDx/multiplier?network=Solana
- `xstocks.circ.BDWAPx` [ok] 200 560ms https://api.backed.fi/api/v2/public/assets/BDWAPx/circulating-supply?format=object
...
- `xstocks.circ.WHRFRx` [ok] 200 231ms https://api.backed.fi/api/v2/public/assets/WHRFRx/circulating-supply?format=object
...
- `xstocks.mult.SITCx` [ok] 200 419ms https://api.backed.fi/api/v2/public/assets/SITCx/multiplier?network=Solana
...
- `xstocks.circ.JDHLTx` [ok] 200 1002ms https://api.backed.fi/api/v2/public/assets/JDHLTx/circulating-supply?format=object
...
- `xstocks.mult.CRESPx` [ok] 200 418ms https://api.backed.fi/api/v2/public/assets/CRESPx/multiplier?network=Solana
...
- `xstocks.mult.SINOTx` [ok] 200 635ms https://api.backed.fi/api/v2/public/assets/SINOTx/multiplier?network=Solana
...
- `xstocks.circ.SINOx` [ok] 200 320ms https://api.backed.fi/api/v2/public/assets/SINOx/circulating-supply?format=object
...
- `xstocks.mult.CTPCAx` [ok] 200 340ms https://api.backed.fi/api/v2/public/assets/CTPCAx/multiplier?network=Solana
...
- `xstocks.mult.GENTEx` [ok] 200 503ms https://api.backed.fi/api/v2/public/assets/GENTEx/multiplier?network=Solana
- `xstocks.circ.WUXIBx` [ok] 200 583ms https://api.backed.fi/api/v2/public/assets/WUXIBx/circulating-supply?format=object
- `xstocks.mult.CRAUTx` [ok] 200 569ms https://api.backed.fi/api/v2/public/assets/CRAUTx/multiplier?network=Solana
- `xstocks.mult.WUXIBx` [ok] 200 649ms https://api.backed.fi/api/v2/public/assets/WUXIBx/multiplier?network=Solana
...
- `xstocks.mult.SWPRPx` [ok] 200 1063ms https://api.backed.fi/api/v2/public/assets/SWPRPx/multiplier?network=Solana
...
- `xstocks.mult.CKINFx` [ok] 200 360ms https://api.backed.fi/api/v2/public/assets/CKINFx/multiplier?network=Solana
- `xstocks.mult.CKAHx` [ok] 200 1253ms https://api.backed.fi/api/v2/public/assets/CKAHx/multiplier?network=Solana
- `xstocks.circ.HKCGAx` [ok] 200 326ms https://api.backed.fi/api/v2/public/assets/HKCGAx/circulating-supply?format=object
- `xstocks.mult.HKCGAx` [ok] 200 542ms https://api.backed.fi/api/v2/public/assets/HKCGAx/multiplier?network=Solana
...
- `xstocks.circ.KUAIx` [ok] 200 1633ms https://api.backed.fi/api/v2/public/assets/KUAIx/circulating-supply?format=object
...
- `xstocks.mult.NONGx` [ok] 200 775ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
- `xstocks.circ.COVELx` [ok] 200 736ms https://api.backed.fi/api/v2/public/assets/COVELx/circulating-supply?format=object
- `xstocks.mult.COVELx` [ok] 200 563ms https://api.backed.fi/api/v2/public/assets/COVELx/multiplier?network=Solana
- `xstocks.circ.HKEXCx` [ok] 200 2171ms https://api.backed.fi/api/v2/public/assets/HKEXCx/circulating-supply?format=object
...
- `xstocks.price.MEITx` [FAIL]  12017ms https://api.backed.fi/api/v2/public/assets/MEITx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.CHONGx` [ok] 200 526ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
...
- `xstocks.circ.GEELx` [ok] 200 1770ms https://api.backed.fi/api/v2/public/assets/GEELx/circulating-supply?format=object
- `xstocks.circ.MEITx` [ok] 200 1879ms https://api.backed.fi/api/v2/public/assets/MEITx/circulating-supply?format=object
- `xstocks.mult.GEELx` [ok] 200 730ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
...
- `xstocks.circ.PICCx` [ok] 200 806ms https://api.backed.fi/api/v2/public/assets/PICCx/circulating-supply?format=object
...
- `xstocks.circ.CKHUTx` [ok] 200 255ms https://api.backed.fi/api/v2/public/assets/CKHUTx/circulating-supply?format=object
- `xstocks.mult.MEITx` [ok] 200 2466ms https://api.backed.fi/api/v2/public/assets/MEITx/multiplier?network=Solana
- `xstocks.circ.HNDLDx` [ok] 200 2748ms https://api.backed.fi/api/v2/public/assets/HNDLDx/circulating-supply?format=object
- `xstocks.circ.COSCx` [ok] 200 960ms https://api.backed.fi/api/v2/public/assets/COSCx/circulating-supply?format=object
- `xstocks.mult.CKHUTx` [ok] 200 582ms https://api.backed.fi/api/v2/public/assets/CKHUTx/multiplier?network=Solana
- `xstocks.mult.COSCx` [ok] 200 252ms https://api.backed.fi/api/v2/public/assets/COSCx/multiplier?network=Solana
- `xstocks.mult.PICCx` [ok] 200 2102ms https://api.backed.fi/api/v2/public/assets/PICCx/multiplier?network=Solana
- `xstocks.mult.HNDLDx` [ok] 200 3054ms https://api.backed.fi/api/v2/public/assets/HNDLDx/multiplier?network=Solana
