...
**Generated** 2026-09-11T05:06:14Z · 2026-09-10 22:06:14 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-11T05:06:03Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** ELEVATED — SOL 24h -2.09%; DEX 24h $2.95B · 1d -2% · vs-7d-ago +20%; slot 317 ms
...
- **INFO · Correlation: risk-off (SOL 24h ↓ + TVL 1d ↓ + DEX 1d ↓)** — SOL 24h -2.09%, DeFiLlama TVL 1d -1.29%, DEX 1d -1.73%. (threshold: `SOL 24h < 0 AND TVL 1d < 0 AND DEX 1d < 0`)
...
| Health | `ok` |
| Slot | 446,073,148 |
| Block height | 424,116,432 |
| Block time | 2026-09-11T05:06:03Z |
| Epoch | 1,032 (57.67% · slot 249,149/432,000) |
| Mean TPS (last ~3,600s) | 3,636.4 |
| Mean non-vote TPS | 1,510.2 |
| Median TPS (same window) | 3,639.2 |
| Mean slot time | 316.5 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 547,275,418,703 |
| Circulating supply | 586,537,721 SOL |
| Total supply | 633,830,286 SOL |
...
- `scs2Ra91…` · 58.59K SOL · commission 10% · lag 194066 slots
- `EWARp8Sy…` · 35.14K SOL · commission 5% · lag 2207 slots
- `mrgn4atx…` · 19.89K SOL · commission 0% · lag 17912 slots
- `AYY1TCe3…` · 10.81K SOL · commission 0% · lag 218991 slots
- `inWVrrYJ…` · 8.46K SOL · commission 0% · lag 374051 slots
- `xLabscif…` · 3.36K SOL · commission 5% · lag 2284775 slots
- `5ZjxMYBb…` · 3.21K SOL · commission 0% · lag 2107226 slots
- `pSoLoZx5…` · 1.51K SOL · commission 4% · lag 277986 slots
- `4GEEKSwu…` · 326.50 SOL · commission 5% · lag 263536 slots
- `stacheBm…` · 3.00 SOL · commission 5% · lag 16537465 slots
- `6mygxmZx…` · 2.00 SOL · commission 100% · lag 446073148 slots
- `Fb77sbwg…` · 1.08 SOL · commission 0% · lag 1234137 slots
...
| Jito tip-floor run-rate (NOT REV) | $38.17K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 38168 USD; at p95 floor → 374545 USD. |
...
24h volume $99.12M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-09-11 (2026-09-10 22:06:14 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 6833ms https://api.mainnet-beta.solana.com
...
- `llama.historical_tvl` [ok] 200 641ms https://api.llama.fi/v2/historicalChainTvl/Solana
...
- `rss.xcancel.solana_devs` [ok] 200 184ms https://xcancel.com/solana_devs/rss
- `rss.nitter.solana` [ok] 200 2576ms https://nitter.perennialte.ch/solana/rss
...
- `rss.nitter.solana_devs` [ok] 200 1912ms https://nitter.perennialte.ch/solana_devs/rss
...
- `xstocks.assets.p0` [FAIL]  15056ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0 — TimeoutError: The read operation timed out
- `xstocks.assets.p0` [FAIL]  15048ms https://api.xstocks.fi/api/v2/public/assets?pageSize=100&page=0 — TimeoutError: The read operation timed out
