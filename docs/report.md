...
**Generated** 2026-09-06T12:27:54Z · 2026-09-06 05:27:54 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-06T12:27:44Z · **RPC health** `ok`
**Health score** 98 / 100 — `25×rpc_ok + 30×clamp(1 − max(0, slot_ms − 300)/300, 0, 1) + 25×clamp(1 − delinquent_stake_pct/2, 0, 1) + 20×clamp(tps / tps_baseline, 0, 1)`
**Network health** HEALTHY · **Ecosystem** ELEVATED — SOL 24h +4.06%; DEX 24h $1.96B · 1d +4% · vs-7d-ago +17%; slot 317 ms
...
| Health | `ok` |
| Slot | 444,792,633 |
| Block height | 422,836,991 |
| Block time | 2026-09-06T12:27:44Z |
| Epoch | 1,029 (61.26% · slot 264,633/432,000) |
| Mean TPS (last ~3,600s) | 3,720.3 |
| Mean non-vote TPS | 1,598.0 |
| Median TPS (same window) | 3,729.1 |
| Mean slot time | 316.9 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 545,678,088,797 |
| Circulating supply | 585,445,161 SOL |
| Total supply | 633,549,037 SOL |
...
- `xLabscif…` · 28.57K SOL · commission 5% · lag 1004260 slots
- `mrgn4atx…` · 20.30K SOL · commission 0% · lag 28523 slots
- `prt1st4R…` · 13.11K SOL · commission 5% · lag 1305691 slots
- `E4xNK4Uw…` · 6.26K SOL · commission 5% · lag 1443910 slots
- `5ZjxMYBb…` · 4.06K SOL · commission 0% · lag 826711 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 2006512 slots
- `pSoLoZx5…` · 1.51K SOL · commission 4% · lag 253442 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 1353994 slots
- `CpdzCVza…` · 193.38 SOL · commission 100% · lag 1992282 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 2033796 slots
- `HFTcVVrX…` · 148.42 SOL · commission 100% · lag 1992176 slots
- `6pEtDovp…` · 131.86 SOL · commission 100% · lag 2006560 slots
...
| Jito tip-floor run-rate (NOT REV) | $31.89K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 31890 USD; at p95 floor → 283983 USD. |
...
| Metric | Value | Source |
| --- | ---: | --- |
| SOL/USD | $106.54 | coingecko.simple_price |
...
24h volume $57.38M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-09-06 (2026-09-06 05:27:54 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rss.nitter.solana_status` [ok] 200 1622ms https://nitter.perennialte.ch/solana_status/rss
...
- `rpc.getBlock.fallback` [ok] 200 284ms https://solana-rpc.publicnode.com
...
- `xstocks.assets.p0` [ok] 200 1064ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0
...
- `xstocks.circ.AAPLx` [ok] 200 637ms https://api.backed.fi/api/v2/public/assets/AAPLx/circulating-supply?format=object
- `xstocks.mult.NVDAx` [ok] 200 481ms https://api.backed.fi/api/v2/public/assets/NVDAx/multiplier?network=Solana
- `xstocks.circ.MSFTx` [ok] 200 697ms https://api.backed.fi/api/v2/public/assets/MSFTx/circulating-supply?format=object
...
- `xstocks.circ.DRAMx` [ok] 200 164ms https://api.backed.fi/api/v2/public/assets/DRAMx/circulating-supply?format=object
...
- `xstocks.mult.MVLLx` [ok] 200 694ms https://api.backed.fi/api/v2/public/assets/MVLLx/multiplier?network=Solana
- `xstocks.mult.KORUx` [ok] 200 272ms https://api.backed.fi/api/v2/public/assets/KORUx/multiplier?network=Solana
- `xstocks.mult.DJTx` [ok] 200 995ms https://api.backed.fi/api/v2/public/assets/DJTx/multiplier?network=Solana
...
- `xstocks.circ.SNXXx` [ok] 200 146ms https://api.backed.fi/api/v2/public/assets/SNXXx/circulating-supply?format=object
...
- `xstocks.mult.SHEINx` [ok] 200 199ms https://api.backed.fi/api/v2/public/assets/SHEINx/multiplier?network=Solana
...
- `xstocks.mult.NWGx` [ok] 200 449ms https://api.backed.fi/api/v2/public/assets/NWGx/multiplier?network=Solana
- `xstocks.circ.BANKCx` [ok] 200 112ms https://api.backed.fi/api/v2/public/assets/BANKCx/circulating-supply?format=object
- `xstocks.mult.SOXSx` [ok] 200 545ms https://api.backed.fi/api/v2/public/assets/SOXSx/multiplier?network=Solana
...
- `xstocks.price.MMGx` [FAIL]  12015ms https://api.backed.fi/api/v2/public/assets/MMGx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.MMGx` [ok] 200 673ms https://api.backed.fi/api/v2/public/assets/MMGx/circulating-supply?format=object
...
- `xstocks.circ.TNGYIx` [ok] 200 110ms https://api.backed.fi/api/v2/public/assets/TNGYIx/circulating-supply?format=object
- `xstocks.price.ZHAOMx` [FAIL]  12013ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.JDLOGx` [ok] 200 110ms https://api.backed.fi/api/v2/public/assets/JDLOGx/circulating-supply?format=object
- `xstocks.mult.TNGYIx` [ok] 200 741ms https://api.backed.fi/api/v2/public/assets/TNGYIx/multiplier?network=Solana
...
- `xstocks.circ.CTINSx` [ok] 200 429ms https://api.backed.fi/api/v2/public/assets/CTINSx/circulating-supply?format=object
...
- `xstocks.mult.KUNLx` [ok] 200 711ms https://api.backed.fi/api/v2/public/assets/KUNLx/multiplier?network=Solana
...
- `xstocks.circ.SMOIHx` [ok] 200 336ms https://api.backed.fi/api/v2/public/assets/SMOIHx/circulating-supply?format=object
...
- `xstocks.circ.CSPCx` [ok] 200 641ms https://api.backed.fi/api/v2/public/assets/CSPCx/circulating-supply?format=object
- `xstocks.mult.CSPCx` [ok] 200 767ms https://api.backed.fi/api/v2/public/assets/CSPCx/multiplier?network=Solana
- `xstocks.circ.CRESBx` [ok] 200 3068ms https://api.backed.fi/api/v2/public/assets/CRESBx/circulating-supply?format=object
- `xstocks.mult.CRESBx` [ok] 200 870ms https://api.backed.fi/api/v2/public/assets/CRESBx/multiplier?network=Solana
...
- `xstocks.circ.CRESMx` [ok] 200 386ms https://api.backed.fi/api/v2/public/assets/CRESMx/circulating-supply?format=object
...
- `xstocks.circ.WXXDCx` [ok] 200 1051ms https://api.backed.fi/api/v2/public/assets/WXXDCx/circulating-supply?format=object
...
- `xstocks.circ.BDWAPx` [ok] 200 888ms https://api.backed.fi/api/v2/public/assets/BDWAPx/circulating-supply?format=object
...
- `xstocks.circ.ASMPTx` [ok] 200 354ms https://api.backed.fi/api/v2/public/assets/ASMPTx/circulating-supply?format=object
- `xstocks.mult.ASMPTx` [ok] 200 1223ms https://api.backed.fi/api/v2/public/assets/ASMPTx/multiplier?network=Solana
...
- `xstocks.mult.WHRFRx` [ok] 200 607ms https://api.backed.fi/api/v2/public/assets/WHRFRx/multiplier?network=Solana
...
- `xstocks.price.SNDSCx` [FAIL]  12009ms https://api.backed.fi/api/v2/public/assets/SNDSCx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.SNDSCx` [ok] 200 826ms https://api.backed.fi/api/v2/public/assets/SNDSCx/circulating-supply?format=object
- `xstocks.mult.CRESPx` [ok] 200 586ms https://api.backed.fi/api/v2/public/assets/CRESPx/multiplier?network=Solana
- `xstocks.mult.SNDSCx` [ok] 200 760ms https://api.backed.fi/api/v2/public/assets/SNDSCx/multiplier?network=Solana
- `xstocks.mult.SINOTx` [ok] 200 1466ms https://api.backed.fi/api/v2/public/assets/SINOTx/multiplier?network=Solana
...
- `xstocks.mult.CTFJWx` [ok] 200 2531ms https://api.backed.fi/api/v2/public/assets/CTFJWx/multiplier?network=Solana
- `xstocks.mult.CLONPx` [ok] 200 2016ms https://api.backed.fi/api/v2/public/assets/CLONPx/multiplier?network=Solana
...
- `xstocks.price.SINOx` [FAIL]  12016ms https://api.backed.fi/api/v2/public/assets/SINOx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.PWAHLx` [ok] 200 900ms https://api.backed.fi/api/v2/public/assets/PWAHLx/multiplier?network=Solana
- `xstocks.circ.GENTEx` [ok] 200 147ms https://api.backed.fi/api/v2/public/assets/GENTEx/circulating-supply?format=object
- `xstocks.mult.SINOx` [ok] 200 2136ms https://api.backed.fi/api/v2/public/assets/SINOx/multiplier?network=Solana
- `xstocks.mult.GENTEx` [ok] 200 150ms https://api.backed.fi/api/v2/public/assets/GENTEx/multiplier?network=Solana
- `xstocks.mult.CLPHDx` [ok] 200 827ms https://api.backed.fi/api/v2/public/assets/CLPHDx/multiplier?network=Solana
...
- `xstocks.mult.WUXIBx` [ok] 200 1077ms https://api.backed.fi/api/v2/public/assets/WUXIBx/multiplier?network=Solana
...
- `xstocks.circ.KUAIx` [ok] 200 217ms https://api.backed.fi/api/v2/public/assets/KUAIx/circulating-supply?format=object
...
- `xstocks.mult.KUAIx` [ok] 200 504ms https://api.backed.fi/api/v2/public/assets/KUAIx/multiplier?network=Solana
- `xstocks.mult.SWPRPx` [ok] 200 2476ms https://api.backed.fi/api/v2/public/assets/SWPRPx/multiplier?network=Solana
- `xstocks.mult.CKINFx` [ok] 200 560ms https://api.backed.fi/api/v2/public/assets/CKINFx/multiplier?network=Solana
- `xstocks.mult.HKEXCx` [ok] 200 914ms https://api.backed.fi/api/v2/public/assets/HKEXCx/multiplier?network=Solana
- `xstocks.mult.HKCGAx` [ok] 200 1823ms https://api.backed.fi/api/v2/public/assets/HKCGAx/multiplier?network=Solana
...
- `xstocks.circ.NONGx` [ok] 200 637ms https://api.backed.fi/api/v2/public/assets/NONGx/circulating-supply?format=object
...
- `xstocks.circ.COVELx` [ok] 200 494ms https://api.backed.fi/api/v2/public/assets/COVELx/circulating-supply?format=object
...
- `xstocks.mult.GEELx` [ok] 200 1163ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
- `xstocks.mult.MEITx` [ok] 200 1909ms https://api.backed.fi/api/v2/public/assets/MEITx/multiplier?network=Solana
- `xstocks.circ.PICCx` [ok] 200 814ms https://api.backed.fi/api/v2/public/assets/PICCx/circulating-supply?format=object
...
- `xstocks.circ.COSCx` [ok] 200 542ms https://api.backed.fi/api/v2/public/assets/COSCx/circulating-supply?format=object
...
- `xstocks.mult.COSCx` [ok] 200 846ms https://api.backed.fi/api/v2/public/assets/COSCx/multiplier?network=Solana
- `xstocks.mult.CKHUTx` [ok] 200 1607ms https://api.backed.fi/api/v2/public/assets/CKHUTx/multiplier?network=Solana
