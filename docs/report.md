...
**Generated** 2026-08-29T15:48:44Z · 2026-08-29 08:48:44 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-29T15:48:33Z · **RPC health** `ok`
**Health score** 98 / 100 — `25×rpc_ok + 30×clamp(1 − max(0, slot_ms − 300)/300, 0, 1) + 25×clamp(1 − delinquent_stake_pct/2, 0, 1) + 20×clamp(tps / tps_baseline, 0, 1)`
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h -0.83%; DEX 24h $2.59B · 1d -30% · vs-7d-ago -28%; slot 317 ms
...
- **INFO · Correlation: risk-off (SOL 24h ↓ + TVL 1d ↓ + DEX 1d ↓)** — SOL 24h -0.83%, DeFiLlama TVL 1d -2.74%, DEX 1d -29.99%. (threshold: `SOL 24h < 0 AND TVL 1d < 0 AND DEX 1d < 0`)
...
| Health | `ok` |
| Slot | 442,644,548 |
| Block height | 420,692,422 |
| Block time | 2026-08-29T15:48:33Z |
| Epoch | 1,024 (64.02% · slot 276,548/432,000) |
| Mean TPS (last ~3,600s) | 3,862.4 |
| Mean non-vote TPS | 1,699.9 |
| Median TPS (same window) | 3,862.6 |
| Mean slot time | 316.9 ms |
| Median slot time | 317.5 ms |
| Transaction count (cluster) | 543,126,489,536 |
| Circulating supply | 584,161,460 SOL |
| Total supply | 633,079,001 SOL |
...
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1391869 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 297847 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 660794 slots
- `kom1oNHy…` · 662.86 SOL · commission 5% · lag 2008032 slots
- `7ZjHeeYE…` · 176.09 SOL · commission 5% · lag 42533 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442644548 slots
- `pSo1KZXg…` · 2.00 SOL · commission 4% · lag 306707 slots
- `7Dvp5zCF…` · 1.07 SOL · commission 100% · lag 465193 slots
- `bcZxRSoz…` · 0.00 SOL · commission 0% · lag 2004549 slots
...
| --- | ---: | --- |
| TPS chart | 111 | data/history.jsonl snapshot tape |
| TVL chart | 111 | data/history.jsonl snapshot tape |
| SOL chart | 110 | data/history.jsonl snapshot tape |
| history.jsonl rows | 111 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $89.63K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 89634 USD; at p95 floor → 828240 USD. |
...
24h volume $22.02M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-08-29 (2026-08-29 08:48:44 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rss.nitter.solana_status` [ok] 200 1809ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [ok] 200 1705ms https://nitter.perennialte.ch/anza_xyz/rss
- `rss.nitter.solana_devs` [ok] 200 2536ms https://nitter.perennialte.ch/solana_devs/rss
...
- `xstocks.assets.p3` [ok] 200 3930ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=3
...
- `xstocks.circ.METAx` [ok] 200 153ms https://api.backed.fi/api/v2/public/assets/METAx/circulating-supply?format=object
...
- `xstocks.mult.NVDAx` [ok] 200 126ms https://api.backed.fi/api/v2/public/assets/NVDAx/multiplier?network=Solana
- `xstocks.mult.AAPLx` [ok] 200 138ms https://api.backed.fi/api/v2/public/assets/AAPLx/multiplier?network=Solana
- `xstocks.circ.TSLAx` [ok] 200 326ms https://api.backed.fi/api/v2/public/assets/TSLAx/circulating-supply?format=object
...
- `xstocks.mult.MSFTx` [ok] 200 139ms https://api.backed.fi/api/v2/public/assets/MSFTx/multiplier?network=Solana
- `xstocks.mult.TSLAx` [ok] 200 371ms https://api.backed.fi/api/v2/public/assets/TSLAx/multiplier?network=Solana
- `xstocks.mult.AMZNx` [ok] 200 619ms https://api.backed.fi/api/v2/public/assets/AMZNx/multiplier?network=Solana
...
- `xstocks.mult.QQQx` [ok] 200 405ms https://api.backed.fi/api/v2/public/assets/QQQx/multiplier?network=Solana
...
- `xstocks.mult.COINx` [ok] 200 716ms https://api.backed.fi/api/v2/public/assets/COINx/multiplier?network=Solana
- `xstocks.circ.LAOPGx` [ok] 200 533ms https://api.backed.fi/api/v2/public/assets/LAOPGx/circulating-supply?format=object
...
- `xstocks.mult.BANKCx` [ok] 200 141ms https://api.backed.fi/api/v2/public/assets/BANKCx/multiplier?network=Solana
...
- `xstocks.mult.JDLOGx` [ok] 200 119ms https://api.backed.fi/api/v2/public/assets/JDLOGx/multiplier?network=Solana
...
- `xstocks.mult.SNBIOx` [ok] 200 129ms https://api.backed.fi/api/v2/public/assets/SNBIOx/multiplier?network=Solana
...
- `xstocks.mult.SZIGHx` [ok] 200 122ms https://api.backed.fi/api/v2/public/assets/SZIGHx/multiplier?network=Solana
- `xstocks.mult.CTINSx` [ok] 200 828ms https://api.backed.fi/api/v2/public/assets/CTINSx/multiplier?network=Solana
- `xstocks.circ.ENNHLx` [ok] 200 349ms https://api.backed.fi/api/v2/public/assets/ENNHLx/circulating-supply?format=object
- `xstocks.mult.WRFHDx` [ok] 200 1028ms https://api.backed.fi/api/v2/public/assets/WRFHDx/multiplier?network=Solana
...
- `xstocks.mult.JTGEXx` [ok] 200 467ms https://api.backed.fi/api/v2/public/assets/JTGEXx/multiplier?network=Solana
- `xstocks.mult.WXXDCx` [ok] 200 302ms https://api.backed.fi/api/v2/public/assets/WXXDCx/multiplier?network=Solana
...
- `xstocks.mult.HRZRBx` [ok] 200 1375ms https://api.backed.fi/api/v2/public/assets/HRZRBx/multiplier?network=Solana
...
- `xstocks.circ.CMENDx` [ok] 200 375ms https://api.backed.fi/api/v2/public/assets/CMENDx/circulating-supply?format=object
...
- `xstocks.circ.MIXUx` [ok] 200 1522ms https://api.backed.fi/api/v2/public/assets/MIXUx/circulating-supply?format=object
...
- `xstocks.circ.SITCx` [ok] 200 1146ms https://api.backed.fi/api/v2/public/assets/SITCx/circulating-supply?format=object
- `xstocks.circ.SNDSCx` [ok] 200 1210ms https://api.backed.fi/api/v2/public/assets/SNDSCx/circulating-supply?format=object
- `xstocks.mult.SNDSCx` [ok] 200 134ms https://api.backed.fi/api/v2/public/assets/SNDSCx/multiplier?network=Solana
- `xstocks.mult.ASMPTx` [ok] 200 921ms https://api.backed.fi/api/v2/public/assets/ASMPTx/multiplier?network=Solana
- `xstocks.mult.SITCx` [ok] 200 830ms https://api.backed.fi/api/v2/public/assets/SITCx/multiplier?network=Solana
...
- `xstocks.circ.PRADx` [ok] 200 1424ms https://api.backed.fi/api/v2/public/assets/PRADx/circulating-supply?format=object
...
- `xstocks.circ.CLONPx` [ok] 200 448ms https://api.backed.fi/api/v2/public/assets/CLONPx/circulating-supply?format=object
...
- `xstocks.circ.CTFJWx` [ok] 200 1243ms https://api.backed.fi/api/v2/public/assets/CTFJWx/circulating-supply?format=object
...
- `xstocks.circ.SINOx` [ok] 200 1173ms https://api.backed.fi/api/v2/public/assets/SINOx/circulating-supply?format=object
...
- `xstocks.mult.CLPHDx` [ok] 200 602ms https://api.backed.fi/api/v2/public/assets/CLPHDx/multiplier?network=Solana
...
- `xstocks.circ.GENTEx` [ok] 200 1151ms https://api.backed.fi/api/v2/public/assets/GENTEx/circulating-supply?format=object
...
- `xstocks.circ.SWPRPx` [ok] 200 900ms https://api.backed.fi/api/v2/public/assets/SWPRPx/circulating-supply?format=object
...
- `xstocks.price.HKCGAx` [FAIL]  12013ms https://api.backed.fi/api/v2/public/assets/HKCGAx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.HKEXCx` [ok] 200 419ms https://api.backed.fi/api/v2/public/assets/HKEXCx/multiplier?network=Solana
...
- `xstocks.mult.CHONGx` [ok] 200 156ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
- `xstocks.circ.GEELx` [ok] 200 115ms https://api.backed.fi/api/v2/public/assets/GEELx/circulating-supply?format=object
- `xstocks.circ.NONGx` [ok] 200 1270ms https://api.backed.fi/api/v2/public/assets/NONGx/circulating-supply?format=object
- `xstocks.mult.GEELx` [ok] 200 189ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
- `xstocks.mult.NONGx` [ok] 200 252ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
...
- `xstocks.mult.MTRCPx` [ok] 200 159ms https://api.backed.fi/api/v2/public/assets/MTRCPx/multiplier?network=Solana
...
- `xstocks.circ.HNDLDx` [ok] 200 1196ms https://api.backed.fi/api/v2/public/assets/HNDLDx/circulating-supply?format=object
...
- `xstocks.mult.BOCOMx` [ok] 200 170ms https://api.backed.fi/api/v2/public/assets/BOCOMx/multiplier?network=Solana
...
- `xstocks.circ.CKHUTx` [ok] 200 1358ms https://api.backed.fi/api/v2/public/assets/CKHUTx/circulating-supply?format=object
...
- `xstocks.circ.BOCHKx` [ok] 200 608ms https://api.backed.fi/api/v2/public/assets/BOCHKx/circulating-supply?format=object
...
- `xstocks.mult.ANTASx` [ok] 200 195ms https://api.backed.fi/api/v2/public/assets/ANTASx/multiplier?network=Solana
- `xstocks.price.HAIERx` [FAIL]  12013ms https://api.backed.fi/api/v2/public/assets/HAIERx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.CITICx` [ok] 200 1353ms https://api.backed.fi/api/v2/public/assets/CITICx/circulating-supply?format=object
- `xstocks.mult.CITICx` [ok] 200 117ms https://api.backed.fi/api/v2/public/assets/CITICx/multiplier?network=Solana
...
- `xstocks.circ.ICBCx` [ok] 200 128ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
- `xstocks.circ.CRESLx` [ok] 200 1257ms https://api.backed.fi/api/v2/public/assets/CRESLx/circulating-supply?format=object
- `xstocks.mult.ICBCx` [ok] 200 200ms https://api.backed.fi/api/v2/public/assets/ICBCx/multiplier?network=Solana
- `xstocks.mult.CRESLx` [ok] 200 120ms https://api.backed.fi/api/v2/public/assets/CRESLx/multiplier?network=Solana
- `xstocks.mult.PSBOCx` [ok] 200 703ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
- `llama.protocol.xstocks` [ok] 200 1077ms https://api.llama.fi/protocol/xstocks
- `jup.tokens.search.xStock` [ok] 200 457ms https://lite-api.jup.ag/tokens/v2/search?query=xStock
- `jup.tokens.search.SUOPTx` [ok] 200 66ms https://lite-api.jup.ag/tokens/v2/search?query=SUOPTx
...
- `jup.tokens.search.JDLOGx` [ok] 200 42ms https://lite-api.jup.ag/tokens/v2/search?query=JDLOGx
- `jup.tokens.search.HAIDLx` [ok] 200 41ms https://lite-api.jup.ag/tokens/v2/search?query=HAIDLx
