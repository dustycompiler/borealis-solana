...
**Generated** 2026-09-05T18:51:16Z · 2026-09-05 11:51:16 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-05T18:51:05Z · **RPC health** `ok`
...
| Health | `ok` |
| Slot | 444,592,109 |
| Block height | 422,636,527 |
| Block time | 2026-09-05T18:51:05Z |
| Epoch | 1,029 (14.84% · slot 64,109/432,000) |
| Mean TPS (last ~3,600s) | 3,497.2 |
| Mean non-vote TPS | 1,370.5 |
| Median TPS (same window) | 3,459.6 |
| Mean slot time | 315.6 ms |
| Median slot time | 314.1 ms |
| Transaction count (cluster) | 545,458,048,415 |
| Circulating supply | 585,445,743 SOL |
| Total supply | 633,549,618 SOL |
...
- `xLabscif…` · 28.57K SOL · commission 5% · lag 803736 slots
- `mrgn4atx…` · 20.30K SOL · commission 0% · lag 33070 slots
- `prt1st4R…` · 13.11K SOL · commission 5% · lag 1105167 slots
- `E4xNK4Uw…` · 6.26K SOL · commission 5% · lag 1243386 slots
- `5ZjxMYBb…` · 4.06K SOL · commission 0% · lag 626187 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 1805988 slots
- `pSoLoZx5…` · 1.51K SOL · commission 4% · lag 52918 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 1153470 slots
- `CpdzCVza…` · 193.38 SOL · commission 100% · lag 1791758 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 1833272 slots
- `HFTcVVrX…` · 148.42 SOL · commission 100% · lag 1791652 slots
- `6pEtDovp…` · 131.86 SOL · commission 100% · lag 1806036 slots
...
| Jito tip-floor run-rate (NOT REV) | $24.59K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 24587 USD; at p95 floor → 1273560 USD. |
...
| p90 / p99 | 0.000010 / 0.000066 SOL | same sample |
...
24h volume $15.71M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-09-05 (2026-09-05 11:51:16 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 7156ms https://api.mainnet-beta.solana.com
...
- `rss.nitter.solana_status` [ok] 200 1299ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [ok] 200 1545ms https://nitter.perennialte.ch/anza_xyz/rss
- `rss.nitter.solana_devs` [ok] 200 788ms https://nitter.perennialte.ch/solana_devs/rss
...
- `rpc.getBlock.fallback` [ok] 200 392ms https://solana-rpc.publicnode.com
...
- `xstocks.assets.p0` [ok] 200 3554ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0
- `xstocks.assets.p1` [ok] 200 1465ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=1
- `xstocks.assets.p2` [ok] 200 2302ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=2
- `xstocks.assets.p3` [ok] 200 1424ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=3
- `xstocks.assets.p4` [ok] 200 2438ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=4
- `xstocks.assets.p5` [ok] 200 4339ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=5
- `xstocks.assets.p6` [ok] 200 1767ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=6
- `xstocks.assets.p7` [ok] 200 980ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=7
...
- `xstocks.circ.AMZNx` [ok] 200 451ms https://api.backed.fi/api/v2/public/assets/AMZNx/circulating-supply?format=object
...
- `xstocks.circ.AAPLx` [ok] 200 1005ms https://api.backed.fi/api/v2/public/assets/AAPLx/circulating-supply?format=object
- `xstocks.circ.MSFTx` [ok] 200 1038ms https://api.backed.fi/api/v2/public/assets/MSFTx/circulating-supply?format=object
...
- `xstocks.mult.NVDAx` [ok] 200 1243ms https://api.backed.fi/api/v2/public/assets/NVDAx/multiplier?network=Solana
- `xstocks.circ.METAx` [ok] 200 3681ms https://api.backed.fi/api/v2/public/assets/METAx/circulating-supply?format=object
...
- `xstocks.circ.QQQx` [ok] 200 1130ms https://api.backed.fi/api/v2/public/assets/QQQx/circulating-supply?format=object
- `xstocks.circ.MUUx` [ok] 200 541ms https://api.backed.fi/api/v2/public/assets/MUUx/circulating-supply?format=object
...
- `xstocks.mult.MUUx` [ok] 200 349ms https://api.backed.fi/api/v2/public/assets/MUUx/multiplier?network=Solana
...
- `xstocks.mult.MVLLx` [ok] 200 2104ms https://api.backed.fi/api/v2/public/assets/MVLLx/multiplier?network=Solana
...
- `xstocks.mult.AXTIx` [ok] 200 2692ms https://api.backed.fi/api/v2/public/assets/AXTIx/multiplier?network=Solana
- `xstocks.mult.KORUx` [ok] 200 152ms https://api.backed.fi/api/v2/public/assets/KORUx/multiplier?network=Solana
- `xstocks.circ.DRAMx` [ok] 200 3987ms https://api.backed.fi/api/v2/public/assets/DRAMx/circulating-supply?format=object
- `xstocks.mult.DRAMx` [ok] 200 1591ms https://api.backed.fi/api/v2/public/assets/DRAMx/multiplier?network=Solana
...
- `xstocks.circ.SNXXx` [ok] 200 624ms https://api.backed.fi/api/v2/public/assets/SNXXx/circulating-supply?format=object
...
- `xstocks.mult.SNXXx` [ok] 200 239ms https://api.backed.fi/api/v2/public/assets/SNXXx/multiplier?network=Solana
- `xstocks.circ.INTWx` [ok] 200 1664ms https://api.backed.fi/api/v2/public/assets/INTWx/circulating-supply?format=object
- `xstocks.circ.SHEINx` [ok] 200 315ms https://api.backed.fi/api/v2/public/assets/SHEINx/circulating-supply?format=object
...
- `xstocks.circ.SOXSx` [ok] 200 1207ms https://api.backed.fi/api/v2/public/assets/SOXSx/circulating-supply?format=object
...
- `xstocks.circ.BANKCx` [ok] 200 324ms https://api.backed.fi/api/v2/public/assets/BANKCx/circulating-supply?format=object
...
- `xstocks.mult.INTWx` [ok] 200 1848ms https://api.backed.fi/api/v2/public/assets/INTWx/multiplier?network=Solana
- `xstocks.mult.NWGx` [ok] 200 1918ms https://api.backed.fi/api/v2/public/assets/NWGx/multiplier?network=Solana
...
- `xstocks.mult.TNGYIx` [ok] 200 478ms https://api.backed.fi/api/v2/public/assets/TNGYIx/multiplier?network=Solana
- `xstocks.circ.LAOPGx` [ok] 200 164ms https://api.backed.fi/api/v2/public/assets/LAOPGx/circulating-supply?format=object
...
- `xstocks.mult.LAOPGx` [ok] 200 1508ms https://api.backed.fi/api/v2/public/assets/LAOPGx/multiplier?network=Solana
...
- `xstocks.mult.JDLOGx` [ok] 200 1275ms https://api.backed.fi/api/v2/public/assets/JDLOGx/multiplier?network=Solana
- `xstocks.circ.WRFHDx` [ok] 200 1171ms https://api.backed.fi/api/v2/public/assets/WRFHDx/circulating-supply?format=object
...
- `xstocks.circ.SNBIOx` [ok] 200 549ms https://api.backed.fi/api/v2/public/assets/SNBIOx/circulating-supply?format=object
...
- `xstocks.mult.SZIGHx` [ok] 200 535ms https://api.backed.fi/api/v2/public/assets/SZIGHx/multiplier?network=Solana
...
- `xstocks.circ.HRZRBx` [ok] 200 683ms https://api.backed.fi/api/v2/public/assets/HRZRBx/circulating-supply?format=object
...
- `xstocks.mult.ENNHLx` [ok] 200 1901ms https://api.backed.fi/api/v2/public/assets/ENNHLx/multiplier?network=Solana
- `xstocks.mult.SMOIHx` [ok] 200 1677ms https://api.backed.fi/api/v2/public/assets/SMOIHx/multiplier?network=Solana
...
- `xstocks.circ.CRESMx` [ok] 200 429ms https://api.backed.fi/api/v2/public/assets/CRESMx/circulating-supply?format=object
...
- `xstocks.circ.WXXDCx` [ok] 200 317ms https://api.backed.fi/api/v2/public/assets/WXXDCx/circulating-supply?format=object
...
- `xstocks.mult.ASMPTx` [ok] 200 677ms https://api.backed.fi/api/v2/public/assets/ASMPTx/multiplier?network=Solana
...
- `xstocks.circ.WHRFRx` [ok] 200 220ms https://api.backed.fi/api/v2/public/assets/WHRFRx/circulating-supply?format=object
- `xstocks.mult.WHRFRx` [ok] 200 405ms https://api.backed.fi/api/v2/public/assets/WHRFRx/multiplier?network=Solana
...
- `xstocks.circ.JDHLTx` [ok] 200 399ms https://api.backed.fi/api/v2/public/assets/JDHLTx/circulating-supply?format=object
...
- `xstocks.mult.SNDSCx` [ok] 200 387ms https://api.backed.fi/api/v2/public/assets/SNDSCx/multiplier?network=Solana
...
- `xstocks.circ.CLONPx` [ok] 200 137ms https://api.backed.fi/api/v2/public/assets/CLONPx/circulating-supply?format=object
- `xstocks.mult.CLONPx` [ok] 200 316ms https://api.backed.fi/api/v2/public/assets/CLONPx/multiplier?network=Solana
...
- `xstocks.circ.SINOx` [ok] 200 697ms https://api.backed.fi/api/v2/public/assets/SINOx/circulating-supply?format=object
...
- `xstocks.mult.SINOx` [ok] 200 1292ms https://api.backed.fi/api/v2/public/assets/SINOx/multiplier?network=Solana
...
- `xstocks.circ.CRAUTx` [ok] 200 1127ms https://api.backed.fi/api/v2/public/assets/CRAUTx/circulating-supply?format=object
...
- `xstocks.mult.PWAHLx` [ok] 200 1988ms https://api.backed.fi/api/v2/public/assets/PWAHLx/multiplier?network=Solana
- `xstocks.mult.WUXIBx` [ok] 200 1367ms https://api.backed.fi/api/v2/public/assets/WUXIBx/multiplier?network=Solana
...
- `xstocks.circ.SWPRPx` [ok] 200 2954ms https://api.backed.fi/api/v2/public/assets/SWPRPx/circulating-supply?format=object
- `xstocks.circ.KUAIx` [ok] 200 251ms https://api.backed.fi/api/v2/public/assets/KUAIx/circulating-supply?format=object
- `xstocks.circ.CKINFx` [ok] 200 1234ms https://api.backed.fi/api/v2/public/assets/CKINFx/circulating-supply?format=object
- `xstocks.mult.SWPRPx` [ok] 200 431ms https://api.backed.fi/api/v2/public/assets/SWPRPx/multiplier?network=Solana
- `xstocks.mult.KUAIx` [ok] 200 805ms https://api.backed.fi/api/v2/public/assets/KUAIx/multiplier?network=Solana
...
- `xstocks.mult.HKCGAx` [ok] 200 1433ms https://api.backed.fi/api/v2/public/assets/HKCGAx/multiplier?network=Solana
- `xstocks.circ.HKEXCx` [ok] 200 492ms https://api.backed.fi/api/v2/public/assets/HKEXCx/circulating-supply?format=object
- `xstocks.circ.NONGx` [ok] 200 694ms https://api.backed.fi/api/v2/public/assets/NONGx/circulating-supply?format=object
- `xstocks.mult.NONGx` [ok] 200 241ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
- `xstocks.mult.HKEXCx` [ok] 200 728ms https://api.backed.fi/api/v2/public/assets/HKEXCx/multiplier?network=Solana
...
- `xstocks.circ.COVELx` [ok] 200 839ms https://api.backed.fi/api/v2/public/assets/COVELx/circulating-supply?format=object
...
- `xstocks.circ.HNDLDx` [ok] 200 285ms https://api.backed.fi/api/v2/public/assets/HNDLDx/circulating-supply?format=object
...
- `xstocks.circ.GEELx` [ok] 200 802ms https://api.backed.fi/api/v2/public/assets/GEELx/circulating-supply?format=object
...
- `xstocks.mult.MTRCPx` [ok] 200 650ms https://api.backed.fi/api/v2/public/assets/MTRCPx/multiplier?network=Solana
- `xstocks.mult.PICCx` [ok] 200 429ms https://api.backed.fi/api/v2/public/assets/PICCx/multiplier?network=Solana
- `xstocks.circ.COSCx` [ok] 200 312ms https://api.backed.fi/api/v2/public/assets/COSCx/circulating-supply?format=object
...
- `jup.tokens.search.DJTx` [ok] 200 58ms https://lite-api.jup.ag/tokens/v2/search?query=DJTx
