...
**Generated** 2026-08-29T13:18:35Z · 2026-08-29 06:18:35 PT
**Author** dustycompiler · **Version** 1.5.6 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-29T13:18:23Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h -1.15%; DEX 24h $2.59B · 1d -30% · vs-7d-ago -28%; slot 317 ms
...
- **WARN · SOL price vs 30d median (solana.com/data)** — Current 103.73 USD is +36.5% vs 30d median 76.00 USD (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
- **INFO · Correlation: risk-off (SOL 24h ↓ + TVL 1d ↓ + DEX 1d ↓)** — SOL 24h -1.15%, DeFiLlama TVL 1d -2.83%, DEX 1d -29.99%. (threshold: `SOL 24h < 0 AND TVL 1d < 0 AND DEX 1d < 0`)
...
| Health | `ok` |
| Slot | 442,616,137 |
| Block height | 420,664,027 |
| Block time | 2026-08-29T13:18:23Z |
| Epoch | 1,024 (57.44% · slot 248,137/432,000) |
| Mean TPS (last ~3,600s) | 3,677.6 |
| Mean non-vote TPS | 1,516.8 |
| Median TPS (same window) | 3,659.7 |
| Mean slot time | 316.9 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 543,091,758,714 |
| Circulating supply | 584,161,552 SOL |
| Total supply | 633,079,092 SOL |
...
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1363458 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 269436 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 632383 slots
- `kom1oNHy…` · 662.86 SOL · commission 5% · lag 1979621 slots
- `7ZjHeeYE…` · 176.09 SOL · commission 5% · lag 14122 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442616137 slots
- `pSo1KZXg…` · 2.00 SOL · commission 4% · lag 278296 slots
- `7Dvp5zCF…` · 1.07 SOL · commission 100% · lag 436782 slots
- `bcZxRSoz…` · 0.00 SOL · commission 0% · lag 1976138 slots
...
| --- | ---: | --- |
| TPS chart | 100 | data/history.jsonl snapshot tape |
| TVL chart | 100 | data/history.jsonl snapshot tape |
| SOL chart | 99 | data/history.jsonl snapshot tape |
| history.jsonl rows | 100 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $135.94K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 135942 USD; at p95 floor → 1321383 USD. |
...
_As of 2026-08-29 (2026-08-29 06:18:35 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rss.nitter.solana` [ok] 200 1995ms https://nitter.perennialte.ch/solana/rss
- `rss.nitter.solana_status` [ok] 200 1372ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [ok] 200 2112ms https://nitter.perennialte.ch/anza_xyz/rss
...
- `xstocks.assets.p3` [ok] 200 1409ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=3
- `xstocks.assets.p4` [ok] 200 1892ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=4
- `xstocks.assets.p5` [ok] 200 1319ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=5
- `xstocks.assets.p6` [ok] 200 1974ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=6
- `xstocks.assets.p7` [ok] 200 370ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=7
...
- `xstocks.mult.MMGx` [ok] 200 397ms https://api.backed.fi/api/v2/public/assets/MMGx/multiplier?network=Solana
- `xstocks.circ.LAOPGx` [ok] 200 857ms https://api.backed.fi/api/v2/public/assets/LAOPGx/circulating-supply?format=object
...
- `xstocks.mult.TNGYIx` [ok] 200 1324ms https://api.backed.fi/api/v2/public/assets/TNGYIx/multiplier?network=Solana
...
- `xstocks.mult.WRFHDx` [ok] 200 271ms https://api.backed.fi/api/v2/public/assets/WRFHDx/multiplier?network=Solana
...
- `xstocks.circ.CTINSx` [ok] 200 1071ms https://api.backed.fi/api/v2/public/assets/CTINSx/circulating-supply?format=object
...
- `xstocks.mult.CTINSx` [ok] 200 123ms https://api.backed.fi/api/v2/public/assets/CTINSx/multiplier?network=Solana
...
- `xstocks.circ.HRZRBx` [ok] 200 977ms https://api.backed.fi/api/v2/public/assets/HRZRBx/circulating-supply?format=object
...
- `xstocks.circ.WXXDCx` [ok] 200 1199ms https://api.backed.fi/api/v2/public/assets/WXXDCx/circulating-supply?format=object
...
- `xstocks.circ.CMENDx` [ok] 200 1153ms https://api.backed.fi/api/v2/public/assets/CMENDx/circulating-supply?format=object
...
- `xstocks.mult.ASMPTx` [ok] 200 563ms https://api.backed.fi/api/v2/public/assets/ASMPTx/multiplier?network=Solana
...
- `xstocks.circ.JDHLTx` [ok] 200 1054ms https://api.backed.fi/api/v2/public/assets/JDHLTx/circulating-supply?format=object
...
- `xstocks.mult.MIXUx` [ok] 200 618ms https://api.backed.fi/api/v2/public/assets/MIXUx/multiplier?network=Solana
- `xstocks.circ.SNDSCx` [ok] 200 574ms https://api.backed.fi/api/v2/public/assets/SNDSCx/circulating-supply?format=object
- `xstocks.mult.WHRFRx` [ok] 200 961ms https://api.backed.fi/api/v2/public/assets/WHRFRx/multiplier?network=Solana
...
- `xstocks.mult.CRESPx` [ok] 200 1401ms https://api.backed.fi/api/v2/public/assets/CRESPx/multiplier?network=Solana
...
- `xstocks.mult.WHGROx` [ok] 200 137ms https://api.backed.fi/api/v2/public/assets/WHGROx/multiplier?network=Solana
...
- `xstocks.mult.SINOTx` [ok] 200 2303ms https://api.backed.fi/api/v2/public/assets/SINOTx/multiplier?network=Solana
- `xstocks.circ.CTPCAx` [ok] 200 680ms https://api.backed.fi/api/v2/public/assets/CTPCAx/circulating-supply?format=object
...
- `xstocks.circ.CRAUTx` [ok] 200 378ms https://api.backed.fi/api/v2/public/assets/CRAUTx/circulating-supply?format=object
- `xstocks.mult.WUXIBx` [ok] 200 230ms https://api.backed.fi/api/v2/public/assets/WUXIBx/multiplier?network=Solana
- `xstocks.mult.CLPHDx` [ok] 200 664ms https://api.backed.fi/api/v2/public/assets/CLPHDx/multiplier?network=Solana
...
- `xstocks.mult.CRAUTx` [ok] 200 594ms https://api.backed.fi/api/v2/public/assets/CRAUTx/multiplier?network=Solana
...
- `xstocks.circ.SWPRPx` [ok] 200 782ms https://api.backed.fi/api/v2/public/assets/SWPRPx/circulating-supply?format=object
- `xstocks.mult.CKAHx` [ok] 200 295ms https://api.backed.fi/api/v2/public/assets/CKAHx/multiplier?network=Solana
- `xstocks.mult.SWPRPx` [ok] 200 142ms https://api.backed.fi/api/v2/public/assets/SWPRPx/multiplier?network=Solana
- `xstocks.mult.CKINFx` [ok] 200 774ms https://api.backed.fi/api/v2/public/assets/CKINFx/multiplier?network=Solana
...
- `xstocks.circ.KUAIx` [ok] 200 611ms https://api.backed.fi/api/v2/public/assets/KUAIx/circulating-supply?format=object
- `xstocks.mult.NONGx` [ok] 200 275ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
- `xstocks.mult.HKEXCx` [ok] 200 350ms https://api.backed.fi/api/v2/public/assets/HKEXCx/multiplier?network=Solana
...
- `xstocks.price.CHONGx` [FAIL]  12025ms https://api.backed.fi/api/v2/public/assets/CHONGx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.COVELx` [ok] 200 968ms https://api.backed.fi/api/v2/public/assets/COVELx/multiplier?network=Solana
...
- `xstocks.mult.CHONGx` [ok] 200 136ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
- `xstocks.mult.GEELx` [ok] 200 502ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
...
- `xstocks.price.COSCx` [FAIL]  12009ms https://api.backed.fi/api/v2/public/assets/COSCx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.HNDLDx` [ok] 200 906ms https://api.backed.fi/api/v2/public/assets/HNDLDx/circulating-supply?format=object
- `xstocks.mult.PICCx` [ok] 200 610ms https://api.backed.fi/api/v2/public/assets/PICCx/multiplier?network=Solana
- `xstocks.price.CKHUTx` [FAIL]  12011ms https://api.backed.fi/api/v2/public/assets/CKHUTx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.HNDLDx` [ok] 200 520ms https://api.backed.fi/api/v2/public/assets/HNDLDx/multiplier?network=Solana
...
- `xstocks.circ.BOCOMx` [ok] 200 117ms https://api.backed.fi/api/v2/public/assets/BOCOMx/circulating-supply?format=object
- `xstocks.mult.BOCOMx` [ok] 200 195ms https://api.backed.fi/api/v2/public/assets/BOCOMx/multiplier?network=Solana
- `xstocks.price.CPETCx` [FAIL]  12016ms https://api.backed.fi/api/v2/public/assets/CPETCx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.CPETCx` [ok] 200 196ms https://api.backed.fi/api/v2/public/assets/CPETCx/circulating-supply?format=object
- `xstocks.mult.CPETCx` [ok] 200 437ms https://api.backed.fi/api/v2/public/assets/CPETCx/multiplier?network=Solana
- `xstocks.mult.POPMTx` [ok] 200 2004ms https://api.backed.fi/api/v2/public/assets/POPMTx/multiplier?network=Solana
...
- `xstocks.circ.BOCHKx` [ok] 200 496ms https://api.backed.fi/api/v2/public/assets/BOCHKx/circulating-supply?format=object
- `xstocks.mult.BOCHKx` [ok] 200 180ms https://api.backed.fi/api/v2/public/assets/BOCHKx/multiplier?network=Solana
...
- `xstocks.circ.CITICx` [ok] 200 330ms https://api.backed.fi/api/v2/public/assets/CITICx/circulating-supply?format=object
...
- `xstocks.circ.ANTASx` [ok] 200 741ms https://api.backed.fi/api/v2/public/assets/ANTASx/circulating-supply?format=object
...
- `xstocks.circ.CRESLx` [ok] 200 477ms https://api.backed.fi/api/v2/public/assets/CRESLx/circulating-supply?format=object
- `xstocks.mult.ANTASx` [ok] 200 267ms https://api.backed.fi/api/v2/public/assets/ANTASx/multiplier?network=Solana
- `xstocks.mult.HAIERx` [ok] 200 144ms https://api.backed.fi/api/v2/public/assets/HAIERx/multiplier?network=Solana
- `xstocks.circ.ZJGLDx` [ok] 200 459ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/circulating-supply?format=object
...
- `xstocks.mult.ZJGLDx` [ok] 200 350ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/multiplier?network=Solana
- `xstocks.circ.PSBOCx` [ok] 200 115ms https://api.backed.fi/api/v2/public/assets/PSBOCx/circulating-supply?format=object
- `xstocks.mult.PSBOCx` [ok] 200 459ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
...
- `xstocks.mult.ICBCx` [ok] 200 1416ms https://api.backed.fi/api/v2/public/assets/ICBCx/multiplier?network=Solana
- `xstocks.mult.CRESLx` [ok] 200 3732ms https://api.backed.fi/api/v2/public/assets/CRESLx/multiplier?network=Solana
- `llama.protocol.xstocks` [ok] 200 2391ms https://api.llama.fi/protocol/xstocks
...
- `jup.tokens.search.LAOPGx` [ok] 200 42ms https://lite-api.jup.ag/tokens/v2/search?query=LAOPGx
- `jup.tokens.search.TNGYIx` [ok] 200 41ms https://lite-api.jup.ag/tokens/v2/search?query=TNGYIx
- `jup.tokens.search.JDLOGx` [ok] 200 38ms https://lite-api.jup.ag/tokens/v2/search?query=JDLOGx
