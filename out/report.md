...
| Metric | Value | Source |
| --- | ---: | --- |
| REV proxy | $14.49M | DeFiLlama Solana fees 24h (REV proxy) |
| Network fees (24h) | 9,162.1 SOL | solana.com/data Fees (Allium) |
...
Borealis 1.1.0 · MIT · author `dustycompiler` · regenerate with `python3 generate.py`
