...
**Generated** 2026-09-05T17:34:23Z · 2026-09-05 10:34:23 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-05T17:34:13Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h +2.58%; DEX 24h $1.88B · 1d -24% · vs-7d-ago -27%; slot 316 ms
...
| Health | `ok` |
| Slot | 444,577,479 |
| Block height | 422,621,927 |
| Block time | 2026-09-05T17:34:13Z |
| Epoch | 1,029 (11.45% · slot 49,481/432,000) |
| Mean TPS (last ~3,600s) | 3,571.3 |
| Mean non-vote TPS | 1,445.7 |
| Median TPS (same window) | 3,576.5 |
| Mean slot time | 316.5 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 545,441,931,265 |
| Circulating supply | 585,445,786 SOL |
| Total supply | 633,549,661 SOL |
...
- `xLabscif…` · 28.57K SOL · commission 5% · lag 789106 slots
- `mrgn4atx…` · 20.30K SOL · commission 0% · lag 18440 slots
- `prt1st4R…` · 13.11K SOL · commission 5% · lag 1090537 slots
- `E4xNK4Uw…` · 6.26K SOL · commission 5% · lag 1228756 slots
- `5ZjxMYBb…` · 4.06K SOL · commission 0% · lag 611557 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 1791358 slots
- `pSoLoZx5…` · 1.51K SOL · commission 4% · lag 38288 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 1138840 slots
- `CpdzCVza…` · 193.38 SOL · commission 100% · lag 1777128 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 1818642 slots
- `HFTcVVrX…` · 148.42 SOL · commission 100% · lag 1777022 slots
- `6pEtDovp…` · 131.86 SOL · commission 100% · lag 1791406 slots
...
| Jito tip-floor run-rate (NOT REV) | $38.99K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 38991 USD; at p95 floor → 696932 USD. |
...
24h volume $15.54M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-09-05 (2026-09-05 10:34:23 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 7032ms https://api.mainnet-beta.solana.com
...
- `llama.stablecoinchains` [ok] 200 448ms https://stablecoins.llama.fi/stablecoinchains
...
- `rss.nitter.solana` [ok] 200 1609ms https://nitter.perennialte.ch/solana/rss
...
- `xstocks.assets.p6` [ok] 200 1991ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=6
...
- `xstocks.circ.TSLAx` [ok] 200 339ms https://api.backed.fi/api/v2/public/assets/TSLAx/circulating-supply?format=object
...
- `xstocks.circ.AMZNx` [ok] 200 469ms https://api.backed.fi/api/v2/public/assets/AMZNx/circulating-supply?format=object
...
- `xstocks.mult.AMZNx` [ok] 200 579ms https://api.backed.fi/api/v2/public/assets/AMZNx/multiplier?network=Solana
- `xstocks.circ.NVDAx` [ok] 200 1990ms https://api.backed.fi/api/v2/public/assets/NVDAx/circulating-supply?format=object
- `xstocks.mult.NVDAx` [ok] 200 638ms https://api.backed.fi/api/v2/public/assets/NVDAx/multiplier?network=Solana
...
- `xstocks.price.DJTx` [FAIL]  12016ms https://api.backed.fi/api/v2/public/assets/DJTx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.AXTIx` [ok] 200 187ms https://api.backed.fi/api/v2/public/assets/AXTIx/circulating-supply?format=object
- `xstocks.circ.COINx` [ok] 200 665ms https://api.backed.fi/api/v2/public/assets/COINx/circulating-supply?format=object
- `xstocks.mult.DRAMx` [ok] 200 215ms https://api.backed.fi/api/v2/public/assets/DRAMx/multiplier?network=Solana
- `xstocks.mult.MVLLx` [ok] 200 434ms https://api.backed.fi/api/v2/public/assets/MVLLx/multiplier?network=Solana
...
- `xstocks.circ.QQQx` [ok] 200 1173ms https://api.backed.fi/api/v2/public/assets/QQQx/circulating-supply?format=object
...
- `xstocks.circ.DJTx` [ok] 200 1205ms https://api.backed.fi/api/v2/public/assets/DJTx/circulating-supply?format=object
...
- `xstocks.circ.KORUx` [ok] 200 715ms https://api.backed.fi/api/v2/public/assets/KORUx/circulating-supply?format=object
...
- `xstocks.circ.INTWx` [ok] 200 773ms https://api.backed.fi/api/v2/public/assets/INTWx/circulating-supply?format=object
...
- `xstocks.mult.INTWx` [ok] 200 1143ms https://api.backed.fi/api/v2/public/assets/INTWx/multiplier?network=Solana
- `xstocks.mult.SUOPTx` [ok] 200 503ms https://api.backed.fi/api/v2/public/assets/SUOPTx/multiplier?network=Solana
...
- `xstocks.mult.BANKCx` [ok] 200 1490ms https://api.backed.fi/api/v2/public/assets/BANKCx/multiplier?network=Solana
...
- `xstocks.price.LAOPGx` [FAIL]  12018ms https://api.backed.fi/api/v2/public/assets/LAOPGx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.TNGYIx` [ok] 200 1527ms https://api.backed.fi/api/v2/public/assets/TNGYIx/circulating-supply?format=object
...
- `xstocks.mult.TNGYIx` [ok] 200 468ms https://api.backed.fi/api/v2/public/assets/TNGYIx/multiplier?network=Solana
- `xstocks.circ.LAOPGx` [ok] 200 1647ms https://api.backed.fi/api/v2/public/assets/LAOPGx/circulating-supply?format=object
...
- `xstocks.circ.JDLOGx` [ok] 200 1385ms https://api.backed.fi/api/v2/public/assets/JDLOGx/circulating-supply?format=object
...
- `xstocks.mult.KUNLx` [ok] 200 851ms https://api.backed.fi/api/v2/public/assets/KUNLx/multiplier?network=Solana
...
- `xstocks.price.SZIGHx` [FAIL]  12011ms https://api.backed.fi/api/v2/public/assets/SZIGHx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.SZIGHx` [ok] 200 657ms https://api.backed.fi/api/v2/public/assets/SZIGHx/multiplier?network=Solana
...
- `xstocks.circ.HRZRBx` [ok] 200 302ms https://api.backed.fi/api/v2/public/assets/HRZRBx/circulating-supply?format=object
...
- `xstocks.mult.SNBIOx` [ok] 200 1352ms https://api.backed.fi/api/v2/public/assets/SNBIOx/multiplier?network=Solana
- `xstocks.mult.CSPCx` [ok] 200 174ms https://api.backed.fi/api/v2/public/assets/CSPCx/multiplier?network=Solana
- `xstocks.mult.HRZRBx` [ok] 200 610ms https://api.backed.fi/api/v2/public/assets/HRZRBx/multiplier?network=Solana
- `xstocks.mult.CRESBx` [ok] 200 686ms https://api.backed.fi/api/v2/public/assets/CRESBx/multiplier?network=Solana
...
- `xstocks.mult.JTGEXx` [ok] 200 349ms https://api.backed.fi/api/v2/public/assets/JTGEXx/multiplier?network=Solana
...
- `xstocks.price.BDWAPx` [FAIL]  12010ms https://api.backed.fi/api/v2/public/assets/BDWAPx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.JDHLTx` [ok] 200 468ms https://api.backed.fi/api/v2/public/assets/JDHLTx/multiplier?network=Solana
...
- `xstocks.circ.PRADx` [ok] 200 343ms https://api.backed.fi/api/v2/public/assets/PRADx/circulating-supply?format=object
- `xstocks.mult.PRADx` [ok] 200 195ms https://api.backed.fi/api/v2/public/assets/PRADx/multiplier?network=Solana
- `xstocks.circ.CTFJWx` [ok] 200 445ms https://api.backed.fi/api/v2/public/assets/CTFJWx/circulating-supply?format=object
...
- `xstocks.mult.CRESPx` [ok] 200 521ms https://api.backed.fi/api/v2/public/assets/CRESPx/multiplier?network=Solana
- `xstocks.mult.SINOTx` [ok] 200 552ms https://api.backed.fi/api/v2/public/assets/SINOTx/multiplier?network=Solana
- `xstocks.mult.CTFJWx` [ok] 200 218ms https://api.backed.fi/api/v2/public/assets/CTFJWx/multiplier?network=Solana
- `xstocks.circ.SITCx` [ok] 200 1867ms https://api.backed.fi/api/v2/public/assets/SITCx/circulating-supply?format=object
- `xstocks.circ.CLONPx` [ok] 200 449ms https://api.backed.fi/api/v2/public/assets/CLONPx/circulating-supply?format=object
...
- `xstocks.mult.WHGROx` [ok] 200 433ms https://api.backed.fi/api/v2/public/assets/WHGROx/multiplier?network=Solana
...
- `xstocks.circ.GENTEx` [ok] 200 511ms https://api.backed.fi/api/v2/public/assets/GENTEx/circulating-supply?format=object
...
- `xstocks.circ.CRAUTx` [ok] 200 602ms https://api.backed.fi/api/v2/public/assets/CRAUTx/circulating-supply?format=object
- `xstocks.mult.CRAUTx` [ok] 200 235ms https://api.backed.fi/api/v2/public/assets/CRAUTx/multiplier?network=Solana
- `xstocks.mult.WUXIBx` [ok] 200 554ms https://api.backed.fi/api/v2/public/assets/WUXIBx/multiplier?network=Solana
- `xstocks.mult.PWAHLx` [ok] 200 4553ms https://api.backed.fi/api/v2/public/assets/PWAHLx/multiplier?network=Solana
...
- `xstocks.circ.HKEXCx` [ok] 200 421ms https://api.backed.fi/api/v2/public/assets/HKEXCx/circulating-supply?format=object
- `xstocks.mult.KUAIx` [ok] 200 864ms https://api.backed.fi/api/v2/public/assets/KUAIx/multiplier?network=Solana
- `xstocks.circ.NONGx` [ok] 200 776ms https://api.backed.fi/api/v2/public/assets/NONGx/circulating-supply?format=object
...
- `xstocks.mult.SWPRPx` [ok] 200 3703ms https://api.backed.fi/api/v2/public/assets/SWPRPx/multiplier?network=Solana
- `xstocks.mult.HKEXCx` [ok] 200 2914ms https://api.backed.fi/api/v2/public/assets/HKEXCx/multiplier?network=Solana
...
- `xstocks.circ.COVELx` [ok] 200 333ms https://api.backed.fi/api/v2/public/assets/COVELx/circulating-supply?format=object
...
- `xstocks.circ.CHONGx` [ok] 200 347ms https://api.backed.fi/api/v2/public/assets/CHONGx/circulating-supply?format=object
...
- `xstocks.circ.MEITx` [ok] 200 341ms https://api.backed.fi/api/v2/public/assets/MEITx/circulating-supply?format=object
- `xstocks.mult.CHONGx` [ok] 200 1147ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
...
- `xstocks.mult.GEELx` [ok] 200 832ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
- `xstocks.circ.MTRCPx` [ok] 200 946ms https://api.backed.fi/api/v2/public/assets/MTRCPx/circulating-supply?format=object
...
- `xstocks.circ.PICCx` [ok] 200 836ms https://api.backed.fi/api/v2/public/assets/PICCx/circulating-supply?format=object
...
- `xstocks.mult.HNDLDx` [ok] 200 2601ms https://api.backed.fi/api/v2/public/assets/HNDLDx/multiplier?network=Solana
- `xstocks.circ.COSCx` [ok] 200 947ms https://api.backed.fi/api/v2/public/assets/COSCx/circulating-supply?format=object
- `xstocks.mult.COSCx` [ok] 200 261ms https://api.backed.fi/api/v2/public/assets/COSCx/multiplier?network=Solana
- `xstocks.circ.CKHUTx` [ok] 200 495ms https://api.backed.fi/api/v2/public/assets/CKHUTx/circulating-supply?format=object
- `xstocks.mult.CKHUTx` [ok] 200 259ms https://api.backed.fi/api/v2/public/assets/CKHUTx/multiplier?network=Solana
- `xstocks.mult.PICCx` [ok] 200 2419ms https://api.backed.fi/api/v2/public/assets/PICCx/multiplier?network=Solana
