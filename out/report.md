...
**Generated** 2026-09-06T18:49:13Z · 2026-09-06 11:49:13 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-06T18:49:02Z · **RPC health** `ok`
**Health score** 98 / 100 — `25×rpc_ok + 30×clamp(1 − max(0, slot_ms − 300)/300, 0, 1) + 25×clamp(1 − delinquent_stake_pct/2, 0, 1) + 20×clamp(tps / tps_baseline, 0, 1)`
**Network health** HEALTHY · **Ecosystem** ELEVATED — SOL 24h +2.10%; DEX 24h $1.96B · 1d +4% · vs-7d-ago +17%; slot 317 ms
...
| Health | `ok` |
| Slot | 444,864,721 |
| Block height | 422,909,051 |
| Block time | 2026-09-06T18:49:02Z |
| Epoch | 1,029 (77.94% · slot 336,722/432,000) |
| Mean TPS (last ~3,600s) | 3,933.0 |
| Mean non-vote TPS | 1,813.5 |
| Median TPS (same window) | 3,890.2 |
| Mean slot time | 317.4 ms |
| Median slot time | 317.5 ms |
| Transaction count (cluster) | 545,767,613,334 |
| Circulating supply | 585,444,926 SOL |
| Total supply | 633,548,801 SOL |
...
- `xLabscif…` · 28.57K SOL · commission 5% · lag 1076348 slots
- `mrgn4atx…` · 20.30K SOL · commission 0% · lag 100611 slots
- `prt1st4R…` · 13.11K SOL · commission 5% · lag 1377779 slots
- `E4xNK4Uw…` · 6.26K SOL · commission 5% · lag 1515998 slots
- `5ZjxMYBb…` · 4.06K SOL · commission 0% · lag 898799 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 2078600 slots
- `pSoLoZx5…` · 1.51K SOL · commission 4% · lag 325530 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 1426082 slots
- `CpdzCVza…` · 193.38 SOL · commission 100% · lag 2064370 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 2105884 slots
- `HFTcVVrX…` · 148.42 SOL · commission 100% · lag 2064264 slots
- `6pEtDovp…` · 131.86 SOL · commission 100% · lag 2078648 slots
...
| Jito tip-floor run-rate (NOT REV) | $58.35K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 58349 USD; at p95 floor → 1820699 USD. |
...
| p90 / p99 | 0.000012 / 0.000173 SOL | same sample |
...
| Metric | Value | Source |
| --- | ---: | --- |
| SOL/USD | $106.02 | coingecko.simple_price |
...
24h volume $96.66M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-09-06 (2026-09-06 11:49:13 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 7112ms https://api.mainnet-beta.solana.com
...
- `solana.com.databricks` [ok] 200 354ms https://solana.com/api/databricks/data?days=30
...
- `rss.nitter.solana_devs` [ok] 200 591ms https://nitter.perennialte.ch/solana_devs/rss
...
- `xstocks.assets.p0` [ok] 200 2069ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0
...
- `xstocks.assets.p4` [ok] 200 2666ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=4
- `xstocks.assets.p5` [ok] 200 1213ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=5
- `xstocks.assets.p6` [ok] 200 2207ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=6
- `xstocks.assets.p7` [ok] 200 750ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=7
...
- `xstocks.mult.GOOGLx` [ok] 200 566ms https://api.backed.fi/api/v2/public/assets/GOOGLx/multiplier?network=Solana
- `xstocks.mult.MSFTx` [ok] 200 719ms https://api.backed.fi/api/v2/public/assets/MSFTx/multiplier?network=Solana
- `xstocks.mult.AMZNx` [ok] 200 1282ms https://api.backed.fi/api/v2/public/assets/AMZNx/multiplier?network=Solana
- `xstocks.circ.NVDAx` [ok] 200 4662ms https://api.backed.fi/api/v2/public/assets/NVDAx/circulating-supply?format=object
- `xstocks.mult.NVDAx` [ok] 200 433ms https://api.backed.fi/api/v2/public/assets/NVDAx/multiplier?network=Solana
- `xstocks.circ.METAx` [ok] 200 5458ms https://api.backed.fi/api/v2/public/assets/METAx/circulating-supply?format=object
...
- `xstocks.circ.DRAMx` [ok] 200 137ms https://api.backed.fi/api/v2/public/assets/DRAMx/circulating-supply?format=object
...
- `xstocks.price.AXTIx` [FAIL]  12014ms https://api.backed.fi/api/v2/public/assets/AXTIx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.AXTIx` [ok] 200 113ms https://api.backed.fi/api/v2/public/assets/AXTIx/multiplier?network=Solana
- `xstocks.mult.MVLLx` [ok] 200 1425ms https://api.backed.fi/api/v2/public/assets/MVLLx/multiplier?network=Solana
...
- `xstocks.circ.KORUx` [ok] 200 766ms https://api.backed.fi/api/v2/public/assets/KORUx/circulating-supply?format=object
- `xstocks.mult.KORUx` [ok] 200 726ms https://api.backed.fi/api/v2/public/assets/KORUx/multiplier?network=Solana
...
- `xstocks.circ.SOXSx` [ok] 200 546ms https://api.backed.fi/api/v2/public/assets/SOXSx/circulating-supply?format=object
- `xstocks.mult.SOXSx` [ok] 200 174ms https://api.backed.fi/api/v2/public/assets/SOXSx/multiplier?network=Solana
- `xstocks.circ.INTWx` [ok] 200 968ms https://api.backed.fi/api/v2/public/assets/INTWx/circulating-supply?format=object
...
- `xstocks.circ.SHEINx` [ok] 200 341ms https://api.backed.fi/api/v2/public/assets/SHEINx/circulating-supply?format=object
...
- `xstocks.mult.NWGx` [ok] 200 377ms https://api.backed.fi/api/v2/public/assets/NWGx/multiplier?network=Solana
- `xstocks.mult.SHEINx` [ok] 200 319ms https://api.backed.fi/api/v2/public/assets/SHEINx/multiplier?network=Solana
- `xstocks.mult.INTWx` [ok] 200 1110ms https://api.backed.fi/api/v2/public/assets/INTWx/multiplier?network=Solana
- `xstocks.circ.BANKCx` [ok] 200 1083ms https://api.backed.fi/api/v2/public/assets/BANKCx/circulating-supply?format=object
...
- `xstocks.circ.SUOPTx` [ok] 200 261ms https://api.backed.fi/api/v2/public/assets/SUOPTx/circulating-supply?format=object
...
- `xstocks.circ.ZHAOMx` [ok] 200 110ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/circulating-supply?format=object
...
- `xstocks.price.JDLOGx` [FAIL]  12013ms https://api.backed.fi/api/v2/public/assets/JDLOGx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.JDLOGx` [ok] 200 495ms https://api.backed.fi/api/v2/public/assets/JDLOGx/multiplier?network=Solana
...
- `xstocks.mult.TNGYIx` [ok] 200 2006ms https://api.backed.fi/api/v2/public/assets/TNGYIx/multiplier?network=Solana
...
- `xstocks.circ.ENNHLx` [ok] 200 367ms https://api.backed.fi/api/v2/public/assets/ENNHLx/circulating-supply?format=object
...
- `xstocks.mult.HRZRBx` [ok] 200 490ms https://api.backed.fi/api/v2/public/assets/HRZRBx/multiplier?network=Solana
...
- `xstocks.circ.CRESBx` [ok] 200 447ms https://api.backed.fi/api/v2/public/assets/CRESBx/circulating-supply?format=object
...
- `xstocks.circ.CSPCx` [ok] 200 700ms https://api.backed.fi/api/v2/public/assets/CSPCx/circulating-supply?format=object
...
- `xstocks.circ.CMENDx` [ok] 200 666ms https://api.backed.fi/api/v2/public/assets/CMENDx/circulating-supply?format=object
...
- `xstocks.mult.MIXUx` [ok] 200 301ms https://api.backed.fi/api/v2/public/assets/MIXUx/multiplier?network=Solana
...
- `xstocks.circ.ASMPTx` [ok] 200 1052ms https://api.backed.fi/api/v2/public/assets/ASMPTx/circulating-supply?format=object
...
- `xstocks.mult.ASMPTx` [ok] 200 1036ms https://api.backed.fi/api/v2/public/assets/ASMPTx/multiplier?network=Solana
- `xstocks.circ.BDWAPx` [ok] 200 5786ms https://api.backed.fi/api/v2/public/assets/BDWAPx/circulating-supply?format=object
- `xstocks.mult.BDWAPx` [ok] 200 1285ms https://api.backed.fi/api/v2/public/assets/BDWAPx/multiplier?network=Solana
...
- `xstocks.mult.SNDSCx` [ok] 200 117ms https://api.backed.fi/api/v2/public/assets/SNDSCx/multiplier?network=Solana
...
- `xstocks.mult.CRESPx` [ok] 200 507ms https://api.backed.fi/api/v2/public/assets/CRESPx/multiplier?network=Solana
...
- `xstocks.circ.PRADx` [ok] 200 867ms https://api.backed.fi/api/v2/public/assets/PRADx/circulating-supply?format=object
- `xstocks.mult.PRADx` [ok] 200 1309ms https://api.backed.fi/api/v2/public/assets/PRADx/multiplier?network=Solana
...
- `xstocks.price.CTFJWx` [FAIL]  12012ms https://api.backed.fi/api/v2/public/assets/CTFJWx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.CTFJWx` [ok] 200 461ms https://api.backed.fi/api/v2/public/assets/CTFJWx/multiplier?network=Solana
...
- `xstocks.circ.WHGROx` [ok] 200 287ms https://api.backed.fi/api/v2/public/assets/WHGROx/circulating-supply?format=object
...
- `xstocks.mult.SINOx` [ok] 200 113ms https://api.backed.fi/api/v2/public/assets/SINOx/multiplier?network=Solana
...
- `xstocks.mult.CTPCAx` [ok] 200 421ms https://api.backed.fi/api/v2/public/assets/CTPCAx/multiplier?network=Solana
...
- `xstocks.mult.CRAUTx` [ok] 200 723ms https://api.backed.fi/api/v2/public/assets/CRAUTx/multiplier?network=Solana
...
- `xstocks.mult.WUXIBx` [ok] 200 350ms https://api.backed.fi/api/v2/public/assets/WUXIBx/multiplier?network=Solana
...
- `xstocks.circ.CKAHx` [ok] 200 582ms https://api.backed.fi/api/v2/public/assets/CKAHx/circulating-supply?format=object
- `xstocks.circ.CKINFx` [ok] 200 457ms https://api.backed.fi/api/v2/public/assets/CKINFx/circulating-supply?format=object
...
- `xstocks.circ.HKCGAx` [ok] 200 603ms https://api.backed.fi/api/v2/public/assets/HKCGAx/circulating-supply?format=object
- `xstocks.mult.HKCGAx` [ok] 200 860ms https://api.backed.fi/api/v2/public/assets/HKCGAx/multiplier?network=Solana
...
- `xstocks.circ.HKEXCx` [ok] 200 411ms https://api.backed.fi/api/v2/public/assets/HKEXCx/circulating-supply?format=object
...
- `xstocks.circ.NONGx` [ok] 200 488ms https://api.backed.fi/api/v2/public/assets/NONGx/circulating-supply?format=object
- `xstocks.mult.NONGx` [ok] 200 1149ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
- `xstocks.price.COVELx` [FAIL]  12010ms https://api.backed.fi/api/v2/public/assets/COVELx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.CHONGx` [ok] 200 390ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
...
- `xstocks.mult.GEELx` [ok] 200 1873ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
...
- `xstocks.mult.HNDLDx` [ok] 200 940ms https://api.backed.fi/api/v2/public/assets/HNDLDx/multiplier?network=Solana
...
- `xstocks.mult.PICCx` [ok] 200 990ms https://api.backed.fi/api/v2/public/assets/PICCx/multiplier?network=Solana
...
- `xstocks.circ.COSCx` [ok] 200 769ms https://api.backed.fi/api/v2/public/assets/COSCx/circulating-supply?format=object
...
- `jup.tokens.search.DJTx` [ok] 200 41ms https://lite-api.jup.ag/tokens/v2/search?query=DJTx
...
- `jito.daily_mev_rewards` [ok] 200 1478ms https://kobe.mainnet.jito.network/api/v1/daily_mev_rewards
