...
**Generated** 2026-08-29T20:48:39Z · 2026-08-29 13:48:39 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-29T20:48:29Z · **RPC health** `ok`
**Health score** 98 / 100 — `25×rpc_ok + 30×clamp(1 − max(0, slot_ms − 300)/300, 0, 1) + 25×clamp(1 − delinquent_stake_pct/2, 0, 1) + 20×clamp(tps / tps_baseline, 0, 1)`
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h +1.33%; DEX 24h $2.59B · 1d -30% · vs-7d-ago -28%; slot 317 ms
...
- **WARN · SOL price vs 30d median (solana.com/data)** — Current 105.30 USD is +38.2% vs 30d median 76.20 USD (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
...
| Health | `ok` |
| Slot | 442,701,243 |
| Block height | 420,749,082 |
| Block time | 2026-08-29T20:48:29Z |
| Epoch | 1,024 (77.14% · slot 333,248/432,000) |
| Mean TPS (last ~3,600s) | 4,014.7 |
| Mean non-vote TPS | 1,849.6 |
| Median TPS (same window) | 4,046.9 |
| Mean slot time | 316.7 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 543,204,429,821 |
| Circulating supply | 584,161,256 SOL |
| Total supply | 633,078,796 SOL |
...
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1448564 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 21405 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 717489 slots
- `kom1oNHy…` · 662.86 SOL · commission 5% · lag 2064727 slots
- `pSo1KZXg…` · 2.00 SOL · commission 4% · lag 363402 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442701243 slots
- `7Dvp5zCF…` · 1.07 SOL · commission 100% · lag 521888 slots
- `bcZxRSoz…` · 0.00 SOL · commission 0% · lag 2061244 slots
...
| --- | ---: | --- |
| TPS chart | 131 | data/history.jsonl snapshot tape |
| TVL chart | 131 | data/history.jsonl snapshot tape |
| SOL chart | 130 | data/history.jsonl snapshot tape |
| history.jsonl rows | 131 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $74.51K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 74511 USD; at p95 floor → 16827240 USD. |
...
| p90 / p99 | 0.000013 / 0.000473 SOL | same sample |
...
| Metric | Value | Source |
| --- | ---: | --- |
| SOL/USD | $105.30 | coingecko.simple_price |
...
24h volume $18.23M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-08-29 (2026-08-29 13:48:39 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getBlockTime` [ok] 200 639ms https://api.mainnet-beta.solana.com
...
- `llama.dexs` [ok] 200 638ms https://api.llama.fi/overview/dexs/Solana?excludeTotalDataChart=true&excludeTotalDataChartBreakdown=true
...
- `solana.com.data_page` [ok] 200 3194ms https://solana.com/data
- `solana.com.databricks` [ok] 200 369ms https://solana.com/api/databricks/data?days=30
...
- `rss.nitter.solana_status` [ok] 200 2340ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [ok] 200 1630ms https://nitter.perennialte.ch/anza_xyz/rss
- `rss.nitter.solana_devs` [ok] 200 2083ms https://nitter.perennialte.ch/solana_devs/rss
...
- `rpc.getBlock` [ok] 200 2616ms https://api.mainnet-beta.solana.com
...
- `xstocks.circ.TSLAx` [ok] 200 640ms https://api.backed.fi/api/v2/public/assets/TSLAx/circulating-supply?format=object
- `xstocks.mult.TSLAx` [ok] 200 120ms https://api.backed.fi/api/v2/public/assets/TSLAx/multiplier?network=Solana
- `xstocks.mult.MSFTx` [ok] 200 546ms https://api.backed.fi/api/v2/public/assets/MSFTx/multiplier?network=Solana
- `xstocks.circ.AMZNx` [ok] 200 1604ms https://api.backed.fi/api/v2/public/assets/AMZNx/circulating-supply?format=object
- `xstocks.mult.AMZNx` [ok] 200 340ms https://api.backed.fi/api/v2/public/assets/AMZNx/multiplier?network=Solana
...
- `xstocks.circ.LAOPGx` [ok] 200 422ms https://api.backed.fi/api/v2/public/assets/LAOPGx/circulating-supply?format=object
- `xstocks.mult.BANKCx` [ok] 200 1951ms https://api.backed.fi/api/v2/public/assets/BANKCx/multiplier?network=Solana
...
- `xstocks.circ.JDLOGx` [ok] 200 444ms https://api.backed.fi/api/v2/public/assets/JDLOGx/circulating-supply?format=object
- `xstocks.circ.CTINSx` [ok] 200 401ms https://api.backed.fi/api/v2/public/assets/CTINSx/circulating-supply?format=object
...
- `xstocks.circ.SZIGHx` [ok] 200 260ms https://api.backed.fi/api/v2/public/assets/SZIGHx/circulating-supply?format=object
- `xstocks.mult.HAIDLx` [ok] 200 1480ms https://api.backed.fi/api/v2/public/assets/HAIDLx/multiplier?network=Solana
- `xstocks.mult.KUNLx` [ok] 200 2037ms https://api.backed.fi/api/v2/public/assets/KUNLx/multiplier?network=Solana
...
- `xstocks.mult.JTGEXx` [ok] 200 994ms https://api.backed.fi/api/v2/public/assets/JTGEXx/multiplier?network=Solana
- `xstocks.mult.CSPCx` [ok] 200 1226ms https://api.backed.fi/api/v2/public/assets/CSPCx/multiplier?network=Solana
- `xstocks.mult.WXXDCx` [ok] 200 985ms https://api.backed.fi/api/v2/public/assets/WXXDCx/multiplier?network=Solana
...
- `xstocks.circ.MIXUx` [ok] 200 112ms https://api.backed.fi/api/v2/public/assets/MIXUx/circulating-supply?format=object
...
- `xstocks.circ.BDWAPx` [ok] 200 467ms https://api.backed.fi/api/v2/public/assets/BDWAPx/circulating-supply?format=object
- `xstocks.mult.MIXUx` [ok] 200 388ms https://api.backed.fi/api/v2/public/assets/MIXUx/multiplier?network=Solana
- `xstocks.mult.BDWAPx` [ok] 200 1201ms https://api.backed.fi/api/v2/public/assets/BDWAPx/multiplier?network=Solana
...
- `xstocks.price.SITCx` [FAIL]  12012ms https://api.backed.fi/api/v2/public/assets/SITCx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.WHRFRx` [ok] 200 342ms https://api.backed.fi/api/v2/public/assets/WHRFRx/multiplier?network=Solana
...
- `xstocks.mult.JDHLTx` [ok] 200 737ms https://api.backed.fi/api/v2/public/assets/JDHLTx/multiplier?network=Solana
...
- `xstocks.mult.PRADx` [ok] 200 250ms https://api.backed.fi/api/v2/public/assets/PRADx/multiplier?network=Solana
- `xstocks.circ.SINOTx` [ok] 200 293ms https://api.backed.fi/api/v2/public/assets/SINOTx/circulating-supply?format=object
- `xstocks.circ.CRESPx` [ok] 200 876ms https://api.backed.fi/api/v2/public/assets/CRESPx/circulating-supply?format=object
...
- `xstocks.circ.CTFJWx` [ok] 200 1296ms https://api.backed.fi/api/v2/public/assets/CTFJWx/circulating-supply?format=object
- `xstocks.mult.CTFJWx` [ok] 200 166ms https://api.backed.fi/api/v2/public/assets/CTFJWx/multiplier?network=Solana
- `xstocks.price.SINOx` [FAIL]  12014ms https://api.backed.fi/api/v2/public/assets/SINOx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.CLONPx` [ok] 200 608ms https://api.backed.fi/api/v2/public/assets/CLONPx/multiplier?network=Solana
- `xstocks.circ.SINOx` [ok] 200 1075ms https://api.backed.fi/api/v2/public/assets/SINOx/circulating-supply?format=object
- `xstocks.circ.WHGROx` [ok] 200 1364ms https://api.backed.fi/api/v2/public/assets/WHGROx/circulating-supply?format=object
...
- `xstocks.circ.CTPCAx` [ok] 200 1100ms https://api.backed.fi/api/v2/public/assets/CTPCAx/circulating-supply?format=object
...
- `xstocks.mult.CLPHDx` [ok] 200 1232ms https://api.backed.fi/api/v2/public/assets/CLPHDx/multiplier?network=Solana
...
- `xstocks.mult.SWPRPx` [ok] 200 322ms https://api.backed.fi/api/v2/public/assets/SWPRPx/multiplier?network=Solana
...
- `xstocks.mult.NONGx` [ok] 200 1399ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
...
- `xstocks.mult.GEELx` [ok] 200 145ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
- `xstocks.mult.COVELx` [ok] 200 1776ms https://api.backed.fi/api/v2/public/assets/COVELx/multiplier?network=Solana
...
- `xstocks.mult.HNDLDx` [ok] 200 1040ms https://api.backed.fi/api/v2/public/assets/HNDLDx/multiplier?network=Solana
...
- `xstocks.price.POPMTx` [FAIL]  12013ms https://api.backed.fi/api/v2/public/assets/POPMTx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.CKHUTx` [ok] 200 325ms https://api.backed.fi/api/v2/public/assets/CKHUTx/multiplier?network=Solana
- `xstocks.mult.POPMTx` [ok] 200 462ms https://api.backed.fi/api/v2/public/assets/POPMTx/multiplier?network=Solana
...
- `xstocks.mult.BOCHKx` [ok] 200 136ms https://api.backed.fi/api/v2/public/assets/BOCHKx/multiplier?network=Solana
...
- `xstocks.circ.PSBOCx` [ok] 200 234ms https://api.backed.fi/api/v2/public/assets/PSBOCx/circulating-supply?format=object
- `xstocks.circ.ZJGLDx` [ok] 200 243ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/circulating-supply?format=object
- `xstocks.mult.ZJGLDx` [ok] 200 139ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/multiplier?network=Solana
- `xstocks.mult.PSBOCx` [ok] 200 275ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
...
- `xstocks.circ.HAIERx` [ok] 200 1271ms https://api.backed.fi/api/v2/public/assets/HAIERx/circulating-supply?format=object
- `xstocks.circ.ICBCx` [ok] 200 470ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
...
- `jup.tokens.search.SUOPTx` [ok] 200 75ms https://lite-api.jup.ag/tokens/v2/search?query=SUOPTx
...
- `jup.tokens.search.ZHAOMx` [ok] 200 37ms https://lite-api.jup.ag/tokens/v2/search?query=ZHAOMx
...
- `rpc.getAccountInfo` [ok] 200 683ms https://api.mainnet-beta.solana.com
