...
**Generated** 2026-09-06T15:35:59Z · 2026-09-06 08:35:59 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-06T15:35:49Z · **RPC health** `ok`
**Health score** 98 / 100 — `25×rpc_ok + 30×clamp(1 − max(0, slot_ms − 300)/300, 0, 1) + 25×clamp(1 − delinquent_stake_pct/2, 0, 1) + 20×clamp(tps / tps_baseline, 0, 1)`
**Network health** HEALTHY · **Ecosystem** ELEVATED — SOL 24h +2.93%; DEX 24h $1.96B · 1d +4% · vs-7d-ago +17%; slot 318 ms
...
| Health | `ok` |
| Slot | 444,828,218 |
| Block height | 422,872,568 |
| Block time | 2026-09-06T15:35:49Z |
| Epoch | 1,029 (69.50% · slot 300,219/432,000) |
| Mean TPS (last ~3,600s) | 3,944.8 |
| Mean non-vote TPS | 1,827.2 |
| Median TPS (same window) | 3,914.0 |
| Mean slot time | 317.7 ms |
| Median slot time | 317.5 ms |
| Transaction count (cluster) | 545,721,939,162 |
| Circulating supply | 585,445,046 SOL |
| Total supply | 633,548,921 SOL |
...
- `xLabscif…` · 28.57K SOL · commission 5% · lag 1039845 slots
- `mrgn4atx…` · 20.30K SOL · commission 0% · lag 64108 slots
- `prt1st4R…` · 13.11K SOL · commission 5% · lag 1341276 slots
- `E4xNK4Uw…` · 6.26K SOL · commission 5% · lag 1479495 slots
- `5ZjxMYBb…` · 4.06K SOL · commission 0% · lag 862296 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 2042097 slots
- `pSoLoZx5…` · 1.51K SOL · commission 4% · lag 289027 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 1389579 slots
- `CpdzCVza…` · 193.38 SOL · commission 100% · lag 2027867 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 2069381 slots
- `HFTcVVrX…` · 148.42 SOL · commission 100% · lag 2027761 slots
- `6pEtDovp…` · 131.86 SOL · commission 100% · lag 2042145 slots
...
| Jito tip-floor run-rate (NOT REV) | $59.47K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 59468 USD; at p95 floor → 1179229 USD. |
...
24h volume $72.68M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
DeFiLlama protocol/xstocks Solana TVL $450.27M — liquidity census, not mcap, not 24h volume.
...
_As of 2026-09-06 (2026-09-06 08:35:59 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSlot` [ok] 200 363ms https://api.mainnet-beta.solana.com
...
- `rpc.getSupply` [ok] 200 7017ms https://api.mainnet-beta.solana.com
...
- `rss.xcancel.solana` [ok] 200 337ms https://xcancel.com/solana/rss
...
- `rss.nitter.solana` [ok] 200 506ms https://nitter.perennialte.ch/solana/rss
- `rss.nitter.solana_status` [ok] 200 2361ms https://nitter.perennialte.ch/solana_status/rss
...
- `xstocks.assets.p0` [ok] 200 2292ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0
...
- `xstocks.assets.p5` [ok] 200 1791ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=5
- `xstocks.assets.p6` [ok] 200 1386ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=6
- `xstocks.assets.p7` [ok] 200 1270ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=7
...
- `xstocks.mult.AMZNx` [ok] 200 450ms https://api.backed.fi/api/v2/public/assets/AMZNx/multiplier?network=Solana
- `xstocks.mult.SPYx` [ok] 200 819ms https://api.backed.fi/api/v2/public/assets/SPYx/multiplier?network=Solana
- `xstocks.circ.GOOGLx` [ok] 200 980ms https://api.backed.fi/api/v2/public/assets/GOOGLx/circulating-supply?format=object
- `xstocks.circ.METAx` [ok] 200 1015ms https://api.backed.fi/api/v2/public/assets/METAx/circulating-supply?format=object
- `xstocks.mult.TSLAx` [ok] 200 575ms https://api.backed.fi/api/v2/public/assets/TSLAx/multiplier?network=Solana
- `xstocks.mult.MSFTx` [ok] 200 839ms https://api.backed.fi/api/v2/public/assets/MSFTx/multiplier?network=Solana
- `xstocks.circ.AAPLx` [ok] 200 1211ms https://api.backed.fi/api/v2/public/assets/AAPLx/circulating-supply?format=object
- `xstocks.mult.NVDAx` [ok] 200 1126ms https://api.backed.fi/api/v2/public/assets/NVDAx/multiplier?network=Solana
- `xstocks.mult.METAx` [ok] 200 288ms https://api.backed.fi/api/v2/public/assets/METAx/multiplier?network=Solana
- `xstocks.mult.GOOGLx` [ok] 200 816ms https://api.backed.fi/api/v2/public/assets/GOOGLx/multiplier?network=Solana
- `xstocks.mult.AAPLx` [ok] 200 1289ms https://api.backed.fi/api/v2/public/assets/AAPLx/multiplier?network=Solana
...
- `xstocks.circ.MVLLx` [ok] 200 115ms https://api.backed.fi/api/v2/public/assets/MVLLx/circulating-supply?format=object
...
- `xstocks.mult.DRAMx` [ok] 200 117ms https://api.backed.fi/api/v2/public/assets/DRAMx/multiplier?network=Solana
...
- `xstocks.mult.MVLLx` [ok] 200 663ms https://api.backed.fi/api/v2/public/assets/MVLLx/multiplier?network=Solana
...
- `xstocks.mult.MUUx` [ok] 200 905ms https://api.backed.fi/api/v2/public/assets/MUUx/multiplier?network=Solana
...
- `xstocks.mult.AXTIx` [ok] 200 701ms https://api.backed.fi/api/v2/public/assets/AXTIx/multiplier?network=Solana
...
- `xstocks.price.SHEINx` [FAIL]  12016ms https://api.backed.fi/api/v2/public/assets/SHEINx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.SNXXx` [ok] 200 427ms https://api.backed.fi/api/v2/public/assets/SNXXx/circulating-supply?format=object
- `xstocks.mult.INTWx` [ok] 200 891ms https://api.backed.fi/api/v2/public/assets/INTWx/multiplier?network=Solana
...
- `xstocks.circ.SHEINx` [ok] 200 627ms https://api.backed.fi/api/v2/public/assets/SHEINx/circulating-supply?format=object
...
- `xstocks.circ.SOXSx` [ok] 200 1435ms https://api.backed.fi/api/v2/public/assets/SOXSx/circulating-supply?format=object
- `xstocks.mult.BANKCx` [ok] 200 461ms https://api.backed.fi/api/v2/public/assets/BANKCx/multiplier?network=Solana
...
- `xstocks.circ.SUOPTx` [ok] 200 335ms https://api.backed.fi/api/v2/public/assets/SUOPTx/circulating-supply?format=object
- `xstocks.circ.MMGx` [ok] 200 239ms https://api.backed.fi/api/v2/public/assets/MMGx/circulating-supply?format=object
- `xstocks.mult.SOXSx` [ok] 200 460ms https://api.backed.fi/api/v2/public/assets/SOXSx/multiplier?network=Solana
- `xstocks.mult.MMGx` [ok] 200 131ms https://api.backed.fi/api/v2/public/assets/MMGx/multiplier?network=Solana
- `xstocks.mult.SHEINx` [ok] 200 1164ms https://api.backed.fi/api/v2/public/assets/SHEINx/multiplier?network=Solana
- `xstocks.mult.SUOPTx` [ok] 200 1141ms https://api.backed.fi/api/v2/public/assets/SUOPTx/multiplier?network=Solana
...
- `xstocks.price.ZHAOMx` [FAIL]  12012ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.TNGYIx` [ok] 200 755ms https://api.backed.fi/api/v2/public/assets/TNGYIx/circulating-supply?format=object
...
- `xstocks.circ.LAOPGx` [ok] 200 510ms https://api.backed.fi/api/v2/public/assets/LAOPGx/circulating-supply?format=object
...
- `xstocks.mult.WRFHDx` [ok] 200 334ms https://api.backed.fi/api/v2/public/assets/WRFHDx/multiplier?network=Solana
- `xstocks.circ.HAIDLx` [ok] 200 245ms https://api.backed.fi/api/v2/public/assets/HAIDLx/circulating-supply?format=object
- `xstocks.mult.ZHAOMx` [ok] 200 1518ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/multiplier?network=Solana
- `xstocks.mult.CTINSx` [ok] 200 616ms https://api.backed.fi/api/v2/public/assets/CTINSx/multiplier?network=Solana
...
- `xstocks.circ.SNBIOx` [ok] 200 1062ms https://api.backed.fi/api/v2/public/assets/SNBIOx/circulating-supply?format=object
...
- `xstocks.circ.HRZRBx` [ok] 200 464ms https://api.backed.fi/api/v2/public/assets/HRZRBx/circulating-supply?format=object
...
- `xstocks.circ.SMOIHx` [ok] 200 704ms https://api.backed.fi/api/v2/public/assets/SMOIHx/circulating-supply?format=object
- `xstocks.mult.SNBIOx` [ok] 200 539ms https://api.backed.fi/api/v2/public/assets/SNBIOx/multiplier?network=Solana
- `xstocks.circ.SZIGHx` [ok] 200 1398ms https://api.backed.fi/api/v2/public/assets/SZIGHx/circulating-supply?format=object
- `xstocks.circ.CMERPx` [ok] 200 625ms https://api.backed.fi/api/v2/public/assets/CMERPx/circulating-supply?format=object
- `xstocks.mult.SZIGHx` [ok] 200 729ms https://api.backed.fi/api/v2/public/assets/SZIGHx/multiplier?network=Solana
- `xstocks.circ.CRESBx` [ok] 200 1585ms https://api.backed.fi/api/v2/public/assets/CRESBx/circulating-supply?format=object
- `xstocks.mult.CRESBx` [ok] 200 196ms https://api.backed.fi/api/v2/public/assets/CRESBx/multiplier?network=Solana
- `xstocks.mult.CMERPx` [ok] 200 1160ms https://api.backed.fi/api/v2/public/assets/CMERPx/multiplier?network=Solana
- `xstocks.mult.SMOIHx` [ok] 200 1455ms https://api.backed.fi/api/v2/public/assets/SMOIHx/multiplier?network=Solana
- `xstocks.mult.CSPCx` [ok] 200 1615ms https://api.backed.fi/api/v2/public/assets/CSPCx/multiplier?network=Solana
- `xstocks.mult.HRZRBx` [ok] 200 4186ms https://api.backed.fi/api/v2/public/assets/HRZRBx/multiplier?network=Solana
...
- `xstocks.circ.JTGEXx` [ok] 200 1843ms https://api.backed.fi/api/v2/public/assets/JTGEXx/circulating-supply?format=object
- `xstocks.circ.ASMPTx` [ok] 200 366ms https://api.backed.fi/api/v2/public/assets/ASMPTx/circulating-supply?format=object
- `xstocks.mult.WXXDCx` [ok] 200 346ms https://api.backed.fi/api/v2/public/assets/WXXDCx/multiplier?network=Solana
- `xstocks.mult.JTGEXx` [ok] 200 148ms https://api.backed.fi/api/v2/public/assets/JTGEXx/multiplier?network=Solana
- `xstocks.mult.MIXUx` [ok] 200 451ms https://api.backed.fi/api/v2/public/assets/MIXUx/multiplier?network=Solana
- `xstocks.circ.CMENDx` [ok] 200 806ms https://api.backed.fi/api/v2/public/assets/CMENDx/circulating-supply?format=object
- `xstocks.mult.CRESMx` [ok] 200 2262ms https://api.backed.fi/api/v2/public/assets/CRESMx/multiplier?network=Solana
- `xstocks.mult.ASMPTx` [ok] 200 703ms https://api.backed.fi/api/v2/public/assets/ASMPTx/multiplier?network=Solana
...
- `xstocks.mult.WHRFRx` [ok] 200 119ms https://api.backed.fi/api/v2/public/assets/WHRFRx/multiplier?network=Solana
...
- `xstocks.mult.SITCx` [ok] 200 113ms https://api.backed.fi/api/v2/public/assets/SITCx/multiplier?network=Solana
...
- `xstocks.circ.JDHLTx` [ok] 200 799ms https://api.backed.fi/api/v2/public/assets/JDHLTx/circulating-supply?format=object
...
- `xstocks.circ.CTFJWx` [ok] 200 147ms https://api.backed.fi/api/v2/public/assets/CTFJWx/circulating-supply?format=object
- `xstocks.circ.PRADx` [ok] 200 518ms https://api.backed.fi/api/v2/public/assets/PRADx/circulating-supply?format=object
- `xstocks.mult.JDHLTx` [ok] 200 453ms https://api.backed.fi/api/v2/public/assets/JDHLTx/multiplier?network=Solana
- `xstocks.mult.CTFJWx` [ok] 200 680ms https://api.backed.fi/api/v2/public/assets/CTFJWx/multiplier?network=Solana
- `xstocks.mult.PRADx` [ok] 200 659ms https://api.backed.fi/api/v2/public/assets/PRADx/multiplier?network=Solana
- `xstocks.circ.CRESPx` [ok] 200 1423ms https://api.backed.fi/api/v2/public/assets/CRESPx/circulating-supply?format=object
...
- `xstocks.mult.CRESPx` [ok] 200 721ms https://api.backed.fi/api/v2/public/assets/CRESPx/multiplier?network=Solana
- `xstocks.circ.CLONPx` [ok] 200 621ms https://api.backed.fi/api/v2/public/assets/CLONPx/circulating-supply?format=object
- `xstocks.mult.CLONPx` [ok] 200 530ms https://api.backed.fi/api/v2/public/assets/CLONPx/multiplier?network=Solana
- `xstocks.mult.SINOTx` [ok] 200 3417ms https://api.backed.fi/api/v2/public/assets/SINOTx/multiplier?network=Solana
...
- `xstocks.mult.WHGROx` [ok] 200 788ms https://api.backed.fi/api/v2/public/assets/WHGROx/multiplier?network=Solana
...
- `xstocks.circ.SINOx` [ok] 200 254ms https://api.backed.fi/api/v2/public/assets/SINOx/circulating-supply?format=object
...
- `xstocks.mult.SINOx` [ok] 200 595ms https://api.backed.fi/api/v2/public/assets/SINOx/multiplier?network=Solana
- `xstocks.circ.PWAHLx` [ok] 200 315ms https://api.backed.fi/api/v2/public/assets/PWAHLx/circulating-supply?format=object
- `xstocks.mult.PWAHLx` [ok] 200 268ms https://api.backed.fi/api/v2/public/assets/PWAHLx/multiplier?network=Solana
- `xstocks.circ.CLPHDx` [ok] 200 721ms https://api.backed.fi/api/v2/public/assets/CLPHDx/circulating-supply?format=object
...
- `xstocks.mult.CLPHDx` [ok] 200 791ms https://api.backed.fi/api/v2/public/assets/CLPHDx/multiplier?network=Solana
...
- `xstocks.circ.GENTEx` [ok] 200 793ms https://api.backed.fi/api/v2/public/assets/GENTEx/circulating-supply?format=object
...
- `xstocks.price.SWPRPx` [FAIL]  12010ms https://api.backed.fi/api/v2/public/assets/SWPRPx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.HKCGAx` [ok] 200 996ms https://api.backed.fi/api/v2/public/assets/HKCGAx/multiplier?network=Solana
...
- `xstocks.mult.KUAIx` [ok] 200 313ms https://api.backed.fi/api/v2/public/assets/KUAIx/multiplier?network=Solana
...
- `xstocks.circ.COVELx` [ok] 200 139ms https://api.backed.fi/api/v2/public/assets/COVELx/circulating-supply?format=object
...
- `xstocks.mult.CHONGx` [ok] 200 769ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
...
- `xstocks.circ.CKHUTx` [ok] 200 541ms https://api.backed.fi/api/v2/public/assets/CKHUTx/circulating-supply?format=object
- `xstocks.mult.CKHUTx` [ok] 200 552ms https://api.backed.fi/api/v2/public/assets/CKHUTx/multiplier?network=Solana
...
- `jup.tokens.search.NWGx` [ok] 200 51ms https://lite-api.jup.ag/tokens/v2/search?query=NWGx
