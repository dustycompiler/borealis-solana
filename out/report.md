...
**Generated** 2026-08-29T09:18:48Z · 2026-08-29 02:18:48 PT
**Author** dustycompiler · **Version** 1.5.6 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-29T09:18:37Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h -2.93%; DEX 24h $2.62B · 1d -29% · vs-7d-ago -27%; slot 316 ms
...
- **WARN · Correlation: risk-off (SOL 24h ↓ + TVL 1d ↓ + DEX 1d ↓)** — SOL 24h -2.93%, DeFiLlama TVL 1d -2.68%, DEX 1d -29.33%. (threshold: `SOL 24h < 0 AND TVL 1d < 0 AND DEX 1d < 0`)
...
| Health | `ok` |
| Slot | 442,570,697 |
| Block height | 420,618,607 |
| Block time | 2026-08-29T09:18:37Z |
| Epoch | 1,024 (46.92% · slot 202,697/432,000) |
| Mean TPS (last ~3,600s) | 3,531.4 |
| Mean non-vote TPS | 1,363.5 |
| Median TPS (same window) | 3,514.4 |
| Mean slot time | 316.1 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 543,042,362,085 |
| Circulating supply | 584,161,682 SOL |
| Total supply | 633,079,222 SOL |
...
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1318018 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 223996 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 586943 slots
- `kom1oNHy…` · 662.86 SOL · commission 5% · lag 1934181 slots
- `7ZjHeeYE…` · 176.09 SOL · commission 5% · lag 146220 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442570697 slots
- `pSo1KZXg…` · 2.00 SOL · commission 4% · lag 232856 slots
- `7Dvp5zCF…` · 1.07 SOL · commission 100% · lag 391342 slots
- `bcZxRSoz…` · 0.00 SOL · commission 0% · lag 1930698 slots
...
| --- | ---: | --- |
| TPS chart | 84 | data/history.jsonl snapshot tape |
| TVL chart | 84 | data/history.jsonl snapshot tape |
| SOL chart | 83 | data/history.jsonl snapshot tape |
| history.jsonl rows | 84 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $36.59K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 36592 USD; at p95 floor → 12185088 USD. |
...
24h volume $30.84M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-08-29 (2026-08-29 02:18:48 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 7433ms https://api.mainnet-beta.solana.com
...
- `llama.fees` [ok] 200 950ms https://api.llama.fi/overview/fees/Solana?excludeTotalDataChart=true&excludeTotalDataChartBreakdown=true
...
- `rss.nitter.solana` [ok] 200 2163ms https://nitter.perennialte.ch/solana/rss
- `rss.nitter.solana_status` [ok] 200 1303ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [ok] 200 2072ms https://nitter.perennialte.ch/anza_xyz/rss
- `rss.nitter.solana_devs` [ok] 200 2232ms https://nitter.perennialte.ch/solana_devs/rss
...
- `xstocks.assets.p3` [ok] 200 2854ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=3
...
- `xstocks.assets.p7` [ok] 200 441ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=7
...
- `xstocks.circ.GOOGLx` [ok] 200 169ms https://api.backed.fi/api/v2/public/assets/GOOGLx/circulating-supply?format=object
...
- `xstocks.circ.MSFTx` [ok] 200 571ms https://api.backed.fi/api/v2/public/assets/MSFTx/circulating-supply?format=object
...
- `xstocks.circ.TSLAx` [ok] 200 1229ms https://api.backed.fi/api/v2/public/assets/TSLAx/circulating-supply?format=object
...
- `xstocks.mult.MMGx` [ok] 200 725ms https://api.backed.fi/api/v2/public/assets/MMGx/multiplier?network=Solana
- `xstocks.circ.LAOPGx` [ok] 200 138ms https://api.backed.fi/api/v2/public/assets/LAOPGx/circulating-supply?format=object
- `xstocks.circ.TNGYIx` [ok] 200 1025ms https://api.backed.fi/api/v2/public/assets/TNGYIx/circulating-supply?format=object
...
- `xstocks.circ.ZHAOMx` [ok] 200 1335ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/circulating-supply?format=object
...
- `xstocks.circ.KUNLx` [ok] 200 743ms https://api.backed.fi/api/v2/public/assets/KUNLx/circulating-supply?format=object
...
- `xstocks.circ.CTINSx` [ok] 200 1358ms https://api.backed.fi/api/v2/public/assets/CTINSx/circulating-supply?format=object
...
- `xstocks.mult.KUNLx` [ok] 200 709ms https://api.backed.fi/api/v2/public/assets/KUNLx/multiplier?network=Solana
- `xstocks.mult.JDLOGx` [ok] 200 186ms https://api.backed.fi/api/v2/public/assets/JDLOGx/multiplier?network=Solana
- `xstocks.circ.WRFHDx` [ok] 200 1442ms https://api.backed.fi/api/v2/public/assets/WRFHDx/circulating-supply?format=object
...
- `xstocks.circ.SZIGHx` [ok] 200 1081ms https://api.backed.fi/api/v2/public/assets/SZIGHx/circulating-supply?format=object
- `xstocks.circ.SNBIOx` [ok] 200 1152ms https://api.backed.fi/api/v2/public/assets/SNBIOx/circulating-supply?format=object
...
- `xstocks.circ.ENNHLx` [ok] 200 904ms https://api.backed.fi/api/v2/public/assets/ENNHLx/circulating-supply?format=object
...
- `xstocks.price.HRZRBx` [FAIL]  12010ms https://api.backed.fi/api/v2/public/assets/HRZRBx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.SMOIHx` [ok] 200 1057ms https://api.backed.fi/api/v2/public/assets/SMOIHx/circulating-supply?format=object
...
- `xstocks.circ.HRZRBx` [ok] 200 1272ms https://api.backed.fi/api/v2/public/assets/HRZRBx/circulating-supply?format=object
...
- `xstocks.circ.CRESMx` [ok] 200 837ms https://api.backed.fi/api/v2/public/assets/CRESMx/circulating-supply?format=object
- `xstocks.mult.CRESMx` [ok] 200 143ms https://api.backed.fi/api/v2/public/assets/CRESMx/multiplier?network=Solana
- `xstocks.circ.CSPCx` [ok] 200 1129ms https://api.backed.fi/api/v2/public/assets/CSPCx/circulating-supply?format=object
- `xstocks.circ.JTGEXx` [ok] 200 1115ms https://api.backed.fi/api/v2/public/assets/JTGEXx/circulating-supply?format=object
...
- `xstocks.circ.WXXDCx` [ok] 200 1103ms https://api.backed.fi/api/v2/public/assets/WXXDCx/circulating-supply?format=object
- `xstocks.mult.CRESBx` [ok] 200 913ms https://api.backed.fi/api/v2/public/assets/CRESBx/multiplier?network=Solana
- `xstocks.mult.WXXDCx` [ok] 200 160ms https://api.backed.fi/api/v2/public/assets/WXXDCx/multiplier?network=Solana
- `xstocks.circ.CMERPx` [ok] 200 3061ms https://api.backed.fi/api/v2/public/assets/CMERPx/circulating-supply?format=object
...
- `xstocks.mult.CMENDx` [ok] 200 988ms https://api.backed.fi/api/v2/public/assets/CMENDx/multiplier?network=Solana
- `xstocks.circ.SITCx` [ok] 200 208ms https://api.backed.fi/api/v2/public/assets/SITCx/circulating-supply?format=object
- `xstocks.circ.MIXUx` [ok] 200 836ms https://api.backed.fi/api/v2/public/assets/MIXUx/circulating-supply?format=object
...
- `xstocks.mult.BDWAPx` [ok] 200 1360ms https://api.backed.fi/api/v2/public/assets/BDWAPx/multiplier?network=Solana
- `xstocks.circ.JDHLTx` [ok] 200 784ms https://api.backed.fi/api/v2/public/assets/JDHLTx/circulating-supply?format=object
...
- `xstocks.circ.SNDSCx` [ok] 200 815ms https://api.backed.fi/api/v2/public/assets/SNDSCx/circulating-supply?format=object
- `xstocks.mult.SNDSCx` [ok] 200 1103ms https://api.backed.fi/api/v2/public/assets/SNDSCx/multiplier?network=Solana
...
- `xstocks.mult.WHGROx` [ok] 200 888ms https://api.backed.fi/api/v2/public/assets/WHGROx/multiplier?network=Solana
...
- `xstocks.mult.PWAHLx` [ok] 200 171ms https://api.backed.fi/api/v2/public/assets/PWAHLx/multiplier?network=Solana
...
- `xstocks.circ.GENTEx` [ok] 200 133ms https://api.backed.fi/api/v2/public/assets/GENTEx/circulating-supply?format=object
- `xstocks.circ.CLPHDx` [ok] 200 354ms https://api.backed.fi/api/v2/public/assets/CLPHDx/circulating-supply?format=object
...
- `xstocks.mult.CLPHDx` [ok] 200 391ms https://api.backed.fi/api/v2/public/assets/CLPHDx/multiplier?network=Solana
- `xstocks.mult.GENTEx` [ok] 200 518ms https://api.backed.fi/api/v2/public/assets/GENTEx/multiplier?network=Solana
...
- `xstocks.circ.SWPRPx` [ok] 200 899ms https://api.backed.fi/api/v2/public/assets/SWPRPx/circulating-supply?format=object
...
- `xstocks.circ.HKCGAx` [ok] 200 607ms https://api.backed.fi/api/v2/public/assets/HKCGAx/circulating-supply?format=object
...
- `xstocks.circ.HKEXCx` [ok] 200 346ms https://api.backed.fi/api/v2/public/assets/HKEXCx/circulating-supply?format=object
- `xstocks.mult.COVELx` [ok] 200 373ms https://api.backed.fi/api/v2/public/assets/COVELx/multiplier?network=Solana
- `xstocks.mult.HKEXCx` [ok] 200 767ms https://api.backed.fi/api/v2/public/assets/HKEXCx/multiplier?network=Solana
- `xstocks.mult.NONGx` [ok] 200 971ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
...
- `xstocks.mult.CHONGx` [ok] 200 611ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
...
- `xstocks.mult.GEELx` [ok] 200 348ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
...
- `xstocks.mult.PICCx` [ok] 200 1469ms https://api.backed.fi/api/v2/public/assets/PICCx/multiplier?network=Solana
- `xstocks.circ.POPMTx` [ok] 200 615ms https://api.backed.fi/api/v2/public/assets/POPMTx/circulating-supply?format=object
- `xstocks.circ.BOCOMx` [ok] 200 291ms https://api.backed.fi/api/v2/public/assets/BOCOMx/circulating-supply?format=object
...
- `xstocks.price.CITICx` [FAIL]  12023ms https://api.backed.fi/api/v2/public/assets/CITICx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.CITICx` [ok] 200 155ms https://api.backed.fi/api/v2/public/assets/CITICx/circulating-supply?format=object
- `xstocks.circ.BOCHKx` [ok] 200 427ms https://api.backed.fi/api/v2/public/assets/BOCHKx/circulating-supply?format=object
- `xstocks.mult.CITICx` [ok] 200 228ms https://api.backed.fi/api/v2/public/assets/CITICx/multiplier?network=Solana
...
- `xstocks.circ.CRESLx` [ok] 200 129ms https://api.backed.fi/api/v2/public/assets/CRESLx/circulating-supply?format=object
...
- `xstocks.circ.HAIERx` [ok] 200 418ms https://api.backed.fi/api/v2/public/assets/HAIERx/circulating-supply?format=object
...
- `xstocks.circ.PSBOCx` [ok] 200 131ms https://api.backed.fi/api/v2/public/assets/PSBOCx/circulating-supply?format=object
- `xstocks.mult.HAIERx` [ok] 200 312ms https://api.backed.fi/api/v2/public/assets/HAIERx/multiplier?network=Solana
...
- `xstocks.circ.ZJGLDx` [ok] 200 1403ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/circulating-supply?format=object
- `xstocks.mult.ZJGLDx` [ok] 200 174ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/multiplier?network=Solana
- `xstocks.circ.ICBCx` [ok] 200 1668ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
- `xstocks.mult.ICBCx` [ok] 200 181ms https://api.backed.fi/api/v2/public/assets/ICBCx/multiplier?network=Solana
...
- `jup.tokens.search.TNGYIx` [ok] 200 57ms https://lite-api.jup.ag/tokens/v2/search?query=TNGYIx
