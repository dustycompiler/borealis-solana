...
**Generated** 2026-09-05T13:34:15Z · 2026-09-05 06:34:15 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-05T13:34:05Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h +1.49%; DEX 24h $1.88B · 1d -24% · vs-7d-ago -27%; slot 315 ms
...
| Health | `ok` |
| Slot | 444,531,880 |
| Block height | 422,576,344 |
| Block time | 2026-09-05T13:34:05Z |
| Epoch | 1,029 (0.90% · slot 3,881/432,000) |
| Mean TPS (last ~3,600s) | 3,248.9 |
| Mean non-vote TPS | 1,116.6 |
| Median TPS (same window) | 3,240.4 |
| Mean slot time | 314.6 ms |
| Median slot time | 314.1 ms |
| Transaction count (cluster) | 545,392,259,779 |
| Circulating supply | 585,446,015 SOL |
| Total supply | 633,549,793 SOL |
...
- `gUvo3g5L…` · 306.62K SOL · commission 0% · lag 3753 slots
- `xLabscif…` · 28.57K SOL · commission 5% · lag 743507 slots
- `mrgn4atx…` · 20.30K SOL · commission 0% · lag 19997 slots
- `prt1st4R…` · 13.11K SOL · commission 5% · lag 1044938 slots
- `E4xNK4Uw…` · 6.26K SOL · commission 5% · lag 1183157 slots
- `5ZjxMYBb…` · 4.06K SOL · commission 0% · lag 565958 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 1745759 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 1093241 slots
- `CpdzCVza…` · 193.38 SOL · commission 100% · lag 1731529 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 1773043 slots
- `HFTcVVrX…` · 148.42 SOL · commission 100% · lag 1731423 slots
- `6pEtDovp…` · 131.86 SOL · commission 100% · lag 1745807 slots
...
| Jito tip-floor run-rate (NOT REV) | $15.05K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 15050 USD; at p95 floor → 4575094 USD. |
...
24h volume $18.42M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-09-05 (2026-09-05 06:34:15 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rss.xcancel.solana` [ok] 200 702ms https://xcancel.com/solana/rss
- `rss.xcancel.solana_status` [ok] 200 146ms https://xcancel.com/solana_status/rss
...
- `rss.nitter.solana_status` [ok] 200 1478ms https://nitter.perennialte.ch/solana_status/rss
...
- `rpc.getBlock.fallback` [ok] 200 675ms https://solana-rpc.publicnode.com
- `rpc.getBlock` [ok] 200 409ms https://api.mainnet-beta.solana.com
- `rpc.getBlock` [ok] 200 409ms https://api.mainnet-beta.solana.com
...
- `xstocks.assets.p1` [ok] 200 2426ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=1
- `xstocks.assets.p2` [ok] 200 1891ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=2
- `xstocks.assets.p3` [ok] 200 1991ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=3
...
- `xstocks.assets.p7` [ok] 200 1084ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=7
...
- `xstocks.circ.METAx` [ok] 200 244ms https://api.backed.fi/api/v2/public/assets/METAx/circulating-supply?format=object
...
- `xstocks.mult.METAx` [ok] 200 300ms https://api.backed.fi/api/v2/public/assets/METAx/multiplier?network=Solana
- `xstocks.mult.TSLAx` [ok] 200 381ms https://api.backed.fi/api/v2/public/assets/TSLAx/multiplier?network=Solana
...
- `xstocks.circ.MSFTx` [ok] 200 752ms https://api.backed.fi/api/v2/public/assets/MSFTx/circulating-supply?format=object
...
- `xstocks.price.MUUx` [FAIL]  12017ms https://api.backed.fi/api/v2/public/assets/MUUx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.DRAMx` [ok] 200 614ms https://api.backed.fi/api/v2/public/assets/DRAMx/circulating-supply?format=object
- `xstocks.mult.QQQx` [ok] 200 518ms https://api.backed.fi/api/v2/public/assets/QQQx/multiplier?network=Solana
- `xstocks.price.KORUx` [FAIL]  12010ms https://api.backed.fi/api/v2/public/assets/KORUx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.DRAMx` [ok] 200 688ms https://api.backed.fi/api/v2/public/assets/DRAMx/multiplier?network=Solana
- `xstocks.circ.MVLLx` [ok] 200 1400ms https://api.backed.fi/api/v2/public/assets/MVLLx/circulating-supply?format=object
- `xstocks.mult.MUUx` [ok] 200 1313ms https://api.backed.fi/api/v2/public/assets/MUUx/multiplier?network=Solana
- `xstocks.mult.MVLLx` [ok] 200 320ms https://api.backed.fi/api/v2/public/assets/MVLLx/multiplier?network=Solana
- `xstocks.circ.AXTIx` [ok] 200 1868ms https://api.backed.fi/api/v2/public/assets/AXTIx/circulating-supply?format=object
- `xstocks.mult.AXTIx` [ok] 200 537ms https://api.backed.fi/api/v2/public/assets/AXTIx/multiplier?network=Solana
- `xstocks.mult.DJTx` [ok] 200 2468ms https://api.backed.fi/api/v2/public/assets/DJTx/multiplier?network=Solana
...
- `xstocks.circ.INTWx` [ok] 200 491ms https://api.backed.fi/api/v2/public/assets/INTWx/circulating-supply?format=object
- `xstocks.mult.INTWx` [ok] 200 157ms https://api.backed.fi/api/v2/public/assets/INTWx/multiplier?network=Solana
...
- `xstocks.circ.SOXSx` [ok] 200 505ms https://api.backed.fi/api/v2/public/assets/SOXSx/circulating-supply?format=object
...
- `xstocks.circ.SHEINx` [ok] 200 485ms https://api.backed.fi/api/v2/public/assets/SHEINx/circulating-supply?format=object
...
- `xstocks.mult.MMGx` [ok] 200 654ms https://api.backed.fi/api/v2/public/assets/MMGx/multiplier?network=Solana
- `xstocks.circ.NWGx` [ok] 200 2490ms https://api.backed.fi/api/v2/public/assets/NWGx/circulating-supply?format=object
- `xstocks.mult.NWGx` [ok] 200 147ms https://api.backed.fi/api/v2/public/assets/NWGx/multiplier?network=Solana
- `xstocks.mult.SUOPTx` [ok] 200 1532ms https://api.backed.fi/api/v2/public/assets/SUOPTx/multiplier?network=Solana
...
- `xstocks.mult.JDLOGx` [ok] 200 635ms https://api.backed.fi/api/v2/public/assets/JDLOGx/multiplier?network=Solana
...
- `xstocks.mult.LAOPGx` [ok] 200 921ms https://api.backed.fi/api/v2/public/assets/LAOPGx/multiplier?network=Solana
- `xstocks.circ.KUNLx` [ok] 200 537ms https://api.backed.fi/api/v2/public/assets/KUNLx/circulating-supply?format=object
- `xstocks.price.WRFHDx` [FAIL]  12017ms https://api.backed.fi/api/v2/public/assets/WRFHDx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.CTINSx` [ok] 200 1897ms https://api.backed.fi/api/v2/public/assets/CTINSx/multiplier?network=Solana
...
- `xstocks.mult.HAIDLx` [ok] 200 607ms https://api.backed.fi/api/v2/public/assets/HAIDLx/multiplier?network=Solana
...
- `xstocks.circ.SNBIOx` [ok] 200 424ms https://api.backed.fi/api/v2/public/assets/SNBIOx/circulating-supply?format=object
...
- `xstocks.mult.SNBIOx` [ok] 200 694ms https://api.backed.fi/api/v2/public/assets/SNBIOx/multiplier?network=Solana
...
- `xstocks.mult.HRZRBx` [ok] 200 1327ms https://api.backed.fi/api/v2/public/assets/HRZRBx/multiplier?network=Solana
...
- `xstocks.price.CRESMx` [FAIL]  12011ms https://api.backed.fi/api/v2/public/assets/CRESMx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.JTGEXx` [ok] 200 577ms https://api.backed.fi/api/v2/public/assets/JTGEXx/multiplier?network=Solana
- `xstocks.mult.CRESMx` [ok] 200 528ms https://api.backed.fi/api/v2/public/assets/CRESMx/multiplier?network=Solana
...
- `xstocks.circ.ASMPTx` [ok] 200 524ms https://api.backed.fi/api/v2/public/assets/ASMPTx/circulating-supply?format=object
- `xstocks.mult.ASMPTx` [ok] 200 402ms https://api.backed.fi/api/v2/public/assets/ASMPTx/multiplier?network=Solana
- `xstocks.circ.WHRFRx` [ok] 200 2501ms https://api.backed.fi/api/v2/public/assets/WHRFRx/circulating-supply?format=object
- `xstocks.mult.WHRFRx` [ok] 200 1117ms https://api.backed.fi/api/v2/public/assets/WHRFRx/multiplier?network=Solana
...
- `xstocks.circ.JDHLTx` [ok] 200 757ms https://api.backed.fi/api/v2/public/assets/JDHLTx/circulating-supply?format=object
- `xstocks.mult.JDHLTx` [ok] 200 281ms https://api.backed.fi/api/v2/public/assets/JDHLTx/multiplier?network=Solana
...
- `xstocks.mult.SNDSCx` [ok] 200 620ms https://api.backed.fi/api/v2/public/assets/SNDSCx/multiplier?network=Solana
- `xstocks.circ.CRESPx` [ok] 200 404ms https://api.backed.fi/api/v2/public/assets/CRESPx/circulating-supply?format=object
...
- `xstocks.mult.CRESPx` [ok] 200 603ms https://api.backed.fi/api/v2/public/assets/CRESPx/multiplier?network=Solana
- `xstocks.circ.SINOTx` [ok] 200 582ms https://api.backed.fi/api/v2/public/assets/SINOTx/circulating-supply?format=object
- `xstocks.mult.PRADx` [ok] 200 513ms https://api.backed.fi/api/v2/public/assets/PRADx/multiplier?network=Solana
...
- `xstocks.mult.SINOTx` [ok] 200 703ms https://api.backed.fi/api/v2/public/assets/SINOTx/multiplier?network=Solana
- `xstocks.circ.CTFJWx` [ok] 200 1391ms https://api.backed.fi/api/v2/public/assets/CTFJWx/circulating-supply?format=object
- `xstocks.mult.CTFJWx` [ok] 200 892ms https://api.backed.fi/api/v2/public/assets/CTFJWx/multiplier?network=Solana
...
- `xstocks.mult.CLONPx` [ok] 200 1460ms https://api.backed.fi/api/v2/public/assets/CLONPx/multiplier?network=Solana
...
- `xstocks.circ.WHGROx` [ok] 200 2819ms https://api.backed.fi/api/v2/public/assets/WHGROx/circulating-supply?format=object
- `xstocks.mult.PWAHLx` [ok] 200 228ms https://api.backed.fi/api/v2/public/assets/PWAHLx/multiplier?network=Solana
- `xstocks.circ.CLPHDx` [ok] 200 586ms https://api.backed.fi/api/v2/public/assets/CLPHDx/circulating-supply?format=object
...
- `xstocks.mult.CLPHDx` [ok] 200 511ms https://api.backed.fi/api/v2/public/assets/CLPHDx/multiplier?network=Solana
- `xstocks.mult.GENTEx` [ok] 200 712ms https://api.backed.fi/api/v2/public/assets/GENTEx/multiplier?network=Solana
...
- `xstocks.circ.WUXIBx` [ok] 200 1111ms https://api.backed.fi/api/v2/public/assets/WUXIBx/circulating-supply?format=object
- `xstocks.mult.WUXIBx` [ok] 200 529ms https://api.backed.fi/api/v2/public/assets/WUXIBx/multiplier?network=Solana
...
- `xstocks.circ.CKAHx` [ok] 200 1143ms https://api.backed.fi/api/v2/public/assets/CKAHx/circulating-supply?format=object
...
- `xstocks.circ.HKEXCx` [ok] 200 2350ms https://api.backed.fi/api/v2/public/assets/HKEXCx/circulating-supply?format=object
...
- `xstocks.mult.GEELx` [ok] 200 938ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
...
- `xstocks.circ.PICCx` [ok] 200 1138ms https://api.backed.fi/api/v2/public/assets/PICCx/circulating-supply?format=object
- `xstocks.circ.COSCx` [ok] 200 379ms https://api.backed.fi/api/v2/public/assets/COSCx/circulating-supply?format=object
- `xstocks.mult.COSCx` [ok] 200 152ms https://api.backed.fi/api/v2/public/assets/COSCx/multiplier?network=Solana
...
- `xstocks.mult.PICCx` [ok] 200 2340ms https://api.backed.fi/api/v2/public/assets/PICCx/multiplier?network=Solana
...
- `jup.tokens.search.DJTx` [ok] 200 73ms https://lite-api.jup.ag/tokens/v2/search?query=DJTx
- `jup.tokens.search.INTWx` [ok] 200 72ms https://lite-api.jup.ag/tokens/v2/search?query=INTWx
