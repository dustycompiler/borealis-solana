...
**Generated** 2026-09-06T17:49:06Z · 2026-09-06 10:49:06 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-06T17:48:56Z · **RPC health** `ok`
**Health score** 98 / 100 — `25×rpc_ok + 30×clamp(1 − max(0, slot_ms − 300)/300, 0, 1) + 25×clamp(1 − delinquent_stake_pct/2, 0, 1) + 20×clamp(tps / tps_baseline, 0, 1)`
**Network health** HEALTHY · **Ecosystem** ELEVATED — SOL 24h +2.26%; DEX 24h $1.96B · 1d +4% · vs-7d-ago +17%; slot 318 ms
...
| Health | `ok` |
| Slot | 444,853,356 |
| Block height | 422,897,688 |
| Block time | 2026-09-06T17:48:56Z |
| Epoch | 1,029 (75.31% · slot 325,359/432,000) |
| Mean TPS (last ~3,600s) | 3,889.8 |
| Mean non-vote TPS | 1,772.6 |
| Median TPS (same window) | 3,879.8 |
| Mean slot time | 317.6 ms |
| Median slot time | 317.5 ms |
| Transaction count (cluster) | 545,753,424,913 |
| Circulating supply | 585,444,963 SOL |
| Total supply | 633,548,838 SOL |
...
- `xLabscif…` · 28.57K SOL · commission 5% · lag 1064983 slots
- `mrgn4atx…` · 20.30K SOL · commission 0% · lag 89246 slots
- `prt1st4R…` · 13.11K SOL · commission 5% · lag 1366414 slots
- `E4xNK4Uw…` · 6.26K SOL · commission 5% · lag 1504633 slots
- `5ZjxMYBb…` · 4.06K SOL · commission 0% · lag 887434 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 2067235 slots
- `pSoLoZx5…` · 1.51K SOL · commission 4% · lag 314165 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 1414717 slots
- `CpdzCVza…` · 193.38 SOL · commission 100% · lag 2053005 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 2094519 slots
- `HFTcVVrX…` · 148.42 SOL · commission 100% · lag 2052899 slots
- `6pEtDovp…` · 131.86 SOL · commission 100% · lag 2067283 slots
...
| Jito tip-floor run-rate (NOT REV) | $53.39K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 53386 USD; at p95 floor → 2030191 USD. |
...
| p90 / p99 | 0.000013 / 0.000264 SOL | same sample |
...
| Metric | Value | Source |
| --- | ---: | --- |
| SOL/USD | $106.05 | coingecko.simple_price |
...
24h volume $89.41M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-09-06 (2026-09-06 10:49:06 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getHealth` [ok] 200 345ms https://api.mainnet-beta.solana.com
...
- `rpc.getVoteAccounts` [ok] 200 608ms https://api.mainnet-beta.solana.com
...
- `solana.com.databricks` [ok] 200 711ms https://solana.com/api/databricks/data?days=30
...
- `rss.nitter.solana` [FAIL] 502 5417ms https://nitter.perennialte.ch/solana/rss — HTTP 502 Bad Gateway
- `rss.nitter.solana_status` [FAIL] 502 4598ms https://nitter.perennialte.ch/solana_status/rss — HTTP 502 Bad Gateway
- `rss.nitter.anza_xyz` [ok] 200 15232ms https://nitter.perennialte.ch/anza_xyz/rss
- `rss.nitter.solana_devs` [ok] 200 6115ms https://nitter.perennialte.ch/solana_devs/rss
...
- `rpc.getBalance` [ok] 200 367ms https://api.mainnet-beta.solana.com
- `rpc.getBlocks` [ok] 200 383ms https://api.mainnet-beta.solana.com
- `rpc.getBlock` [ok] 200 1147ms https://api.mainnet-beta.solana.com
- `rpc.getBlock` [ok] 200 1323ms https://api.mainnet-beta.solana.com
- `rpc.getBlock` [ok] 200 1451ms https://api.mainnet-beta.solana.com
- `rpc.getBlock` [ok] 200 1441ms https://api.mainnet-beta.solana.com
...
- `xstocks.assets.p0` [ok] 200 1900ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0
...
- `xstocks.circ.GOOGLx` [ok] 200 366ms https://api.backed.fi/api/v2/public/assets/GOOGLx/circulating-supply?format=object
...
- `xstocks.circ.NVDAx` [ok] 200 617ms https://api.backed.fi/api/v2/public/assets/NVDAx/circulating-supply?format=object
...
- `xstocks.circ.MUUx` [ok] 200 181ms https://api.backed.fi/api/v2/public/assets/MUUx/circulating-supply?format=object
...
- `xstocks.mult.MUUx` [ok] 200 638ms https://api.backed.fi/api/v2/public/assets/MUUx/multiplier?network=Solana
- `xstocks.mult.MVLLx` [ok] 200 533ms https://api.backed.fi/api/v2/public/assets/MVLLx/multiplier?network=Solana
- `xstocks.circ.KORUx` [ok] 200 2209ms https://api.backed.fi/api/v2/public/assets/KORUx/circulating-supply?format=object
- `xstocks.circ.DJTx` [ok] 200 2539ms https://api.backed.fi/api/v2/public/assets/DJTx/circulating-supply?format=object
...
- `xstocks.circ.INTWx` [ok] 200 1028ms https://api.backed.fi/api/v2/public/assets/INTWx/circulating-supply?format=object
...
- `xstocks.circ.NWGx` [ok] 200 1341ms https://api.backed.fi/api/v2/public/assets/NWGx/circulating-supply?format=object
- `xstocks.circ.SOXSx` [ok] 200 2149ms https://api.backed.fi/api/v2/public/assets/SOXSx/circulating-supply?format=object
...
- `xstocks.mult.SOXSx` [ok] 200 418ms https://api.backed.fi/api/v2/public/assets/SOXSx/multiplier?network=Solana
...
- `xstocks.mult.SUOPTx` [ok] 200 125ms https://api.backed.fi/api/v2/public/assets/SUOPTx/multiplier?network=Solana
- `xstocks.mult.MMGx` [ok] 200 1078ms https://api.backed.fi/api/v2/public/assets/MMGx/multiplier?network=Solana
...
- `xstocks.circ.TNGYIx` [ok] 200 900ms https://api.backed.fi/api/v2/public/assets/TNGYIx/circulating-supply?format=object
- `xstocks.circ.LAOPGx` [ok] 200 734ms https://api.backed.fi/api/v2/public/assets/LAOPGx/circulating-supply?format=object
- `xstocks.mult.LAOPGx` [ok] 200 142ms https://api.backed.fi/api/v2/public/assets/LAOPGx/multiplier?network=Solana
- `xstocks.mult.TNGYIx` [ok] 200 572ms https://api.backed.fi/api/v2/public/assets/TNGYIx/multiplier?network=Solana
- `xstocks.circ.JDLOGx` [ok] 200 1070ms https://api.backed.fi/api/v2/public/assets/JDLOGx/circulating-supply?format=object
...
- `xstocks.price.WRFHDx` [FAIL]  12024ms https://api.backed.fi/api/v2/public/assets/WRFHDx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.WRFHDx` [ok] 200 385ms https://api.backed.fi/api/v2/public/assets/WRFHDx/circulating-supply?format=object
...
- `xstocks.circ.ZHAOMx` [ok] 200 2762ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/circulating-supply?format=object
...
- `xstocks.circ.KUNLx` [ok] 200 3275ms https://api.backed.fi/api/v2/public/assets/KUNLx/circulating-supply?format=object
- `xstocks.mult.KUNLx` [ok] 200 488ms https://api.backed.fi/api/v2/public/assets/KUNLx/multiplier?network=Solana
...
- `xstocks.circ.SNBIOx` [ok] 200 487ms https://api.backed.fi/api/v2/public/assets/SNBIOx/circulating-supply?format=object
- `xstocks.mult.SNBIOx` [ok] 200 326ms https://api.backed.fi/api/v2/public/assets/SNBIOx/multiplier?network=Solana
- `xstocks.circ.ENNHLx` [ok] 200 727ms https://api.backed.fi/api/v2/public/assets/ENNHLx/circulating-supply?format=object
- `xstocks.mult.ENNHLx` [ok] 200 125ms https://api.backed.fi/api/v2/public/assets/ENNHLx/multiplier?network=Solana
...
- `xstocks.circ.SZIGHx` [ok] 200 1332ms https://api.backed.fi/api/v2/public/assets/SZIGHx/circulating-supply?format=object
...
- `xstocks.mult.SMOIHx` [ok] 200 569ms https://api.backed.fi/api/v2/public/assets/SMOIHx/multiplier?network=Solana
...
- `xstocks.circ.HRZRBx` [ok] 200 1796ms https://api.backed.fi/api/v2/public/assets/HRZRBx/circulating-supply?format=object
- `xstocks.mult.HRZRBx` [ok] 200 156ms https://api.backed.fi/api/v2/public/assets/HRZRBx/multiplier?network=Solana
- `xstocks.mult.CRESBx` [ok] 200 576ms https://api.backed.fi/api/v2/public/assets/CRESBx/multiplier?network=Solana
...
- `xstocks.circ.JTGEXx` [ok] 200 2444ms https://api.backed.fi/api/v2/public/assets/JTGEXx/circulating-supply?format=object
...
- `xstocks.mult.JTGEXx` [ok] 200 1017ms https://api.backed.fi/api/v2/public/assets/JTGEXx/multiplier?network=Solana
...
- `xstocks.circ.ASMPTx` [ok] 200 1418ms https://api.backed.fi/api/v2/public/assets/ASMPTx/circulating-supply?format=object
...
- `xstocks.price.CRESPx` [FAIL]  12017ms https://api.backed.fi/api/v2/public/assets/CRESPx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.CRESPx` [ok] 200 246ms https://api.backed.fi/api/v2/public/assets/CRESPx/circulating-supply?format=object
...
- `xstocks.mult.SNDSCx` [ok] 200 976ms https://api.backed.fi/api/v2/public/assets/SNDSCx/multiplier?network=Solana
...
- `xstocks.mult.SINOTx` [ok] 200 112ms https://api.backed.fi/api/v2/public/assets/SINOTx/multiplier?network=Solana
...
- `xstocks.mult.CLONPx` [ok] 200 496ms https://api.backed.fi/api/v2/public/assets/CLONPx/multiplier?network=Solana
...
- `xstocks.circ.WHGROx` [ok] 200 717ms https://api.backed.fi/api/v2/public/assets/WHGROx/circulating-supply?format=object
...
- `xstocks.mult.SINOx` [ok] 200 506ms https://api.backed.fi/api/v2/public/assets/SINOx/multiplier?network=Solana
...
- `xstocks.price.CLPHDx` [FAIL]  12013ms https://api.backed.fi/api/v2/public/assets/CLPHDx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.CTPCAx` [ok] 200 1145ms https://api.backed.fi/api/v2/public/assets/CTPCAx/multiplier?network=Solana
- `xstocks.circ.CLPHDx` [ok] 200 1226ms https://api.backed.fi/api/v2/public/assets/CLPHDx/circulating-supply?format=object
...
- `xstocks.mult.SWPRPx` [ok] 200 1418ms https://api.backed.fi/api/v2/public/assets/SWPRPx/multiplier?network=Solana
...
- `xstocks.mult.CKINFx` [ok] 200 1196ms https://api.backed.fi/api/v2/public/assets/CKINFx/multiplier?network=Solana
...
- `xstocks.circ.HKCGAx` [ok] 200 1792ms https://api.backed.fi/api/v2/public/assets/HKCGAx/circulating-supply?format=object
- `xstocks.mult.HKCGAx` [ok] 200 568ms https://api.backed.fi/api/v2/public/assets/HKCGAx/multiplier?network=Solana
- `xstocks.mult.COVELx` [ok] 200 896ms https://api.backed.fi/api/v2/public/assets/COVELx/multiplier?network=Solana
- `xstocks.mult.NONGx` [ok] 200 1658ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
...
- `xstocks.circ.CHONGx` [ok] 200 237ms https://api.backed.fi/api/v2/public/assets/CHONGx/circulating-supply?format=object
...
- `xstocks.circ.GEELx` [ok] 200 1195ms https://api.backed.fi/api/v2/public/assets/GEELx/circulating-supply?format=object
...
- `xstocks.mult.HNDLDx` [ok] 200 652ms https://api.backed.fi/api/v2/public/assets/HNDLDx/multiplier?network=Solana
...
- `xstocks.mult.GEELx` [ok] 200 1197ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
...
- `xstocks.circ.COSCx` [ok] 200 1088ms https://api.backed.fi/api/v2/public/assets/COSCx/circulating-supply?format=object
- `xstocks.mult.CKHUTx` [ok] 200 1068ms https://api.backed.fi/api/v2/public/assets/CKHUTx/multiplier?network=Solana
- `xstocks.mult.COSCx` [ok] 200 2441ms https://api.backed.fi/api/v2/public/assets/COSCx/multiplier?network=Solana
...
- `jup.tokens.search.AXTIx` [ok] 200 49ms https://lite-api.jup.ag/tokens/v2/search?query=AXTIx
