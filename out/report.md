...
**Generated** 2026-09-11T03:25:06Z · 2026-09-10 20:25:06 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-11T03:24:56Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** ELEVATED — SOL 24h -2.62%; DEX 24h $2.95B · 1d -2% · vs-7d-ago +20%; slot 317 ms
...
- **INFO · Correlation: risk-off (SOL 24h ↓ + TVL 1d ↓ + DEX 1d ↓)** — SOL 24h -2.62%, DeFiLlama TVL 1d -0.74%, DEX 1d -1.73%. (threshold: `SOL 24h < 0 AND TVL 1d < 0 AND DEX 1d < 0`)
...
| Health | `ok` |
| Slot | 446,053,981 |
| Block height | 424,097,281 |
| Block time | 2026-09-11T03:24:56Z |
| Epoch | 1,032 (53.24% · slot 229,982/432,000) |
| Mean TPS (last ~3,600s) | 3,942.9 |
| Mean non-vote TPS | 1,820.3 |
| Median TPS (same window) | 3,868.2 |
| Mean slot time | 317.3 ms |
| Median slot time | 317.5 ms |
| Transaction count (cluster) | 547,252,652,067 |
| Circulating supply | 586,537,782 SOL |
| Total supply | 633,830,347 SOL |
...
| Activated stake | 438,913,784 SOL |
| Delinquent stake | 274,429.43 SOL (0.062%) |
...
- `2jS8AX38…` · 97.37K SOL · commission 0% · lag 1612 slots
- `mrgn2vUP…` · 90.78K SOL · commission 0% · lag 6391 slots
- `scs2Ra91…` · 58.59K SOL · commission 10% · lag 174899 slots
- `AYY1TCe3…` · 10.81K SOL · commission 0% · lag 199824 slots
- `inWVrrYJ…` · 8.46K SOL · commission 0% · lag 354884 slots
- `xLabscif…` · 3.36K SOL · commission 5% · lag 2265608 slots
- `5ZjxMYBb…` · 3.21K SOL · commission 0% · lag 2088059 slots
- `pSoLoZx5…` · 1.51K SOL · commission 4% · lag 258819 slots
- `4GEEKSwu…` · 326.50 SOL · commission 5% · lag 244369 slots
- `stacheBm…` · 3.00 SOL · commission 5% · lag 16518298 slots
- `6mygxmZx…` · 2.00 SOL · commission 100% · lag 446053981 slots
- `Fb77sbwg…` · 1.08 SOL · commission 0% · lag 1214970 slots
...
| Jito tip-floor run-rate (NOT REV) | $77.55K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 77547 USD; at p95 floor → 533062 USD. |
| Protocol fees 24h | $14.81M | EXCLUDED from REV — DeFiLlama Solana protocol fees 24h (not REV) |
| Median tx fee p50 | 0.000005 SOL ($0.0005) | NOT a 24h census · ~2.8h · n_tx=2240 window_seconds=9920 |
...
_As of 2026-09-11 (2026-09-10 20:25:06 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 7657ms https://api.mainnet-beta.solana.com
...
- `llama.historical_tvl` [ok] 200 991ms https://api.llama.fi/v2/historicalChainTvl/Solana
...
- `rss.status.atom` [ok] 200 1676ms https://status.solana.com/history.atom
- `rss.news.rss` [ok] 200 311ms https://solana.com/news/rss.xml
- `rss.anza.medium` [ok] 200 457ms https://medium.com/feed/anza-xyz
- `rss.xcancel.solana` [ok] 200 1096ms https://xcancel.com/solana/rss
- `rss.xcancel.solana_status` [ok] 200 426ms https://xcancel.com/solana_status/rss
...
- `rss.nitter.solana` [ok] 200 2532ms https://nitter.perennialte.ch/solana/rss
- `rss.nitter.solana_status` [ok] 200 198ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [ok] 200 4107ms https://nitter.perennialte.ch/anza_xyz/rss
...
- `xstocks.assets.p0` [FAIL]  15236ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0 — TimeoutError: The read operation timed out
- `xstocks.assets.p0` [FAIL]  15116ms https://api.xstocks.fi/api/v2/public/assets?pageSize=100&page=0 — TimeoutError: The read operation timed out
- `llama.protocol.xstocks` [ok] 200 966ms https://api.llama.fi/protocol/xstocks
