...
**Generated** 2026-08-29T18:48:47Z · 2026-08-29 11:48:47 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-29T18:48:37Z · **RPC health** `ok`
**Health score** 98 / 100 — `25×rpc_ok + 30×clamp(1 − max(0, slot_ms − 300)/300, 0, 1) + 25×clamp(1 − delinquent_stake_pct/2, 0, 1) + 20×clamp(tps / tps_baseline, 0, 1)`
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h +2.36%; DEX 24h $2.59B · 1d -30% · vs-7d-ago -28%; slot 317 ms
...
- **INFO · TPS vs 30d median (solana.com/data tx/86400)** — Current 4,517.28 TPS is +26.0% vs 30d median 3,585.83 TPS (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
...
| Health | `ok` |
| Slot | 442,678,568 |
| Block height | 420,726,415 |
| Block time | 2026-08-29T18:48:37Z |
| Epoch | 1,024 (71.89% · slot 310,569/432,000) |
| Mean TPS (last ~3,600s) | 4,517.3 |
| Mean non-vote TPS | 2,354.5 |
| Median TPS (same window) | 4,536.8 |
| Mean slot time | 316.9 ms |
| Median slot time | 317.5 ms |
| Transaction count (cluster) | 543,174,464,860 |
| Circulating supply | 584,161,335 SOL |
| Total supply | 633,078,875 SOL |
...
- `GiYSnFRr…` · 190.21K SOL · commission 5% · lag 2878 slots
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1425889 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 331867 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 694814 slots
- `kom1oNHy…` · 662.86 SOL · commission 5% · lag 2042052 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442678568 slots
- `pSo1KZXg…` · 2.00 SOL · commission 4% · lag 340727 slots
- `7Dvp5zCF…` · 1.07 SOL · commission 100% · lag 499213 slots
- `bcZxRSoz…` · 0.00 SOL · commission 0% · lag 2038569 slots
...
| --- | ---: | --- |
| TPS chart | 123 | data/history.jsonl snapshot tape |
| TVL chart | 123 | data/history.jsonl snapshot tape |
| SOL chart | 122 | data/history.jsonl snapshot tape |
| history.jsonl rows | 123 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $82.75K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 82748 USD; at p95 floor → 4047391 USD. |
...
| p90 / p99 | 0.000016 / 0.000387 SOL | same sample |
...
_As of 2026-08-29 (2026-08-29 11:48:47 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 7188ms https://api.mainnet-beta.solana.com
...
- `rss.xcancel.solana` [ok] 200 285ms https://xcancel.com/solana/rss
...
- `rss.nitter.solana` [ok] 200 1365ms https://nitter.perennialte.ch/solana/rss
- `rss.nitter.solana_status` [ok] 200 1391ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [ok] 200 1878ms https://nitter.perennialte.ch/anza_xyz/rss
- `rss.nitter.solana_devs` [ok] 200 2065ms https://nitter.perennialte.ch/solana_devs/rss
...
- `xstocks.assets.p0` [ok] 200 1925ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0
- `xstocks.assets.p1` [ok] 200 802ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=1
- `xstocks.assets.p2` [ok] 200 2089ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=2
...
- `xstocks.circ.MSFTx` [ok] 200 271ms https://api.backed.fi/api/v2/public/assets/MSFTx/circulating-supply?format=object
...
- `xstocks.circ.AMZNx` [ok] 200 421ms https://api.backed.fi/api/v2/public/assets/AMZNx/circulating-supply?format=object
- `xstocks.circ.AAPLx` [ok] 200 574ms https://api.backed.fi/api/v2/public/assets/AAPLx/circulating-supply?format=object
- `xstocks.mult.METAx` [ok] 200 333ms https://api.backed.fi/api/v2/public/assets/METAx/multiplier?network=Solana
...
- `xstocks.circ.TNGYIx` [ok] 200 290ms https://api.backed.fi/api/v2/public/assets/TNGYIx/circulating-supply?format=object
...
- `xstocks.circ.BANKCx` [ok] 200 645ms https://api.backed.fi/api/v2/public/assets/BANKCx/circulating-supply?format=object
...
- `xstocks.mult.TNGYIx` [ok] 200 831ms https://api.backed.fi/api/v2/public/assets/TNGYIx/multiplier?network=Solana
- `xstocks.circ.SUOPTx` [ok] 200 1191ms https://api.backed.fi/api/v2/public/assets/SUOPTx/circulating-supply?format=object
- `xstocks.mult.SUOPTx` [ok] 200 133ms https://api.backed.fi/api/v2/public/assets/SUOPTx/multiplier?network=Solana
- `xstocks.circ.MMGx` [ok] 200 1389ms https://api.backed.fi/api/v2/public/assets/MMGx/circulating-supply?format=object
...
- `xstocks.mult.WRFHDx` [ok] 200 146ms https://api.backed.fi/api/v2/public/assets/WRFHDx/multiplier?network=Solana
- `xstocks.mult.JDLOGx` [ok] 200 767ms https://api.backed.fi/api/v2/public/assets/JDLOGx/multiplier?network=Solana
...
- `xstocks.circ.SNBIOx` [ok] 200 418ms https://api.backed.fi/api/v2/public/assets/SNBIOx/circulating-supply?format=object
...
- `xstocks.mult.SZIGHx` [ok] 200 390ms https://api.backed.fi/api/v2/public/assets/SZIGHx/multiplier?network=Solana
...
- `xstocks.circ.SMOIHx` [ok] 200 114ms https://api.backed.fi/api/v2/public/assets/SMOIHx/circulating-supply?format=object
...
- `xstocks.circ.CMERPx` [ok] 200 789ms https://api.backed.fi/api/v2/public/assets/CMERPx/circulating-supply?format=object
...
- `xstocks.price.BDWAPx` [FAIL]  12011ms https://api.backed.fi/api/v2/public/assets/BDWAPx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.BDWAPx` [ok] 200 233ms https://api.backed.fi/api/v2/public/assets/BDWAPx/circulating-supply?format=object
...
- `xstocks.price.SINOTx` [FAIL]  12014ms https://api.backed.fi/api/v2/public/assets/SINOTx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.CTFJWx` [ok] 200 306ms https://api.backed.fi/api/v2/public/assets/CTFJWx/multiplier?network=Solana
...
- `xstocks.mult.WHGROx` [ok] 200 118ms https://api.backed.fi/api/v2/public/assets/WHGROx/multiplier?network=Solana
...
- `xstocks.price.CLPHDx` [FAIL]  12011ms https://api.backed.fi/api/v2/public/assets/CLPHDx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.KUAIx` [ok] 200 290ms https://api.backed.fi/api/v2/public/assets/KUAIx/circulating-supply?format=object
...
- `xstocks.mult.HKCGAx` [ok] 200 429ms https://api.backed.fi/api/v2/public/assets/HKCGAx/multiplier?network=Solana
- `xstocks.circ.NONGx` [ok] 200 117ms https://api.backed.fi/api/v2/public/assets/NONGx/circulating-supply?format=object
- `xstocks.circ.HKEXCx` [ok] 200 754ms https://api.backed.fi/api/v2/public/assets/HKEXCx/circulating-supply?format=object
...
- `xstocks.mult.CHONGx` [ok] 200 726ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
...
- `xstocks.mult.COVELx` [ok] 200 1231ms https://api.backed.fi/api/v2/public/assets/COVELx/multiplier?network=Solana
...
- `xstocks.circ.HNDLDx` [ok] 200 654ms https://api.backed.fi/api/v2/public/assets/HNDLDx/circulating-supply?format=object
...
- `xstocks.mult.COSCx` [ok] 200 608ms https://api.backed.fi/api/v2/public/assets/COSCx/multiplier?network=Solana
...
- `xstocks.circ.BOCOMx` [ok] 200 122ms https://api.backed.fi/api/v2/public/assets/BOCOMx/circulating-supply?format=object
...
- `xstocks.mult.BOCHKx` [ok] 200 121ms https://api.backed.fi/api/v2/public/assets/BOCHKx/multiplier?network=Solana
...
- `xstocks.price.HAIERx` [FAIL]  12016ms https://api.backed.fi/api/v2/public/assets/HAIERx/price-data — TimeoutError: The read operation timed out
- `xstocks.price.ZJGLDx` [FAIL]  12016ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.CITICx` [ok] 200 911ms https://api.backed.fi/api/v2/public/assets/CITICx/multiplier?network=Solana
- `xstocks.mult.ZJGLDx` [ok] 200 142ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/multiplier?network=Solana
- `xstocks.circ.ANTASx` [ok] 200 1003ms https://api.backed.fi/api/v2/public/assets/ANTASx/circulating-supply?format=object
...
- `xstocks.circ.HAIERx` [ok] 200 597ms https://api.backed.fi/api/v2/public/assets/HAIERx/circulating-supply?format=object
...
- `xstocks.mult.HAIERx` [ok] 200 132ms https://api.backed.fi/api/v2/public/assets/HAIERx/multiplier?network=Solana
...
- `xstocks.mult.ICBCx` [ok] 200 136ms https://api.backed.fi/api/v2/public/assets/ICBCx/multiplier?network=Solana
- `xstocks.mult.PSBOCx` [ok] 200 701ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
- `llama.protocol.xstocks` [ok] 200 1139ms https://api.llama.fi/protocol/xstocks
...
- `jup.tokens.search.BANKCx` [ok] 200 455ms https://lite-api.jup.ag/tokens/v2/search?query=BANKCx
- `jup.tokens.search.LAOPGx` [ok] 200 41ms https://lite-api.jup.ag/tokens/v2/search?query=LAOPGx
- `jup.tokens.search.TNGYIx` [ok] 200 49ms https://lite-api.jup.ag/tokens/v2/search?query=TNGYIx
- `jup.tokens.search.SUOPTx` [ok] 200 50ms https://lite-api.jup.ag/tokens/v2/search?query=SUOPTx
- `jup.tokens.search.MMGx` [ok] 200 45ms https://lite-api.jup.ag/tokens/v2/search?query=MMGx
