...
**Generated** 2026-08-30T07:03:46Z · 2026-08-30 00:03:46 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-30T07:03:36Z · **RPC health** `ok`
...
- **WARN · SOL price vs 30d median (solana.com/data)** — Current 105.28 USD is +38.2% vs 30d median 76.20 USD (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
...
| Health | `ok` |
| Slot | 442,817,683 |
| Block height | 420,865,480 |
| Block time | 2026-08-30T07:03:36Z |
| Epoch | 1,025 (4.09% · slot 17,685/432,000) |
| Mean TPS (last ~3,600s) | 3,441.2 |
| Mean non-vote TPS | 1,298.1 |
| Median TPS (same window) | 3,413.1 |
| Mean slot time | 316.1 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 543,346,626,744 |
| Circulating supply | 585,122,363 SOL |
| Total supply | 633,173,875 SOL |
...
- `mrgn4atx…` · 21.79K SOL · commission 0% · lag 13946 slots
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1565004 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 31562 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 137845 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 833929 slots
- `CpdzCVza…` · 315.26 SOL · commission 100% · lag 17332 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 58846 slots
- `HFTcVVrX…` · 152.80 SOL · commission 100% · lag 17226 slots
- `6pEtDovp…` · 131.96 SOL · commission 100% · lag 31610 slots
- `7G4Rfctw…` · 75.85 SOL · commission 100% · lag 55984 slots
- `DZKTNGR3…` · 48.61 SOL · commission 100% · lag 63526 slots
- `As9NxA9b…` · 46.69 SOL · commission 100% · lag 17349 slots
...
| --- | ---: | --- |
| TPS chart | 172 | data/history.jsonl snapshot tape |
| TVL chart | 172 | data/history.jsonl snapshot tape |
| SOL chart | 171 | data/history.jsonl snapshot tape |
| history.jsonl rows | 172 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $24.58K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 24583 USD; at p95 floor → 1180737 USD. |
...
24h volume $8.68M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-08-30 (2026-08-30 00:03:46 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getBlockTime` [ok] 200 362ms https://api.mainnet-beta.solana.com
...
- `rss.xcancel.solana` [ok] 200 330ms https://xcancel.com/solana/rss
...
- `rss.nitter.solana` [ok] 200 2095ms https://nitter.perennialte.ch/solana/rss
- `rss.nitter.solana_status` [ok] 200 2387ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [ok] 200 2017ms https://nitter.perennialte.ch/anza_xyz/rss
...
- `xstocks.assets.p0` [ok] 200 1362ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0
...
- `xstocks.mult.METAx` [ok] 200 484ms https://api.backed.fi/api/v2/public/assets/METAx/multiplier?network=Solana
- `xstocks.mult.TSLAx` [ok] 200 296ms https://api.backed.fi/api/v2/public/assets/TSLAx/multiplier?network=Solana
- `xstocks.mult.MSFTx` [ok] 200 656ms https://api.backed.fi/api/v2/public/assets/MSFTx/multiplier?network=Solana
...
- `xstocks.circ.SUOPTx` [ok] 200 1166ms https://api.backed.fi/api/v2/public/assets/SUOPTx/circulating-supply?format=object
- `xstocks.circ.TNGYIx` [ok] 200 1007ms https://api.backed.fi/api/v2/public/assets/TNGYIx/circulating-supply?format=object
- `xstocks.mult.TNGYIx` [ok] 200 164ms https://api.backed.fi/api/v2/public/assets/TNGYIx/multiplier?network=Solana
- `xstocks.circ.MMGx` [ok] 200 1332ms https://api.backed.fi/api/v2/public/assets/MMGx/circulating-supply?format=object
...
- `xstocks.mult.MMGx` [ok] 200 133ms https://api.backed.fi/api/v2/public/assets/MMGx/multiplier?network=Solana
...
- `xstocks.circ.KUNLx` [ok] 200 1093ms https://api.backed.fi/api/v2/public/assets/KUNLx/circulating-supply?format=object
- `xstocks.circ.WRFHDx` [ok] 200 809ms https://api.backed.fi/api/v2/public/assets/WRFHDx/circulating-supply?format=object
...
- `xstocks.mult.KUNLx` [ok] 200 1118ms https://api.backed.fi/api/v2/public/assets/KUNLx/multiplier?network=Solana
- `xstocks.circ.SNBIOx` [ok] 200 1073ms https://api.backed.fi/api/v2/public/assets/SNBIOx/circulating-supply?format=object
- `xstocks.mult.HAIDLx` [ok] 200 965ms https://api.backed.fi/api/v2/public/assets/HAIDLx/multiplier?network=Solana
- `xstocks.mult.SNBIOx` [ok] 200 128ms https://api.backed.fi/api/v2/public/assets/SNBIOx/multiplier?network=Solana
- `xstocks.circ.SZIGHx` [ok] 200 2415ms https://api.backed.fi/api/v2/public/assets/SZIGHx/circulating-supply?format=object
...
- `xstocks.mult.CRESBx` [ok] 200 119ms https://api.backed.fi/api/v2/public/assets/CRESBx/multiplier?network=Solana
...
- `xstocks.circ.SMOIHx` [ok] 200 1253ms https://api.backed.fi/api/v2/public/assets/SMOIHx/circulating-supply?format=object
...
- `xstocks.price.CRESMx` [FAIL]  12008ms https://api.backed.fi/api/v2/public/assets/CRESMx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.JTGEXx` [ok] 200 457ms https://api.backed.fi/api/v2/public/assets/JTGEXx/circulating-supply?format=object
- `xstocks.mult.JTGEXx` [ok] 200 201ms https://api.backed.fi/api/v2/public/assets/JTGEXx/multiplier?network=Solana
- `xstocks.mult.CRESMx` [ok] 200 607ms https://api.backed.fi/api/v2/public/assets/CRESMx/multiplier?network=Solana
...
- `xstocks.circ.CMENDx` [ok] 200 527ms https://api.backed.fi/api/v2/public/assets/CMENDx/circulating-supply?format=object
...
- `xstocks.circ.ASMPTx` [ok] 200 626ms https://api.backed.fi/api/v2/public/assets/ASMPTx/circulating-supply?format=object
...
- `xstocks.mult.MIXUx` [ok] 200 829ms https://api.backed.fi/api/v2/public/assets/MIXUx/multiplier?network=Solana
- `xstocks.circ.SITCx` [ok] 200 1614ms https://api.backed.fi/api/v2/public/assets/SITCx/circulating-supply?format=object
- `xstocks.circ.JDHLTx` [ok] 200 1577ms https://api.backed.fi/api/v2/public/assets/JDHLTx/circulating-supply?format=object
- `xstocks.mult.JDHLTx` [ok] 200 208ms https://api.backed.fi/api/v2/public/assets/JDHLTx/multiplier?network=Solana
- `xstocks.mult.SITCx` [ok] 200 394ms https://api.backed.fi/api/v2/public/assets/SITCx/multiplier?network=Solana
...
- `xstocks.price.CRESPx` [FAIL]  12010ms https://api.backed.fi/api/v2/public/assets/CRESPx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.price.CLONPx` [FAIL]  12007ms https://api.backed.fi/api/v2/public/assets/CLONPx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.PRADx` [ok] 200 1501ms https://api.backed.fi/api/v2/public/assets/PRADx/circulating-supply?format=object
- `xstocks.mult.PRADx` [ok] 200 157ms https://api.backed.fi/api/v2/public/assets/PRADx/multiplier?network=Solana
- `xstocks.circ.SINOTx` [ok] 200 1284ms https://api.backed.fi/api/v2/public/assets/SINOTx/circulating-supply?format=object
...
- `xstocks.mult.WHGROx` [ok] 200 191ms https://api.backed.fi/api/v2/public/assets/WHGROx/multiplier?network=Solana
...
- `xstocks.circ.SINOx` [ok] 200 1433ms https://api.backed.fi/api/v2/public/assets/SINOx/circulating-supply?format=object
- `xstocks.mult.SINOx` [ok] 200 369ms https://api.backed.fi/api/v2/public/assets/SINOx/multiplier?network=Solana
...
- `xstocks.circ.PWAHLx` [ok] 200 1733ms https://api.backed.fi/api/v2/public/assets/PWAHLx/circulating-supply?format=object
...
- `xstocks.circ.GENTEx` [ok] 200 496ms https://api.backed.fi/api/v2/public/assets/GENTEx/circulating-supply?format=object
...
- `xstocks.circ.WUXIBx` [ok] 200 342ms https://api.backed.fi/api/v2/public/assets/WUXIBx/circulating-supply?format=object
...
- `xstocks.mult.PWAHLx` [ok] 200 2558ms https://api.backed.fi/api/v2/public/assets/PWAHLx/multiplier?network=Solana
- `xstocks.circ.SWPRPx` [ok] 200 1300ms https://api.backed.fi/api/v2/public/assets/SWPRPx/circulating-supply?format=object
...
- `xstocks.circ.HKCGAx` [ok] 200 1073ms https://api.backed.fi/api/v2/public/assets/HKCGAx/circulating-supply?format=object
- `xstocks.circ.NONGx` [ok] 200 195ms https://api.backed.fi/api/v2/public/assets/NONGx/circulating-supply?format=object
- `xstocks.mult.HKEXCx` [ok] 200 379ms https://api.backed.fi/api/v2/public/assets/HKEXCx/multiplier?network=Solana
...
- `xstocks.circ.KUAIx` [ok] 200 940ms https://api.backed.fi/api/v2/public/assets/KUAIx/circulating-supply?format=object
...
- `xstocks.circ.MEITx` [ok] 200 460ms https://api.backed.fi/api/v2/public/assets/MEITx/circulating-supply?format=object
- `xstocks.circ.CHONGx` [ok] 200 681ms https://api.backed.fi/api/v2/public/assets/CHONGx/circulating-supply?format=object
...
- `xstocks.mult.GEELx` [ok] 200 304ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
...
- `xstocks.circ.MTRCPx` [ok] 200 527ms https://api.backed.fi/api/v2/public/assets/MTRCPx/circulating-supply?format=object
...
- `xstocks.mult.CKHUTx` [ok] 200 435ms https://api.backed.fi/api/v2/public/assets/CKHUTx/multiplier?network=Solana
- `xstocks.price.POPMTx` [FAIL]  12016ms https://api.backed.fi/api/v2/public/assets/POPMTx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.BOCOMx` [ok] 200 716ms https://api.backed.fi/api/v2/public/assets/BOCOMx/multiplier?network=Solana
- `xstocks.circ.CPETCx` [ok] 200 962ms https://api.backed.fi/api/v2/public/assets/CPETCx/circulating-supply?format=object
...
- `xstocks.circ.BOCHKx` [ok] 200 331ms https://api.backed.fi/api/v2/public/assets/BOCHKx/circulating-supply?format=object
...
- `xstocks.circ.CRESLx` [ok] 200 319ms https://api.backed.fi/api/v2/public/assets/CRESLx/circulating-supply?format=object
- `xstocks.mult.BOCHKx` [ok] 200 693ms https://api.backed.fi/api/v2/public/assets/BOCHKx/multiplier?network=Solana
- `xstocks.mult.ANTASx` [ok] 200 759ms https://api.backed.fi/api/v2/public/assets/ANTASx/multiplier?network=Solana
...
- `xstocks.circ.ZJGLDx` [ok] 200 674ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/circulating-supply?format=object
- `xstocks.mult.CRESLx` [ok] 200 2117ms https://api.backed.fi/api/v2/public/assets/CRESLx/multiplier?network=Solana
- `xstocks.mult.ZJGLDx` [ok] 200 139ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/multiplier?network=Solana
...
- `xstocks.mult.HAIERx` [ok] 200 1217ms https://api.backed.fi/api/v2/public/assets/HAIERx/multiplier?network=Solana
...
- `xstocks.circ.ICBCx` [ok] 200 315ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
- `xstocks.mult.PSBOCx` [ok] 200 1006ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
- `xstocks.mult.ICBCx` [ok] 200 1091ms https://api.backed.fi/api/v2/public/assets/ICBCx/multiplier?network=Solana
...
- `jup.tokens.search.LAOPGx` [ok] 200 38ms https://lite-api.jup.ag/tokens/v2/search?query=LAOPGx
- `jup.tokens.search.CTINSx` [ok] 200 40ms https://lite-api.jup.ag/tokens/v2/search?query=CTINSx
- `jup.tokens.search.JDLOGx` [ok] 200 45ms https://lite-api.jup.ag/tokens/v2/search?query=JDLOGx
...
- `jito.daily_mev_rewards` [ok] 200 71ms https://kobe.mainnet.jito.network/api/v1/daily_mev_rewards
