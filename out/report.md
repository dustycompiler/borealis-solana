...
**Generated** 2026-08-29T16:53:00Z · 2026-08-29 09:53:00 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-29T16:52:49Z · **RPC health** `ok`
**Health score** 98 / 100 — `25×rpc_ok + 30×clamp(1 − max(0, slot_ms − 300)/300, 0, 1) + 25×clamp(1 − delinquent_stake_pct/2, 0, 1) + 20×clamp(tps / tps_baseline, 0, 1)`
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h -0.22%; DEX 24h $2.59B · 1d -30% · vs-7d-ago -28%; slot 318 ms
...
- **INFO · Correlation: risk-off (SOL 24h ↓ + TVL 1d ↓ + DEX 1d ↓)** — SOL 24h -0.22%, DeFiLlama TVL 1d -2.38%, DEX 1d -29.99%. (threshold: `SOL 24h < 0 AND TVL 1d < 0 AND DEX 1d < 0`)
...
- **INFO · TPS vs 30d median (solana.com/data tx/86400)** — Current 4,388.07 TPS is +22.4% vs 30d median 3,585.83 TPS (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
...
| Health | `ok` |
| Slot | 442,656,666 |
| Block height | 420,704,525 |
| Block time | 2026-08-29T16:52:49Z |
| Epoch | 1,024 (66.82% · slot 288,667/432,000) |
| Mean TPS (last ~3,600s) | 4,388.1 |
| Mean non-vote TPS | 2,239.1 |
| Median TPS (same window) | 4,421.4 |
| Mean slot time | 318.2 ms |
| Median slot time | 317.5 ms |
| Transaction count (cluster) | 543,143,340,456 |
| Circulating supply | 584,161,416 SOL |
| Total supply | 633,078,956 SOL |
...
- `mrgn4atx…` · 20.33K SOL · commission 0% · lag 7921 slots
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1403987 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 309965 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 672912 slots
- `kom1oNHy…` · 662.86 SOL · commission 5% · lag 2020150 slots
- `7ZjHeeYE…` · 176.09 SOL · commission 5% · lag 54651 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442656666 slots
- `pSo1KZXg…` · 2.00 SOL · commission 4% · lag 318825 slots
- `7Dvp5zCF…` · 1.07 SOL · commission 100% · lag 477311 slots
- `bcZxRSoz…` · 0.00 SOL · commission 0% · lag 2016667 slots
...
| --- | ---: | --- |
| TPS chart | 115 | data/history.jsonl snapshot tape |
| TVL chart | 115 | data/history.jsonl snapshot tape |
| SOL chart | 114 | data/history.jsonl snapshot tape |
| history.jsonl rows | 115 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $203.19K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 203188 USD; at p95 floor → 17784258 USD. |
...
| p90 / p99 | 0.000013 / 0.000160 SOL | same sample |
...
_As of 2026-08-29 (2026-08-29 09:53:00 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `solana.com.rpc_data` [ok] 200 44ms https://solana.com/api/rpc/data
...
- `rss.nitter.anza_xyz` [ok] 200 355ms https://nitter.perennialte.ch/anza_xyz/rss
...
- `xstocks.assets.p0` [ok] 200 1653ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0
- `xstocks.assets.p1` [ok] 200 3263ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=1
...
- `xstocks.assets.p5` [ok] 200 2167ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=5
...
- `xstocks.circ.NVDAx` [ok] 200 1051ms https://api.backed.fi/api/v2/public/assets/NVDAx/circulating-supply?format=object
- `xstocks.circ.GOOGLx` [ok] 200 1096ms https://api.backed.fi/api/v2/public/assets/GOOGLx/circulating-supply?format=object
- `xstocks.mult.NVDAx` [ok] 200 140ms https://api.backed.fi/api/v2/public/assets/NVDAx/multiplier?network=Solana
- `xstocks.circ.METAx` [ok] 200 1501ms https://api.backed.fi/api/v2/public/assets/METAx/circulating-supply?format=object
...
- `xstocks.circ.BANKCx` [ok] 200 1067ms https://api.backed.fi/api/v2/public/assets/BANKCx/circulating-supply?format=object
...
- `xstocks.mult.ZHAOMx` [ok] 200 249ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/multiplier?network=Solana
...
- `xstocks.price.WRFHDx` [FAIL]  12008ms https://api.backed.fi/api/v2/public/assets/WRFHDx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.SNBIOx` [ok] 200 135ms https://api.backed.fi/api/v2/public/assets/SNBIOx/multiplier?network=Solana
...
- `xstocks.circ.CMERPx` [ok] 200 577ms https://api.backed.fi/api/v2/public/assets/CMERPx/circulating-supply?format=object
...
- `xstocks.mult.CRESMx` [ok] 200 578ms https://api.backed.fi/api/v2/public/assets/CRESMx/multiplier?network=Solana
...
- `xstocks.circ.WXXDCx` [ok] 200 1118ms https://api.backed.fi/api/v2/public/assets/WXXDCx/circulating-supply?format=object
...
- `xstocks.circ.CMENDx` [ok] 200 314ms https://api.backed.fi/api/v2/public/assets/CMENDx/circulating-supply?format=object
...
- `xstocks.circ.MIXUx` [ok] 200 448ms https://api.backed.fi/api/v2/public/assets/MIXUx/circulating-supply?format=object
...
- `xstocks.mult.CMENDx` [ok] 200 1738ms https://api.backed.fi/api/v2/public/assets/CMENDx/multiplier?network=Solana
...
- `xstocks.circ.SINOTx` [ok] 200 1000ms https://api.backed.fi/api/v2/public/assets/SINOTx/circulating-supply?format=object
...
- `xstocks.price.PWAHLx` [FAIL]  12007ms https://api.backed.fi/api/v2/public/assets/PWAHLx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.PWAHLx` [ok] 200 897ms https://api.backed.fi/api/v2/public/assets/PWAHLx/multiplier?network=Solana
...
- `xstocks.mult.HKCGAx` [ok] 200 805ms https://api.backed.fi/api/v2/public/assets/HKCGAx/multiplier?network=Solana
...
- `xstocks.mult.GEELx` [ok] 200 165ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
...
- `xstocks.circ.PICCx` [ok] 200 710ms https://api.backed.fi/api/v2/public/assets/PICCx/circulating-supply?format=object
- `xstocks.mult.POPMTx` [ok] 200 501ms https://api.backed.fi/api/v2/public/assets/POPMTx/multiplier?network=Solana
...
- `xstocks.mult.CPETCx` [ok] 200 618ms https://api.backed.fi/api/v2/public/assets/CPETCx/multiplier?network=Solana
...
- `xstocks.circ.BOCHKx` [ok] 200 150ms https://api.backed.fi/api/v2/public/assets/BOCHKx/circulating-supply?format=object
- `xstocks.circ.CITICx` [ok] 200 115ms https://api.backed.fi/api/v2/public/assets/CITICx/circulating-supply?format=object
- `xstocks.mult.BOCHKx` [ok] 200 128ms https://api.backed.fi/api/v2/public/assets/BOCHKx/multiplier?network=Solana
- `xstocks.mult.CITICx` [ok] 200 123ms https://api.backed.fi/api/v2/public/assets/CITICx/multiplier?network=Solana
...
- `xstocks.mult.ANTASx` [ok] 200 265ms https://api.backed.fi/api/v2/public/assets/ANTASx/multiplier?network=Solana
...
- `xstocks.circ.ZJGLDx` [ok] 200 188ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/circulating-supply?format=object
- `xstocks.circ.PSBOCx` [ok] 200 237ms https://api.backed.fi/api/v2/public/assets/PSBOCx/circulating-supply?format=object
...
- `xstocks.mult.HAIERx` [ok] 200 476ms https://api.backed.fi/api/v2/public/assets/HAIERx/multiplier?network=Solana
...
- `xstocks.mult.ICBCx` [ok] 200 924ms https://api.backed.fi/api/v2/public/assets/ICBCx/multiplier?network=Solana
...
- `jup.tokens.search.ZHAOMx` [ok] 200 49ms https://lite-api.jup.ag/tokens/v2/search?query=ZHAOMx
- `jup.tokens.search.LAOPGx` [ok] 200 41ms https://lite-api.jup.ag/tokens/v2/search?query=LAOPGx
- `jup.tokens.search.JDLOGx` [ok] 200 49ms https://lite-api.jup.ag/tokens/v2/search?query=JDLOGx
