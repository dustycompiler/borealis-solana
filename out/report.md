...
**Generated** 2026-08-30T02:03:52Z · 2026-08-29 19:03:52 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-30T02:03:41Z · **RPC health** `ok`
**Health score** 98 / 100 — `25×rpc_ok + 30×clamp(1 − max(0, slot_ms − 300)/300, 0, 1) + 25×clamp(1 − delinquent_stake_pct/2, 0, 1) + 20×clamp(tps / tps_baseline, 0, 1)`
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h +0.96%; DEX 24h $1.81B · 1d -30% · vs-7d-ago -51%; slot 318 ms
...
| Health | `ok` |
| Slot | 442,760,885 |
| Block height | 420,808,684 |
| Block time | 2026-08-30T02:03:41Z |
| Epoch | 1,024 (90.95% · slot 392,885/432,000) |
| Mean TPS (last ~3,600s) | 3,863.4 |
| Mean non-vote TPS | 1,708.4 |
| Median TPS (same window) | 3,816.3 |
| Mean slot time | 317.6 ms |
| Median slot time | 317.5 ms |
| Transaction count (cluster) | 543,281,352,174 |
| Circulating supply | 585,036,054 SOL |
| Total supply | 633,078,594 SOL |
...
| Activated stake | 436,095,567 SOL |
| Delinquent stake | 38,722.55 SOL (0.009%) |
...
- `mrgn4atx…` · 20.33K SOL · commission 0% · lag 45985 slots
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1508206 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 81047 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 777131 slots
- `kom1oNHy…` · 662.86 SOL · commission 5% · lag 2124369 slots
- `7ZjHeeYE…` · 176.09 SOL · commission 5% · lag 2048 slots
- `DZKTNGR3…` · 48.60 SOL · commission 100% · lag 6728 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442760885 slots
- `pSo1KZXg…` · 2.00 SOL · commission 4% · lag 423044 slots
- `7Dvp5zCF…` · 1.07 SOL · commission 100% · lag 581530 slots
- `bcZxRSoz…` · 0.00 SOL · commission 0% · lag 2120886 slots
...
| --- | ---: | --- |
| TPS chart | 152 | data/history.jsonl snapshot tape |
| TVL chart | 152 | data/history.jsonl snapshot tape |
| SOL chart | 151 | data/history.jsonl snapshot tape |
| history.jsonl rows | 152 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $38.30K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 38298 USD; at p95 floor → 2669517 USD. |
...
_As of 2026-08-30 (2026-08-29 19:03:52 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rss.nitter.solana` [ok] 200 2322ms https://nitter.perennialte.ch/solana/rss
- `rss.nitter.solana_status` [ok] 200 1426ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [FAIL] 502 949ms https://nitter.perennialte.ch/anza_xyz/rss — HTTP 502 Bad Gateway
- `rss.nitter.solana_devs` [ok] 200 2939ms https://nitter.perennialte.ch/solana_devs/rss
...
- `xstocks.assets.p0` [ok] 200 1573ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0
- `xstocks.assets.p1` [ok] 200 1401ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=1
...
- `xstocks.mult.BANKCx` [ok] 200 139ms https://api.backed.fi/api/v2/public/assets/BANKCx/multiplier?network=Solana
...
- `xstocks.price.MMGx` [ok] 200 397ms https://api.backed.fi/api/v2/public/assets/MMGx/price-data
...
- `xstocks.price.TNGYIx` [ok] 200 755ms https://api.backed.fi/api/v2/public/assets/TNGYIx/price-data
...
- `xstocks.price.LAOPGx` [ok] 200 546ms https://api.backed.fi/api/v2/public/assets/LAOPGx/price-data
...
- `xstocks.price.CTINSx` [ok] 200 424ms https://api.backed.fi/api/v2/public/assets/CTINSx/price-data
...
- `xstocks.circ.LAOPGx` [ok] 200 519ms https://api.backed.fi/api/v2/public/assets/LAOPGx/circulating-supply?format=object
...
- `xstocks.circ.MMGx` [ok] 200 1270ms https://api.backed.fi/api/v2/public/assets/MMGx/circulating-supply?format=object
- `xstocks.mult.JDLOGx` [ok] 200 846ms https://api.backed.fi/api/v2/public/assets/JDLOGx/multiplier?network=Solana
...
- `xstocks.circ.HAIDLx` [ok] 200 650ms https://api.backed.fi/api/v2/public/assets/HAIDLx/circulating-supply?format=object
...
- `xstocks.price.CMERPx` [ok] 200 502ms https://api.backed.fi/api/v2/public/assets/CMERPx/price-data
...
- `xstocks.price.JDHLTx` [ok] 200 309ms https://api.backed.fi/api/v2/public/assets/JDHLTx/price-data
...
- `xstocks.price.SITCx` [ok] 200 1391ms https://api.backed.fi/api/v2/public/assets/SITCx/price-data
...
- `xstocks.circ.CLONPx` [ok] 200 295ms https://api.backed.fi/api/v2/public/assets/CLONPx/circulating-supply?format=object
...
- `xstocks.circ.SITCx` [ok] 200 433ms https://api.backed.fi/api/v2/public/assets/SITCx/circulating-supply?format=object
...
- `xstocks.mult.PWAHLx` [ok] 200 294ms https://api.backed.fi/api/v2/public/assets/PWAHLx/multiplier?network=Solana
...
- `xstocks.mult.CKAHx` [ok] 200 148ms https://api.backed.fi/api/v2/public/assets/CKAHx/multiplier?network=Solana
...
- `xstocks.price.KUAIx` [ok] 200 428ms https://api.backed.fi/api/v2/public/assets/KUAIx/price-data
...
- `xstocks.mult.CTPCAx` [ok] 200 1550ms https://api.backed.fi/api/v2/public/assets/CTPCAx/multiplier?network=Solana
- `xstocks.mult.SWPRPx` [ok] 200 833ms https://api.backed.fi/api/v2/public/assets/SWPRPx/multiplier?network=Solana
...
- `xstocks.price.GEELx` [ok] 200 379ms https://api.backed.fi/api/v2/public/assets/GEELx/price-data
- `xstocks.circ.GEELx` [ok] 200 115ms https://api.backed.fi/api/v2/public/assets/GEELx/circulating-supply?format=object
- `xstocks.mult.CHONGx` [ok] 200 420ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
...
- `xstocks.mult.NONGx` [ok] 200 881ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
- `xstocks.mult.COVELx` [ok] 200 793ms https://api.backed.fi/api/v2/public/assets/COVELx/multiplier?network=Solana
...
- `xstocks.price.POPMTx` [ok] 200 120ms https://api.backed.fi/api/v2/public/assets/POPMTx/price-data
- `xstocks.circ.HKEXCx` [ok] 200 1699ms https://api.backed.fi/api/v2/public/assets/HKEXCx/circulating-supply?format=object
...
- `xstocks.price.CITICx` [ok] 200 122ms https://api.backed.fi/api/v2/public/assets/CITICx/price-data
- `xstocks.price.CPETCx` [ok] 200 269ms https://api.backed.fi/api/v2/public/assets/CPETCx/price-data
...
- `xstocks.price.ANTASx` [ok] 200 128ms https://api.backed.fi/api/v2/public/assets/ANTASx/price-data
...
- `xstocks.mult.BOCHKx` [ok] 200 193ms https://api.backed.fi/api/v2/public/assets/BOCHKx/multiplier?network=Solana
- `xstocks.mult.CPETCx` [ok] 200 162ms https://api.backed.fi/api/v2/public/assets/CPETCx/multiplier?network=Solana
- `xstocks.price.CRESLx` [ok] 200 299ms https://api.backed.fi/api/v2/public/assets/CRESLx/price-data
- `xstocks.mult.ANTASx` [ok] 200 135ms https://api.backed.fi/api/v2/public/assets/ANTASx/multiplier?network=Solana
- `xstocks.price.HAIERx` [ok] 200 123ms https://api.backed.fi/api/v2/public/assets/HAIERx/price-data
- `xstocks.price.BOCOMx` [ok] 200 725ms https://api.backed.fi/api/v2/public/assets/BOCOMx/price-data
- `xstocks.price.ZJGLDx` [ok] 200 129ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/price-data
- `xstocks.circ.CRESLx` [ok] 200 125ms https://api.backed.fi/api/v2/public/assets/CRESLx/circulating-supply?format=object
- `xstocks.price.PSBOCx` [ok] 200 125ms https://api.backed.fi/api/v2/public/assets/PSBOCx/price-data
- `xstocks.circ.CITICx` [ok] 200 525ms https://api.backed.fi/api/v2/public/assets/CITICx/circulating-supply?format=object
...
- `xstocks.mult.CRESLx` [ok] 200 177ms https://api.backed.fi/api/v2/public/assets/CRESLx/multiplier?network=Solana
- `xstocks.mult.HAIERx` [ok] 200 137ms https://api.backed.fi/api/v2/public/assets/HAIERx/multiplier?network=Solana
- `xstocks.mult.BOCOMx` [ok] 200 139ms https://api.backed.fi/api/v2/public/assets/BOCOMx/multiplier?network=Solana
- `xstocks.mult.CITICx` [ok] 200 443ms https://api.backed.fi/api/v2/public/assets/CITICx/multiplier?network=Solana
- `xstocks.circ.PSBOCx` [ok] 200 484ms https://api.backed.fi/api/v2/public/assets/PSBOCx/circulating-supply?format=object
- `xstocks.mult.ZJGLDx` [ok] 200 367ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/multiplier?network=Solana
- `xstocks.price.ICBCx` [ok] 200 400ms https://api.backed.fi/api/v2/public/assets/ICBCx/price-data
- `xstocks.mult.PSBOCx` [ok] 200 132ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
...
- `jup.tokens.search.KUAIx` [ok] 200 74ms https://lite-api.jup.ag/tokens/v2/search?query=KUAIx
