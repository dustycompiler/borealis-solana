...
**Generated** 2026-08-29T15:03:42Z · 2026-08-29 08:03:42 PT
**Author** dustycompiler · **Version** 1.5.6 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-29T15:03:31Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h -0.66%; DEX 24h $2.59B · 1d -30% · vs-7d-ago -28%; slot 317 ms
...
- **INFO · Correlation: risk-off (SOL 24h ↓ + TVL 1d ↓ + DEX 1d ↓)** — SOL 24h -0.66%, DeFiLlama TVL 1d -2.79%, DEX 1d -29.99%. (threshold: `SOL 24h < 0 AND TVL 1d < 0 AND DEX 1d < 0`)
...
| Health | `ok` |
| Slot | 442,636,026 |
| Block height | 420,683,905 |
| Block time | 2026-08-29T15:03:31Z |
| Epoch | 1,024 (62.04% · slot 268,027/432,000) |
| Mean TPS (last ~3,600s) | 3,931.6 |
| Mean non-vote TPS | 1,767.9 |
| Median TPS (same window) | 3,920.6 |
| Mean slot time | 316.8 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 543,116,118,031 |
| Circulating supply | 584,161,488 SOL |
| Total supply | 633,079,028 SOL |
...
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1383347 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 289325 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 652272 slots
- `kom1oNHy…` · 662.86 SOL · commission 5% · lag 1999510 slots
- `7ZjHeeYE…` · 176.09 SOL · commission 5% · lag 34011 slots
- `pSo1KZXg…` · 2.00 SOL · commission 4% · lag 298185 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442636026 slots
- `7Dvp5zCF…` · 1.07 SOL · commission 100% · lag 456671 slots
- `bcZxRSoz…` · 0.00 SOL · commission 0% · lag 1996027 slots
...
| --- | ---: | --- |
| TPS chart | 107 | data/history.jsonl snapshot tape |
| TVL chart | 107 | data/history.jsonl snapshot tape |
| SOL chart | 106 | data/history.jsonl snapshot tape |
| history.jsonl rows | 107 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $104.25K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 104250 USD; at p95 floor → 673692 USD. |
...
24h volume $23.87M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-08-29 (2026-08-29 08:03:42 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 6759ms https://api.mainnet-beta.solana.com
...
- `llama.chains` [ok] 200 610ms https://api.llama.fi/v2/chains
...
- `rss.nitter.solana` [ok] 200 1464ms https://nitter.perennialte.ch/solana/rss
...
- `rss.nitter.solana_devs` [ok] 200 1280ms https://nitter.perennialte.ch/solana_devs/rss
...
- `xstocks.assets.p1` [ok] 200 852ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=1
- `xstocks.assets.p2` [ok] 200 1867ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=2
...
- `xstocks.assets.p6` [ok] 200 1662ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=6
- `xstocks.assets.p7` [ok] 200 539ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=7
...
- `xstocks.mult.METAx` [ok] 200 218ms https://api.backed.fi/api/v2/public/assets/METAx/multiplier?network=Solana
- `xstocks.circ.AMZNx` [ok] 200 526ms https://api.backed.fi/api/v2/public/assets/AMZNx/circulating-supply?format=object
- `xstocks.circ.AAPLx` [ok] 200 836ms https://api.backed.fi/api/v2/public/assets/AAPLx/circulating-supply?format=object
- `xstocks.mult.AMZNx` [ok] 200 523ms https://api.backed.fi/api/v2/public/assets/AMZNx/multiplier?network=Solana
...
- `xstocks.price.BANKCx` [FAIL]  12016ms https://api.backed.fi/api/v2/public/assets/BANKCx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.BANKCx` [ok] 200 380ms https://api.backed.fi/api/v2/public/assets/BANKCx/circulating-supply?format=object
...
- `xstocks.circ.QQQx` [ok] 200 601ms https://api.backed.fi/api/v2/public/assets/QQQx/circulating-supply?format=object
...
- `xstocks.mult.BANKCx` [ok] 200 641ms https://api.backed.fi/api/v2/public/assets/BANKCx/multiplier?network=Solana
- `xstocks.circ.LAOPGx` [ok] 200 185ms https://api.backed.fi/api/v2/public/assets/LAOPGx/circulating-supply?format=object
- `xstocks.mult.QQQx` [ok] 200 529ms https://api.backed.fi/api/v2/public/assets/QQQx/multiplier?network=Solana
- `xstocks.mult.TNGYIx` [ok] 200 212ms https://api.backed.fi/api/v2/public/assets/TNGYIx/multiplier?network=Solana
- `xstocks.mult.ZHAOMx` [ok] 200 314ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/multiplier?network=Solana
...
- `xstocks.mult.KUNLx` [ok] 200 243ms https://api.backed.fi/api/v2/public/assets/KUNLx/multiplier?network=Solana
...
- `xstocks.mult.WRFHDx` [ok] 200 415ms https://api.backed.fi/api/v2/public/assets/WRFHDx/multiplier?network=Solana
...
- `xstocks.circ.SMOIHx` [ok] 200 419ms https://api.backed.fi/api/v2/public/assets/SMOIHx/circulating-supply?format=object
- `xstocks.mult.HRZRBx` [ok] 200 215ms https://api.backed.fi/api/v2/public/assets/HRZRBx/multiplier?network=Solana
- `xstocks.circ.CRESBx` [ok] 200 192ms https://api.backed.fi/api/v2/public/assets/CRESBx/circulating-supply?format=object
- `xstocks.price.CMERPx` [FAIL]  12009ms https://api.backed.fi/api/v2/public/assets/CMERPx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.WXXDCx` [ok] 200 254ms https://api.backed.fi/api/v2/public/assets/WXXDCx/multiplier?network=Solana
...
- `xstocks.price.MIXUx` [FAIL]  12012ms https://api.backed.fi/api/v2/public/assets/MIXUx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.BDWAPx` [ok] 200 198ms https://api.backed.fi/api/v2/public/assets/BDWAPx/multiplier?network=Solana
...
- `xstocks.price.WHRFRx` [FAIL]  12010ms https://api.backed.fi/api/v2/public/assets/WHRFRx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.MIXUx` [ok] 200 585ms https://api.backed.fi/api/v2/public/assets/MIXUx/multiplier?network=Solana
...
- `xstocks.mult.ASMPTx` [ok] 200 1894ms https://api.backed.fi/api/v2/public/assets/ASMPTx/multiplier?network=Solana
...
- `xstocks.price.PRADx` [FAIL]  12007ms https://api.backed.fi/api/v2/public/assets/PRADx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.price.WHGROx` [FAIL]  12008ms https://api.backed.fi/api/v2/public/assets/WHGROx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.WHGROx` [ok] 200 344ms https://api.backed.fi/api/v2/public/assets/WHGROx/multiplier?network=Solana
- `xstocks.mult.SINOTx` [ok] 200 1130ms https://api.backed.fi/api/v2/public/assets/SINOTx/multiplier?network=Solana
- `xstocks.circ.SINOx` [ok] 200 696ms https://api.backed.fi/api/v2/public/assets/SINOx/circulating-supply?format=object
- `xstocks.mult.CRESPx` [ok] 200 1910ms https://api.backed.fi/api/v2/public/assets/CRESPx/multiplier?network=Solana
...
- `xstocks.mult.SINOx` [ok] 200 1056ms https://api.backed.fi/api/v2/public/assets/SINOx/multiplier?network=Solana
- `xstocks.circ.CTPCAx` [ok] 200 807ms https://api.backed.fi/api/v2/public/assets/CTPCAx/circulating-supply?format=object
...
- `xstocks.mult.CLPHDx` [ok] 200 358ms https://api.backed.fi/api/v2/public/assets/CLPHDx/multiplier?network=Solana
...
- `xstocks.circ.CRAUTx` [ok] 200 339ms https://api.backed.fi/api/v2/public/assets/CRAUTx/circulating-supply?format=object
...
- `xstocks.price.SWPRPx` [FAIL]  12009ms https://api.backed.fi/api/v2/public/assets/SWPRPx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.GENTEx` [ok] 200 1972ms https://api.backed.fi/api/v2/public/assets/GENTEx/multiplier?network=Solana
- `xstocks.mult.CKINFx` [ok] 200 192ms https://api.backed.fi/api/v2/public/assets/CKINFx/multiplier?network=Solana
- `xstocks.mult.WUXIBx` [ok] 200 1691ms https://api.backed.fi/api/v2/public/assets/WUXIBx/multiplier?network=Solana
...
- `xstocks.circ.HKEXCx` [ok] 200 269ms https://api.backed.fi/api/v2/public/assets/HKEXCx/circulating-supply?format=object
...
- `xstocks.price.GEELx` [FAIL]  12025ms https://api.backed.fi/api/v2/public/assets/GEELx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.GEELx` [ok] 200 602ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
...
- `xstocks.circ.MTRCPx` [ok] 200 633ms https://api.backed.fi/api/v2/public/assets/MTRCPx/circulating-supply?format=object
...
- `xstocks.price.PICCx` [FAIL]  12010ms https://api.backed.fi/api/v2/public/assets/PICCx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.COSCx` [ok] 200 172ms https://api.backed.fi/api/v2/public/assets/COSCx/circulating-supply?format=object
...
- `xstocks.circ.POPMTx` [ok] 200 186ms https://api.backed.fi/api/v2/public/assets/POPMTx/circulating-supply?format=object
- `xstocks.circ.BOCOMx` [ok] 200 187ms https://api.backed.fi/api/v2/public/assets/BOCOMx/circulating-supply?format=object
- `xstocks.mult.POPMTx` [ok] 200 187ms https://api.backed.fi/api/v2/public/assets/POPMTx/multiplier?network=Solana
- `xstocks.price.CPETCx` [FAIL]  12008ms https://api.backed.fi/api/v2/public/assets/CPETCx/price-data — TimeoutError: The read operation timed out
- `xstocks.mult.BOCOMx` [ok] 200 228ms https://api.backed.fi/api/v2/public/assets/BOCOMx/multiplier?network=Solana
- `xstocks.circ.CPETCx` [ok] 200 622ms https://api.backed.fi/api/v2/public/assets/CPETCx/circulating-supply?format=object
...
- `xstocks.circ.BOCHKx` [ok] 200 234ms https://api.backed.fi/api/v2/public/assets/BOCHKx/circulating-supply?format=object
- `xstocks.mult.BOCHKx` [ok] 200 377ms https://api.backed.fi/api/v2/public/assets/BOCHKx/multiplier?network=Solana
...
- `xstocks.circ.ANTASx` [ok] 200 185ms https://api.backed.fi/api/v2/public/assets/ANTASx/circulating-supply?format=object
- `xstocks.circ.CITICx` [ok] 200 618ms https://api.backed.fi/api/v2/public/assets/CITICx/circulating-supply?format=object
- `xstocks.mult.CITICx` [ok] 200 267ms https://api.backed.fi/api/v2/public/assets/CITICx/multiplier?network=Solana
...
- `xstocks.circ.CRESLx` [ok] 200 226ms https://api.backed.fi/api/v2/public/assets/CRESLx/circulating-supply?format=object
...
- `xstocks.circ.ZJGLDx` [ok] 200 181ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/circulating-supply?format=object
- `xstocks.mult.ANTASx` [ok] 200 1772ms https://api.backed.fi/api/v2/public/assets/ANTASx/multiplier?network=Solana
- `xstocks.mult.ZJGLDx` [ok] 200 426ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/multiplier?network=Solana
- `xstocks.circ.HAIERx` [ok] 200 987ms https://api.backed.fi/api/v2/public/assets/HAIERx/circulating-supply?format=object
...
- `xstocks.circ.PSBOCx` [ok] 200 1148ms https://api.backed.fi/api/v2/public/assets/PSBOCx/circulating-supply?format=object
- `xstocks.circ.ICBCx` [ok] 200 1023ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
- `xstocks.mult.ICBCx` [ok] 200 254ms https://api.backed.fi/api/v2/public/assets/ICBCx/multiplier?network=Solana
- `xstocks.mult.PSBOCx` [ok] 200 1276ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
- `llama.protocol.xstocks` [ok] 200 1685ms https://api.llama.fi/protocol/xstocks
- `jup.tokens.search.xStock` [ok] 200 404ms https://lite-api.jup.ag/tokens/v2/search?query=xStock
- `jup.tokens.search.SUOPTx` [ok] 200 107ms https://lite-api.jup.ag/tokens/v2/search?query=SUOPTx
- `jup.tokens.search.MMGx` [ok] 200 108ms https://lite-api.jup.ag/tokens/v2/search?query=MMGx
- `jup.tokens.search.BANKCx` [ok] 200 99ms https://lite-api.jup.ag/tokens/v2/search?query=BANKCx
- `jup.tokens.search.TNGYIx` [ok] 200 121ms https://lite-api.jup.ag/tokens/v2/search?query=TNGYIx
- `jup.tokens.search.ZHAOMx` [ok] 200 123ms https://lite-api.jup.ag/tokens/v2/search?query=ZHAOMx
- `jup.tokens.search.LAOPGx` [ok] 200 102ms https://lite-api.jup.ag/tokens/v2/search?query=LAOPGx
- `jup.tokens.search.JDLOGx` [ok] 200 105ms https://lite-api.jup.ag/tokens/v2/search?query=JDLOGx
