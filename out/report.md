...
**Generated** 2026-09-06T16:48:54Z · 2026-09-06 09:48:54 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-06T16:48:43Z · **RPC health** `ok`
**Health score** 98 / 100 — `25×rpc_ok + 30×clamp(1 − max(0, slot_ms − 300)/300, 0, 1) + 25×clamp(1 − delinquent_stake_pct/2, 0, 1) + 20×clamp(tps / tps_baseline, 0, 1)`
**Network health** HEALTHY · **Ecosystem** ELEVATED — SOL 24h +3.01%; DEX 24h $1.96B · 1d +4% · vs-7d-ago +17%; slot 318 ms
...
| Health | `ok` |
| Slot | 444,841,981 |
| Block height | 422,886,318 |
| Block time | 2026-09-06T16:48:43Z |
| Epoch | 1,029 (72.68% · slot 313,981/432,000) |
| Mean TPS (last ~3,600s) | 3,984.6 |
| Mean non-vote TPS | 1,868.6 |
| Median TPS (same window) | 3,926.7 |
| Mean slot time | 318.0 ms |
| Median slot time | 317.5 ms |
| Transaction count (cluster) | 545,739,365,311 |
| Circulating supply | 585,445,000 SOL |
| Total supply | 633,548,875 SOL |
...
- `xLabscif…` · 28.57K SOL · commission 5% · lag 1053608 slots
- `mrgn4atx…` · 20.30K SOL · commission 0% · lag 77871 slots
- `prt1st4R…` · 13.11K SOL · commission 5% · lag 1355039 slots
- `E4xNK4Uw…` · 6.26K SOL · commission 5% · lag 1493258 slots
- `5ZjxMYBb…` · 4.06K SOL · commission 0% · lag 876059 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 2055860 slots
- `pSoLoZx5…` · 1.51K SOL · commission 4% · lag 302790 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 1403342 slots
- `CpdzCVza…` · 193.38 SOL · commission 100% · lag 2041630 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 2083144 slots
- `HFTcVVrX…` · 148.42 SOL · commission 100% · lag 2041524 slots
- `6pEtDovp…` · 131.86 SOL · commission 100% · lag 2055908 slots
...
| Jito tip-floor run-rate (NOT REV) | $55.17K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 55168 USD; at p95 floor → 374721 USD. |
...
| p90 / p99 | 0.000011 / 0.000211 SOL | same sample |
...
| Metric | Value | Source |
| --- | ---: | --- |
| SOL/USD | $106.22 | coingecko.simple_price |
...
_As of 2026-09-06 (2026-09-06 09:48:54 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 7653ms https://api.mainnet-beta.solana.com
...
- `rss.xcancel.solana` [ok] 200 325ms https://xcancel.com/solana/rss
...
- `rss.nitter.solana` [ok] 200 1774ms https://nitter.perennialte.ch/solana/rss
...
- `xstocks.assets.p3` [ok] 200 2408ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=3
...
- `xstocks.circ.AAPLx` [ok] 200 487ms https://api.backed.fi/api/v2/public/assets/AAPLx/circulating-supply?format=object
...
- `xstocks.circ.TSLAx` [ok] 200 1006ms https://api.backed.fi/api/v2/public/assets/TSLAx/circulating-supply?format=object
- `xstocks.mult.MSFTx` [ok] 200 909ms https://api.backed.fi/api/v2/public/assets/MSFTx/multiplier?network=Solana
- `xstocks.mult.TSLAx` [ok] 200 154ms https://api.backed.fi/api/v2/public/assets/TSLAx/multiplier?network=Solana
- `xstocks.mult.AMZNx` [ok] 200 1006ms https://api.backed.fi/api/v2/public/assets/AMZNx/multiplier?network=Solana
- `xstocks.circ.METAx` [ok] 200 1855ms https://api.backed.fi/api/v2/public/assets/METAx/circulating-supply?format=object
- `xstocks.mult.METAx` [ok] 200 3569ms https://api.backed.fi/api/v2/public/assets/METAx/multiplier?network=Solana
...
- `xstocks.circ.MVLLx` [ok] 200 112ms https://api.backed.fi/api/v2/public/assets/MVLLx/circulating-supply?format=object
...
- `xstocks.circ.MUUx` [ok] 200 113ms https://api.backed.fi/api/v2/public/assets/MUUx/circulating-supply?format=object
...
- `xstocks.mult.QQQx` [ok] 200 813ms https://api.backed.fi/api/v2/public/assets/QQQx/multiplier?network=Solana
- `xstocks.circ.DJTx` [ok] 200 176ms https://api.backed.fi/api/v2/public/assets/DJTx/circulating-supply?format=object
- `xstocks.mult.MVLLx` [ok] 200 797ms https://api.backed.fi/api/v2/public/assets/MVLLx/multiplier?network=Solana
- `xstocks.mult.DJTx` [ok] 200 195ms https://api.backed.fi/api/v2/public/assets/DJTx/multiplier?network=Solana
- `xstocks.circ.AXTIx` [ok] 200 634ms https://api.backed.fi/api/v2/public/assets/AXTIx/circulating-supply?format=object
- `xstocks.mult.AXTIx` [ok] 200 240ms https://api.backed.fi/api/v2/public/assets/AXTIx/multiplier?network=Solana
- `xstocks.mult.DRAMx` [ok] 200 964ms https://api.backed.fi/api/v2/public/assets/DRAMx/multiplier?network=Solana
...
- `xstocks.circ.KORUx` [ok] 200 311ms https://api.backed.fi/api/v2/public/assets/KORUx/circulating-supply?format=object
- `xstocks.mult.KORUx` [ok] 200 1514ms https://api.backed.fi/api/v2/public/assets/KORUx/multiplier?network=Solana
...
- `xstocks.circ.SOXSx` [ok] 200 291ms https://api.backed.fi/api/v2/public/assets/SOXSx/circulating-supply?format=object
...
- `xstocks.circ.SNXXx` [ok] 200 461ms https://api.backed.fi/api/v2/public/assets/SNXXx/circulating-supply?format=object
...
- `xstocks.circ.SUOPTx` [ok] 200 856ms https://api.backed.fi/api/v2/public/assets/SUOPTx/circulating-supply?format=object
- `xstocks.mult.SUOPTx` [ok] 200 194ms https://api.backed.fi/api/v2/public/assets/SUOPTx/multiplier?network=Solana
- `xstocks.mult.SNXXx` [ok] 200 1549ms https://api.backed.fi/api/v2/public/assets/SNXXx/multiplier?network=Solana
- `xstocks.mult.BANKCx` [ok] 200 1452ms https://api.backed.fi/api/v2/public/assets/BANKCx/multiplier?network=Solana
- `xstocks.mult.INTWx` [ok] 200 2340ms https://api.backed.fi/api/v2/public/assets/INTWx/multiplier?network=Solana
- `xstocks.circ.NWGx` [ok] 200 1916ms https://api.backed.fi/api/v2/public/assets/NWGx/circulating-supply?format=object
- `xstocks.mult.NWGx` [ok] 200 174ms https://api.backed.fi/api/v2/public/assets/NWGx/multiplier?network=Solana
...
- `xstocks.circ.ZHAOMx` [ok] 200 387ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/circulating-supply?format=object
...
- `xstocks.mult.CTINSx` [ok] 200 340ms https://api.backed.fi/api/v2/public/assets/CTINSx/multiplier?network=Solana
- `xstocks.mult.WRFHDx` [ok] 200 617ms https://api.backed.fi/api/v2/public/assets/WRFHDx/multiplier?network=Solana
...
- `xstocks.mult.HAIDLx` [ok] 200 534ms https://api.backed.fi/api/v2/public/assets/HAIDLx/multiplier?network=Solana
...
- `xstocks.circ.SNBIOx` [ok] 200 143ms https://api.backed.fi/api/v2/public/assets/SNBIOx/circulating-supply?format=object
...
- `xstocks.mult.ENNHLx` [ok] 200 1117ms https://api.backed.fi/api/v2/public/assets/ENNHLx/multiplier?network=Solana
- `xstocks.mult.CMERPx` [ok] 200 727ms https://api.backed.fi/api/v2/public/assets/CMERPx/multiplier?network=Solana
- `xstocks.mult.CRESBx` [ok] 200 2515ms https://api.backed.fi/api/v2/public/assets/CRESBx/multiplier?network=Solana
- `xstocks.mult.HRZRBx` [ok] 200 3055ms https://api.backed.fi/api/v2/public/assets/HRZRBx/multiplier?network=Solana
...
- `xstocks.mult.CRESMx` [ok] 200 281ms https://api.backed.fi/api/v2/public/assets/CRESMx/multiplier?network=Solana
...
- `xstocks.circ.CMENDx` [ok] 200 406ms https://api.backed.fi/api/v2/public/assets/CMENDx/circulating-supply?format=object
...
- `xstocks.mult.CMENDx` [ok] 200 909ms https://api.backed.fi/api/v2/public/assets/CMENDx/multiplier?network=Solana
...
- `xstocks.circ.MIXUx` [ok] 200 586ms https://api.backed.fi/api/v2/public/assets/MIXUx/circulating-supply?format=object
- `xstocks.circ.ASMPTx` [ok] 200 125ms https://api.backed.fi/api/v2/public/assets/ASMPTx/circulating-supply?format=object
- `xstocks.mult.MIXUx` [ok] 200 750ms https://api.backed.fi/api/v2/public/assets/MIXUx/multiplier?network=Solana
- `xstocks.mult.ASMPTx` [ok] 200 725ms https://api.backed.fi/api/v2/public/assets/ASMPTx/multiplier?network=Solana
...
- `xstocks.mult.JDHLTx` [ok] 200 706ms https://api.backed.fi/api/v2/public/assets/JDHLTx/multiplier?network=Solana
- `xstocks.circ.SNDSCx` [ok] 200 644ms https://api.backed.fi/api/v2/public/assets/SNDSCx/circulating-supply?format=object
...
- `xstocks.mult.CRESPx` [ok] 200 120ms https://api.backed.fi/api/v2/public/assets/CRESPx/multiplier?network=Solana
...
- `xstocks.mult.PRADx` [ok] 200 494ms https://api.backed.fi/api/v2/public/assets/PRADx/multiplier?network=Solana
...
- `xstocks.mult.SINOTx` [ok] 200 1104ms https://api.backed.fi/api/v2/public/assets/SINOTx/multiplier?network=Solana
...
- `xstocks.circ.SINOx` [ok] 200 472ms https://api.backed.fi/api/v2/public/assets/SINOx/circulating-supply?format=object
...
- `xstocks.circ.PWAHLx` [ok] 200 763ms https://api.backed.fi/api/v2/public/assets/PWAHLx/circulating-supply?format=object
...
- `xstocks.mult.CLPHDx` [ok] 200 357ms https://api.backed.fi/api/v2/public/assets/CLPHDx/multiplier?network=Solana
...
- `xstocks.mult.CRAUTx` [ok] 200 940ms https://api.backed.fi/api/v2/public/assets/CRAUTx/multiplier?network=Solana
...
- `xstocks.mult.SWPRPx` [ok] 200 206ms https://api.backed.fi/api/v2/public/assets/SWPRPx/multiplier?network=Solana
...
- `xstocks.mult.HKEXCx` [ok] 200 303ms https://api.backed.fi/api/v2/public/assets/HKEXCx/multiplier?network=Solana
...
- `xstocks.mult.NONGx` [ok] 200 731ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
...
- `xstocks.mult.CHONGx` [ok] 200 119ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
- `xstocks.price.MEITx` [FAIL]  12016ms https://api.backed.fi/api/v2/public/assets/MEITx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.GEELx` [ok] 200 318ms https://api.backed.fi/api/v2/public/assets/GEELx/circulating-supply?format=object
...
- `xstocks.mult.GEELx` [ok] 200 363ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
...
- `xstocks.mult.HNDLDx` [ok] 200 990ms https://api.backed.fi/api/v2/public/assets/HNDLDx/multiplier?network=Solana
...
- `xstocks.circ.PICCx` [ok] 200 720ms https://api.backed.fi/api/v2/public/assets/PICCx/circulating-supply?format=object
...
- `xstocks.mult.PICCx` [ok] 200 673ms https://api.backed.fi/api/v2/public/assets/PICCx/multiplier?network=Solana
...
- `xstocks.mult.COSCx` [ok] 200 831ms https://api.backed.fi/api/v2/public/assets/COSCx/multiplier?network=Solana
...
- `rpc.getAccountInfo` [ok] 200 30ms https://api.mainnet-beta.solana.com
- `jito.daily_mev_rewards` [ok] 200 2410ms https://kobe.mainnet.jito.network/api/v1/daily_mev_rewards
