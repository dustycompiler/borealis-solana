...
**Generated** 2026-08-29T17:18:41Z · 2026-08-29 10:18:41 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-29T17:18:31Z · **RPC health** `ok`
**Health score** 98 / 100 — `25×rpc_ok + 30×clamp(1 − max(0, slot_ms − 300)/300, 0, 1) + 25×clamp(1 − delinquent_stake_pct/2, 0, 1) + 20×clamp(tps / tps_baseline, 0, 1)`
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h +0.11%; DEX 24h $2.59B · 1d -30% · vs-7d-ago -28%; slot 318 ms
...
- **WARN · SOL price vs 30d median (solana.com/data)** — Current 105.09 USD is +37.9% vs 30d median 76.20 USD (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
- **WARN · Last TPS sample outside 2.5σ of the 60-sample window** — Last sample 3,649 TPS is -2.85σ vs window mean 4,394 (n=60, σ=261). (threshold: `|last sample − window mean| > 2.5σ`)
...
- **INFO · TPS vs 30d median (solana.com/data tx/86400)** — Current 4,393.51 TPS is +22.5% vs 30d median 3,585.83 TPS (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
...
| Health | `ok` |
| Slot | 442,661,525 |
| Block height | 420,709,386 |
| Block time | 2026-08-29T17:18:31Z |
| Epoch | 1,024 (67.95% · slot 293,528/432,000) |
| Mean TPS (last ~3,600s) | 4,393.5 |
| Mean non-vote TPS | 2,239.8 |
| Median TPS (same window) | 4,417.1 |
| Mean slot time | 317.8 ms |
| Median slot time | 317.5 ms |
| Transaction count (cluster) | 543,150,152,643 |
| Circulating supply | 584,161,398 SOL |
| Total supply | 633,078,938 SOL |
...
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1408846 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 314824 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 677771 slots
- `kom1oNHy…` · 662.86 SOL · commission 5% · lag 2025009 slots
- `7ZjHeeYE…` · 176.09 SOL · commission 5% · lag 59510 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442661525 slots
- `pSo1KZXg…` · 2.00 SOL · commission 4% · lag 323684 slots
- `7Dvp5zCF…` · 1.07 SOL · commission 100% · lag 482170 slots
- `bcZxRSoz…` · 0.00 SOL · commission 0% · lag 2021526 slots
...
| --- | ---: | --- |
| TPS chart | 117 | data/history.jsonl snapshot tape |
| TVL chart | 117 | data/history.jsonl snapshot tape |
| SOL chart | 116 | data/history.jsonl snapshot tape |
| history.jsonl rows | 117 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $50.28K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 50282 USD; at p95 floor → 578661 USD. |
...
| Metric | Value | Source |
| --- | ---: | --- |
| SOL/USD | $105.09 | coingecko.simple_price |
...
| Raydium AMM | $141.40M | -22.55% |
| Axiom | $124.30M | -25.03% |
| pump.fun | $117.62M | -18.59% |
| Manifest Trade | $107.35M | -40.89% |
...
24h volume $19.84M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
DeFiLlama protocol/xstocks Solana TVL $433.09M — liquidity census, not mcap, not 24h volume.
...
_As of 2026-08-29 (2026-08-29 10:18:41 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getHealth` [ok] 200 644ms https://api.mainnet-beta.solana.com
- `rpc.getSlot` [ok] 200 617ms https://api.mainnet-beta.solana.com
...
- `rpc.getVoteAccounts` [ok] 200 1130ms https://api.mainnet-beta.solana.com
...
- `rss.nitter.solana` [FAIL] 429 1111ms https://nitter.perennialte.ch/solana/rss — HTTP 429 Too Many Requests
- `rss.nitter.solana_status` [FAIL] 429 257ms https://nitter.perennialte.ch/solana_status/rss — HTTP 429 Too Many Requests
- `rss.nitter.anza_xyz` [ok] 200 3099ms https://nitter.perennialte.ch/anza_xyz/rss
- `rss.nitter.solana_devs` [ok] 200 11024ms https://nitter.perennialte.ch/solana_devs/rss
...
- `rpc.getBlock` [ok] 200 2370ms https://api.mainnet-beta.solana.com
...
- `xstocks.assets.p6` [ok] 200 2267ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=6
- `xstocks.assets.p7` [ok] 200 297ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=7
...
- `xstocks.circ.TSLAx` [ok] 200 510ms https://api.backed.fi/api/v2/public/assets/TSLAx/circulating-supply?format=object
...
- `xstocks.mult.METAx` [ok] 200 579ms https://api.backed.fi/api/v2/public/assets/METAx/multiplier?network=Solana
- `xstocks.circ.AAPLx` [ok] 200 1078ms https://api.backed.fi/api/v2/public/assets/AAPLx/circulating-supply?format=object
...
- `xstocks.circ.AMZNx` [ok] 200 2247ms https://api.backed.fi/api/v2/public/assets/AMZNx/circulating-supply?format=object
...
- `xstocks.circ.MMGx` [ok] 200 486ms https://api.backed.fi/api/v2/public/assets/MMGx/circulating-supply?format=object
...
- `xstocks.circ.TNGYIx` [ok] 200 531ms https://api.backed.fi/api/v2/public/assets/TNGYIx/circulating-supply?format=object
- `xstocks.circ.COINx` [ok] 200 1355ms https://api.backed.fi/api/v2/public/assets/COINx/circulating-supply?format=object
...
- `xstocks.circ.WRFHDx` [ok] 200 438ms https://api.backed.fi/api/v2/public/assets/WRFHDx/circulating-supply?format=object
...
- `xstocks.circ.SNBIOx` [ok] 200 112ms https://api.backed.fi/api/v2/public/assets/SNBIOx/circulating-supply?format=object
...
- `xstocks.mult.SNBIOx` [ok] 200 727ms https://api.backed.fi/api/v2/public/assets/SNBIOx/multiplier?network=Solana
...
- `xstocks.circ.CTINSx` [ok] 200 2142ms https://api.backed.fi/api/v2/public/assets/CTINSx/circulating-supply?format=object
...
- `xstocks.circ.HAIDLx` [ok] 200 1557ms https://api.backed.fi/api/v2/public/assets/HAIDLx/circulating-supply?format=object
...
- `xstocks.circ.HRZRBx` [ok] 200 706ms https://api.backed.fi/api/v2/public/assets/HRZRBx/circulating-supply?format=object
...
- `xstocks.circ.CRESBx` [ok] 200 987ms https://api.backed.fi/api/v2/public/assets/CRESBx/circulating-supply?format=object
...
- `xstocks.mult.CRESBx` [ok] 200 723ms https://api.backed.fi/api/v2/public/assets/CRESBx/multiplier?network=Solana
- `xstocks.mult.WXXDCx` [ok] 200 522ms https://api.backed.fi/api/v2/public/assets/WXXDCx/multiplier?network=Solana
- `xstocks.circ.CMERPx` [ok] 200 2149ms https://api.backed.fi/api/v2/public/assets/CMERPx/circulating-supply?format=object
- `xstocks.circ.CRESMx` [ok] 200 1455ms https://api.backed.fi/api/v2/public/assets/CRESMx/circulating-supply?format=object
- `xstocks.circ.CSPCx` [ok] 200 2243ms https://api.backed.fi/api/v2/public/assets/CSPCx/circulating-supply?format=object
...
- `xstocks.price.CMENDx` [FAIL]  12013ms https://api.backed.fi/api/v2/public/assets/CMENDx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.CMENDx` [ok] 200 1135ms https://api.backed.fi/api/v2/public/assets/CMENDx/circulating-supply?format=object
- `xstocks.mult.CMENDx` [ok] 200 307ms https://api.backed.fi/api/v2/public/assets/CMENDx/multiplier?network=Solana
...
- `xstocks.circ.BDWAPx` [ok] 200 1550ms https://api.backed.fi/api/v2/public/assets/BDWAPx/circulating-supply?format=object
...
- `xstocks.circ.MIXUx` [ok] 200 1158ms https://api.backed.fi/api/v2/public/assets/MIXUx/circulating-supply?format=object
...
- `xstocks.circ.WHRFRx` [ok] 200 1109ms https://api.backed.fi/api/v2/public/assets/WHRFRx/circulating-supply?format=object
- `xstocks.mult.WHRFRx` [ok] 200 279ms https://api.backed.fi/api/v2/public/assets/WHRFRx/multiplier?network=Solana
- `xstocks.circ.SNDSCx` [ok] 200 839ms https://api.backed.fi/api/v2/public/assets/SNDSCx/circulating-supply?format=object
- `xstocks.mult.SNDSCx` [ok] 200 347ms https://api.backed.fi/api/v2/public/assets/SNDSCx/multiplier?network=Solana
- `xstocks.circ.JDHLTx` [ok] 200 1226ms https://api.backed.fi/api/v2/public/assets/JDHLTx/circulating-supply?format=object
- `xstocks.circ.SITCx` [ok] 200 1643ms https://api.backed.fi/api/v2/public/assets/SITCx/circulating-supply?format=object
...
- `xstocks.circ.CRESPx` [ok] 200 970ms https://api.backed.fi/api/v2/public/assets/CRESPx/circulating-supply?format=object
...
- `xstocks.circ.PRADx` [ok] 200 1536ms https://api.backed.fi/api/v2/public/assets/PRADx/circulating-supply?format=object
...
- `xstocks.circ.CLONPx` [ok] 200 1432ms https://api.backed.fi/api/v2/public/assets/CLONPx/circulating-supply?format=object
...
- `xstocks.circ.CTPCAx` [ok] 200 772ms https://api.backed.fi/api/v2/public/assets/CTPCAx/circulating-supply?format=object
...
- `xstocks.circ.SINOx` [ok] 200 1438ms https://api.backed.fi/api/v2/public/assets/SINOx/circulating-supply?format=object
- `xstocks.circ.WHGROx` [ok] 200 2085ms https://api.backed.fi/api/v2/public/assets/WHGROx/circulating-supply?format=object
...
- `xstocks.circ.PWAHLx` [ok] 200 1493ms https://api.backed.fi/api/v2/public/assets/PWAHLx/circulating-supply?format=object
...
- `xstocks.price.GENTEx` [FAIL]  12025ms https://api.backed.fi/api/v2/public/assets/GENTEx/price-data — TimeoutError: The read operation timed out
- `xstocks.mult.CLPHDx` [ok] 200 781ms https://api.backed.fi/api/v2/public/assets/CLPHDx/multiplier?network=Solana
- `xstocks.circ.GENTEx` [ok] 200 1052ms https://api.backed.fi/api/v2/public/assets/GENTEx/circulating-supply?format=object
...
- `xstocks.circ.WUXIBx` [ok] 200 1552ms https://api.backed.fi/api/v2/public/assets/WUXIBx/circulating-supply?format=object
- `xstocks.mult.WUXIBx` [ok] 200 144ms https://api.backed.fi/api/v2/public/assets/WUXIBx/multiplier?network=Solana
- `xstocks.circ.CKAHx` [ok] 200 1494ms https://api.backed.fi/api/v2/public/assets/CKAHx/circulating-supply?format=object
- `xstocks.circ.CKINFx` [ok] 200 1200ms https://api.backed.fi/api/v2/public/assets/CKINFx/circulating-supply?format=object
...
- `xstocks.mult.HKCGAx` [ok] 200 737ms https://api.backed.fi/api/v2/public/assets/HKCGAx/multiplier?network=Solana
...
- `xstocks.circ.NONGx` [ok] 200 1290ms https://api.backed.fi/api/v2/public/assets/NONGx/circulating-supply?format=object
- `xstocks.mult.NONGx` [ok] 200 164ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
- `xstocks.circ.COVELx` [ok] 200 1492ms https://api.backed.fi/api/v2/public/assets/COVELx/circulating-supply?format=object
...
- `xstocks.mult.COVELx` [ok] 200 275ms https://api.backed.fi/api/v2/public/assets/COVELx/multiplier?network=Solana
- `xstocks.circ.CHONGx` [ok] 200 1679ms https://api.backed.fi/api/v2/public/assets/CHONGx/circulating-supply?format=object
- `xstocks.mult.CHONGx` [ok] 200 192ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
- `xstocks.circ.GEELx` [ok] 200 1945ms https://api.backed.fi/api/v2/public/assets/GEELx/circulating-supply?format=object
- `xstocks.mult.GEELx` [ok] 200 139ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
- `xstocks.circ.MEITx` [ok] 200 2743ms https://api.backed.fi/api/v2/public/assets/MEITx/circulating-supply?format=object
...
- `xstocks.circ.MTRCPx` [ok] 200 1503ms https://api.backed.fi/api/v2/public/assets/MTRCPx/circulating-supply?format=object
- `xstocks.mult.MTRCPx` [ok] 200 150ms https://api.backed.fi/api/v2/public/assets/MTRCPx/multiplier?network=Solana
- `xstocks.circ.HNDLDx` [ok] 200 1637ms https://api.backed.fi/api/v2/public/assets/HNDLDx/circulating-supply?format=object
- `xstocks.mult.HNDLDx` [ok] 200 132ms https://api.backed.fi/api/v2/public/assets/HNDLDx/multiplier?network=Solana
- `xstocks.circ.PICCx` [ok] 200 1605ms https://api.backed.fi/api/v2/public/assets/PICCx/circulating-supply?format=object
- `xstocks.mult.PICCx` [ok] 200 232ms https://api.backed.fi/api/v2/public/assets/PICCx/multiplier?network=Solana
...
- `xstocks.price.CKHUTx` [FAIL]  12023ms https://api.backed.fi/api/v2/public/assets/CKHUTx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.POPMTx` [ok] 200 995ms https://api.backed.fi/api/v2/public/assets/POPMTx/circulating-supply?format=object
- `xstocks.circ.CKHUTx` [ok] 200 1913ms https://api.backed.fi/api/v2/public/assets/CKHUTx/circulating-supply?format=object
...
- `xstocks.mult.POPMTx` [ok] 200 437ms https://api.backed.fi/api/v2/public/assets/POPMTx/multiplier?network=Solana
- `xstocks.mult.BOCOMx` [ok] 200 202ms https://api.backed.fi/api/v2/public/assets/BOCOMx/multiplier?network=Solana
...
- `xstocks.mult.CPETCx` [ok] 200 206ms https://api.backed.fi/api/v2/public/assets/CPETCx/multiplier?network=Solana
...
- `xstocks.circ.CITICx` [ok] 200 147ms https://api.backed.fi/api/v2/public/assets/CITICx/circulating-supply?format=object
- `xstocks.circ.BOCHKx` [ok] 200 913ms https://api.backed.fi/api/v2/public/assets/BOCHKx/circulating-supply?format=object
- `xstocks.mult.CITICx` [ok] 200 862ms https://api.backed.fi/api/v2/public/assets/CITICx/multiplier?network=Solana
...
- `xstocks.mult.ANTASx` [ok] 200 400ms https://api.backed.fi/api/v2/public/assets/ANTASx/multiplier?network=Solana
...
- `xstocks.circ.HAIERx` [ok] 200 169ms https://api.backed.fi/api/v2/public/assets/HAIERx/circulating-supply?format=object
- `xstocks.mult.HAIERx` [ok] 200 127ms https://api.backed.fi/api/v2/public/assets/HAIERx/multiplier?network=Solana
- `xstocks.circ.CRESLx` [ok] 200 1090ms https://api.backed.fi/api/v2/public/assets/CRESLx/circulating-supply?format=object
- `xstocks.mult.CRESLx` [ok] 200 120ms https://api.backed.fi/api/v2/public/assets/CRESLx/multiplier?network=Solana
...
- `xstocks.circ.ZJGLDx` [ok] 200 900ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/circulating-supply?format=object
- `xstocks.mult.ZJGLDx` [ok] 200 129ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/multiplier?network=Solana
- `xstocks.circ.PSBOCx` [ok] 200 1048ms https://api.backed.fi/api/v2/public/assets/PSBOCx/circulating-supply?format=object
- `xstocks.circ.ICBCx` [ok] 200 427ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
- `xstocks.mult.PSBOCx` [ok] 200 250ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
- `xstocks.mult.ICBCx` [ok] 200 581ms https://api.backed.fi/api/v2/public/assets/ICBCx/multiplier?network=Solana
...
- `jup.tokens.search.SUOPTx` [ok] 200 43ms https://lite-api.jup.ag/tokens/v2/search?query=SUOPTx
...
- `jup.tokens.search.TNGYIx` [ok] 200 41ms https://lite-api.jup.ag/tokens/v2/search?query=TNGYIx
- `jup.tokens.search.ZHAOMx` [ok] 200 42ms https://lite-api.jup.ag/tokens/v2/search?query=ZHAOMx
- `jup.tokens.search.LAOPGx` [ok] 200 39ms https://lite-api.jup.ag/tokens/v2/search?query=LAOPGx
- `jup.tokens.search.JDLOGx` [ok] 200 39ms https://lite-api.jup.ag/tokens/v2/search?query=JDLOGx
