...
**Generated** 2026-08-30T05:33:36Z · 2026-08-29 22:33:36 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-30T05:33:26Z · **RPC health** `ok`
**Health score** 98 / 100 — `25×rpc_ok + 30×clamp(1 − max(0, slot_ms − 300)/300, 0, 1) + 25×clamp(1 − delinquent_stake_pct/2, 0, 1) + 20×clamp(tps / tps_baseline, 0, 1)`
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h +1.00%; DEX 24h $1.81B · 1d -30% · vs-7d-ago -51%; slot 317 ms
...
- **WARN · SOL price vs 30d median (solana.com/data)** — Current 105.03 USD is +37.8% vs 30d median 76.20 USD (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
...
| Health | `ok` |
| Slot | 442,800,571 |
| Block height | 420,848,369 |
| Block time | 2026-08-30T05:33:26Z |
| Epoch | 1,025 (0.13% · slot 574/432,000) |
| Mean TPS (last ~3,600s) | 3,509.6 |
| Mean non-vote TPS | 1,361.5 |
| Median TPS (same window) | 3,487.0 |
| Mean slot time | 316.9 ms |
| Median slot time | 317.5 ms |
| Transaction count (cluster) | 543,327,975,876 |
| Circulating supply | 585,122,464 SOL |
| Total supply | 633,173,924 SOL |
...
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1547892 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 14450 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 120733 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 816817 slots
- `CpdzCVza…` · 315.26 SOL · commission 100% · lag 220 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 41734 slots
- `HFTcVVrX…` · 152.80 SOL · commission 100% · lag 114 slots
- `6pEtDovp…` · 131.96 SOL · commission 100% · lag 14498 slots
- `7G4Rfctw…` · 75.85 SOL · commission 100% · lag 38872 slots
- `DZKTNGR3…` · 48.61 SOL · commission 100% · lag 46414 slots
- `As9NxA9b…` · 46.69 SOL · commission 100% · lag 237 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442800571 slots
...
| --- | ---: | --- |
| TPS chart | 166 | data/history.jsonl snapshot tape |
| TVL chart | 166 | data/history.jsonl snapshot tape |
| SOL chart | 165 | data/history.jsonl snapshot tape |
| history.jsonl rows | 166 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $43.77K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 43774 USD; at p95 floor → 1520938 USD. |
...
24h volume $8.55M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-08-30 (2026-08-29 22:33:36 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getEpochInfo` [ok] 200 606ms https://api.mainnet-beta.solana.com
...
- `llama.stablecoincharts` [ok] 200 1162ms https://stablecoins.llama.fi/stablecoincharts/Solana
...
- `rss.nitter.solana_status` [ok] 200 1388ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [ok] 200 1354ms https://nitter.perennialte.ch/anza_xyz/rss
- `rss.nitter.solana_devs` [ok] 200 1407ms https://nitter.perennialte.ch/solana_devs/rss
...
- `xstocks.assets.p0` [ok] 200 2836ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0
...
- `xstocks.circ.SPYx` [ok] 200 443ms https://api.backed.fi/api/v2/public/assets/SPYx/circulating-supply?format=object
...
- `xstocks.mult.NVDAx` [ok] 200 599ms https://api.backed.fi/api/v2/public/assets/NVDAx/multiplier?network=Solana
- `xstocks.mult.SPYx` [ok] 200 515ms https://api.backed.fi/api/v2/public/assets/SPYx/multiplier?network=Solana
- `xstocks.circ.AMZNx` [ok] 200 1222ms https://api.backed.fi/api/v2/public/assets/AMZNx/circulating-supply?format=object
...
- `xstocks.circ.COINx` [ok] 200 1126ms https://api.backed.fi/api/v2/public/assets/COINx/circulating-supply?format=object
- `xstocks.mult.COINx` [ok] 200 187ms https://api.backed.fi/api/v2/public/assets/COINx/multiplier?network=Solana
- `xstocks.circ.BANKCx` [ok] 200 1315ms https://api.backed.fi/api/v2/public/assets/BANKCx/circulating-supply?format=object
- `xstocks.circ.LAOPGx` [ok] 200 483ms https://api.backed.fi/api/v2/public/assets/LAOPGx/circulating-supply?format=object
...
- `xstocks.circ.SUOPTx` [ok] 200 2100ms https://api.backed.fi/api/v2/public/assets/SUOPTx/circulating-supply?format=object
- `xstocks.circ.ZHAOMx` [ok] 200 1633ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/circulating-supply?format=object
- `xstocks.mult.SUOPTx` [ok] 200 483ms https://api.backed.fi/api/v2/public/assets/SUOPTx/multiplier?network=Solana
...
- `xstocks.price.WRFHDx` [FAIL]  12011ms https://api.backed.fi/api/v2/public/assets/WRFHDx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.WRFHDx` [ok] 200 1367ms https://api.backed.fi/api/v2/public/assets/WRFHDx/circulating-supply?format=object
- `xstocks.price.SZIGHx` [FAIL]  12015ms https://api.backed.fi/api/v2/public/assets/SZIGHx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.KUNLx` [ok] 200 2499ms https://api.backed.fi/api/v2/public/assets/KUNLx/circulating-supply?format=object
- `xstocks.mult.ENNHLx` [ok] 200 459ms https://api.backed.fi/api/v2/public/assets/ENNHLx/multiplier?network=Solana
- `xstocks.mult.KUNLx` [ok] 200 478ms https://api.backed.fi/api/v2/public/assets/KUNLx/multiplier?network=Solana
...
- `xstocks.circ.HRZRBx` [ok] 200 258ms https://api.backed.fi/api/v2/public/assets/HRZRBx/circulating-supply?format=object
- `xstocks.circ.SMOIHx` [ok] 200 426ms https://api.backed.fi/api/v2/public/assets/SMOIHx/circulating-supply?format=object
...
- `xstocks.circ.CRESBx` [ok] 200 486ms https://api.backed.fi/api/v2/public/assets/CRESBx/circulating-supply?format=object
...
- `xstocks.circ.CMENDx` [ok] 200 442ms https://api.backed.fi/api/v2/public/assets/CMENDx/circulating-supply?format=object
...
- `xstocks.mult.MIXUx` [ok] 200 584ms https://api.backed.fi/api/v2/public/assets/MIXUx/multiplier?network=Solana
...
- `xstocks.circ.SNDSCx` [ok] 200 230ms https://api.backed.fi/api/v2/public/assets/SNDSCx/circulating-supply?format=object
...
- `xstocks.circ.WHGROx` [ok] 200 373ms https://api.backed.fi/api/v2/public/assets/WHGROx/circulating-supply?format=object
...
- `xstocks.mult.CLONPx` [ok] 200 379ms https://api.backed.fi/api/v2/public/assets/CLONPx/multiplier?network=Solana
- `xstocks.circ.CTPCAx` [ok] 200 357ms https://api.backed.fi/api/v2/public/assets/CTPCAx/circulating-supply?format=object
- `xstocks.mult.SINOTx` [ok] 200 1102ms https://api.backed.fi/api/v2/public/assets/SINOTx/multiplier?network=Solana
- `xstocks.mult.WHGROx` [ok] 200 876ms https://api.backed.fi/api/v2/public/assets/WHGROx/multiplier?network=Solana
- `xstocks.circ.SINOx` [ok] 200 1039ms https://api.backed.fi/api/v2/public/assets/SINOx/circulating-supply?format=object
...
- `xstocks.mult.CRAUTx` [ok] 200 462ms https://api.backed.fi/api/v2/public/assets/CRAUTx/multiplier?network=Solana
...
- `xstocks.circ.CKINFx` [ok] 200 290ms https://api.backed.fi/api/v2/public/assets/CKINFx/circulating-supply?format=object
- `xstocks.circ.WUXIBx` [ok] 200 1163ms https://api.backed.fi/api/v2/public/assets/WUXIBx/circulating-supply?format=object
- `xstocks.circ.CKAHx` [ok] 200 801ms https://api.backed.fi/api/v2/public/assets/CKAHx/circulating-supply?format=object
- `xstocks.mult.WUXIBx` [ok] 200 243ms https://api.backed.fi/api/v2/public/assets/WUXIBx/multiplier?network=Solana
- `xstocks.circ.SWPRPx` [ok] 200 1286ms https://api.backed.fi/api/v2/public/assets/SWPRPx/circulating-supply?format=object
...
- `xstocks.circ.KUAIx` [ok] 200 1680ms https://api.backed.fi/api/v2/public/assets/KUAIx/circulating-supply?format=object
- `xstocks.circ.NONGx` [ok] 200 338ms https://api.backed.fi/api/v2/public/assets/NONGx/circulating-supply?format=object
...
- `xstocks.circ.COVELx` [ok] 200 336ms https://api.backed.fi/api/v2/public/assets/COVELx/circulating-supply?format=object
...
- `xstocks.circ.CHONGx` [ok] 200 834ms https://api.backed.fi/api/v2/public/assets/CHONGx/circulating-supply?format=object
...
- `xstocks.circ.POPMTx` [ok] 200 179ms https://api.backed.fi/api/v2/public/assets/POPMTx/circulating-supply?format=object
...
- `xstocks.circ.BOCOMx` [ok] 200 648ms https://api.backed.fi/api/v2/public/assets/BOCOMx/circulating-supply?format=object
...
- `xstocks.mult.POPMTx` [ok] 200 1039ms https://api.backed.fi/api/v2/public/assets/POPMTx/multiplier?network=Solana
...
- `xstocks.mult.BOCHKx` [ok] 200 262ms https://api.backed.fi/api/v2/public/assets/BOCHKx/multiplier?network=Solana
- `xstocks.circ.CITICx` [ok] 200 451ms https://api.backed.fi/api/v2/public/assets/CITICx/circulating-supply?format=object
...
- `xstocks.circ.ANTASx` [ok] 200 339ms https://api.backed.fi/api/v2/public/assets/ANTASx/circulating-supply?format=object
- `xstocks.mult.ANTASx` [ok] 200 238ms https://api.backed.fi/api/v2/public/assets/ANTASx/multiplier?network=Solana
...
- `xstocks.circ.HAIERx` [ok] 200 274ms https://api.backed.fi/api/v2/public/assets/HAIERx/circulating-supply?format=object
...
- `xstocks.price.ICBCx` [FAIL]  12011ms https://api.backed.fi/api/v2/public/assets/ICBCx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.ZJGLDx` [ok] 200 426ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/circulating-supply?format=object
- `xstocks.mult.ZJGLDx` [ok] 200 198ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/multiplier?network=Solana
- `xstocks.circ.ICBCx` [ok] 200 551ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
- `xstocks.mult.ICBCx` [ok] 200 210ms https://api.backed.fi/api/v2/public/assets/ICBCx/multiplier?network=Solana
- `xstocks.circ.PSBOCx` [ok] 200 1567ms https://api.backed.fi/api/v2/public/assets/PSBOCx/circulating-supply?format=object
- `xstocks.mult.PSBOCx` [ok] 200 575ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
- `llama.protocol.xstocks` [ok] 200 1163ms https://api.llama.fi/protocol/xstocks
- `jup.tokens.search.xStock` [ok] 200 661ms https://lite-api.jup.ag/tokens/v2/search?query=xStock
- `jup.tokens.search.MMGx` [ok] 200 105ms https://lite-api.jup.ag/tokens/v2/search?query=MMGx
- `jup.tokens.search.TNGYIx` [ok] 200 122ms https://lite-api.jup.ag/tokens/v2/search?query=TNGYIx
- `jup.tokens.search.BANKCx` [ok] 200 107ms https://lite-api.jup.ag/tokens/v2/search?query=BANKCx
- `jup.tokens.search.LAOPGx` [ok] 200 106ms https://lite-api.jup.ag/tokens/v2/search?query=LAOPGx
...
- `jup.tokens.search.JDLOGx` [ok] 200 119ms https://lite-api.jup.ag/tokens/v2/search?query=JDLOGx
