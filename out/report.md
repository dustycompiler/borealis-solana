...
**Generated** 2026-09-06T14:23:12Z · 2026-09-06 07:23:12 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-06T14:23:01Z · **RPC health** `ok`
**Health score** 98 / 100 — `25×rpc_ok + 30×clamp(1 − max(0, slot_ms − 300)/300, 0, 1) + 25×clamp(1 − delinquent_stake_pct/2, 0, 1) + 20×clamp(tps / tps_baseline, 0, 1)`
**Network health** HEALTHY · **Ecosystem** ELEVATED — SOL 24h +3.03%; DEX 24h $1.96B · 1d +4% · vs-7d-ago +17%; slot 317 ms
...
- **WARN · Last TPS sample outside 2.5σ of the 60-sample window** — Last sample 4,570 TPS is +3.14σ vs window mean 3,823 (n=60, σ=238). (threshold: `|last sample − window mean| > 2.5σ`)
...
| Health | `ok` |
| Slot | 444,814,455 |
| Block height | 422,858,808 |
| Block time | 2026-09-06T14:23:01Z |
| Epoch | 1,029 (66.31% · slot 286,458/432,000) |
| Mean TPS (last ~3,600s) | 3,822.6 |
| Mean non-vote TPS | 1,702.3 |
| Median TPS (same window) | 3,810.0 |
| Mean slot time | 317.0 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 545,704,504,102 |
| Circulating supply | 585,445,092 SOL |
| Total supply | 633,548,967 SOL |
...
- `xLabscif…` · 28.57K SOL · commission 5% · lag 1026082 slots
- `mrgn4atx…` · 20.30K SOL · commission 0% · lag 50345 slots
- `prt1st4R…` · 13.11K SOL · commission 5% · lag 1327513 slots
- `E4xNK4Uw…` · 6.26K SOL · commission 5% · lag 1465732 slots
- `5ZjxMYBb…` · 4.06K SOL · commission 0% · lag 848533 slots
- `FSyAsxcE…` · 3.02K SOL · commission 100% · lag 2028334 slots
- `pSoLoZx5…` · 1.51K SOL · commission 4% · lag 275264 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 1375816 slots
- `CpdzCVza…` · 193.38 SOL · commission 100% · lag 2014104 slots
- `7ZjHeeYE…` · 176.10 SOL · commission 5% · lag 2055618 slots
- `HFTcVVrX…` · 148.42 SOL · commission 100% · lag 2013998 slots
- `6pEtDovp…` · 131.86 SOL · commission 100% · lag 2028382 slots
...
| Jito tip-floor run-rate (NOT REV) | $69.36K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 69359 USD; at p95 floor → 1355070 USD. |
...
| Metric | Value | Source |
| --- | ---: | --- |
| SOL/USD | $105.83 | coingecko.simple_price |
...
24h volume $64.29M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-09-06 (2026-09-06 07:23:12 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getBlockTime` [ok] 200 473ms https://api.mainnet-beta.solana.com
- `rpc.getEpochInfo` [ok] 200 311ms https://api.mainnet-beta.solana.com
...
- `rpc.getVoteAccounts` [ok] 200 669ms https://api.mainnet-beta.solana.com
...
- `llama.stablecoincharts` [ok] 200 1157ms https://stablecoins.llama.fi/stablecoincharts/Solana
...
- `rss.nitter.anza_xyz` [ok] 200 1750ms https://nitter.perennialte.ch/anza_xyz/rss
...
- `xstocks.assets.p1` [ok] 200 3854ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=1
- `xstocks.assets.p2` [ok] 200 5884ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=2
- `xstocks.assets.p3` [ok] 200 4952ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=3
- `xstocks.assets.p4` [ok] 200 2447ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=4
- `xstocks.assets.p5` [ok] 200 3471ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=5
- `xstocks.assets.p6` [ok] 200 3811ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=6
- `xstocks.assets.p7` [ok] 200 1883ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=7
...
- `xstocks.circ.GOOGLx` [ok] 200 329ms https://api.backed.fi/api/v2/public/assets/GOOGLx/circulating-supply?format=object
- `xstocks.circ.SPYx` [ok] 200 574ms https://api.backed.fi/api/v2/public/assets/SPYx/circulating-supply?format=object
...
- `xstocks.circ.METAx` [ok] 200 922ms https://api.backed.fi/api/v2/public/assets/METAx/circulating-supply?format=object
- `xstocks.circ.AMZNx` [ok] 200 995ms https://api.backed.fi/api/v2/public/assets/AMZNx/circulating-supply?format=object
...
- `xstocks.mult.MVLLx` [ok] 200 231ms https://api.backed.fi/api/v2/public/assets/MVLLx/multiplier?network=Solana
...
- `xstocks.circ.QQQx` [ok] 200 713ms https://api.backed.fi/api/v2/public/assets/QQQx/circulating-supply?format=object
...
- `xstocks.circ.DJTx` [ok] 200 950ms https://api.backed.fi/api/v2/public/assets/DJTx/circulating-supply?format=object
- `xstocks.mult.KORUx` [ok] 200 784ms https://api.backed.fi/api/v2/public/assets/KORUx/multiplier?network=Solana
- `xstocks.mult.DRAMx` [ok] 200 1492ms https://api.backed.fi/api/v2/public/assets/DRAMx/multiplier?network=Solana
...
- `xstocks.circ.INTWx` [ok] 200 294ms https://api.backed.fi/api/v2/public/assets/INTWx/circulating-supply?format=object
...
- `xstocks.circ.SOXSx` [ok] 200 266ms https://api.backed.fi/api/v2/public/assets/SOXSx/circulating-supply?format=object
...
- `xstocks.price.NWGx` [FAIL]  12010ms https://api.backed.fi/api/v2/public/assets/NWGx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.price.MMGx` [FAIL]  12017ms https://api.backed.fi/api/v2/public/assets/MMGx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.SUOPTx` [ok] 200 315ms https://api.backed.fi/api/v2/public/assets/SUOPTx/circulating-supply?format=object
- `xstocks.circ.MMGx` [ok] 200 446ms https://api.backed.fi/api/v2/public/assets/MMGx/circulating-supply?format=object
- `xstocks.mult.SUOPTx` [ok] 200 1004ms https://api.backed.fi/api/v2/public/assets/SUOPTx/multiplier?network=Solana
- `xstocks.mult.BANKCx` [ok] 200 1353ms https://api.backed.fi/api/v2/public/assets/BANKCx/multiplier?network=Solana
...
- `xstocks.circ.ZHAOMx` [ok] 200 473ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/circulating-supply?format=object
...
- `xstocks.circ.JDLOGx` [ok] 200 482ms https://api.backed.fi/api/v2/public/assets/JDLOGx/circulating-supply?format=object
...
- `xstocks.mult.LAOPGx` [ok] 200 1107ms https://api.backed.fi/api/v2/public/assets/LAOPGx/multiplier?network=Solana
- `xstocks.mult.JDLOGx` [ok] 200 1094ms https://api.backed.fi/api/v2/public/assets/JDLOGx/multiplier?network=Solana
...
- `xstocks.circ.KUNLx` [ok] 200 326ms https://api.backed.fi/api/v2/public/assets/KUNLx/circulating-supply?format=object
- `xstocks.circ.WRFHDx` [ok] 200 346ms https://api.backed.fi/api/v2/public/assets/WRFHDx/circulating-supply?format=object
...
- `xstocks.circ.HAIDLx` [ok] 200 429ms https://api.backed.fi/api/v2/public/assets/HAIDLx/circulating-supply?format=object
...
- `xstocks.circ.SZIGHx` [ok] 200 363ms https://api.backed.fi/api/v2/public/assets/SZIGHx/circulating-supply?format=object
...
- `xstocks.mult.SMOIHx` [ok] 200 225ms https://api.backed.fi/api/v2/public/assets/SMOIHx/multiplier?network=Solana
- `xstocks.circ.HRZRBx` [ok] 200 168ms https://api.backed.fi/api/v2/public/assets/HRZRBx/circulating-supply?format=object
- `xstocks.mult.SZIGHx` [ok] 200 1191ms https://api.backed.fi/api/v2/public/assets/SZIGHx/multiplier?network=Solana
...
- `xstocks.mult.HRZRBx` [ok] 200 690ms https://api.backed.fi/api/v2/public/assets/HRZRBx/multiplier?network=Solana
- `xstocks.circ.CRESBx` [ok] 200 503ms https://api.backed.fi/api/v2/public/assets/CRESBx/circulating-supply?format=object
- `xstocks.circ.CMERPx` [ok] 200 438ms https://api.backed.fi/api/v2/public/assets/CMERPx/circulating-supply?format=object
...
- `xstocks.mult.CRESBx` [ok] 200 443ms https://api.backed.fi/api/v2/public/assets/CRESBx/multiplier?network=Solana
...
- `xstocks.circ.CMENDx` [ok] 200 427ms https://api.backed.fi/api/v2/public/assets/CMENDx/circulating-supply?format=object
- `xstocks.mult.JTGEXx` [ok] 200 914ms https://api.backed.fi/api/v2/public/assets/JTGEXx/multiplier?network=Solana
...
- `xstocks.mult.WXXDCx` [ok] 200 982ms https://api.backed.fi/api/v2/public/assets/WXXDCx/multiplier?network=Solana
...
- `xstocks.mult.CMENDx` [ok] 200 422ms https://api.backed.fi/api/v2/public/assets/CMENDx/multiplier?network=Solana
...
- `xstocks.mult.WHRFRx` [ok] 200 567ms https://api.backed.fi/api/v2/public/assets/WHRFRx/multiplier?network=Solana
- `xstocks.mult.ASMPTx` [ok] 200 652ms https://api.backed.fi/api/v2/public/assets/ASMPTx/multiplier?network=Solana
- `xstocks.mult.CRESMx` [ok] 200 3524ms https://api.backed.fi/api/v2/public/assets/CRESMx/multiplier?network=Solana
...
- `xstocks.mult.CRESPx` [ok] 200 383ms https://api.backed.fi/api/v2/public/assets/CRESPx/multiplier?network=Solana
...
- `xstocks.mult.CTFJWx` [ok] 200 1476ms https://api.backed.fi/api/v2/public/assets/CTFJWx/multiplier?network=Solana
- `xstocks.mult.CLONPx` [ok] 200 1252ms https://api.backed.fi/api/v2/public/assets/CLONPx/multiplier?network=Solana
- `xstocks.mult.SNDSCx` [ok] 200 4356ms https://api.backed.fi/api/v2/public/assets/SNDSCx/multiplier?network=Solana
...
- `xstocks.circ.SINOx` [ok] 200 346ms https://api.backed.fi/api/v2/public/assets/SINOx/circulating-supply?format=object
...
- `xstocks.mult.SINOx` [ok] 200 705ms https://api.backed.fi/api/v2/public/assets/SINOx/multiplier?network=Solana
...
- `xstocks.mult.WHGROx` [ok] 200 2015ms https://api.backed.fi/api/v2/public/assets/WHGROx/multiplier?network=Solana
- `xstocks.mult.PWAHLx` [ok] 200 868ms https://api.backed.fi/api/v2/public/assets/PWAHLx/multiplier?network=Solana
- `xstocks.price.GENTEx` [FAIL]  12007ms https://api.backed.fi/api/v2/public/assets/GENTEx/price-data — TimeoutError: The read operation timed out
- `xstocks.mult.CLPHDx` [ok] 200 1493ms https://api.backed.fi/api/v2/public/assets/CLPHDx/multiplier?network=Solana
...
- `xstocks.mult.GENTEx` [ok] 200 849ms https://api.backed.fi/api/v2/public/assets/GENTEx/multiplier?network=Solana
...
- `xstocks.mult.WUXIBx` [ok] 200 193ms https://api.backed.fi/api/v2/public/assets/WUXIBx/multiplier?network=Solana
- `xstocks.mult.CRAUTx` [ok] 200 994ms https://api.backed.fi/api/v2/public/assets/CRAUTx/multiplier?network=Solana
...
- `xstocks.circ.SWPRPx` [ok] 200 248ms https://api.backed.fi/api/v2/public/assets/SWPRPx/circulating-supply?format=object
...
- `xstocks.circ.NONGx` [ok] 200 296ms https://api.backed.fi/api/v2/public/assets/NONGx/circulating-supply?format=object
- `xstocks.mult.NONGx` [ok] 200 194ms https://api.backed.fi/api/v2/public/assets/NONGx/multiplier?network=Solana
- `xstocks.circ.COVELx` [ok] 200 552ms https://api.backed.fi/api/v2/public/assets/COVELx/circulating-supply?format=object
- `xstocks.mult.HKEXCx` [ok] 200 1785ms https://api.backed.fi/api/v2/public/assets/HKEXCx/multiplier?network=Solana
- `xstocks.mult.COVELx` [ok] 200 677ms https://api.backed.fi/api/v2/public/assets/COVELx/multiplier?network=Solana
...
- `xstocks.mult.CHONGx` [ok] 200 584ms https://api.backed.fi/api/v2/public/assets/CHONGx/multiplier?network=Solana
...
- `xstocks.mult.GEELx` [ok] 200 510ms https://api.backed.fi/api/v2/public/assets/GEELx/multiplier?network=Solana
...
- `xstocks.circ.MTRCPx` [ok] 200 1339ms https://api.backed.fi/api/v2/public/assets/MTRCPx/circulating-supply?format=object
...
- `xstocks.mult.HNDLDx` [ok] 200 558ms https://api.backed.fi/api/v2/public/assets/HNDLDx/multiplier?network=Solana
...
- `xstocks.circ.PICCx` [ok] 200 980ms https://api.backed.fi/api/v2/public/assets/PICCx/circulating-supply?format=object
...
- `xstocks.mult.CKHUTx` [ok] 200 375ms https://api.backed.fi/api/v2/public/assets/CKHUTx/multiplier?network=Solana
- `xstocks.mult.PICCx` [ok] 200 701ms https://api.backed.fi/api/v2/public/assets/PICCx/multiplier?network=Solana
