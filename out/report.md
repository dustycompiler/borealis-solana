...
**Generated** 2026-08-29T09:33:35Z · 2026-08-29 02:33:35 PT
**Author** dustycompiler · **Version** 1.5.6 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-29T09:33:24Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h -2.68%; DEX 24h $2.62B · 1d -29% · vs-7d-ago -27%; slot 316 ms
...
- **WARN · Correlation: risk-off (SOL 24h ↓ + TVL 1d ↓ + DEX 1d ↓)** — SOL 24h -2.68%, DeFiLlama TVL 1d -2.71%, DEX 1d -29.33%. (threshold: `SOL 24h < 0 AND TVL 1d < 0 AND DEX 1d < 0`)
- **WARN · Large Solana DEX volume 7d move** — DeFiLlama Solana DEX volume 7d change is -27.38%. (threshold: `|7d %| >= 20`)
- **WARN · SOL price vs 30d median (solana.com/data)** — Current 103.40 USD is +35.7% vs 30d median 76.20 USD (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
...
| Health | `ok` |
| Slot | 442,573,494 |
| Block height | 420,621,404 |
| Block time | 2026-08-29T09:33:24Z |
| Epoch | 1,024 (47.57% · slot 205,494/432,000) |
| Mean TPS (last ~3,600s) | 3,538.8 |
| Mean non-vote TPS | 1,372.5 |
| Median TPS (same window) | 3,514.2 |
| Mean slot time | 316.4 ms |
| Median slot time | 315.8 ms |
| Transaction count (cluster) | 543,045,357,376 |
| Circulating supply | 584,161,675 SOL |
| Total supply | 633,079,215 SOL |
...
- `mrgn4atx…` · 20.33K SOL · commission 0% · lag 1741 slots
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1320815 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 226793 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 589740 slots
- `kom1oNHy…` · 662.86 SOL · commission 5% · lag 1936978 slots
- `7ZjHeeYE…` · 176.09 SOL · commission 5% · lag 149017 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442573494 slots
- `pSo1KZXg…` · 2.00 SOL · commission 4% · lag 235653 slots
- `7Dvp5zCF…` · 1.07 SOL · commission 100% · lag 394139 slots
- `bcZxRSoz…` · 0.00 SOL · commission 0% · lag 1933495 slots
...
| --- | ---: | --- |
| TPS chart | 85 | data/history.jsonl snapshot tape |
| TVL chart | 85 | data/history.jsonl snapshot tape |
| SOL chart | 84 | data/history.jsonl snapshot tape |
| history.jsonl rows | 85 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $122.61K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 122614 USD; at p95 floor → 12261437 USD. |
...
24h volume $30.73M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-08-29 (2026-08-29 02:33:35 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 7452ms https://api.mainnet-beta.solana.com
...
- `rss.nitter.anza_xyz` [ok] 200 2044ms https://nitter.perennialte.ch/anza_xyz/rss
...
- `xstocks.mult.AMZNx` [ok] 200 922ms https://api.backed.fi/api/v2/public/assets/AMZNx/multiplier?network=Solana
...
- `xstocks.price.MMGx` [FAIL]  12014ms https://api.backed.fi/api/v2/public/assets/MMGx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.ZHAOMx` [ok] 200 670ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/circulating-supply?format=object
- `xstocks.mult.LAOPGx` [ok] 200 148ms https://api.backed.fi/api/v2/public/assets/LAOPGx/multiplier?network=Solana
- `xstocks.mult.ZHAOMx` [ok] 200 882ms https://api.backed.fi/api/v2/public/assets/ZHAOMx/multiplier?network=Solana
...
- `xstocks.circ.JDLOGx` [ok] 200 540ms https://api.backed.fi/api/v2/public/assets/JDLOGx/circulating-supply?format=object
...
- `xstocks.mult.ENNHLx` [ok] 200 185ms https://api.backed.fi/api/v2/public/assets/ENNHLx/multiplier?network=Solana
...
- `xstocks.circ.WXXDCx` [ok] 200 797ms https://api.backed.fi/api/v2/public/assets/WXXDCx/circulating-supply?format=object
- `xstocks.mult.WXXDCx` [ok] 200 782ms https://api.backed.fi/api/v2/public/assets/WXXDCx/multiplier?network=Solana
...
- `xstocks.mult.WHRFRx` [ok] 200 680ms https://api.backed.fi/api/v2/public/assets/WHRFRx/multiplier?network=Solana
- `xstocks.circ.JDHLTx` [ok] 200 588ms https://api.backed.fi/api/v2/public/assets/JDHLTx/circulating-supply?format=object
...
- `xstocks.circ.PRADx` [ok] 200 436ms https://api.backed.fi/api/v2/public/assets/PRADx/circulating-supply?format=object
...
- `xstocks.price.WHGROx` [FAIL]  12011ms https://api.backed.fi/api/v2/public/assets/WHGROx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.CTFJWx` [ok] 200 1044ms https://api.backed.fi/api/v2/public/assets/CTFJWx/circulating-supply?format=object
...
- `xstocks.circ.CLONPx` [ok] 200 1861ms https://api.backed.fi/api/v2/public/assets/CLONPx/circulating-supply?format=object
- `xstocks.circ.WHGROx` [ok] 200 1515ms https://api.backed.fi/api/v2/public/assets/WHGROx/circulating-supply?format=object
...
- `xstocks.mult.CLONPx` [ok] 200 484ms https://api.backed.fi/api/v2/public/assets/CLONPx/multiplier?network=Solana
- `xstocks.circ.CTPCAx` [ok] 200 1269ms https://api.backed.fi/api/v2/public/assets/CTPCAx/circulating-supply?format=object
...
- `xstocks.circ.PWAHLx` [ok] 200 1080ms https://api.backed.fi/api/v2/public/assets/PWAHLx/circulating-supply?format=object
- `xstocks.mult.PWAHLx` [ok] 200 242ms https://api.backed.fi/api/v2/public/assets/PWAHLx/multiplier?network=Solana
- `xstocks.price.GENTEx` [FAIL]  12011ms https://api.backed.fi/api/v2/public/assets/GENTEx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.CLPHDx` [ok] 200 1227ms https://api.backed.fi/api/v2/public/assets/CLPHDx/circulating-supply?format=object
...
- `xstocks.circ.GENTEx` [ok] 200 1042ms https://api.backed.fi/api/v2/public/assets/GENTEx/circulating-supply?format=object
...
- `xstocks.circ.WUXIBx` [ok] 200 1024ms https://api.backed.fi/api/v2/public/assets/WUXIBx/circulating-supply?format=object
- `xstocks.mult.WUXIBx` [ok] 200 140ms https://api.backed.fi/api/v2/public/assets/WUXIBx/multiplier?network=Solana
- `xstocks.circ.CKAHx` [ok] 200 846ms https://api.backed.fi/api/v2/public/assets/CKAHx/circulating-supply?format=object
...
- `xstocks.circ.CKINFx` [ok] 200 1769ms https://api.backed.fi/api/v2/public/assets/CKINFx/circulating-supply?format=object
...
- `xstocks.circ.HKCGAx` [ok] 200 1052ms https://api.backed.fi/api/v2/public/assets/HKCGAx/circulating-supply?format=object
...
- `xstocks.circ.HKEXCx` [ok] 200 912ms https://api.backed.fi/api/v2/public/assets/HKEXCx/circulating-supply?format=object
...
- `xstocks.circ.KUAIx` [ok] 200 2722ms https://api.backed.fi/api/v2/public/assets/KUAIx/circulating-supply?format=object
- `xstocks.mult.KUAIx` [ok] 200 145ms https://api.backed.fi/api/v2/public/assets/KUAIx/multiplier?network=Solana
- `xstocks.price.MEITx` [FAIL]  12012ms https://api.backed.fi/api/v2/public/assets/MEITx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.MEITx` [ok] 200 136ms https://api.backed.fi/api/v2/public/assets/MEITx/circulating-supply?format=object
...
- `xstocks.price.COSCx` [FAIL]  12010ms https://api.backed.fi/api/v2/public/assets/COSCx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.COSCx` [ok] 200 569ms https://api.backed.fi/api/v2/public/assets/COSCx/circulating-supply?format=object
...
- `xstocks.mult.COSCx` [ok] 200 142ms https://api.backed.fi/api/v2/public/assets/COSCx/multiplier?network=Solana
- `xstocks.circ.POPMTx` [ok] 200 158ms https://api.backed.fi/api/v2/public/assets/POPMTx/circulating-supply?format=object
...
- `xstocks.circ.BOCOMx` [ok] 200 221ms https://api.backed.fi/api/v2/public/assets/BOCOMx/circulating-supply?format=object
- `xstocks.mult.BOCOMx` [ok] 200 187ms https://api.backed.fi/api/v2/public/assets/BOCOMx/multiplier?network=Solana
- `xstocks.price.CPETCx` [FAIL]  12014ms https://api.backed.fi/api/v2/public/assets/CPETCx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.CPETCx` [ok] 200 306ms https://api.backed.fi/api/v2/public/assets/CPETCx/circulating-supply?format=object
- `xstocks.mult.CPETCx` [ok] 200 846ms https://api.backed.fi/api/v2/public/assets/CPETCx/multiplier?network=Solana
...
- `xstocks.circ.BOCHKx` [ok] 200 560ms https://api.backed.fi/api/v2/public/assets/BOCHKx/circulating-supply?format=object
- `xstocks.mult.BOCHKx` [ok] 200 125ms https://api.backed.fi/api/v2/public/assets/BOCHKx/multiplier?network=Solana
...
- `xstocks.mult.CITICx` [ok] 200 129ms https://api.backed.fi/api/v2/public/assets/CITICx/multiplier?network=Solana
- `xstocks.circ.ANTASx` [ok] 200 157ms https://api.backed.fi/api/v2/public/assets/ANTASx/circulating-supply?format=object
- `xstocks.circ.CRESLx` [ok] 200 147ms https://api.backed.fi/api/v2/public/assets/CRESLx/circulating-supply?format=object
...
- `xstocks.mult.ANTASx` [ok] 200 130ms https://api.backed.fi/api/v2/public/assets/ANTASx/multiplier?network=Solana
...
- `xstocks.circ.ZJGLDx` [ok] 200 138ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/circulating-supply?format=object
...
- `xstocks.circ.PSBOCx` [ok] 200 510ms https://api.backed.fi/api/v2/public/assets/PSBOCx/circulating-supply?format=object
- `xstocks.mult.PSBOCx` [ok] 200 197ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
- `xstocks.price.ICBCx` [FAIL]  12012ms https://api.backed.fi/api/v2/public/assets/ICBCx/price-data — TimeoutError: The read operation timed out
- `xstocks.circ.ICBCx` [ok] 200 220ms https://api.backed.fi/api/v2/public/assets/ICBCx/circulating-supply?format=object
...
- `jup.tokens.search.LAOPGx` [ok] 200 50ms https://lite-api.jup.ag/tokens/v2/search?query=LAOPGx
- `jup.tokens.search.ZHAOMx` [ok] 200 53ms https://lite-api.jup.ag/tokens/v2/search?query=ZHAOMx
- `jup.tokens.search.WRFHDx` [ok] 200 53ms https://lite-api.jup.ag/tokens/v2/search?query=WRFHDx
