...
**Generated** 2026-09-20T07:49:18Z · 2026-09-20 00:49:18 PT
**Author** dustycompiler · **Version** 1.5.7 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-09-20T07:49:09Z · **RPC health** `ok`
...
- **WARN · Correlation: risk-off (SOL 24h ↓ + TVL 1d ↓ + DEX 1d ↓)** — SOL 24h -2.78%, DeFiLlama TVL 1d -2.75%, DEX 1d -8.58%. (threshold: `SOL 24h < 0 AND TVL 1d < 0 AND DEX 1d < 0`)
...
| Health | `ok` |
| Slot | 448,668,697 |
| Block height | 426,709,420 |
| Block time | 2026-09-20T07:49:09Z |
| Epoch | 1,038 (58.49% · slot 252,697/432,000) |
| Mean TPS (last ~3,600s) | 3,894.5 |
| Mean non-vote TPS | 1,352.8 |
| Median TPS (same window) | 3,887.7 |
| Mean slot time | 265.7 ms |
| Median slot time | 265.5 ms |
| Transaction count (cluster) | 550,476,005,448 |
| Circulating supply | 587,367,006 SOL |
| Total supply | 634,375,685 SOL |
...
- `t23p8aBQ…` · 14.48K SOL · commission 0% · lag 1073461 slots
- `AYY1TCe3…` · 10.81K SOL · commission 0% · lag 44727 slots
- `mrgn4atx…` · 2.26K SOL · commission 0% · lag 71292 slots
- `pSoLoZx5…` · 1.51K SOL · commission 4% · lag 793945 slots
- `Hgozywot…` · 797.43 SOL · commission 100% · lag 175826 slots
- `EWARp8Sy…` · 64.91 SOL · commission 5% · lag 1672701 slots
- `FLVgaCPv…` · 9.28 SOL · commission 5% · lag 20653159 slots
- `stacheBm…` · 3.00 SOL · commission 5% · lag 19133014 slots
- `HDRqPft5…` · 2.00 SOL · commission 100% · lag 448668697 slots
- `6mygxmZx…` · 2.00 SOL · commission 100% · lag 60259 slots
- `6DTkuiey…` · 2.00 SOL · commission 100% · lag 448668697 slots
- `Fb77sbwg…` · 1.08 SOL · commission 0% · lag 2412670 slots
...
| Jito tip-floor run-rate (NOT REV) | $76.12K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 76124 USD; at p95 floor → 2537473 USD. |
...
| Metric | Value | Source |
| --- | ---: | --- |
| SOL/USD | $108.55 | coingecko.simple_price |
| 24h change | -2.78% | coingecko.simple_price |
| Market cap | $63.76B | coingecko.simple_price |
...
24h volume $96.16M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-09-20 (2026-09-20 00:49:18 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rss.nitter.solana` [ok] 200 2473ms https://nitter.perennialte.ch/solana/rss
...
- `xstocks.assets.p0` [ok] 200 2860ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=0
- `xstocks.assets.p1` [ok] 200 5718ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=1
...
- `xstocks.assets.p7` [ok] 200 2166ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=7
...
- `xstocks.circ.FLNCx` [ok] 200 477ms https://api.backed.fi/api/v2/public/assets/FLNCx/circulating-supply?format=object
- `xstocks.mult.QUBTx` [ok] 200 299ms https://api.backed.fi/api/v2/public/assets/QUBTx/multiplier?network=Solana
- `xstocks.circ.METCx` [ok] 200 520ms https://api.backed.fi/api/v2/public/assets/METCx/circulating-supply?format=object
...
- `xstocks.circ.INDIx` [ok] 200 898ms https://api.backed.fi/api/v2/public/assets/INDIx/circulating-supply?format=object
...
- `xstocks.mult.WRLDx` [ok] 200 878ms https://api.backed.fi/api/v2/public/assets/WRLDx/multiplier?network=Solana
...
- `xstocks.mult.WYFIx` [ok] 200 671ms https://api.backed.fi/api/v2/public/assets/WYFIx/multiplier?network=Solana
...
- `xstocks.circ.DRSx` [ok] 200 1167ms https://api.backed.fi/api/v2/public/assets/DRSx/circulating-supply?format=object
- `xstocks.circ.BSYx` [ok] 200 1000ms https://api.backed.fi/api/v2/public/assets/BSYx/circulating-supply?format=object
...
- `xstocks.circ.SAILx` [ok] 200 1303ms https://api.backed.fi/api/v2/public/assets/SAILx/circulating-supply?format=object
...
- `xstocks.mult.DVAx` [ok] 200 1177ms https://api.backed.fi/api/v2/public/assets/DVAx/multiplier?network=Solana
...
- `xstocks.circ.FRHCx` [ok] 200 731ms https://api.backed.fi/api/v2/public/assets/FRHCx/circulating-supply?format=object
...
- `xstocks.mult.AMx` [ok] 200 407ms https://api.backed.fi/api/v2/public/assets/AMx/multiplier?network=Solana
...
- `xstocks.mult.FDSx` [ok] 200 526ms https://api.backed.fi/api/v2/public/assets/FDSx/multiplier?network=Solana
...
- `xstocks.mult.ALSNx` [ok] 200 638ms https://api.backed.fi/api/v2/public/assets/ALSNx/multiplier?network=Solana
...
- `xstocks.circ.BPOPx` [ok] 200 493ms https://api.backed.fi/api/v2/public/assets/BPOPx/circulating-supply?format=object
...
- `xstocks.mult.DPZx` [ok] 200 443ms https://api.backed.fi/api/v2/public/assets/DPZx/multiplier?network=Solana
...
- `xstocks.circ.ARx` [ok] 200 1448ms https://api.backed.fi/api/v2/public/assets/ARx/circulating-supply?format=object
...
- `xstocks.circ.HUBSx` [ok] 200 440ms https://api.backed.fi/api/v2/public/assets/HUBSx/circulating-supply?format=object
...
- `xstocks.mult.OCx` [ok] 200 1105ms https://api.backed.fi/api/v2/public/assets/OCx/multiplier?network=Solana
...
- `xstocks.price.AMHx` [FAIL]  12010ms https://api.backed.fi/api/v2/public/assets/AMHx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.VNOMx` [ok] 200 602ms https://api.backed.fi/api/v2/public/assets/VNOMx/circulating-supply?format=object
...
- `xstocks.circ.IVZx` [ok] 200 266ms https://api.backed.fi/api/v2/public/assets/IVZx/circulating-supply?format=object
...
- `xstocks.circ.STRLx` [ok] 200 441ms https://api.backed.fi/api/v2/public/assets/STRLx/circulating-supply?format=object
...
- `xstocks.mult.NWSAx` [ok] 200 314ms https://api.backed.fi/api/v2/public/assets/NWSAx/multiplier?network=Solana
...
- `xstocks.circ.AURx` [ok] 200 1771ms https://api.backed.fi/api/v2/public/assets/AURx/circulating-supply?format=object
- `xstocks.circ.Hx` [ok] 200 201ms https://api.backed.fi/api/v2/public/assets/Hx/circulating-supply?format=object
- `xstocks.mult.AURx` [ok] 200 326ms https://api.backed.fi/api/v2/public/assets/AURx/multiplier?network=Solana
...
- `xstocks.circ.ARWRx` [ok] 200 1495ms https://api.backed.fi/api/v2/public/assets/ARWRx/circulating-supply?format=object
...
- `xstocks.price.RVTYx` [FAIL]  12015ms https://api.backed.fi/api/v2/public/assets/RVTYx/price-data — TimeoutError: The read operation timed out
