...
**Generated** 2026-08-29T09:48:45Z · 2026-08-29 02:48:45 PT
**Author** dustycompiler · **Version** 1.5.6 · **License** MIT
**Live demo** https://dustycompiler.github.io/borealis-solana/
**Cluster block time** 2026-08-29T09:48:34Z · **RPC health** `ok`
...
**Network health** HEALTHY · **Ecosystem** CONTRACTION — SOL 24h -2.24%; DEX 24h $2.62B · 1d -29% · vs-7d-ago -27%; slot 317 ms
...
- **WARN · Correlation: risk-off (SOL 24h ↓ + TVL 1d ↓ + DEX 1d ↓)** — SOL 24h -2.24%, DeFiLlama TVL 1d -2.71%, DEX 1d -29.33%. (threshold: `SOL 24h < 0 AND TVL 1d < 0 AND DEX 1d < 0`)
- **WARN · Large Solana DEX volume 7d move** — DeFiLlama Solana DEX volume 7d change is -27.38%. (threshold: `|7d %| >= 20`)
- **WARN · SOL price vs 30d median (solana.com/data)** — Current 103.43 USD is +36.1% vs 30d median 76.00 USD (solana.com/data). (threshold: `|current − 30d median| / median >= 20%`)
...
| Health | `ok` |
| Slot | 442,576,347 |
| Block height | 420,624,257 |
| Block time | 2026-08-29T09:48:34Z |
| Epoch | 1,024 (48.23% · slot 208,347/432,000) |
| Mean TPS (last ~3,600s) | 3,550.2 |
| Mean non-vote TPS | 1,391.6 |
| Median TPS (same window) | 3,557.0 |
| Mean slot time | 317.4 ms |
| Median slot time | 317.5 ms |
| Transaction count (cluster) | 543,048,545,614 |
| Circulating supply | 584,161,666 SOL |
| Total supply | 633,079,206 SOL |
...
- `mrgn4atx…` · 20.33K SOL · commission 0% · lag 4594 slots
- `gangtCrQ…` · 15.32K SOL · commission 0% · lag 1323668 slots
- `4GEEKSwu…` · 1.34K SOL · commission 5% · lag 229646 slots
- `ChaossRP…` · 827.71 SOL · commission 0% · lag 592593 slots
- `kom1oNHy…` · 662.86 SOL · commission 5% · lag 1939831 slots
- `7ZjHeeYE…` · 176.09 SOL · commission 5% · lag 151870 slots
- `6adw3JVB…` · 2.00 SOL · commission 100% · lag 442576347 slots
- `pSo1KZXg…` · 2.00 SOL · commission 4% · lag 238506 slots
- `7Dvp5zCF…` · 1.07 SOL · commission 100% · lag 396992 slots
- `bcZxRSoz…` · 0.00 SOL · commission 0% · lag 1936348 slots
...
| --- | ---: | --- |
| TPS chart | 86 | data/history.jsonl snapshot tape |
| TVL chart | 86 | data/history.jsonl snapshot tape |
| SOL chart | 85 | data/history.jsonl snapshot tape |
| history.jsonl rows | 86 | data/history.jsonl |
...
| Jito tip-floor run-rate (NOT REV) | $12.88K | INVALID as a 24h aggregate · included_in_headline=false · sensitivity (NOT a 24h aggregate, NOT headline REV): invalid run-rate at p50 floor → 12884 USD; at p95 floor → 2163462 USD. |
...
| p90 / p99 | 0.000009 / 0.000116 SOL | same sample |
...
24h volume $30.69M — Jupiter-reported xStocks subset 24h activity (stats24h buy+sell per mint; a swap is buy XOR sell of that mint, not a double-count; not all 715, not all Solana DEX) · 7d volume omitted (no no-key Jupiter/DeFiLlama series).
...
_As of 2026-08-29 (2026-08-29 02:48:45 PT). Editorial. Gate labels come from getAccountInfo Feature accounts (effective epoch = activation epoch + 1). Observed slot ms is INFERRED corroboration, not proof. Ignore solana.com/upgrades/reduced-slot-times if it lists 400 ms as current._
...
- `rpc.getSupply` [ok] 200 7782ms https://api.mainnet-beta.solana.com
...
- `rss.nitter.solana_status` [ok] 200 2907ms https://nitter.perennialte.ch/solana_status/rss
- `rss.nitter.anza_xyz` [FAIL] 502 1351ms https://nitter.perennialte.ch/anza_xyz/rss — HTTP 502 Bad Gateway
...
- `xstocks.assets.p3` [ok] 200 791ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=3
- `xstocks.assets.p4` [ok] 200 1403ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=4
- `xstocks.assets.p5` [ok] 200 1129ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=5
- `xstocks.assets.p6` [ok] 200 1181ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=6
- `xstocks.assets.p7` [ok] 200 191ms https://api.backed.fi/api/v2/public/assets?pageSize=100&page=7
...
- `xstocks.mult.TSLAx` [ok] 200 394ms https://api.backed.fi/api/v2/public/assets/TSLAx/multiplier?network=Solana
...
- `xstocks.mult.AMZNx` [ok] 200 582ms https://api.backed.fi/api/v2/public/assets/AMZNx/multiplier?network=Solana
- `xstocks.circ.MSFTx` [ok] 200 1586ms https://api.backed.fi/api/v2/public/assets/MSFTx/circulating-supply?format=object
...
- `xstocks.mult.COINx` [ok] 200 114ms https://api.backed.fi/api/v2/public/assets/COINx/multiplier?network=Solana
...
- `xstocks.circ.BANKCx` [ok] 200 1510ms https://api.backed.fi/api/v2/public/assets/BANKCx/circulating-supply?format=object
- `xstocks.mult.LAOPGx` [ok] 200 304ms https://api.backed.fi/api/v2/public/assets/LAOPGx/multiplier?network=Solana
...
- `xstocks.circ.SZIGHx` [ok] 200 544ms https://api.backed.fi/api/v2/public/assets/SZIGHx/circulating-supply?format=object
...
- `xstocks.circ.SMOIHx` [ok] 200 291ms https://api.backed.fi/api/v2/public/assets/SMOIHx/circulating-supply?format=object
...
- `xstocks.mult.CRESBx` [ok] 200 113ms https://api.backed.fi/api/v2/public/assets/CRESBx/multiplier?network=Solana
...
- `xstocks.circ.CMERPx` [ok] 200 432ms https://api.backed.fi/api/v2/public/assets/CMERPx/circulating-supply?format=object
...
- `xstocks.price.WXXDCx` [FAIL]  12013ms https://api.backed.fi/api/v2/public/assets/WXXDCx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.circ.WHRFRx` [ok] 200 336ms https://api.backed.fi/api/v2/public/assets/WHRFRx/circulating-supply?format=object
...
- `xstocks.mult.CRESPx` [ok] 200 170ms https://api.backed.fi/api/v2/public/assets/CRESPx/multiplier?network=Solana
...
- `xstocks.circ.CLONPx` [ok] 200 1026ms https://api.backed.fi/api/v2/public/assets/CLONPx/circulating-supply?format=object
- `xstocks.circ.WHGROx` [ok] 200 964ms https://api.backed.fi/api/v2/public/assets/WHGROx/circulating-supply?format=object
- `xstocks.circ.CTFJWx` [ok] 200 1326ms https://api.backed.fi/api/v2/public/assets/CTFJWx/circulating-supply?format=object
...
- `xstocks.circ.CTPCAx` [ok] 200 1023ms https://api.backed.fi/api/v2/public/assets/CTPCAx/circulating-supply?format=object
- `xstocks.circ.SINOx` [ok] 200 1155ms https://api.backed.fi/api/v2/public/assets/SINOx/circulating-supply?format=object
- `xstocks.mult.SINOx` [ok] 200 132ms https://api.backed.fi/api/v2/public/assets/SINOx/multiplier?network=Solana
- `xstocks.mult.CLONPx` [ok] 200 991ms https://api.backed.fi/api/v2/public/assets/CLONPx/multiplier?network=Solana
...
- `xstocks.circ.PWAHLx` [ok] 200 1078ms https://api.backed.fi/api/v2/public/assets/PWAHLx/circulating-supply?format=object
...
- `xstocks.circ.WUXIBx` [ok] 200 1001ms https://api.backed.fi/api/v2/public/assets/WUXIBx/circulating-supply?format=object
- `xstocks.circ.CRAUTx` [ok] 200 1114ms https://api.backed.fi/api/v2/public/assets/CRAUTx/circulating-supply?format=object
- `xstocks.mult.WUXIBx` [ok] 200 155ms https://api.backed.fi/api/v2/public/assets/WUXIBx/multiplier?network=Solana
- `xstocks.circ.GENTEx` [ok] 200 1655ms https://api.backed.fi/api/v2/public/assets/GENTEx/circulating-supply?format=object
...
- `xstocks.circ.CKAHx` [ok] 200 1030ms https://api.backed.fi/api/v2/public/assets/CKAHx/circulating-supply?format=object
- `xstocks.mult.CKAHx` [ok] 200 134ms https://api.backed.fi/api/v2/public/assets/CKAHx/multiplier?network=Solana
- `xstocks.circ.CKINFx` [ok] 200 1600ms https://api.backed.fi/api/v2/public/assets/CKINFx/circulating-supply?format=object
- `xstocks.mult.CKINFx` [ok] 200 161ms https://api.backed.fi/api/v2/public/assets/CKINFx/multiplier?network=Solana
- `xstocks.circ.SWPRPx` [ok] 200 3469ms https://api.backed.fi/api/v2/public/assets/SWPRPx/circulating-supply?format=object
...
- `xstocks.circ.HKCGAx` [ok] 200 1084ms https://api.backed.fi/api/v2/public/assets/HKCGAx/circulating-supply?format=object
- `xstocks.mult.HKCGAx` [ok] 200 165ms https://api.backed.fi/api/v2/public/assets/HKCGAx/multiplier?network=Solana
- `xstocks.circ.KUAIx` [ok] 200 1176ms https://api.backed.fi/api/v2/public/assets/KUAIx/circulating-supply?format=object
...
- `xstocks.mult.COVELx` [ok] 200 161ms https://api.backed.fi/api/v2/public/assets/COVELx/multiplier?network=Solana
...
- `xstocks.circ.HKEXCx` [ok] 200 999ms https://api.backed.fi/api/v2/public/assets/HKEXCx/circulating-supply?format=object
...
- `xstocks.circ.MEITx` [ok] 200 150ms https://api.backed.fi/api/v2/public/assets/MEITx/circulating-supply?format=object
...
- `xstocks.circ.MTRCPx` [ok] 200 849ms https://api.backed.fi/api/v2/public/assets/MTRCPx/circulating-supply?format=object
- `xstocks.mult.HNDLDx` [ok] 200 137ms https://api.backed.fi/api/v2/public/assets/HNDLDx/multiplier?network=Solana
- `xstocks.price.PICCx` [FAIL]  12008ms https://api.backed.fi/api/v2/public/assets/PICCx/price-data — TimeoutError: The read operation timed out
...
- `xstocks.mult.CKHUTx` [ok] 200 355ms https://api.backed.fi/api/v2/public/assets/CKHUTx/multiplier?network=Solana
- `xstocks.mult.MTRCPx` [ok] 200 1280ms https://api.backed.fi/api/v2/public/assets/MTRCPx/multiplier?network=Solana
- `xstocks.mult.POPMTx` [ok] 200 414ms https://api.backed.fi/api/v2/public/assets/POPMTx/multiplier?network=Solana
- `xstocks.circ.COSCx` [ok] 200 1689ms https://api.backed.fi/api/v2/public/assets/COSCx/circulating-supply?format=object
...
- `xstocks.mult.CPETCx` [ok] 200 763ms https://api.backed.fi/api/v2/public/assets/CPETCx/multiplier?network=Solana
...
- `xstocks.circ.ANTASx` [ok] 200 303ms https://api.backed.fi/api/v2/public/assets/ANTASx/circulating-supply?format=object
...
- `xstocks.mult.CRESLx` [ok] 200 245ms https://api.backed.fi/api/v2/public/assets/CRESLx/multiplier?network=Solana
- `xstocks.mult.ANTASx` [ok] 200 399ms https://api.backed.fi/api/v2/public/assets/ANTASx/multiplier?network=Solana
- `xstocks.mult.HAIERx` [ok] 200 429ms https://api.backed.fi/api/v2/public/assets/HAIERx/multiplier?network=Solana
...
- `xstocks.circ.ZJGLDx` [ok] 200 466ms https://api.backed.fi/api/v2/public/assets/ZJGLDx/circulating-supply?format=object
...
- `xstocks.mult.PSBOCx` [ok] 200 665ms https://api.backed.fi/api/v2/public/assets/PSBOCx/multiplier?network=Solana
- `xstocks.price.ICBCx` [FAIL]  12014ms https://api.backed.fi/api/v2/public/assets/ICBCx/price-data — TimeoutError: The read operation timed out
...
- `jup.tokens.search.SUOPTx` [ok] 200 38ms https://lite-api.jup.ag/tokens/v2/search?query=SUOPTx
